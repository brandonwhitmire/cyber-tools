#!/bin/sh
# cyber-tools-srcsha: b6d72713a8da939a320d7baca44f3ef99fd379d18638a10fb54975166d0295ff
...
if [ "$SEARCH_IN_FOLDER" ]; then
  ...
  FIND_DIR_CUSTOM=`eval_bckgrd "find $SEARCH_IN_FOLDER -type d -name \"sites-enabled\" -o -name \".codex\" -o -name \"rke2\" -o -name \"crio\" -o -name \"roundcube\" -o -name \"Google Cloud Directory Sync\" -o -name \"k0s\" -o -name \"system-services\" -o -name \"kubernetes.io\" -o -name \"ErrorRecords\" -o -name \"ldap\" -o -name \".kube*\" -o -name \"doctl\" -o -name \"keyrings\" -o -name \".svn\" -o -name \".vnc\" -o -name \".password-store\" -o -name \"system-local.d\" -o -name \"services\" -o -name \".irssi\" -o -name \"net.d\" -o -name \"kube-proxy\" -o -name \"concourse-keys\" -o -name \"k3s\" -o -name \"logstash\" -o -name \"couchdb\" -o -name \"Google Password Sync\" -o -name \"seeddms*\" -o -name \"legacy_credentials\" -o -name \"apt.conf.d\" -o -name \".cloudflared\" -o -name \"dirsrv\" -o -name \"varnish\" -o -name \"system.d\" -o -name \".gemini\" -o -name \"pam.d\" -o -name \"ipa\" -o -name \"concourse-auth\" -o -name \"system-connections\" -o -name \".docker\" -o -name \"etcd\" -o -name \"sentry\" -o -name \"origin\" -o -name \"kubelet\" -o -name \"bind\" -o -name \"filezilla\" -o -name \".claude\" -o -name \"gcloud\" -o -name \".cursor\" -o -name \"zabbix\" -o -name \".bluemix\" -o -name \"*jenkins\" -o -name \"neo4j\" -o -name \"gh\" -o -name \"cacti\" -o -name \"kubernetes\" -o -name \"environments\" -o -name \"microk8s\" -o -name \"wpa_supplicant\" -o -name \"postfix\" -o -name \"containerd\" -o -name \"session.d\" -o -name \"mysql\" -o -name \"nginx\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_CUSTOM=`eval_bckgrd "find $SEARCH_IN_FOLDER -name \"state.vscdb.backup\" -o -name \"snmpd.conf\" -o -name \"*.kdbx\" -o -name \"supervisord.conf\" -o -name \"*.rdg\" -o -name \"groups.xml\" -o -name \"msal_http_cache.bin\" -o -name \"setupinfo.bak\" -o -name \"*.gpg\" -o -name \"*.viminfo\" -o -name \".pypirc\" -o -name \"hudson.util.Secret\" -o -name \"cloud.cfg\" -o -name \"pg_hba.conf\" -o -name \"psk.txt\" -o -name \".claude.json\" -o -name \"ipsec.secrets\" -o -name \"credentials.tfrc.json\" -o -name \"autologin\" -o -name \"secring.gpg\" -o -name \"gitlab.rm\" -o -name \"snyk.json\" -o -name \"rsyncd.conf\" -o -name \"gitlab.yml\" -o -name \"unattended.xml\" -o -name \"SAM\" -o -name \"sites.ini\" -o -name \"KeePass.enforced*\" -o -name \"docker-compose.yml\" -o -name \"pgsql.conf\" -o -name \".secrets.mkey\" -o -name \"master.key\" -o -name \"scheduledtasks.xml\" -o -name \"*.crt\" -o -name \"private-keys-v1.d/*.key\" -o -name \"id_rsa*\" -o -name \"passbolt.php\" -o -name \"docker.sock\" -o -name \"pgadmin*.db\" -o -name \"pgadmin4.db\" -o -name \"appcmd.exe\" -o -name \".k5login\" -o -name \"ws_ftp.ini\" -o -name \"ddclient.conf\" -o -name \"msal_token_cache.json\" -o -name \"*.vhd\" -o -name \"ftp.config\" -o -name \"firebase-tools.json\" -o -name \".git\" -o -name \".plan\" -o -name \"webserver_config.py\" -o -name \"postgresql.conf\" -o -name \".sudo_as_admin_successful\" -o -name \"*.sqlite3\" -o -name \"service_principal_entries.json\" -o -name \"*.sqlite\" -o -name \".profile\" -o -name \"*kubeconfig*\" -o -name \"*.tfstate\" -o -name \"id_dsa*\" -o -name \"sitemanager.xml\" -o -name \"index.dat\" -o -name \"krb5cc_*\" -o -name \"*.swp\" -o -name \"airflow.cfg\" -o -name \"aliases\" -o -name \"*.pcapng\" -o -name \"SecEvent.Evt\" -o -name \"rsyncd.secrets\" -o -name \"legacy_credentials.db\" -o -name \".roadtools_auth\" -o -name \"state.vscdb\" -o -name \"*.maintenance*\" -o -name \"*vnc*.xml\" -o -name \"config.xml\" -o -name \"docker.socket\" -o -name \"hosts.equiv\" -o -name \"passwd.ibd\" -o -name \"*.pem\" -o -name \"server.xml\" -o -name \"Dockerfile\" -o -name \"rktlet.sock\" -o -name \"vsftpd.conf\" -o -name \".wgetrc\" -o -name \"NetSetup.log\" -o -name \"msal_token_cache.bin\" -o -name \"sysprep.inf\" -o -name \"krb5.conf\" -o -name \"pwd.ibd\" -o -name \"azureProfile.json\" -o -name \"unattend.xml\" -o -name \"ssh-agent.sock\" -o -name \"authorized_hosts\" -o -name \"racoon.conf\" -o -name \"TokenCache.dat\" -o -name \"FreePBX.conf\" -o -name \"service_principal_entries.bin\" -o -name \"jetty-realm.properties\" -o -name \"glusterfs.key\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.cer\" -o -name \"RDCMan.settings\" -o -name \"backups\" -o -name \"agent.*\" -o -name \"kibana.y*ml\" -o -name \"*knockd*\" -o -name \"wp-config.php\" -o -name \"adc.json\" -o -name \"passwd\" -o -name \"autounattend.xml\" -o -name \"*vnc*.txt\" -o -name \"plum.sqlite\" -o -name \"secrets.ldb\" -o -name \"bash.exe\" -o -name \"db.php\" -o -name \"crontab-ui.service\" -o -name \"*.pub\" -o -name \".credentials.json\" -o -name \"pubring.kbx\" -o -name \"filezilla.xml\" -o -name \"*vnc*.ini\" -o -name \"ffftp.ini\" -o -name \"ftp.ini\" -o -name \".github\" -o -name \".Xauthority\" -o -name \".mcp.json\" -o -name \"bitcoin.conf\" -o -name \"vault-ssh-helper.hcl\" -o -name \".msmtprc\" -o -name \"setupinfo\" -o -name \"*.p12\" -o -name \"credentials.db\" -o -name \"*_history*\" -o -name \"ntuser.dat\" -o -name \"backup\" -o -name \"sess_*\" -o -name \"bootstrap-kubelet.conf\" -o -name \"ConsoleHost_history.txt\" -o -name \".erlang.cookie\" -o -name \"smb.conf\" -o -name \"access_tokens.db\" -o -name \"*.vhdx\" -o -name \"https-xampp.conf\" -o -name \"grafana.ini\" -o -name \"containerd.sock\" -o -name \"glusterfs.ca\" -o -name \"000-default.conf\" -o -name \"printers.xml\" -o -name \"storage.php\" -o -name \"api_key\" -o -name \".htpasswd\" -o -name \"security.sav\" -o -name \"amportal.conf\" -o -name \"atlantis.db\" -o -name \"database.php\" -o -name \"secrets.yml\" -o -name \"access_tokens.json\" -o -name \"mariadb.cnf\" -o -name \"sssd.conf\" -o -name \".ldaprc\" -o -name \"*.vmdk\" -o -name \"frakti.sock\" -o -name \"scclient.exe\" -o -name \"keys.log\" -o -name \"creds*\" -o -name \"software.sav\" -o -name \"tomcat-users.xml\" -o -name \"web*.config\" -o -name \"error.log\" -o -name \".rhosts\" -o -name \"sentry.conf.py\" -o -name \"protecteduserkey.bin\" -o -name \"Elastix.conf\" -o -name \"nginx.conf\" -o -name \"*.ftpconfig\" -o -name \"apt.conf\" -o -name \"https.conf\" -o -name \"clouds.config\" -o -name \"AzureRMContext.json\" -o -name \"anaconda-ks.cfg\" -o -name \"trustdb.gpg\" -o -name \"autologin.conf\" -o -name \"environment\" -o -name \"*.ovpn\" -o -name \".git-credentials\" -o -name \"*.keyring\" -o -name \"debian.cnf\" -o -name \".gitconfig\" -o -name \"mosquitto.conf\" -o -name \"unattend.inf\" -o -name \"*.pcap\" -o -name \"known_hosts\" -o -name \"kubelet.conf\" -o -name \"secret.asc\" -o -name \"KeePass.ini\" -o -name \"glusterfs.pem\" -o -name \"*.pgp\" -o -name \"hostapd.conf\" -o -name \"admin.conf\" -o -name \"*credential*\" -o -name \"mongod*.conf\" -o -name \"*.db\" -o -name \".recently-used.xbel\" -o -name \"exports\" -o -name \"*vnc*.c*nf*\" -o -name \".flyrc\" -o -name \".bashrc\" -o -name \"*.timer\" -o -name \"elasticsearch.y*ml\" -o -name \"gpg-agent.conf\" -o -name \"*config*.php\" -o -name \".vault-token\" -o -name \"sysprep.xml\" -o -name \"settings.php\" -o -name \".boto\" -o -name \"ssh*config\" -o -name \"accessTokens.json\" -o -name \"wcx_ftp.ini\" -o -name \"default.sav\" -o -name \".pgpass\" -o -name \"SYSTEM\" -o -name \"software\" -o -name \"*password*\" -o -name \"*.key\" -o -name \"rocketchat.service\" -o -name \"snyk.config.json\" -o -name \"zabbix_server.conf\" -o -name \"storage.json\" -o -name \"httpd.conf\" -o -name \"redis.conf\" -o -name \"recentservers.xml\" -o -name \"crio.sock\" -o -name \"*.psk\" -o -name \".env*\" -o -name \"*.der\" -o -name \"AppEvent.Evt\" -o -name \"crontab.db\" -o -name \"*.tf\" -o -name \"system.sav\" -o -name \"*.service\" -o -name \"*.asc\" -o -name \"password*.ibd\" -o -name \"*.pfx\" -o -name \"KeePass.config*\" -o -name \"winscp.ini\" -o -name \".lesshst\" -o -name \"dockershim.sock\" -o -name \"sslkeylog.log\" -o -name \"zabbix_agentd.conf\" -o -name \"gvm-tools.conf\" -o -name \"log4j-core*.jar\" -o -name \"sip.conf\" -o -name \"unattend.txt\" -o -name \"my.ini\" -o -name \"wsl.exe\" -o -name \".mylogin.cnf\" -o -name \".google_authenticator\" -o -name \"my.cnf\" -o -name \"credentials.xml\" -o -name \"php.ini\" -o -name \"fastcgi_params\" -o -name \"*.gnupg\" -o -name \"config.php\" -o -name \"access.log\" -o -name \"pagefile.sys\" -o -name \"mysqld.cnf\" -o -name \"cesi.conf\" -o -name \"rpcd\" -o -name \"*.jks\" -o -name \"ipsec.conf\" -o -name \"*.csr\" -o -name \"influxdb.conf\" -o -name \"drives.xml\" -o -name \"datasources.xml\" -o -name \"*.keytab\" -o -name \"*.socket\" -o -name \"iis6.log\" -o -name \"kcpassword\" -o -name \"authorized_keys\" -o -name \"kadm5.acl\" -o -name \"*.keystore\" -o -name \"Ntds.dit\" -o -name \"fat.config\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  CONT_THREADS=0
  # FIND ALL KNOWN INTERESTING SOFTWARE FILES
  FIND_DIR_APPLICATIONS=`eval_bckgrd "find ${ROOT_FOLDER}applications -type d -name \"sites-enabled\" -o -name \".codex\" -o -name \"roundcube\" -o -name \"Google Cloud Directory Sync\" -o -name \"ErrorRecords\" -o -name \"ldap\" -o -name \".kube*\" -o -name \"doctl\" -o -name \"keyrings\" -o -name \".svn\" -o -name \".vnc\" -o -name \".password-store\" -o -name \".irssi\" -o -name \"concourse-keys\" -o -name \"logstash\" -o -name \"couchdb\" -o -name \"Google Password Sync\" -o -name \"seeddms*\" -o -name \"legacy_credentials\" -o -name \"apt.conf.d\" -o -name \".cloudflared\" -o -name \"dirsrv\" -o -name \"varnish\" -o -name \".gemini\" -o -name \"ipa\" -o -name \"concourse-auth\" -o -name \".docker\" -o -name \"sentry\" -o -name \"filezilla\" -o -name \".claude\" -o -name \"gcloud\" -o -name \".cursor\" -o -name \"zabbix\" -o -name \".bluemix\" -o -name \"*jenkins\" -o -name \"neo4j\" -o -name \"gh\" -o -name \"cacti\" -o -name \"environments\" -o -name \"postfix\" -o -name \"mysql\" -o -name \"nginx\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_BIN=`eval_bckgrd "find ${ROOT_FOLDER}bin -type d -name \"sites-enabled\" -o -name \".codex\" -o -name \"roundcube\" -o -name \"Google Cloud Directory Sync\" -o -name \"ErrorRecords\" -o -name \"ldap\" -o -name \".kube*\" -o -name \"doctl\" -o -name \"keyrings\" -o -name \".svn\" -o -name \".vnc\" -o -name \".password-store\" -o -name \".irssi\" -o -name \"concourse-keys\" -o -name \"logstash\" -o -name \"couchdb\" -o -name \"Google Password Sync\" -o -name \"seeddms*\" -o -name \"legacy_credentials\" -o -name \"apt.conf.d\" -o -name \".cloudflared\" -o -name \"dirsrv\" -o -name \"varnish\" -o -name \".gemini\" -o -name \"ipa\" -o -name \"concourse-auth\" -o -name \".docker\" -o -name \"sentry\" -o -name \"filezilla\" -o -name \".claude\" -o -name \"gcloud\" -o -name \".cursor\" -o -name \"zabbix\" -o -name \".bluemix\" -o -name \"*jenkins\" -o -name \"neo4j\" -o -name \"gh\" -o -name \"cacti\" -o -name \"environments\" -o -name \"postfix\" -o -name \"mysql\" -o -name \"nginx\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_CACHE=`eval_bckgrd "find ${ROOT_FOLDER}.cache -type d -name \"sites-enabled\" -o -name \".codex\" -o -name \"roundcube\" -o -name \"Google Cloud Directory Sync\" -o -name \"ErrorRecords\" -o -name \"ldap\" -o -name \".kube*\" -o -name \"doctl\" -o -name \"keyrings\" -o -name \".svn\" -o -name \".vnc\" -o -name \".password-store\" -o -name \".irssi\" -o -name \"concourse-keys\" -o -name \"logstash\" -o -name \"couchdb\" -o -name \"Google Password Sync\" -o -name \"seeddms*\" -o -name \"legacy_credentials\" -o -name \"apt.conf.d\" -o -name \".cloudflared\" -o -name \"dirsrv\" -o -name \"varnish\" -o -name \".gemini\" -o -name \"ipa\" -o -name \"concourse-auth\" -o -name \".docker\" -o -name \"sentry\" -o -name \"filezilla\" -o -name \".claude\" -o -name \"gcloud\" -o -name \".cursor\" -o -name \"zabbix\" -o -name \".bluemix\" -o -name \"*jenkins\" -o -name \"neo4j\" -o -name \"gh\" -o -name \"cacti\" -o -name \"environments\" -o -name \"postfix\" -o -name \"mysql\" -o -name \"nginx\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_CDROM=`eval_bckgrd "find ${ROOT_FOLDER}cdrom -type d -name \"sites-enabled\" -o -name \".codex\" -o -name \"roundcube\" -o -name \"Google Cloud Directory Sync\" -o -name \"ErrorRecords\" -o -name \"ldap\" -o -name \".kube*\" -o -name \"doctl\" -o -name \"keyrings\" -o -name \".svn\" -o -name \".vnc\" -o -name \".password-store\" -o -name \".irssi\" -o -name \"concourse-keys\" -o -name \"logstash\" -o -name \"couchdb\" -o -name \"Google Password Sync\" -o -name \"seeddms*\" -o -name \"legacy_credentials\" -o -name \"apt.conf.d\" -o -name \".cloudflared\" -o -name \"dirsrv\" -o -name \"varnish\" -o -name \".gemini\" -o -name \"ipa\" -o -name \"concourse-auth\" -o -name \".docker\" -o -name \"sentry\" -o -name \"filezilla\" -o -name \".claude\" -o -name \"gcloud\" -o -name \".cursor\" -o -name \"zabbix\" -o -name \".bluemix\" -o -name \"*jenkins\" -o -name \"neo4j\" -o -name \"gh\" -o -name \"cacti\" -o -name \"environments\" -o -name \"postfix\" -o -name \"mysql\" -o -name \"nginx\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_ETC=`eval_bckgrd "find ${ROOT_FOLDER}etc -type d -name \"sites-enabled\" -o -name \"rke2\" -o -name \".codex\" -o -name \"crio\" -o -name \"k0s\" -o -name \"Google Cloud Directory Sync\" -o -name \"roundcube\" -o -name \"ErrorRecords\" -o -name \"ldap\" -o -name \".kube*\" -o -name \"system-local.d\" -o -name \"doctl\" -o -name \"keyrings\" -o -name \".vnc\" -o -name \".svn\" -o -name \".password-store\" -o -name \"net.d\" -o -name \"kube-proxy\" -o -name \".irssi\" -o -name \"concourse-keys\" -o -name \"k3s\" -o -name \"logstash\" -o -name \"couchdb\" -o -name \"Google Password Sync\" -o -name \"seeddms*\" -o -name \"legacy_credentials\" -o -name \"apt.conf.d\" -o -name \".cloudflared\" -o -name \"dirsrv\" -o -name \"varnish\" -o -name \"system.d\" -o -name \".gemini\" -o -name \"pam.d\" -o -name \"ipa\" -o -name \"concourse-auth\" -o -name \"system-connections\" -o -name \"etcd\" -o -name \"origin\" -o -name \".docker\" -o -name \"kubelet\" -o -name \"bind\" -o -name \"sentry\" -o -name \"filezilla\" -o -name \".claude\" -o -name \"gcloud\" -o -name \".cursor\" -o -name \"zabbix\" -o -name \".bluemix\" -o -name \"*jenkins\" -o -name \"neo4j\" -o -name \"gh\" -o -name \"kubernetes\" -o -name \"cacti\" -o -name \"environments\" -o -name \"wpa_supplicant\" -o -name \"containerd\" -o -name \"postfix\" -o -name \"session.d\" -o -name \"mysql\" -o -name \"nginx\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_HOMESEARCH=`eval_bckgrd "find $HOMESEARCH -type d -name \"sites-enabled\" -o -name \".codex\" -o -name \"roundcube\" -o -name \"Google Cloud Directory Sync\" -o -name \"ErrorRecords\" -o -name \"ldap\" -o -name \".kube*\" -o -name \"doctl\" -o -name \"keyrings\" -o -name \".svn\" -o -name \".vnc\" -o -name \".password-store\" -o -name \".irssi\" -o -name \"concourse-keys\" -o -name \"logstash\" -o -name \"couchdb\" -o -name \"Google Password Sync\" -o -name \"seeddms*\" -o -name \"legacy_credentials\" -o -name \"apt.conf.d\" -o -name \".cloudflared\" -o -name \"dirsrv\" -o -name \"varnish\" -o -name \".gemini\" -o -name \"ipa\" -o -name \"concourse-auth\" -o -name \".docker\" -o -name \"sentry\" -o -name \"filezilla\" -o -name \".claude\" -o -name \"gcloud\" -o -name \".cursor\" -o -name \"zabbix\" -o -name \".bluemix\" -o -name \"*jenkins\" -o -name \"neo4j\" -o -name \"gh\" -o -name \"cacti\" -o -name \"environments\" -o -name \"postfix\" -o -name \"mysql\" -o -name \"nginx\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_MEDIA=`eval_bckgrd "find ${ROOT_FOLDER}media -type d -name \"sites-enabled\" -o -name \".codex\" -o -name \"roundcube\" -o -name \"Google Cloud Directory Sync\" -o -name \"ErrorRecords\" -o -name \"ldap\" -o -name \".kube*\" -o -name \"doctl\" -o -name \"keyrings\" -o -name \".svn\" -o -name \".vnc\" -o -name \".password-store\" -o -name \".irssi\" -o -name \"concourse-keys\" -o -name \"logstash\" -o -name \"couchdb\" -o -name \"Google Password Sync\" -o -name \"seeddms*\" -o -name \"legacy_credentials\" -o -name \"apt.conf.d\" -o -name \".cloudflared\" -o -name \"dirsrv\" -o -name \"varnish\" -o -name \".gemini\" -o -name \"ipa\" -o -name \"concourse-auth\" -o -name \".docker\" -o -name \"sentry\" -o -name \"filezilla\" -o -name \".claude\" -o -name \"gcloud\" -o -name \".cursor\" -o -name \"zabbix\" -o -name \".bluemix\" -o -name \"*jenkins\" -o -name \"neo4j\" -o -name \"gh\" -o -name \"cacti\" -o -name \"environments\" -o -name \"postfix\" -o -name \"mysql\" -o -name \"nginx\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_MNT=`eval_bckgrd "find ${ROOT_FOLDER}mnt -type d -name \"sites-enabled\" -o -name \".codex\" -o -name \"roundcube\" -o -name \"Google Cloud Directory Sync\" -o -name \"ErrorRecords\" -o -name \"ldap\" -o -name \".kube*\" -o -name \"doctl\" -o -name \"keyrings\" -o -name \".svn\" -o -name \".vnc\" -o -name \".password-store\" -o -name \".irssi\" -o -name \"concourse-keys\" -o -name \"logstash\" -o -name \"couchdb\" -o -name \"Google Password Sync\" -o -name \"seeddms*\" -o -name \"legacy_credentials\" -o -name \"apt.conf.d\" -o -name \".cloudflared\" -o -name \"dirsrv\" -o -name \"varnish\" -o -name \".gemini\" -o -name \"ipa\" -o -name \"concourse-auth\" -o -name \".docker\" -o -name \"sentry\" -o -name \"filezilla\" -o -name \".claude\" -o -name \"gcloud\" -o -name \".cursor\" -o -name \"zabbix\" -o -name \".bluemix\" -o -name \"*jenkins\" -o -name \"neo4j\" -o -name \"gh\" -o -name \"cacti\" -o -name \"environments\" -o -name \"postfix\" -o -name \"mysql\" -o -name \"nginx\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_OPT=`eval_bckgrd "find ${ROOT_FOLDER}opt -type d -name \"sites-enabled\" -o -name \".codex\" -o -name \"roundcube\" -o -name \"Google Cloud Directory Sync\" -o -name \"ErrorRecords\" -o -name \"ldap\" -o -name \".kube*\" -o -name \"doctl\" -o -name \"keyrings\" -o -name \".svn\" -o -name \".vnc\" -o -name \".password-store\" -o -name \".irssi\" -o -name \"concourse-keys\" -o -name \"logstash\" -o -name \"couchdb\" -o -name \"Google Password Sync\" -o -name \"seeddms*\" -o -name \"legacy_credentials\" -o -name \"apt.conf.d\" -o -name \".cloudflared\" -o -name \"dirsrv\" -o -name \"varnish\" -o -name \".gemini\" -o -name \"ipa\" -o -name \"concourse-auth\" -o -name \".docker\" -o -name \"sentry\" -o -name \"filezilla\" -o -name \".claude\" -o -name \"gcloud\" -o -name \".cursor\" -o -name \"zabbix\" -o -name \".bluemix\" -o -name \"*jenkins\" -o -name \"neo4j\" -o -name \"gh\" -o -name \"cacti\" -o -name \"environments\" -o -name \"postfix\" -o -name \"mysql\" -o -name \"nginx\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_PRIVATE=`eval_bckgrd "find ${ROOT_FOLDER}private -type d -name \"sites-enabled\" -o -name \".codex\" -o -name \"roundcube\" -o -name \"Google Cloud Directory Sync\" -o -name \"ErrorRecords\" -o -name \"ldap\" -o -name \".kube*\" -o -name \"doctl\" -o -name \"keyrings\" -o -name \".svn\" -o -name \".vnc\" -o -name \".password-store\" -o -name \".irssi\" -o -name \"concourse-keys\" -o -name \"logstash\" -o -name \"couchdb\" -o -name \"Google Password Sync\" -o -name \"seeddms*\" -o -name \"legacy_credentials\" -o -name \"apt.conf.d\" -o -name \".cloudflared\" -o -name \"dirsrv\" -o -name \"varnish\" -o -name \".gemini\" -o -name \"ipa\" -o -name \"concourse-auth\" -o -name \".docker\" -o -name \"sentry\" -o -name \"filezilla\" -o -name \".claude\" -o -name \"gcloud\" -o -name \".cursor\" -o -name \"zabbix\" -o -name \".bluemix\" -o -name \"*jenkins\" -o -name \"neo4j\" -o -name \"gh\" -o -name \"cacti\" -o -name \"environments\" -o -name \"postfix\" -o -name \"mysql\" -o -name \"nginx\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_RUN=`eval_bckgrd "find ${ROOT_FOLDER}run -type d -name \"kubernetes.io\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SBIN=`eval_bckgrd "find ${ROOT_FOLDER}sbin -type d -name \"sites-enabled\" -o -name \".codex\" -o -name \"roundcube\" -o -name \"Google Cloud Directory Sync\" -o -name \"ErrorRecords\" -o -name \"ldap\" -o -name \".kube*\" -o -name \"doctl\" -o -name \"keyrings\" -o -name \".svn\" -o -name \".vnc\" -o -name \".password-store\" -o -name \".irssi\" -o -name \"concourse-keys\" -o -name \"logstash\" -o -name \"couchdb\" -o -name \"Google Password Sync\" -o -name \"seeddms*\" -o -name \"legacy_credentials\" -o -name \"apt.conf.d\" -o -name \".cloudflared\" -o -name \"dirsrv\" -o -name \"varnish\" -o -name \".gemini\" -o -name \"ipa\" -o -name \"concourse-auth\" -o -name \".docker\" -o -name \"sentry\" -o -name \"filezilla\" -o -name \".claude\" -o -name \"gcloud\" -o -name \".cursor\" -o -name \"zabbix\" -o -name \".bluemix\" -o -name \"*jenkins\" -o -name \"neo4j\" -o -name \"gh\" -o -name \"cacti\" -o -name \"environments\" -o -name \"postfix\" -o -name \"mysql\" -o -name \"nginx\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SNAP=`eval_bckgrd "find ${ROOT_FOLDER}snap -type d -name \"sites-enabled\" -o -name \".codex\" -o -name \"roundcube\" -o -name \"Google Cloud Directory Sync\" -o -name \"ErrorRecords\" -o -name \"ldap\" -o -name \".kube*\" -o -name \"doctl\" -o -name \"keyrings\" -o -name \".svn\" -o -name \".vnc\" -o -name \".password-store\" -o -name \".irssi\" -o -name \"concourse-keys\" -o -name \"logstash\" -o -name \"couchdb\" -o -name \"Google Password Sync\" -o -name \"seeddms*\" -o -name \"legacy_credentials\" -o -name \"apt.conf.d\" -o -name \".cloudflared\" -o -name \"dirsrv\" -o -name \"varnish\" -o -name \".gemini\" -o -name \"ipa\" -o -name \"concourse-auth\" -o -name \".docker\" -o -name \"sentry\" -o -name \"filezilla\" -o -name \".claude\" -o -name \"gcloud\" -o -name \".cursor\" -o -name \"zabbix\" -o -name \".bluemix\" -o -name \"*jenkins\" -o -name \"neo4j\" -o -name \"gh\" -o -name \"cacti\" -o -name \"environments\" -o -name \"postfix\" -o -name \"mysql\" -o -name \"nginx\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SRV=`eval_bckgrd "find ${ROOT_FOLDER}srv -type d -name \"sites-enabled\" -o -name \".codex\" -o -name \"roundcube\" -o -name \"Google Cloud Directory Sync\" -o -name \"ErrorRecords\" -o -name \"ldap\" -o -name \".kube*\" -o -name \"doctl\" -o -name \"keyrings\" -o -name \".svn\" -o -name \".vnc\" -o -name \".password-store\" -o -name \".irssi\" -o -name \"concourse-keys\" -o -name \"logstash\" -o -name \"couchdb\" -o -name \"Google Password Sync\" -o -name \"seeddms*\" -o -name \"legacy_credentials\" -o -name \"apt.conf.d\" -o -name \".cloudflared\" -o -name \"dirsrv\" -o -name \"varnish\" -o -name \".gemini\" -o -name \"ipa\" -o -name \"concourse-auth\" -o -name \".docker\" -o -name \"sentry\" -o -name \"filezilla\" -o -name \".claude\" -o -name \"gcloud\" -o -name \".cursor\" -o -name \"zabbix\" -o -name \".bluemix\" -o -name \"*jenkins\" -o -name \"neo4j\" -o -name \"gh\" -o -name \"cacti\" -o -name \"environments\" -o -name \"postfix\" -o -name \"mysql\" -o -name \"nginx\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_TMP=`eval_bckgrd "find ${ROOT_FOLDER}tmp -type d -name \"sites-enabled\" -o -name \".codex\" -o -name \"roundcube\" -o -name \"Google Cloud Directory Sync\" -o -name \"ErrorRecords\" -o -name \"ldap\" -o -name \".kube*\" -o -name \"doctl\" -o -name \"keyrings\" -o -name \".svn\" -o -name \".vnc\" -o -name \".password-store\" -o -name \".irssi\" -o -name \"concourse-keys\" -o -name \"logstash\" -o -name \"couchdb\" -o -name \"Google Password Sync\" -o -name \"seeddms*\" -o -name \"legacy_credentials\" -o -name \"apt.conf.d\" -o -name \".cloudflared\" -o -name \"dirsrv\" -o -name \"varnish\" -o -name \".gemini\" -o -name \"ipa\" -o -name \"concourse-auth\" -o -name \".docker\" -o -name \"sentry\" -o -name \"filezilla\" -o -name \".claude\" -o -name \"gcloud\" -o -name \".cursor\" -o -name \"zabbix\" -o -name \".bluemix\" -o -name \"*jenkins\" -o -name \"neo4j\" -o -name \"gh\" -o -name \"cacti\" -o -name \"environments\" -o -name \"postfix\" -o -name \"mysql\" -o -name \"nginx\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_USR=`eval_bckgrd "find ${ROOT_FOLDER}usr -type d -name \"sites-enabled\" -o -name \".codex\" -o -name \"roundcube\" -o -name \"Google Cloud Directory Sync\" -o -name \"system-services\" -o -name \"ErrorRecords\" -o -name \"ldap\" -o -name \".kube*\" -o -name \"doctl\" -o -name \"keyrings\" -o -name \".svn\" -o -name \".vnc\" -o -name \".password-store\" -o -name \"services\" -o -name \".irssi\" -o -name \"concourse-keys\" -o -name \"logstash\" -o -name \"couchdb\" -o -name \"Google Password Sync\" -o -name \"seeddms*\" -o -name \"legacy_credentials\" -o -name \"apt.conf.d\" -o -name \".cloudflared\" -o -name \"dirsrv\" -o -name \"varnish\" -o -name \".gemini\" -o -name \"ipa\" -o -name \"concourse-auth\" -o -name \".docker\" -o -name \"bind\" -o -name \"sentry\" -o -name \"filezilla\" -o -name \".claude\" -o -name \"gcloud\" -o -name \".cursor\" -o -name \"zabbix\" -o -name \".bluemix\" -o -name \"*jenkins\" -o -name \"neo4j\" -o -name \"gh\" -o -name \"cacti\" -o -name \"environments\" -o -name \"postfix\" -o -name \"session.d\" -o -name \"mysql\" -o -name \"nginx\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_VAR=`eval_bckgrd "find ${ROOT_FOLDER}var -type d -name \"sites-enabled\" -o -name \"rke2\" -o -name \".codex\" -o -name \"crio\" -o -name \"k0s\" -o -name \"Google Cloud Directory Sync\" -o -name \"roundcube\" -o -name \"kubernetes.io\" -o -name \"ErrorRecords\" -o -name \"ldap\" -o -name \".kube*\" -o -name \"doctl\" -o -name \"keyrings\" -o -name \".svn\" -o -name \".vnc\" -o -name \".password-store\" -o -name \"net.d\" -o -name \"kube-proxy\" -o -name \".irssi\" -o -name \"concourse-keys\" -o -name \"k3s\" -o -name \"logstash\" -o -name \"couchdb\" -o -name \"Google Password Sync\" -o -name \"seeddms*\" -o -name \"legacy_credentials\" -o -name \"apt.conf.d\" -o -name \".cloudflared\" -o -name \"dirsrv\" -o -name \"varnish\" -o -name \".gemini\" -o -name \"ipa\" -o -name \"concourse-auth\" -o -name \"etcd\" -o -name \"origin\" -o -name \".docker\" -o -name \"kubelet\" -o -name \"bind\" -o -name \"sentry\" -o -name \"filezilla\" -o -name \".claude\" -o -name \"gcloud\" -o -name \".cursor\" -o -name \"zabbix\" -o -name \".bluemix\" -o -name \"*jenkins\" -o -name \"neo4j\" -o -name \"gh\" -o -name \"kubernetes\" -o -name \"cacti\" -o -name \"environments\" -o -name \"microk8s\" -o -name \"containerd\" -o -name \"postfix\" -o -name \"mysql\" -o -name \"nginx\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  FIND_APPLICATIONS=`eval_bckgrd "find ${ROOT_FOLDER}applications -name \"state.vscdb.backup\" -o -name \"snmpd.conf\" -o -name \"supervisord.conf\" -o -name \"*.kdbx\" -o -name \"*.rdg\" -o -name \"groups.xml\" -o -name \"msal_http_cache.bin\" -o -name \"setupinfo.bak\" -o -name \"*.gpg\" -o -name \"*.viminfo\" -o -name \".pypirc\" -o -name \"hudson.util.Secret\" -o -name \"cloud.cfg\" -o -name \"pg_hba.conf\" -o -name \"psk.txt\" -o -name \".claude.json\" -o -name \"ipsec.secrets\" -o -name \"credentials.tfrc.json\" -o -name \"autologin\" -o -name \"secring.gpg\" -o -name \"gitlab.rm\" -o -name \"snyk.json\" -o -name \"rsyncd.conf\" -o -name \"gitlab.yml\" -o -name \"unattended.xml\" -o -name \"SAM\" -o -name \"sites.ini\" -o -name \"KeePass.enforced*\" -o -name \"docker-compose.yml\" -o -name \"pgsql.conf\" -o -name \".secrets.mkey\" -o -name \"master.key\" -o -name \"scheduledtasks.xml\" -o -name \"*.crt\" -o -name \"private-keys-v1.d/*.key\" -o -name \"id_rsa*\" -o -name \"passbolt.php\" -o -name \"docker.sock\" -o -name \"pgadmin*.db\" -o -name \"pgadmin4.db\" -o -name \"appcmd.exe\" -o -name \".k5login\" -o -name \"ws_ftp.ini\" -o -name \"ddclient.conf\" -o -name \"msal_token_cache.json\" -o -name \"*.vhd\" -o -name \"ftp.config\" -o -name \"firebase-tools.json\" -o -name \".git\" -o -name \".plan\" -o -name \"webserver_config.py\" -o -name \"postgresql.conf\" -o -name \".sudo_as_admin_successful\" -o -name \"*.sqlite3\" -o -name \"service_principal_entries.json\" -o -name \"*.sqlite\" -o -name \".profile\" -o -name \"*kubeconfig*\" -o -name \"*.tfstate\" -o -name \"id_dsa*\" -o -name \"sitemanager.xml\" -o -name \"index.dat\" -o -name \"krb5cc_*\" -o -name \"*.swp\" -o -name \"airflow.cfg\" -o -name \"aliases\" -o -name \"*.pcapng\" -o -name \"SecEvent.Evt\" -o -name \"rsyncd.secrets\" -o -name \"legacy_credentials.db\" -o -name \"state.vscdb\" -o -name \".roadtools_auth\" -o -name \"*.maintenance*\" -o -name \"*vnc*.xml\" -o -name \"config.xml\" -o -name \"docker.socket\" -o -name \"hosts.equiv\" -o -name \"passwd.ibd\" -o -name \"*.pem\" -o -name \"server.xml\" -o -name \"Dockerfile\" -o -name \"rktlet.sock\" -o -name \"vsftpd.conf\" -o -name \".wgetrc\" -o -name \"NetSetup.log\" -o -name \"msal_token_cache.bin\" -o -name \"sysprep.inf\" -o -name \"krb5.conf\" -o -name \"pwd.ibd\" -o -name \"azureProfile.json\" -o -name \"unattend.xml\" -o -name \"authorized_hosts\" -o -name \"racoon.conf\" -o -name \"TokenCache.dat\" -o -name \"FreePBX.conf\" -o -name \"service_principal_entries.bin\" -o -name \"jetty-realm.properties\" -o -name \"glusterfs.key\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.cer\" -o -name \"RDCMan.settings\" -o -name \"backups\" -o -name \"kibana.y*ml\" -o -name \"wp-config.php\" -o -name \"adc.json\" -o -name \"passwd\" -o -name \"autounattend.xml\" -o -name \"*vnc*.txt\" -o -name \"plum.sqlite\" -o -name \"secrets.ldb\" -o -name \"bash.exe\" -o -name \"db.php\" -o -name \"crontab-ui.service\" -o -name \"*.pub\" -o -name \".credentials.json\" -o -name \"pubring.kbx\" -o -name \"filezilla.xml\" -o -name \"*vnc*.ini\" -o -name \"ffftp.ini\" -o -name \"ftp.ini\" -o -name \".github\" -o -name \".Xauthority\" -o -name \".mcp.json\" -o -name \"bitcoin.conf\" -o -name \"vault-ssh-helper.hcl\" -o -name \".msmtprc\" -o -name \"setupinfo\" -o -name \"*.p12\" -o -name \"credentials.db\" -o -name \"*_history*\" -o -name \"ntuser.dat\" -o -name \"backup\" -o -name \"bootstrap-kubelet.conf\" -o -name \"ConsoleHost_history.txt\" -o -name \".erlang.cookie\" -o -name \"smb.conf\" -o -name \"access_tokens.db\" -o -name \"*.vhdx\" -o -name \"https-xampp.conf\" -o -name \"grafana.ini\" -o -name \"containerd.sock\" -o -name \"glusterfs.ca\" -o -name \"000-default.conf\" -o -name \"printers.xml\" -o -name \"storage.php\" -o -name \"api_key\" -o -name \".htpasswd\" -o -name \"security.sav\" -o -name \"amportal.conf\" -o -name \"atlantis.db\" -o -name \"database.php\" -o -name \"secrets.yml\" -o -name \"access_tokens.json\" -o -name \"mariadb.cnf\" -o -name \"sssd.conf\" -o -name \".ldaprc\" -o -name \"*.vmdk\" -o -name \"frakti.sock\" -o -name \"scclient.exe\" -o -name \"keys.log\" -o -name \"creds*\" -o -name \"software.sav\" -o -name \"tomcat-users.xml\" -o -name \"web*.config\" -o -name \"error.log\" -o -name \".rhosts\" -o -name \"sentry.conf.py\" -o -name \"protecteduserkey.bin\" -o -name \"Elastix.conf\" -o -name \"nginx.conf\" -o -name \"*.ftpconfig\" -o -name \"apt.conf\" -o -name \"https.conf\" -o -name \"clouds.config\" -o -name \"AzureRMContext.json\" -o -name \"anaconda-ks.cfg\" -o -name \"trustdb.gpg\" -o -name \"autologin.conf\" -o -name \"environment\" -o -name \"*.ovpn\" -o -name \".git-credentials\" -o -name \"*.keyring\" -o -name \"debian.cnf\" -o -name \".gitconfig\" -o -name \"mosquitto.conf\" -o -name \"unattend.inf\" -o -name \"*.pcap\" -o -name \"known_hosts\" -o -name \"kubelet.conf\" -o -name \"secret.asc\" -o -name \"KeePass.ini\" -o -name \"glusterfs.pem\" -o -name \"*.pgp\" -o -name \"hostapd.conf\" -o -name \"admin.conf\" -o -name \"*credential*\" -o -name \"mongod*.conf\" -o -name \"*.db\" -o -name \".recently-used.xbel\" -o -name \"*vnc*.c*nf*\" -o -name \".flyrc\" -o -name \".bashrc\" -o -name \"*.timer\" -o -name \"elasticsearch.y*ml\" -o -name \"gpg-agent.conf\" -o -name \"*config*.php\" -o -name \".vault-token\" -o -name \"sysprep.xml\" -o -name \"settings.php\" -o -name \".boto\" -o -name \"accessTokens.json\" -o -name \"wcx_ftp.ini\" -o -name \"default.sav\" -o -name \".pgpass\" -o -name \"SYSTEM\" -o -name \"software\" -o -name \"*password*\" -o -name \"*.key\" -o -name \"rocketchat.service\" -o -name \"snyk.config.json\" -o -name \"zabbix_server.conf\" -o -name \"storage.json\" -o -name \"httpd.conf\" -o -name \"redis.conf\" -o -name \"recentservers.xml\" -o -name \"crio.sock\" -o -name \"*.psk\" -o -name \".env*\" -o -name \"*.der\" -o -name \"AppEvent.Evt\" -o -name \"crontab.db\" -o -name \"*.tf\" -o -name \"system.sav\" -o -name \"*.service\" -o -name \"*.asc\" -o -name \"password*.ibd\" -o -name \"*.pfx\" -o -name \"KeePass.config*\" -o -name \"winscp.ini\" -o -name \".lesshst\" -o -name \"dockershim.sock\" -o -name \"sslkeylog.log\" -o -name \"zabbix_agentd.conf\" -o -name \"gvm-tools.conf\" -o -name \"log4j-core*.jar\" -o -name \"sip.conf\" -o -name \"unattend.txt\" -o -name \"my.ini\" -o -name \"wsl.exe\" -o -name \".mylogin.cnf\" -o -name \".google_authenticator\" -o -name \"my.cnf\" -o -name \"credentials.xml\" -o -name \"php.ini\" -o -name \"fastcgi_params\" -o -name \"*.gnupg\" -o -name \"config.php\" -o -name \"access.log\" -o -name \"pagefile.sys\" -o -name \"mysqld.cnf\" -o -name \"cesi.conf\" -o -name \"rpcd\" -o -name \"*.jks\" -o -name \"ipsec.conf\" -o -name \"*.csr\" -o -name \"influxdb.conf\" -o -name \"drives.xml\" -o -name \"datasources.xml\" -o -name \"*.keytab\" -o -name \"*.socket\" -o -name \"iis6.log\" -o -name \"kcpassword\" -o -name \"authorized_keys\" -o -name \"kadm5.acl\" -o -name \"*.keystore\" -o -name \"Ntds.dit\" -o -name \"fat.config\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_BIN=`eval_bckgrd "find ${ROOT_FOLDER}bin -name \"state.vscdb.backup\" -o -name \"snmpd.conf\" -o -name \"supervisord.conf\" -o -name \"*.kdbx\" -o -name \"*.rdg\" -o -name \"groups.xml\" -o -name \"msal_http_cache.bin\" -o -name \"setupinfo.bak\" -o -name \"*.gpg\" -o -name \"*.viminfo\" -o -name \".pypirc\" -o -name \"hudson.util.Secret\" -o -name \"cloud.cfg\" -o -name \"pg_hba.conf\" -o -name \"psk.txt\" -o -name \".claude.json\" -o -name \"ipsec.secrets\" -o -name \"credentials.tfrc.json\" -o -name \"autologin\" -o -name \"secring.gpg\" -o -name \"gitlab.rm\" -o -name \"snyk.json\" -o -name \"rsyncd.conf\" -o -name \"gitlab.yml\" -o -name \"unattended.xml\" -o -name \"SAM\" -o -name \"sites.ini\" -o -name \"KeePass.enforced*\" -o -name \"docker-compose.yml\" -o -name \"pgsql.conf\" -o -name \".secrets.mkey\" -o -name \"master.key\" -o -name \"scheduledtasks.xml\" -o -name \"*.crt\" -o -name \"private-keys-v1.d/*.key\" -o -name \"id_rsa*\" -o -name \"passbolt.php\" -o -name \"docker.sock\" -o -name \"pgadmin*.db\" -o -name \"pgadmin4.db\" -o -name \"appcmd.exe\" -o -name \".k5login\" -o -name \"ws_ftp.ini\" -o -name \"ddclient.conf\" -o -name \"msal_token_cache.json\" -o -name \"*.vhd\" -o -name \"ftp.config\" -o -name \"firebase-tools.json\" -o -name \".git\" -o -name \".plan\" -o -name \"webserver_config.py\" -o -name \"postgresql.conf\" -o -name \".sudo_as_admin_successful\" -o -name \"*.sqlite3\" -o -name \"service_principal_entries.json\" -o -name \"*.sqlite\" -o -name \".profile\" -o -name \"*kubeconfig*\" -o -name \"*.tfstate\" -o -name \"id_dsa*\" -o -name \"sitemanager.xml\" -o -name \"index.dat\" -o -name \"krb5cc_*\" -o -name \"*.swp\" -o -name \"airflow.cfg\" -o -name \"aliases\" -o -name \"*.pcapng\" -o -name \"SecEvent.Evt\" -o -name \"rsyncd.secrets\" -o -name \"legacy_credentials.db\" -o -name \"state.vscdb\" -o -name \".roadtools_auth\" -o -name \"*.maintenance*\" -o -name \"*vnc*.xml\" -o -name \"config.xml\" -o -name \"docker.socket\" -o -name \"hosts.equiv\" -o -name \"passwd.ibd\" -o -name \"*.pem\" -o -name \"server.xml\" -o -name \"Dockerfile\" -o -name \"rktlet.sock\" -o -name \"vsftpd.conf\" -o -name \".wgetrc\" -o -name \"NetSetup.log\" -o -name \"msal_token_cache.bin\" -o -name \"sysprep.inf\" -o -name \"krb5.conf\" -o -name \"pwd.ibd\" -o -name \"azureProfile.json\" -o -name \"unattend.xml\" -o -name \"authorized_hosts\" -o -name \"racoon.conf\" -o -name \"TokenCache.dat\" -o -name \"FreePBX.conf\" -o -name \"service_principal_entries.bin\" -o -name \"jetty-realm.properties\" -o -name \"glusterfs.key\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.cer\" -o -name \"RDCMan.settings\" -o -name \"backups\" -o -name \"kibana.y*ml\" -o -name \"wp-config.php\" -o -name \"adc.json\" -o -name \"passwd\" -o -name \"autounattend.xml\" -o -name \"*vnc*.txt\" -o -name \"plum.sqlite\" -o -name \"secrets.ldb\" -o -name \"bash.exe\" -o -name \"db.php\" -o -name \"crontab-ui.service\" -o -name \"*.pub\" -o -name \".credentials.json\" -o -name \"pubring.kbx\" -o -name \"filezilla.xml\" -o -name \"*vnc*.ini\" -o -name \"ffftp.ini\" -o -name \"ftp.ini\" -o -name \".github\" -o -name \".Xauthority\" -o -name \".mcp.json\" -o -name \"bitcoin.conf\" -o -name \"vault-ssh-helper.hcl\" -o -name \".msmtprc\" -o -name \"setupinfo\" -o -name \"*.p12\" -o -name \"credentials.db\" -o -name \"*_history*\" -o -name \"ntuser.dat\" -o -name \"backup\" -o -name \"bootstrap-kubelet.conf\" -o -name \"ConsoleHost_history.txt\" -o -name \".erlang.cookie\" -o -name \"smb.conf\" -o -name \"access_tokens.db\" -o -name \"*.vhdx\" -o -name \"https-xampp.conf\" -o -name \"grafana.ini\" -o -name \"containerd.sock\" -o -name \"glusterfs.ca\" -o -name \"000-default.conf\" -o -name \"printers.xml\" -o -name \"storage.php\" -o -name \"api_key\" -o -name \".htpasswd\" -o -name \"security.sav\" -o -name \"amportal.conf\" -o -name \"atlantis.db\" -o -name \"database.php\" -o -name \"secrets.yml\" -o -name \"access_tokens.json\" -o -name \"mariadb.cnf\" -o -name \"sssd.conf\" -o -name \".ldaprc\" -o -name \"*.vmdk\" -o -name \"frakti.sock\" -o -name \"scclient.exe\" -o -name \"keys.log\" -o -name \"creds*\" -o -name \"software.sav\" -o -name \"tomcat-users.xml\" -o -name \"web*.config\" -o -name \"error.log\" -o -name \".rhosts\" -o -name \"sentry.conf.py\" -o -name \"protecteduserkey.bin\" -o -name \"Elastix.conf\" -o -name \"nginx.conf\" -o -name \"*.ftpconfig\" -o -name \"apt.conf\" -o -name \"https.conf\" -o -name \"clouds.config\" -o -name \"AzureRMContext.json\" -o -name \"anaconda-ks.cfg\" -o -name \"trustdb.gpg\" -o -name \"autologin.conf\" -o -name \"environment\" -o -name \"*.ovpn\" -o -name \".git-credentials\" -o -name \"*.keyring\" -o -name \"debian.cnf\" -o -name \".gitconfig\" -o -name \"mosquitto.conf\" -o -name \"unattend.inf\" -o -name \"*.pcap\" -o -name \"known_hosts\" -o -name \"kubelet.conf\" -o -name \"secret.asc\" -o -name \"KeePass.ini\" -o -name \"glusterfs.pem\" -o -name \"*.pgp\" -o -name \"hostapd.conf\" -o -name \"admin.conf\" -o -name \"*credential*\" -o -name \"mongod*.conf\" -o -name \"*.db\" -o -name \".recently-used.xbel\" -o -name \"*vnc*.c*nf*\" -o -name \".flyrc\" -o -name \".bashrc\" -o -name \"*.timer\" -o -name \"elasticsearch.y*ml\" -o -name \"gpg-agent.conf\" -o -name \"*config*.php\" -o -name \".vault-token\" -o -name \"sysprep.xml\" -o -name \"settings.php\" -o -name \".boto\" -o -name \"accessTokens.json\" -o -name \"wcx_ftp.ini\" -o -name \"default.sav\" -o -name \".pgpass\" -o -name \"SYSTEM\" -o -name \"software\" -o -name \"*password*\" -o -name \"*.key\" -o -name \"rocketchat.service\" -o -name \"snyk.config.json\" -o -name \"zabbix_server.conf\" -o -name \"storage.json\" -o -name \"httpd.conf\" -o -name \"redis.conf\" -o -name \"recentservers.xml\" -o -name \"crio.sock\" -o -name \"*.psk\" -o -name \".env*\" -o -name \"*.der\" -o -name \"AppEvent.Evt\" -o -name \"crontab.db\" -o -name \"*.tf\" -o -name \"system.sav\" -o -name \"*.service\" -o -name \"*.asc\" -o -name \"password*.ibd\" -o -name \"*.pfx\" -o -name \"KeePass.config*\" -o -name \"winscp.ini\" -o -name \".lesshst\" -o -name \"dockershim.sock\" -o -name \"sslkeylog.log\" -o -name \"zabbix_agentd.conf\" -o -name \"gvm-tools.conf\" -o -name \"log4j-core*.jar\" -o -name \"sip.conf\" -o -name \"unattend.txt\" -o -name \"my.ini\" -o -name \"wsl.exe\" -o -name \".mylogin.cnf\" -o -name \".google_authenticator\" -o -name \"my.cnf\" -o -name \"credentials.xml\" -o -name \"php.ini\" -o -name \"fastcgi_params\" -o -name \"*.gnupg\" -o -name \"config.php\" -o -name \"access.log\" -o -name \"pagefile.sys\" -o -name \"mysqld.cnf\" -o -name \"cesi.conf\" -o -name \"rpcd\" -o -name \"*.jks\" -o -name \"ipsec.conf\" -o -name \"*.csr\" -o -name \"influxdb.conf\" -o -name \"drives.xml\" -o -name \"datasources.xml\" -o -name \"*.keytab\" -o -name \"*.socket\" -o -name \"iis6.log\" -o -name \"kcpassword\" -o -name \"authorized_keys\" -o -name \"kadm5.acl\" -o -name \"*.keystore\" -o -name \"Ntds.dit\" -o -name \"fat.config\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_CACHE=`eval_bckgrd "find ${ROOT_FOLDER}.cache -name \"state.vscdb.backup\" -o -name \"snmpd.conf\" -o -name \"supervisord.conf\" -o -name \"*.kdbx\" -o -name \"*.rdg\" -o -name \"groups.xml\" -o -name \"msal_http_cache.bin\" -o -name \"setupinfo.bak\" -o -name \"*.gpg\" -o -name \"*.viminfo\" -o -name \".pypirc\" -o -name \"hudson.util.Secret\" -o -name \"cloud.cfg\" -o -name \"pg_hba.conf\" -o -name \"psk.txt\" -o -name \".claude.json\" -o -name \"ipsec.secrets\" -o -name \"credentials.tfrc.json\" -o -name \"autologin\" -o -name \"secring.gpg\" -o -name \"gitlab.rm\" -o -name \"snyk.json\" -o -name \"rsyncd.conf\" -o -name \"gitlab.yml\" -o -name \"unattended.xml\" -o -name \"SAM\" -o -name \"sites.ini\" -o -name \"KeePass.enforced*\" -o -name \"docker-compose.yml\" -o -name \"pgsql.conf\" -o -name \".secrets.mkey\" -o -name \"master.key\" -o -name \"scheduledtasks.xml\" -o -name \"*.crt\" -o -name \"private-keys-v1.d/*.key\" -o -name \"id_rsa*\" -o -name \"passbolt.php\" -o -name \"docker.sock\" -o -name \"pgadmin*.db\" -o -name \"pgadmin4.db\" -o -name \"appcmd.exe\" -o -name \".k5login\" -o -name \"ws_ftp.ini\" -o -name \"ddclient.conf\" -o -name \"msal_token_cache.json\" -o -name \"*.vhd\" -o -name \"ftp.config\" -o -name \"firebase-tools.json\" -o -name \".git\" -o -name \".plan\" -o -name \"webserver_config.py\" -o -name \"postgresql.conf\" -o -name \".sudo_as_admin_successful\" -o -name \"*.sqlite3\" -o -name \"service_principal_entries.json\" -o -name \"*.sqlite\" -o -name \".profile\" -o -name \"*kubeconfig*\" -o -name \"*.tfstate\" -o -name \"id_dsa*\" -o -name \"sitemanager.xml\" -o -name \"index.dat\" -o -name \"krb5cc_*\" -o -name \"*.swp\" -o -name \"airflow.cfg\" -o -name \"aliases\" -o -name \"*.pcapng\" -o -name \"SecEvent.Evt\" -o -name \"rsyncd.secrets\" -o -name \"legacy_credentials.db\" -o -name \"state.vscdb\" -o -name \".roadtools_auth\" -o -name \"*.maintenance*\" -o -name \"*vnc*.xml\" -o -name \"config.xml\" -o -name \"docker.socket\" -o -name \"hosts.equiv\" -o -name \"passwd.ibd\" -o -name \"*.pem\" -o -name \"server.xml\" -o -name \"Dockerfile\" -o -name \"rktlet.sock\" -o -name \"vsftpd.conf\" -o -name \".wgetrc\" -o -name \"NetSetup.log\" -o -name \"msal_token_cache.bin\" -o -name \"sysprep.inf\" -o -name \"krb5.conf\" -o -name \"pwd.ibd\" -o -name \"azureProfile.json\" -o -name \"unattend.xml\" -o -name \"authorized_hosts\" -o -name \"racoon.conf\" -o -name \"TokenCache.dat\" -o -name \"FreePBX.conf\" -o -name \"service_principal_entries.bin\" -o -name \"jetty-realm.properties\" -o -name \"glusterfs.key\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.cer\" -o -name \"RDCMan.settings\" -o -name \"backups\" -o -name \"kibana.y*ml\" -o -name \"wp-config.php\" -o -name \"adc.json\" -o -name \"passwd\" -o -name \"autounattend.xml\" -o -name \"*vnc*.txt\" -o -name \"plum.sqlite\" -o -name \"secrets.ldb\" -o -name \"bash.exe\" -o -name \"db.php\" -o -name \"crontab-ui.service\" -o -name \"*.pub\" -o -name \".credentials.json\" -o -name \"pubring.kbx\" -o -name \"filezilla.xml\" -o -name \"*vnc*.ini\" -o -name \"ffftp.ini\" -o -name \"ftp.ini\" -o -name \".github\" -o -name \".Xauthority\" -o -name \".mcp.json\" -o -name \"bitcoin.conf\" -o -name \"vault-ssh-helper.hcl\" -o -name \".msmtprc\" -o -name \"setupinfo\" -o -name \"*.p12\" -o -name \"credentials.db\" -o -name \"*_history*\" -o -name \"ntuser.dat\" -o -name \"backup\" -o -name \"bootstrap-kubelet.conf\" -o -name \"ConsoleHost_history.txt\" -o -name \".erlang.cookie\" -o -name \"smb.conf\" -o -name \"access_tokens.db\" -o -name \"*.vhdx\" -o -name \"https-xampp.conf\" -o -name \"grafana.ini\" -o -name \"containerd.sock\" -o -name \"glusterfs.ca\" -o -name \"000-default.conf\" -o -name \"printers.xml\" -o -name \"storage.php\" -o -name \"api_key\" -o -name \".htpasswd\" -o -name \"security.sav\" -o -name \"amportal.conf\" -o -name \"atlantis.db\" -o -name \"database.php\" -o -name \"secrets.yml\" -o -name \"access_tokens.json\" -o -name \"mariadb.cnf\" -o -name \"sssd.conf\" -o -name \".ldaprc\" -o -name \"*.vmdk\" -o -name \"frakti.sock\" -o -name \"scclient.exe\" -o -name \"keys.log\" -o -name \"creds*\" -o -name \"software.sav\" -o -name \"tomcat-users.xml\" -o -name \"web*.config\" -o -name \"error.log\" -o -name \".rhosts\" -o -name \"sentry.conf.py\" -o -name \"protecteduserkey.bin\" -o -name \"Elastix.conf\" -o -name \"nginx.conf\" -o -name \"*.ftpconfig\" -o -name \"apt.conf\" -o -name \"https.conf\" -o -name \"clouds.config\" -o -name \"AzureRMContext.json\" -o -name \"anaconda-ks.cfg\" -o -name \"trustdb.gpg\" -o -name \"autologin.conf\" -o -name \"environment\" -o -name \"*.ovpn\" -o -name \".git-credentials\" -o -name \"*.keyring\" -o -name \"debian.cnf\" -o -name \".gitconfig\" -o -name \"mosquitto.conf\" -o -name \"unattend.inf\" -o -name \"*.pcap\" -o -name \"known_hosts\" -o -name \"kubelet.conf\" -o -name \"secret.asc\" -o -name \"KeePass.ini\" -o -name \"glusterfs.pem\" -o -name \"*.pgp\" -o -name \"hostapd.conf\" -o -name \"admin.conf\" -o -name \"*credential*\" -o -name \"mongod*.conf\" -o -name \"*.db\" -o -name \".recently-used.xbel\" -o -name \"*vnc*.c*nf*\" -o -name \".flyrc\" -o -name \".bashrc\" -o -name \"*.timer\" -o -name \"elasticsearch.y*ml\" -o -name \"gpg-agent.conf\" -o -name \"*config*.php\" -o -name \".vault-token\" -o -name \"sysprep.xml\" -o -name \"settings.php\" -o -name \".boto\" -o -name \"accessTokens.json\" -o -name \"wcx_ftp.ini\" -o -name \"default.sav\" -o -name \".pgpass\" -o -name \"SYSTEM\" -o -name \"software\" -o -name \"*password*\" -o -name \"*.key\" -o -name \"rocketchat.service\" -o -name \"snyk.config.json\" -o -name \"zabbix_server.conf\" -o -name \"storage.json\" -o -name \"httpd.conf\" -o -name \"redis.conf\" -o -name \"recentservers.xml\" -o -name \"crio.sock\" -o -name \"*.psk\" -o -name \".env*\" -o -name \"*.der\" -o -name \"AppEvent.Evt\" -o -name \"crontab.db\" -o -name \"*.tf\" -o -name \"system.sav\" -o -name \"*.service\" -o -name \"*.asc\" -o -name \"password*.ibd\" -o -name \"*.pfx\" -o -name \"KeePass.config*\" -o -name \"winscp.ini\" -o -name \".lesshst\" -o -name \"dockershim.sock\" -o -name \"sslkeylog.log\" -o -name \"zabbix_agentd.conf\" -o -name \"gvm-tools.conf\" -o -name \"log4j-core*.jar\" -o -name \"sip.conf\" -o -name \"unattend.txt\" -o -name \"my.ini\" -o -name \"wsl.exe\" -o -name \".mylogin.cnf\" -o -name \".google_authenticator\" -o -name \"my.cnf\" -o -name \"credentials.xml\" -o -name \"php.ini\" -o -name \"fastcgi_params\" -o -name \"*.gnupg\" -o -name \"config.php\" -o -name \"access.log\" -o -name \"pagefile.sys\" -o -name \"mysqld.cnf\" -o -name \"cesi.conf\" -o -name \"rpcd\" -o -name \"*.jks\" -o -name \"ipsec.conf\" -o -name \"*.csr\" -o -name \"influxdb.conf\" -o -name \"drives.xml\" -o -name \"datasources.xml\" -o -name \"*.keytab\" -o -name \"*.socket\" -o -name \"iis6.log\" -o -name \"kcpassword\" -o -name \"authorized_keys\" -o -name \"kadm5.acl\" -o -name \"*.keystore\" -o -name \"Ntds.dit\" -o -name \"fat.config\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_CDROM=`eval_bckgrd "find ${ROOT_FOLDER}cdrom -name \"state.vscdb.backup\" -o -name \"snmpd.conf\" -o -name \"supervisord.conf\" -o -name \"*.kdbx\" -o -name \"*.rdg\" -o -name \"groups.xml\" -o -name \"msal_http_cache.bin\" -o -name \"setupinfo.bak\" -o -name \"*.gpg\" -o -name \"*.viminfo\" -o -name \".pypirc\" -o -name \"hudson.util.Secret\" -o -name \"cloud.cfg\" -o -name \"pg_hba.conf\" -o -name \"psk.txt\" -o -name \".claude.json\" -o -name \"ipsec.secrets\" -o -name \"credentials.tfrc.json\" -o -name \"autologin\" -o -name \"secring.gpg\" -o -name \"gitlab.rm\" -o -name \"snyk.json\" -o -name \"rsyncd.conf\" -o -name \"gitlab.yml\" -o -name \"unattended.xml\" -o -name \"SAM\" -o -name \"sites.ini\" -o -name \"KeePass.enforced*\" -o -name \"docker-compose.yml\" -o -name \"pgsql.conf\" -o -name \".secrets.mkey\" -o -name \"master.key\" -o -name \"scheduledtasks.xml\" -o -name \"*.crt\" -o -name \"private-keys-v1.d/*.key\" -o -name \"id_rsa*\" -o -name \"passbolt.php\" -o -name \"docker.sock\" -o -name \"pgadmin*.db\" -o -name \"pgadmin4.db\" -o -name \"appcmd.exe\" -o -name \".k5login\" -o -name \"ws_ftp.ini\" -o -name \"ddclient.conf\" -o -name \"msal_token_cache.json\" -o -name \"*.vhd\" -o -name \"ftp.config\" -o -name \"firebase-tools.json\" -o -name \".git\" -o -name \".plan\" -o -name \"webserver_config.py\" -o -name \"postgresql.conf\" -o -name \".sudo_as_admin_successful\" -o -name \"*.sqlite3\" -o -name \"service_principal_entries.json\" -o -name \"*.sqlite\" -o -name \".profile\" -o -name \"*kubeconfig*\" -o -name \"*.tfstate\" -o -name \"id_dsa*\" -o -name \"sitemanager.xml\" -o -name \"index.dat\" -o -name \"krb5cc_*\" -o -name \"*.swp\" -o -name \"airflow.cfg\" -o -name \"aliases\" -o -name \"*.pcapng\" -o -name \"SecEvent.Evt\" -o -name \"rsyncd.secrets\" -o -name \"legacy_credentials.db\" -o -name \"state.vscdb\" -o -name \".roadtools_auth\" -o -name \"*.maintenance*\" -o -name \"*vnc*.xml\" -o -name \"config.xml\" -o -name \"docker.socket\" -o -name \"hosts.equiv\" -o -name \"passwd.ibd\" -o -name \"*.pem\" -o -name \"server.xml\" -o -name \"Dockerfile\" -o -name \"rktlet.sock\" -o -name \"vsftpd.conf\" -o -name \".wgetrc\" -o -name \"NetSetup.log\" -o -name \"msal_token_cache.bin\" -o -name \"sysprep.inf\" -o -name \"krb5.conf\" -o -name \"pwd.ibd\" -o -name \"azureProfile.json\" -o -name \"unattend.xml\" -o -name \"authorized_hosts\" -o -name \"racoon.conf\" -o -name \"TokenCache.dat\" -o -name \"FreePBX.conf\" -o -name \"service_principal_entries.bin\" -o -name \"jetty-realm.properties\" -o -name \"glusterfs.key\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.cer\" -o -name \"RDCMan.settings\" -o -name \"backups\" -o -name \"kibana.y*ml\" -o -name \"wp-config.php\" -o -name \"adc.json\" -o -name \"passwd\" -o -name \"autounattend.xml\" -o -name \"*vnc*.txt\" -o -name \"plum.sqlite\" -o -name \"secrets.ldb\" -o -name \"bash.exe\" -o -name \"db.php\" -o -name \"crontab-ui.service\" -o -name \"*.pub\" -o -name \".credentials.json\" -o -name \"pubring.kbx\" -o -name \"filezilla.xml\" -o -name \"*vnc*.ini\" -o -name \"ffftp.ini\" -o -name \"ftp.ini\" -o -name \".github\" -o -name \".Xauthority\" -o -name \".mcp.json\" -o -name \"bitcoin.conf\" -o -name \"vault-ssh-helper.hcl\" -o -name \".msmtprc\" -o -name \"setupinfo\" -o -name \"*.p12\" -o -name \"credentials.db\" -o -name \"*_history*\" -o -name \"ntuser.dat\" -o -name \"backup\" -o -name \"bootstrap-kubelet.conf\" -o -name \"ConsoleHost_history.txt\" -o -name \".erlang.cookie\" -o -name \"smb.conf\" -o -name \"access_tokens.db\" -o -name \"*.vhdx\" -o -name \"https-xampp.conf\" -o -name \"grafana.ini\" -o -name \"containerd.sock\" -o -name \"glusterfs.ca\" -o -name \"000-default.conf\" -o -name \"printers.xml\" -o -name \"storage.php\" -o -name \"api_key\" -o -name \".htpasswd\" -o -name \"security.sav\" -o -name \"amportal.conf\" -o -name \"atlantis.db\" -o -name \"database.php\" -o -name \"secrets.yml\" -o -name \"access_tokens.json\" -o -name \"mariadb.cnf\" -o -name \"sssd.conf\" -o -name \".ldaprc\" -o -name \"*.vmdk\" -o -name \"frakti.sock\" -o -name \"scclient.exe\" -o -name \"keys.log\" -o -name \"creds*\" -o -name \"software.sav\" -o -name \"tomcat-users.xml\" -o -name \"web*.config\" -o -name \"error.log\" -o -name \".rhosts\" -o -name \"sentry.conf.py\" -o -name \"protecteduserkey.bin\" -o -name \"Elastix.conf\" -o -name \"nginx.conf\" -o -name \"*.ftpconfig\" -o -name \"apt.conf\" -o -name \"https.conf\" -o -name \"clouds.config\" -o -name \"AzureRMContext.json\" -o -name \"anaconda-ks.cfg\" -o -name \"trustdb.gpg\" -o -name \"autologin.conf\" -o -name \"environment\" -o -name \"*.ovpn\" -o -name \".git-credentials\" -o -name \"*.keyring\" -o -name \"debian.cnf\" -o -name \".gitconfig\" -o -name \"mosquitto.conf\" -o -name \"unattend.inf\" -o -name \"*.pcap\" -o -name \"known_hosts\" -o -name \"kubelet.conf\" -o -name \"secret.asc\" -o -name \"KeePass.ini\" -o -name \"glusterfs.pem\" -o -name \"*.pgp\" -o -name \"hostapd.conf\" -o -name \"admin.conf\" -o -name \"*credential*\" -o -name \"mongod*.conf\" -o -name \"*.db\" -o -name \".recently-used.xbel\" -o -name \"*vnc*.c*nf*\" -o -name \".flyrc\" -o -name \".bashrc\" -o -name \"*.timer\" -o -name \"elasticsearch.y*ml\" -o -name \"gpg-agent.conf\" -o -name \"*config*.php\" -o -name \".vault-token\" -o -name \"sysprep.xml\" -o -name \"settings.php\" -o -name \".boto\" -o -name \"accessTokens.json\" -o -name \"wcx_ftp.ini\" -o -name \"default.sav\" -o -name \".pgpass\" -o -name \"SYSTEM\" -o -name \"software\" -o -name \"*password*\" -o -name \"*.key\" -o -name \"rocketchat.service\" -o -name \"snyk.config.json\" -o -name \"zabbix_server.conf\" -o -name \"storage.json\" -o -name \"httpd.conf\" -o -name \"redis.conf\" -o -name \"recentservers.xml\" -o -name \"crio.sock\" -o -name \"*.psk\" -o -name \".env*\" -o -name \"*.der\" -o -name \"AppEvent.Evt\" -o -name \"crontab.db\" -o -name \"*.tf\" -o -name \"system.sav\" -o -name \"*.service\" -o -name \"*.asc\" -o -name \"password*.ibd\" -o -name \"*.pfx\" -o -name \"KeePass.config*\" -o -name \"winscp.ini\" -o -name \".lesshst\" -o -name \"dockershim.sock\" -o -name \"sslkeylog.log\" -o -name \"zabbix_agentd.conf\" -o -name \"gvm-tools.conf\" -o -name \"log4j-core*.jar\" -o -name \"sip.conf\" -o -name \"unattend.txt\" -o -name \"my.ini\" -o -name \"wsl.exe\" -o -name \".mylogin.cnf\" -o -name \".google_authenticator\" -o -name \"my.cnf\" -o -name \"credentials.xml\" -o -name \"php.ini\" -o -name \"fastcgi_params\" -o -name \"*.gnupg\" -o -name \"config.php\" -o -name \"access.log\" -o -name \"pagefile.sys\" -o -name \"mysqld.cnf\" -o -name \"cesi.conf\" -o -name \"rpcd\" -o -name \"*.jks\" -o -name \"ipsec.conf\" -o -name \"*.csr\" -o -name \"influxdb.conf\" -o -name \"drives.xml\" -o -name \"datasources.xml\" -o -name \"*.keytab\" -o -name \"*.socket\" -o -name \"iis6.log\" -o -name \"kcpassword\" -o -name \"authorized_keys\" -o -name \"kadm5.acl\" -o -name \"*.keystore\" -o -name \"Ntds.dit\" -o -name \"fat.config\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_ETC=`eval_bckgrd "find ${ROOT_FOLDER}etc -name \"state.vscdb.backup\" -o -name \"snmpd.conf\" -o -name \"supervisord.conf\" -o -name \"*.kdbx\" -o -name \"*.rdg\" -o -name \"groups.xml\" -o -name \"msal_http_cache.bin\" -o -name \"setupinfo.bak\" -o -name \"*.gpg\" -o -name \"*.viminfo\" -o -name \".pypirc\" -o -name \"hudson.util.Secret\" -o -name \"cloud.cfg\" -o -name \"pg_hba.conf\" -o -name \"psk.txt\" -o -name \".claude.json\" -o -name \"ipsec.secrets\" -o -name \"credentials.tfrc.json\" -o -name \"autologin\" -o -name \"secring.gpg\" -o -name \"gitlab.rm\" -o -name \"snyk.json\" -o -name \"rsyncd.conf\" -o -name \"gitlab.yml\" -o -name \"unattended.xml\" -o -name \"SAM\" -o -name \"sites.ini\" -o -name \"KeePass.enforced*\" -o -name \"docker-compose.yml\" -o -name \"pgsql.conf\" -o -name \".secrets.mkey\" -o -name \"master.key\" -o -name \"scheduledtasks.xml\" -o -name \"*.crt\" -o -name \"private-keys-v1.d/*.key\" -o -name \"id_rsa*\" -o -name \"passbolt.php\" -o -name \"docker.sock\" -o -name \"pgadmin*.db\" -o -name \"pgadmin4.db\" -o -name \"appcmd.exe\" -o -name \".k5login\" -o -name \"ws_ftp.ini\" -o -name \"ddclient.conf\" -o -name \"msal_token_cache.json\" -o -name \"*.vhd\" -o -name \"ftp.config\" -o -name \"firebase-tools.json\" -o -name \".git\" -o -name \".plan\" -o -name \"webserver_config.py\" -o -name \"postgresql.conf\" -o -name \".sudo_as_admin_successful\" -o -name \"*.sqlite3\" -o -name \"service_principal_entries.json\" -o -name \"*.sqlite\" -o -name \".profile\" -o -name \"*kubeconfig*\" -o -name \"*.tfstate\" -o -name \"id_dsa*\" -o -name \"sitemanager.xml\" -o -name \"index.dat\" -o -name \"krb5cc_*\" -o -name \"*.swp\" -o -name \"airflow.cfg\" -o -name \"aliases\" -o -name \"*.pcapng\" -o -name \"SecEvent.Evt\" -o -name \"rsyncd.secrets\" -o -name \"legacy_credentials.db\" -o -name \"state.vscdb\" -o -name \".roadtools_auth\" -o -name \"*.maintenance*\" -o -name \"*vnc*.xml\" -o -name \"config.xml\" -o -name \"docker.socket\" -o -name \"hosts.equiv\" -o -name \"passwd.ibd\" -o -name \"*.pem\" -o -name \"server.xml\" -o -name \"Dockerfile\" -o -name \"rktlet.sock\" -o -name \"vsftpd.conf\" -o -name \".wgetrc\" -o -name \"NetSetup.log\" -o -name \"msal_token_cache.bin\" -o -name \"sysprep.inf\" -o -name \"krb5.conf\" -o -name \"pwd.ibd\" -o -name \"azureProfile.json\" -o -name \"unattend.xml\" -o -name \"authorized_hosts\" -o -name \"racoon.conf\" -o -name \"TokenCache.dat\" -o -name \"FreePBX.conf\" -o -name \"service_principal_entries.bin\" -o -name \"jetty-realm.properties\" -o -name \"glusterfs.key\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.cer\" -o -name \"RDCMan.settings\" -o -name \"backups\" -o -name \"kibana.y*ml\" -o -name \"*knockd*\" -o -name \"wp-config.php\" -o -name \"adc.json\" -o -name \"passwd\" -o -name \"autounattend.xml\" -o -name \"*vnc*.txt\" -o -name \"plum.sqlite\" -o -name \"secrets.ldb\" -o -name \"bash.exe\" -o -name \"db.php\" -o -name \"crontab-ui.service\" -o -name \"*.pub\" -o -name \".credentials.json\" -o -name \"pubring.kbx\" -o -name \"filezilla.xml\" -o -name \"*vnc*.ini\" -o -name \"ffftp.ini\" -o -name \"ftp.ini\" -o -name \".github\" -o -name \".Xauthority\" -o -name \".mcp.json\" -o -name \"bitcoin.conf\" -o -name \"vault-ssh-helper.hcl\" -o -name \".msmtprc\" -o -name \"setupinfo\" -o -name \"*.p12\" -o -name \"credentials.db\" -o -name \"*_history*\" -o -name \"ntuser.dat\" -o -name \"backup\" -o -name \"bootstrap-kubelet.conf\" -o -name \"ConsoleHost_history.txt\" -o -name \".erlang.cookie\" -o -name \"smb.conf\" -o -name \"access_tokens.db\" -o -name \"*.vhdx\" -o -name \"https-xampp.conf\" -o -name \"grafana.ini\" -o -name \"containerd.sock\" -o -name \"glusterfs.ca\" -o -name \"000-default.conf\" -o -name \"printers.xml\" -o -name \"storage.php\" -o -name \"api_key\" -o -name \".htpasswd\" -o -name \"security.sav\" -o -name \"amportal.conf\" -o -name \"atlantis.db\" -o -name \"database.php\" -o -name \"secrets.yml\" -o -name \"access_tokens.json\" -o -name \"mariadb.cnf\" -o -name \"sssd.conf\" -o -name \".ldaprc\" -o -name \"*.vmdk\" -o -name \"frakti.sock\" -o -name \"scclient.exe\" -o -name \"keys.log\" -o -name \"creds*\" -o -name \"software.sav\" -o -name \"tomcat-users.xml\" -o -name \"web*.config\" -o -name \"error.log\" -o -name \".rhosts\" -o -name \"sentry.conf.py\" -o -name \"protecteduserkey.bin\" -o -name \"Elastix.conf\" -o -name \"nginx.conf\" -o -name \"*.ftpconfig\" -o -name \"apt.conf\" -o -name \"https.conf\" -o -name \"clouds.config\" -o -name \"AzureRMContext.json\" -o -name \"anaconda-ks.cfg\" -o -name \"trustdb.gpg\" -o -name \"autologin.conf\" -o -name \"environment\" -o -name \"*.ovpn\" -o -name \".git-credentials\" -o -name \"*.keyring\" -o -name \"debian.cnf\" -o -name \".gitconfig\" -o -name \"mosquitto.conf\" -o -name \"unattend.inf\" -o -name \"*.pcap\" -o -name \"known_hosts\" -o -name \"kubelet.conf\" -o -name \"secret.asc\" -o -name \"KeePass.ini\" -o -name \"glusterfs.pem\" -o -name \"*.pgp\" -o -name \"hostapd.conf\" -o -name \"admin.conf\" -o -name \"*credential*\" -o -name \"mongod*.conf\" -o -name \"*.db\" -o -name \".recently-used.xbel\" -o -name \"exports\" -o -name \"*vnc*.c*nf*\" -o -name \".flyrc\" -o -name \".bashrc\" -o -name \"*.timer\" -o -name \"elasticsearch.y*ml\" -o -name \"gpg-agent.conf\" -o -name \"*config*.php\" -o -name \".vault-token\" -o -name \"sysprep.xml\" -o -name \"settings.php\" -o -name \".boto\" -o -name \"accessTokens.json\" -o -name \"wcx_ftp.ini\" -o -name \"default.sav\" -o -name \".pgpass\" -o -name \"SYSTEM\" -o -name \"software\" -o -name \"*password*\" -o -name \"*.key\" -o -name \"rocketchat.service\" -o -name \"snyk.config.json\" -o -name \"zabbix_server.conf\" -o -name \"storage.json\" -o -name \"httpd.conf\" -o -name \"redis.conf\" -o -name \"recentservers.xml\" -o -name \"crio.sock\" -o -name \"*.psk\" -o -name \".env*\" -o -name \"*.der\" -o -name \"AppEvent.Evt\" -o -name \"crontab.db\" -o -name \"*.tf\" -o -name \"system.sav\" -o -name \"*.service\" -o -name \"*.asc\" -o -name \"password*.ibd\" -o -name \"*.pfx\" -o -name \"KeePass.config*\" -o -name \"winscp.ini\" -o -name \".lesshst\" -o -name \"dockershim.sock\" -o -name \"sslkeylog.log\" -o -name \"zabbix_agentd.conf\" -o -name \"gvm-tools.conf\" -o -name \"log4j-core*.jar\" -o -name \"sip.conf\" -o -name \"unattend.txt\" -o -name \"my.ini\" -o -name \"wsl.exe\" -o -name \".mylogin.cnf\" -o -name \".google_authenticator\" -o -name \"my.cnf\" -o -name \"credentials.xml\" -o -name \"php.ini\" -o -name \"fastcgi_params\" -o -name \"*.gnupg\" -o -name \"config.php\" -o -name \"access.log\" -o -name \"pagefile.sys\" -o -name \"mysqld.cnf\" -o -name \"cesi.conf\" -o -name \"rpcd\" -o -name \"*.jks\" -o -name \"ipsec.conf\" -o -name \"*.csr\" -o -name \"influxdb.conf\" -o -name \"drives.xml\" -o -name \"datasources.xml\" -o -name \"*.keytab\" -o -name \"*.socket\" -o -name \"iis6.log\" -o -name \"kcpassword\" -o -name \"authorized_keys\" -o -name \"kadm5.acl\" -o -name \"*.keystore\" -o -name \"Ntds.dit\" -o -name \"fat.config\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_HOMESEARCH=`eval_bckgrd "find $HOMESEARCH -name \"state.vscdb.backup\" -o -name \"snmpd.conf\" -o -name \"supervisord.conf\" -o -name \"*.kdbx\" -o -name \"*.rdg\" -o -name \"groups.xml\" -o -name \"msal_http_cache.bin\" -o -name \"setupinfo.bak\" -o -name \"*.gpg\" -o -name \"*.viminfo\" -o -name \".pypirc\" -o -name \"hudson.util.Secret\" -o -name \"cloud.cfg\" -o -name \"pg_hba.conf\" -o -name \"psk.txt\" -o -name \".claude.json\" -o -name \"ipsec.secrets\" -o -name \"credentials.tfrc.json\" -o -name \"autologin\" -o -name \"secring.gpg\" -o -name \"gitlab.rm\" -o -name \"snyk.json\" -o -name \"rsyncd.conf\" -o -name \"gitlab.yml\" -o -name \"unattended.xml\" -o -name \"SAM\" -o -name \"sites.ini\" -o -name \"KeePass.enforced*\" -o -name \"docker-compose.yml\" -o -name \"pgsql.conf\" -o -name \".secrets.mkey\" -o -name \"master.key\" -o -name \"scheduledtasks.xml\" -o -name \"*.crt\" -o -name \"private-keys-v1.d/*.key\" -o -name \"id_rsa*\" -o -name \"passbolt.php\" -o -name \"docker.sock\" -o -name \"pgadmin*.db\" -o -name \"pgadmin4.db\" -o -name \"appcmd.exe\" -o -name \".k5login\" -o -name \"ws_ftp.ini\" -o -name \"ddclient.conf\" -o -name \"msal_token_cache.json\" -o -name \"*.vhd\" -o -name \"ftp.config\" -o -name \"firebase-tools.json\" -o -name \".git\" -o -name \".plan\" -o -name \"webserver_config.py\" -o -name \"postgresql.conf\" -o -name \".sudo_as_admin_successful\" -o -name \"*.sqlite3\" -o -name \"service_principal_entries.json\" -o -name \"*.sqlite\" -o -name \".profile\" -o -name \"*kubeconfig*\" -o -name \"*.tfstate\" -o -name \"id_dsa*\" -o -name \"sitemanager.xml\" -o -name \"index.dat\" -o -name \"krb5cc_*\" -o -name \"*.swp\" -o -name \"airflow.cfg\" -o -name \"aliases\" -o -name \"*.pcapng\" -o -name \"SecEvent.Evt\" -o -name \"rsyncd.secrets\" -o -name \"legacy_credentials.db\" -o -name \"state.vscdb\" -o -name \".roadtools_auth\" -o -name \"*.maintenance*\" -o -name \"*vnc*.xml\" -o -name \"config.xml\" -o -name \"docker.socket\" -o -name \"hosts.equiv\" -o -name \"passwd.ibd\" -o -name \"*.pem\" -o -name \"server.xml\" -o -name \"Dockerfile\" -o -name \"rktlet.sock\" -o -name \"vsftpd.conf\" -o -name \".wgetrc\" -o -name \"NetSetup.log\" -o -name \"msal_token_cache.bin\" -o -name \"sysprep.inf\" -o -name \"krb5.conf\" -o -name \"pwd.ibd\" -o -name \"azureProfile.json\" -o -name \"unattend.xml\" -o -name \"authorized_hosts\" -o -name \"racoon.conf\" -o -name \"TokenCache.dat\" -o -name \"FreePBX.conf\" -o -name \"service_principal_entries.bin\" -o -name \"jetty-realm.properties\" -o -name \"glusterfs.key\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.cer\" -o -name \"RDCMan.settings\" -o -name \"backups\" -o -name \"kibana.y*ml\" -o -name \"wp-config.php\" -o -name \"adc.json\" -o -name \"passwd\" -o -name \"autounattend.xml\" -o -name \"*vnc*.txt\" -o -name \"plum.sqlite\" -o -name \"secrets.ldb\" -o -name \"bash.exe\" -o -name \"db.php\" -o -name \"crontab-ui.service\" -o -name \"*.pub\" -o -name \".credentials.json\" -o -name \"pubring.kbx\" -o -name \"filezilla.xml\" -o -name \"*vnc*.ini\" -o -name \"ffftp.ini\" -o -name \"ftp.ini\" -o -name \".github\" -o -name \".Xauthority\" -o -name \".mcp.json\" -o -name \"bitcoin.conf\" -o -name \"vault-ssh-helper.hcl\" -o -name \".msmtprc\" -o -name \"setupinfo\" -o -name \"*.p12\" -o -name \"credentials.db\" -o -name \"*_history*\" -o -name \"ntuser.dat\" -o -name \"backup\" -o -name \"bootstrap-kubelet.conf\" -o -name \"ConsoleHost_history.txt\" -o -name \".erlang.cookie\" -o -name \"smb.conf\" -o -name \"access_tokens.db\" -o -name \"*.vhdx\" -o -name \"https-xampp.conf\" -o -name \"grafana.ini\" -o -name \"containerd.sock\" -o -name \"glusterfs.ca\" -o -name \"000-default.conf\" -o -name \"printers.xml\" -o -name \"storage.php\" -o -name \"api_key\" -o -name \".htpasswd\" -o -name \"security.sav\" -o -name \"amportal.conf\" -o -name \"atlantis.db\" -o -name \"database.php\" -o -name \"secrets.yml\" -o -name \"access_tokens.json\" -o -name \"mariadb.cnf\" -o -name \"sssd.conf\" -o -name \".ldaprc\" -o -name \"*.vmdk\" -o -name \"frakti.sock\" -o -name \"scclient.exe\" -o -name \"keys.log\" -o -name \"creds*\" -o -name \"software.sav\" -o -name \"tomcat-users.xml\" -o -name \"web*.config\" -o -name \"error.log\" -o -name \".rhosts\" -o -name \"sentry.conf.py\" -o -name \"protecteduserkey.bin\" -o -name \"Elastix.conf\" -o -name \"nginx.conf\" -o -name \"*.ftpconfig\" -o -name \"apt.conf\" -o -name \"https.conf\" -o -name \"clouds.config\" -o -name \"AzureRMContext.json\" -o -name \"anaconda-ks.cfg\" -o -name \"trustdb.gpg\" -o -name \"autologin.conf\" -o -name \"environment\" -o -name \"*.ovpn\" -o -name \".git-credentials\" -o -name \"*.keyring\" -o -name \"debian.cnf\" -o -name \".gitconfig\" -o -name \"mosquitto.conf\" -o -name \"unattend.inf\" -o -name \"*.pcap\" -o -name \"known_hosts\" -o -name \"kubelet.conf\" -o -name \"secret.asc\" -o -name \"KeePass.ini\" -o -name \"glusterfs.pem\" -o -name \"*.pgp\" -o -name \"hostapd.conf\" -o -name \"admin.conf\" -o -name \"*credential*\" -o -name \"mongod*.conf\" -o -name \"*.db\" -o -name \".recently-used.xbel\" -o -name \"*vnc*.c*nf*\" -o -name \".flyrc\" -o -name \".bashrc\" -o -name \"*.timer\" -o -name \"elasticsearch.y*ml\" -o -name \"gpg-agent.conf\" -o -name \"*config*.php\" -o -name \".vault-token\" -o -name \"ssh*config\" -o -name \"settings.php\" -o -name \".boto\" -o -name \"sysprep.xml\" -o -name \"accessTokens.json\" -o -name \"wcx_ftp.ini\" -o -name \"default.sav\" -o -name \".pgpass\" -o -name \"SYSTEM\" -o -name \"software\" -o -name \"*password*\" -o -name \"*.key\" -o -name \"rocketchat.service\" -o -name \"snyk.config.json\" -o -name \"zabbix_server.conf\" -o -name \"storage.json\" -o -name \"httpd.conf\" -o -name \"redis.conf\" -o -name \"recentservers.xml\" -o -name \"crio.sock\" -o -name \"*.psk\" -o -name \".env*\" -o -name \"*.der\" -o -name \"AppEvent.Evt\" -o -name \"crontab.db\" -o -name \"*.tf\" -o -name \"system.sav\" -o -name \"*.service\" -o -name \"*.asc\" -o -name \"password*.ibd\" -o -name \"*.pfx\" -o -name \"KeePass.config*\" -o -name \"winscp.ini\" -o -name \".lesshst\" -o -name \"dockershim.sock\" -o -name \"sslkeylog.log\" -o -name \"zabbix_agentd.conf\" -o -name \"gvm-tools.conf\" -o -name \"log4j-core*.jar\" -o -name \"sip.conf\" -o -name \"unattend.txt\" -o -name \"my.ini\" -o -name \"wsl.exe\" -o -name \".mylogin.cnf\" -o -name \".google_authenticator\" -o -name \"my.cnf\" -o -name \"credentials.xml\" -o -name \"php.ini\" -o -name \"fastcgi_params\" -o -name \"*.gnupg\" -o -name \"config.php\" -o -name \"access.log\" -o -name \"pagefile.sys\" -o -name \"mysqld.cnf\" -o -name \"cesi.conf\" -o -name \"rpcd\" -o -name \"*.jks\" -o -name \"ipsec.conf\" -o -name \"*.csr\" -o -name \"influxdb.conf\" -o -name \"drives.xml\" -o -name \"datasources.xml\" -o -name \"*.keytab\" -o -name \"*.socket\" -o -name \"iis6.log\" -o -name \"kcpassword\" -o -name \"authorized_keys\" -o -name \"kadm5.acl\" -o -name \"*.keystore\" -o -name \"Ntds.dit\" -o -name \"fat.config\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_LIB=`eval_bckgrd "find ${ROOT_FOLDER}lib -name \"rocketchat.service\" -o -name \"*.socket\" -o -name \"*.timer\" -o -name \"log4j-core*.jar\" -o -name \"*.service\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  FIND_MEDIA=`eval_bckgrd "find ${ROOT_FOLDER}media -name \"state.vscdb.backup\" -o -name \"snmpd.conf\" -o -name \"supervisord.conf\" -o -name \"*.kdbx\" -o -name \"*.rdg\" -o -name \"groups.xml\" -o -name \"msal_http_cache.bin\" -o -name \"setupinfo.bak\" -o -name \"*.gpg\" -o -name \"*.viminfo\" -o -name \".pypirc\" -o -name \"hudson.util.Secret\" -o -name \"cloud.cfg\" -o -name \"pg_hba.conf\" -o -name \"psk.txt\" -o -name \".claude.json\" -o -name \"ipsec.secrets\" -o -name \"credentials.tfrc.json\" -o -name \"autologin\" -o -name \"secring.gpg\" -o -name \"gitlab.rm\" -o -name \"snyk.json\" -o -name \"rsyncd.conf\" -o -name \"gitlab.yml\" -o -name \"unattended.xml\" -o -name \"SAM\" -o -name \"sites.ini\" -o -name \"KeePass.enforced*\" -o -name \"docker-compose.yml\" -o -name \"pgsql.conf\" -o -name \".secrets.mkey\" -o -name \"master.key\" -o -name \"scheduledtasks.xml\" -o -name \"*.crt\" -o -name \"private-keys-v1.d/*.key\" -o -name \"id_rsa*\" -o -name \"passbolt.php\" -o -name \"docker.sock\" -o -name \"pgadmin*.db\" -o -name \"pgadmin4.db\" -o -name \"appcmd.exe\" -o -name \".k5login\" -o -name \"ws_ftp.ini\" -o -name \"ddclient.conf\" -o -name \"msal_token_cache.json\" -o -name \"*.vhd\" -o -name \"ftp.config\" -o -name \"firebase-tools.json\" -o -name \".git\" -o -name \".plan\" -o -name \"webserver_config.py\" -o -name \"postgresql.conf\" -o -name \".sudo_as_admin_successful\" -o -name \"*.sqlite3\" -o -name \"service_principal_entries.json\" -o -name \"*.sqlite\" -o -name \".profile\" -o -name \"*kubeconfig*\" -o -name \"*.tfstate\" -o -name \"id_dsa*\" -o -name \"sitemanager.xml\" -o -name \"index.dat\" -o -name \"krb5cc_*\" -o -name \"*.swp\" -o -name \"airflow.cfg\" -o -name \"aliases\" -o -name \"*.pcapng\" -o -name \"SecEvent.Evt\" -o -name \"rsyncd.secrets\" -o -name \"legacy_credentials.db\" -o -name \"state.vscdb\" -o -name \".roadtools_auth\" -o -name \"*.maintenance*\" -o -name \"*vnc*.xml\" -o -name \"config.xml\" -o -name \"docker.socket\" -o -name \"hosts.equiv\" -o -name \"passwd.ibd\" -o -name \"*.pem\" -o -name \"server.xml\" -o -name \"Dockerfile\" -o -name \"rktlet.sock\" -o -name \"vsftpd.conf\" -o -name \".wgetrc\" -o -name \"NetSetup.log\" -o -name \"msal_token_cache.bin\" -o -name \"sysprep.inf\" -o -name \"krb5.conf\" -o -name \"pwd.ibd\" -o -name \"azureProfile.json\" -o -name \"unattend.xml\" -o -name \"authorized_hosts\" -o -name \"racoon.conf\" -o -name \"TokenCache.dat\" -o -name \"FreePBX.conf\" -o -name \"service_principal_entries.bin\" -o -name \"jetty-realm.properties\" -o -name \"glusterfs.key\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.cer\" -o -name \"RDCMan.settings\" -o -name \"backups\" -o -name \"kibana.y*ml\" -o -name \"wp-config.php\" -o -name \"adc.json\" -o -name \"passwd\" -o -name \"autounattend.xml\" -o -name \"*vnc*.txt\" -o -name \"plum.sqlite\" -o -name \"secrets.ldb\" -o -name \"bash.exe\" -o -name \"db.php\" -o -name \"crontab-ui.service\" -o -name \"*.pub\" -o -name \".credentials.json\" -o -name \"pubring.kbx\" -o -name \"filezilla.xml\" -o -name \"*vnc*.ini\" -o -name \"ffftp.ini\" -o -name \"ftp.ini\" -o -name \".github\" -o -name \".Xauthority\" -o -name \".mcp.json\" -o -name \"bitcoin.conf\" -o -name \"vault-ssh-helper.hcl\" -o -name \".msmtprc\" -o -name \"setupinfo\" -o -name \"*.p12\" -o -name \"credentials.db\" -o -name \"*_history*\" -o -name \"ntuser.dat\" -o -name \"backup\" -o -name \"bootstrap-kubelet.conf\" -o -name \"ConsoleHost_history.txt\" -o -name \".erlang.cookie\" -o -name \"smb.conf\" -o -name \"access_tokens.db\" -o -name \"*.vhdx\" -o -name \"https-xampp.conf\" -o -name \"grafana.ini\" -o -name \"containerd.sock\" -o -name \"glusterfs.ca\" -o -name \"000-default.conf\" -o -name \"printers.xml\" -o -name \"storage.php\" -o -name \"api_key\" -o -name \".htpasswd\" -o -name \"security.sav\" -o -name \"amportal.conf\" -o -name \"atlantis.db\" -o -name \"database.php\" -o -name \"secrets.yml\" -o -name \"access_tokens.json\" -o -name \"mariadb.cnf\" -o -name \"sssd.conf\" -o -name \".ldaprc\" -o -name \"*.vmdk\" -o -name \"frakti.sock\" -o -name \"scclient.exe\" -o -name \"keys.log\" -o -name \"creds*\" -o -name \"software.sav\" -o -name \"tomcat-users.xml\" -o -name \"web*.config\" -o -name \"error.log\" -o -name \".rhosts\" -o -name \"sentry.conf.py\" -o -name \"protecteduserkey.bin\" -o -name \"Elastix.conf\" -o -name \"nginx.conf\" -o -name \"*.ftpconfig\" -o -name \"apt.conf\" -o -name \"https.conf\" -o -name \"clouds.config\" -o -name \"AzureRMContext.json\" -o -name \"anaconda-ks.cfg\" -o -name \"trustdb.gpg\" -o -name \"autologin.conf\" -o -name \"environment\" -o -name \"*.ovpn\" -o -name \".git-credentials\" -o -name \"*.keyring\" -o -name \"debian.cnf\" -o -name \".gitconfig\" -o -name \"mosquitto.conf\" -o -name \"unattend.inf\" -o -name \"*.pcap\" -o -name \"known_hosts\" -o -name \"kubelet.conf\" -o -name \"secret.asc\" -o -name \"KeePass.ini\" -o -name \"glusterfs.pem\" -o -name \"*.pgp\" -o -name \"hostapd.conf\" -o -name \"admin.conf\" -o -name \"*credential*\" -o -name \"mongod*.conf\" -o -name \"*.db\" -o -name \".recently-used.xbel\" -o -name \"*vnc*.c*nf*\" -o -name \".flyrc\" -o -name \".bashrc\" -o -name \"*.timer\" -o -name \"elasticsearch.y*ml\" -o -name \"gpg-agent.conf\" -o -name \"*config*.php\" -o -name \".vault-token\" -o -name \"sysprep.xml\" -o -name \"settings.php\" -o -name \".boto\" -o -name \"accessTokens.json\" -o -name \"wcx_ftp.ini\" -o -name \"default.sav\" -o -name \".pgpass\" -o -name \"SYSTEM\" -o -name \"software\" -o -name \"*password*\" -o -name \"*.key\" -o -name \"rocketchat.service\" -o -name \"snyk.config.json\" -o -name \"zabbix_server.conf\" -o -name \"storage.json\" -o -name \"httpd.conf\" -o -name \"redis.conf\" -o -name \"recentservers.xml\" -o -name \"crio.sock\" -o -name \"*.psk\" -o -name \".env*\" -o -name \"*.der\" -o -name \"AppEvent.Evt\" -o -name \"crontab.db\" -o -name \"*.tf\" -o -name \"system.sav\" -o -name \"*.service\" -o -name \"*.asc\" -o -name \"password*.ibd\" -o -name \"*.pfx\" -o -name \"KeePass.config*\" -o -name \"winscp.ini\" -o -name \".lesshst\" -o -name \"dockershim.sock\" -o -name \"sslkeylog.log\" -o -name \"zabbix_agentd.conf\" -o -name \"gvm-tools.conf\" -o -name \"log4j-core*.jar\" -o -name \"sip.conf\" -o -name \"unattend.txt\" -o -name \"my.ini\" -o -name \"wsl.exe\" -o -name \".mylogin.cnf\" -o -name \".google_authenticator\" -o -name \"my.cnf\" -o -name \"credentials.xml\" -o -name \"php.ini\" -o -name \"fastcgi_params\" -o -name \"*.gnupg\" -o -name \"config.php\" -o -name \"access.log\" -o -name \"pagefile.sys\" -o -name \"mysqld.cnf\" -o -name \"cesi.conf\" -o -name \"rpcd\" -o -name \"*.jks\" -o -name \"ipsec.conf\" -o -name \"*.csr\" -o -name \"influxdb.conf\" -o -name \"drives.xml\" -o -name \"datasources.xml\" -o -name \"*.keytab\" -o -name \"*.socket\" -o -name \"iis6.log\" -o -name \"kcpassword\" -o -name \"authorized_keys\" -o -name \"kadm5.acl\" -o -name \"*.keystore\" -o -name \"Ntds.dit\" -o -name \"fat.config\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_MNT=`eval_bckgrd "find ${ROOT_FOLDER}mnt -name \"state.vscdb.backup\" -o -name \"snmpd.conf\" -o -name \"supervisord.conf\" -o -name \"*.kdbx\" -o -name \"*.rdg\" -o -name \"groups.xml\" -o -name \"msal_http_cache.bin\" -o -name \"setupinfo.bak\" -o -name \"*.gpg\" -o -name \"*.viminfo\" -o -name \".pypirc\" -o -name \"hudson.util.Secret\" -o -name \"cloud.cfg\" -o -name \"pg_hba.conf\" -o -name \"psk.txt\" -o -name \".claude.json\" -o -name \"ipsec.secrets\" -o -name \"credentials.tfrc.json\" -o -name \"autologin\" -o -name \"secring.gpg\" -o -name \"gitlab.rm\" -o -name \"snyk.json\" -o -name \"rsyncd.conf\" -o -name \"gitlab.yml\" -o -name \"unattended.xml\" -o -name \"SAM\" -o -name \"sites.ini\" -o -name \"KeePass.enforced*\" -o -name \"docker-compose.yml\" -o -name \"pgsql.conf\" -o -name \".secrets.mkey\" -o -name \"master.key\" -o -name \"scheduledtasks.xml\" -o -name \"*.crt\" -o -name \"private-keys-v1.d/*.key\" -o -name \"id_rsa*\" -o -name \"passbolt.php\" -o -name \"docker.sock\" -o -name \"pgadmin*.db\" -o -name \"pgadmin4.db\" -o -name \"appcmd.exe\" -o -name \".k5login\" -o -name \"ws_ftp.ini\" -o -name \"ddclient.conf\" -o -name \"msal_token_cache.json\" -o -name \"*.vhd\" -o -name \"ftp.config\" -o -name \"firebase-tools.json\" -o -name \".git\" -o -name \".plan\" -o -name \"webserver_config.py\" -o -name \"postgresql.conf\" -o -name \".sudo_as_admin_successful\" -o -name \"*.sqlite3\" -o -name \"service_principal_entries.json\" -o -name \"*.sqlite\" -o -name \".profile\" -o -name \"*kubeconfig*\" -o -name \"*.tfstate\" -o -name \"id_dsa*\" -o -name \"sitemanager.xml\" -o -name \"index.dat\" -o -name \"krb5cc_*\" -o -name \"*.swp\" -o -name \"airflow.cfg\" -o -name \"aliases\" -o -name \"*.pcapng\" -o -name \"SecEvent.Evt\" -o -name \"rsyncd.secrets\" -o -name \"legacy_credentials.db\" -o -name \"state.vscdb\" -o -name \".roadtools_auth\" -o -name \"*.maintenance*\" -o -name \"*vnc*.xml\" -o -name \"config.xml\" -o -name \"docker.socket\" -o -name \"hosts.equiv\" -o -name \"passwd.ibd\" -o -name \"*.pem\" -o -name \"server.xml\" -o -name \"Dockerfile\" -o -name \"rktlet.sock\" -o -name \"vsftpd.conf\" -o -name \".wgetrc\" -o -name \"NetSetup.log\" -o -name \"msal_token_cache.bin\" -o -name \"sysprep.inf\" -o -name \"krb5.conf\" -o -name \"pwd.ibd\" -o -name \"azureProfile.json\" -o -name \"unattend.xml\" -o -name \"authorized_hosts\" -o -name \"racoon.conf\" -o -name \"TokenCache.dat\" -o -name \"FreePBX.conf\" -o -name \"service_principal_entries.bin\" -o -name \"jetty-realm.properties\" -o -name \"glusterfs.key\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.cer\" -o -name \"RDCMan.settings\" -o -name \"backups\" -o -name \"kibana.y*ml\" -o -name \"wp-config.php\" -o -name \"adc.json\" -o -name \"passwd\" -o -name \"autounattend.xml\" -o -name \"*vnc*.txt\" -o -name \"plum.sqlite\" -o -name \"secrets.ldb\" -o -name \"bash.exe\" -o -name \"db.php\" -o -name \"crontab-ui.service\" -o -name \"*.pub\" -o -name \".credentials.json\" -o -name \"pubring.kbx\" -o -name \"filezilla.xml\" -o -name \"*vnc*.ini\" -o -name \"ffftp.ini\" -o -name \"ftp.ini\" -o -name \".github\" -o -name \".Xauthority\" -o -name \".mcp.json\" -o -name \"bitcoin.conf\" -o -name \"vault-ssh-helper.hcl\" -o -name \".msmtprc\" -o -name \"setupinfo\" -o -name \"*.p12\" -o -name \"credentials.db\" -o -name \"sess_*\" -o -name \"*_history*\" -o -name \"ntuser.dat\" -o -name \"backup\" -o -name \"bootstrap-kubelet.conf\" -o -name \"ConsoleHost_history.txt\" -o -name \".erlang.cookie\" -o -name \"smb.conf\" -o -name \"access_tokens.db\" -o -name \"*.vhdx\" -o -name \"https-xampp.conf\" -o -name \"grafana.ini\" -o -name \"containerd.sock\" -o -name \"glusterfs.ca\" -o -name \"000-default.conf\" -o -name \"printers.xml\" -o -name \"storage.php\" -o -name \"api_key\" -o -name \".htpasswd\" -o -name \"security.sav\" -o -name \"amportal.conf\" -o -name \"atlantis.db\" -o -name \"database.php\" -o -name \"secrets.yml\" -o -name \"access_tokens.json\" -o -name \"mariadb.cnf\" -o -name \"sssd.conf\" -o -name \".ldaprc\" -o -name \"*.vmdk\" -o -name \"frakti.sock\" -o -name \"scclient.exe\" -o -name \"keys.log\" -o -name \"creds*\" -o -name \"software.sav\" -o -name \"tomcat-users.xml\" -o -name \"web*.config\" -o -name \"error.log\" -o -name \".rhosts\" -o -name \"sentry.conf.py\" -o -name \"protecteduserkey.bin\" -o -name \"Elastix.conf\" -o -name \"nginx.conf\" -o -name \"*.ftpconfig\" -o -name \"apt.conf\" -o -name \"https.conf\" -o -name \"clouds.config\" -o -name \"AzureRMContext.json\" -o -name \"anaconda-ks.cfg\" -o -name \"trustdb.gpg\" -o -name \"autologin.conf\" -o -name \"environment\" -o -name \"*.ovpn\" -o -name \".git-credentials\" -o -name \"*.keyring\" -o -name \"debian.cnf\" -o -name \".gitconfig\" -o -name \"mosquitto.conf\" -o -name \"unattend.inf\" -o -name \"*.pcap\" -o -name \"known_hosts\" -o -name \"kubelet.conf\" -o -name \"secret.asc\" -o -name \"KeePass.ini\" -o -name \"glusterfs.pem\" -o -name \"*.pgp\" -o -name \"hostapd.conf\" -o -name \"admin.conf\" -o -name \"*credential*\" -o -name \"mongod*.conf\" -o -name \"*.db\" -o -name \".recently-used.xbel\" -o -name \"*vnc*.c*nf*\" -o -name \".flyrc\" -o -name \".bashrc\" -o -name \"*.timer\" -o -name \"elasticsearch.y*ml\" -o -name \"gpg-agent.conf\" -o -name \"*config*.php\" -o -name \".vault-token\" -o -name \"sysprep.xml\" -o -name \"settings.php\" -o -name \".boto\" -o -name \"accessTokens.json\" -o -name \"wcx_ftp.ini\" -o -name \"default.sav\" -o -name \".pgpass\" -o -name \"SYSTEM\" -o -name \"software\" -o -name \"*password*\" -o -name \"*.key\" -o -name \"rocketchat.service\" -o -name \"snyk.config.json\" -o -name \"zabbix_server.conf\" -o -name \"storage.json\" -o -name \"httpd.conf\" -o -name \"redis.conf\" -o -name \"recentservers.xml\" -o -name \"crio.sock\" -o -name \"*.psk\" -o -name \".env*\" -o -name \"*.der\" -o -name \"AppEvent.Evt\" -o -name \"crontab.db\" -o -name \"*.tf\" -o -name \"system.sav\" -o -name \"*.service\" -o -name \"*.asc\" -o -name \"password*.ibd\" -o -name \"*.pfx\" -o -name \"KeePass.config*\" -o -name \"winscp.ini\" -o -name \".lesshst\" -o -name \"dockershim.sock\" -o -name \"sslkeylog.log\" -o -name \"zabbix_agentd.conf\" -o -name \"gvm-tools.conf\" -o -name \"log4j-core*.jar\" -o -name \"sip.conf\" -o -name \"unattend.txt\" -o -name \"my.ini\" -o -name \"wsl.exe\" -o -name \".mylogin.cnf\" -o -name \".google_authenticator\" -o -name \"my.cnf\" -o -name \"credentials.xml\" -o -name \"php.ini\" -o -name \"fastcgi_params\" -o -name \"*.gnupg\" -o -name \"config.php\" -o -name \"access.log\" -o -name \"pagefile.sys\" -o -name \"mysqld.cnf\" -o -name \"cesi.conf\" -o -name \"rpcd\" -o -name \"*.jks\" -o -name \"ipsec.conf\" -o -name \"*.csr\" -o -name \"influxdb.conf\" -o -name \"drives.xml\" -o -name \"datasources.xml\" -o -name \"*.keytab\" -o -name \"*.socket\" -o -name \"iis6.log\" -o -name \"kcpassword\" -o -name \"authorized_keys\" -o -name \"kadm5.acl\" -o -name \"*.keystore\" -o -name \"Ntds.dit\" -o -name \"fat.config\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_OPT=`eval_bckgrd "find ${ROOT_FOLDER}opt -name \"state.vscdb.backup\" -o -name \"snmpd.conf\" -o -name \"supervisord.conf\" -o -name \"*.kdbx\" -o -name \"*.rdg\" -o -name \"groups.xml\" -o -name \"msal_http_cache.bin\" -o -name \"setupinfo.bak\" -o -name \"*.gpg\" -o -name \"*.viminfo\" -o -name \".pypirc\" -o -name \"hudson.util.Secret\" -o -name \"cloud.cfg\" -o -name \"pg_hba.conf\" -o -name \"psk.txt\" -o -name \".claude.json\" -o -name \"ipsec.secrets\" -o -name \"credentials.tfrc.json\" -o -name \"autologin\" -o -name \"secring.gpg\" -o -name \"gitlab.rm\" -o -name \"snyk.json\" -o -name \"rsyncd.conf\" -o -name \"gitlab.yml\" -o -name \"unattended.xml\" -o -name \"SAM\" -o -name \"sites.ini\" -o -name \"KeePass.enforced*\" -o -name \"docker-compose.yml\" -o -name \"pgsql.conf\" -o -name \".secrets.mkey\" -o -name \"master.key\" -o -name \"scheduledtasks.xml\" -o -name \"*.crt\" -o -name \"private-keys-v1.d/*.key\" -o -name \"id_rsa*\" -o -name \"passbolt.php\" -o -name \"docker.sock\" -o -name \"pgadmin*.db\" -o -name \"pgadmin4.db\" -o -name \"appcmd.exe\" -o -name \".k5login\" -o -name \"ws_ftp.ini\" -o -name \"ddclient.conf\" -o -name \"msal_token_cache.json\" -o -name \"*.vhd\" -o -name \"ftp.config\" -o -name \"firebase-tools.json\" -o -name \".git\" -o -name \".plan\" -o -name \"webserver_config.py\" -o -name \"postgresql.conf\" -o -name \".sudo_as_admin_successful\" -o -name \"*.sqlite3\" -o -name \"service_principal_entries.json\" -o -name \"*.sqlite\" -o -name \".profile\" -o -name \"*kubeconfig*\" -o -name \"*.tfstate\" -o -name \"id_dsa*\" -o -name \"sitemanager.xml\" -o -name \"index.dat\" -o -name \"krb5cc_*\" -o -name \"*.swp\" -o -name \"airflow.cfg\" -o -name \"aliases\" -o -name \"*.pcapng\" -o -name \"SecEvent.Evt\" -o -name \"rsyncd.secrets\" -o -name \"legacy_credentials.db\" -o -name \"state.vscdb\" -o -name \".roadtools_auth\" -o -name \"*.maintenance*\" -o -name \"*vnc*.xml\" -o -name \"config.xml\" -o -name \"docker.socket\" -o -name \"hosts.equiv\" -o -name \"passwd.ibd\" -o -name \"*.pem\" -o -name \"server.xml\" -o -name \"Dockerfile\" -o -name \"rktlet.sock\" -o -name \"vsftpd.conf\" -o -name \".wgetrc\" -o -name \"NetSetup.log\" -o -name \"msal_token_cache.bin\" -o -name \"sysprep.inf\" -o -name \"krb5.conf\" -o -name \"pwd.ibd\" -o -name \"azureProfile.json\" -o -name \"unattend.xml\" -o -name \"authorized_hosts\" -o -name \"racoon.conf\" -o -name \"TokenCache.dat\" -o -name \"FreePBX.conf\" -o -name \"service_principal_entries.bin\" -o -name \"jetty-realm.properties\" -o -name \"glusterfs.key\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.cer\" -o -name \"RDCMan.settings\" -o -name \"backups\" -o -name \"kibana.y*ml\" -o -name \"wp-config.php\" -o -name \"adc.json\" -o -name \"passwd\" -o -name \"autounattend.xml\" -o -name \"*vnc*.txt\" -o -name \"plum.sqlite\" -o -name \"secrets.ldb\" -o -name \"bash.exe\" -o -name \"db.php\" -o -name \"crontab-ui.service\" -o -name \"*.pub\" -o -name \".credentials.json\" -o -name \"pubring.kbx\" -o -name \"filezilla.xml\" -o -name \"*vnc*.ini\" -o -name \"ffftp.ini\" -o -name \"ftp.ini\" -o -name \".github\" -o -name \".Xauthority\" -o -name \".mcp.json\" -o -name \"bitcoin.conf\" -o -name \"vault-ssh-helper.hcl\" -o -name \".msmtprc\" -o -name \"setupinfo\" -o -name \"*.p12\" -o -name \"credentials.db\" -o -name \"*_history*\" -o -name \"ntuser.dat\" -o -name \"backup\" -o -name \"bootstrap-kubelet.conf\" -o -name \"ConsoleHost_history.txt\" -o -name \".erlang.cookie\" -o -name \"smb.conf\" -o -name \"access_tokens.db\" -o -name \"*.vhdx\" -o -name \"https-xampp.conf\" -o -name \"grafana.ini\" -o -name \"containerd.sock\" -o -name \"glusterfs.ca\" -o -name \"000-default.conf\" -o -name \"printers.xml\" -o -name \"storage.php\" -o -name \"api_key\" -o -name \".htpasswd\" -o -name \"security.sav\" -o -name \"amportal.conf\" -o -name \"atlantis.db\" -o -name \"database.php\" -o -name \"secrets.yml\" -o -name \"access_tokens.json\" -o -name \"mariadb.cnf\" -o -name \"sssd.conf\" -o -name \".ldaprc\" -o -name \"*.vmdk\" -o -name \"frakti.sock\" -o -name \"scclient.exe\" -o -name \"keys.log\" -o -name \"creds*\" -o -name \"software.sav\" -o -name \"tomcat-users.xml\" -o -name \"web*.config\" -o -name \"error.log\" -o -name \".rhosts\" -o -name \"sentry.conf.py\" -o -name \"protecteduserkey.bin\" -o -name \"Elastix.conf\" -o -name \"nginx.conf\" -o -name \"*.ftpconfig\" -o -name \"apt.conf\" -o -name \"https.conf\" -o -name \"clouds.config\" -o -name \"AzureRMContext.json\" -o -name \"anaconda-ks.cfg\" -o -name \"trustdb.gpg\" -o -name \"autologin.conf\" -o -name \"environment\" -o -name \"*.ovpn\" -o -name \".git-credentials\" -o -name \"*.keyring\" -o -name \"debian.cnf\" -o -name \".gitconfig\" -o -name \"mosquitto.conf\" -o -name \"unattend.inf\" -o -name \"*.pcap\" -o -name \"known_hosts\" -o -name \"kubelet.conf\" -o -name \"secret.asc\" -o -name \"KeePass.ini\" -o -name \"glusterfs.pem\" -o -name \"*.pgp\" -o -name \"hostapd.conf\" -o -name \"admin.conf\" -o -name \"*credential*\" -o -name \"mongod*.conf\" -o -name \"*.db\" -o -name \".recently-used.xbel\" -o -name \"*vnc*.c*nf*\" -o -name \".flyrc\" -o -name \".bashrc\" -o -name \"*.timer\" -o -name \"elasticsearch.y*ml\" -o -name \"gpg-agent.conf\" -o -name \"*config*.php\" -o -name \".vault-token\" -o -name \"sysprep.xml\" -o -name \"settings.php\" -o -name \".boto\" -o -name \"accessTokens.json\" -o -name \"wcx_ftp.ini\" -o -name \"default.sav\" -o -name \".pgpass\" -o -name \"SYSTEM\" -o -name \"software\" -o -name \"*password*\" -o -name \"*.key\" -o -name \"rocketchat.service\" -o -name \"snyk.config.json\" -o -name \"zabbix_server.conf\" -o -name \"storage.json\" -o -name \"httpd.conf\" -o -name \"redis.conf\" -o -name \"recentservers.xml\" -o -name \"crio.sock\" -o -name \"*.psk\" -o -name \".env*\" -o -name \"*.der\" -o -name \"AppEvent.Evt\" -o -name \"crontab.db\" -o -name \"*.tf\" -o -name \"system.sav\" -o -name \"*.service\" -o -name \"*.asc\" -o -name \"password*.ibd\" -o -name \"*.pfx\" -o -name \"KeePass.config*\" -o -name \"winscp.ini\" -o -name \".lesshst\" -o -name \"dockershim.sock\" -o -name \"sslkeylog.log\" -o -name \"zabbix_agentd.conf\" -o -name \"gvm-tools.conf\" -o -name \"log4j-core*.jar\" -o -name \"sip.conf\" -o -name \"unattend.txt\" -o -name \"my.ini\" -o -name \"wsl.exe\" -o -name \".mylogin.cnf\" -o -name \".google_authenticator\" -o -name \"my.cnf\" -o -name \"credentials.xml\" -o -name \"php.ini\" -o -name \"fastcgi_params\" -o -name \"*.gnupg\" -o -name \"config.php\" -o -name \"access.log\" -o -name \"pagefile.sys\" -o -name \"mysqld.cnf\" -o -name \"cesi.conf\" -o -name \"rpcd\" -o -name \"*.jks\" -o -name \"ipsec.conf\" -o -name \"*.csr\" -o -name \"influxdb.conf\" -o -name \"drives.xml\" -o -name \"datasources.xml\" -o -name \"*.keytab\" -o -name \"*.socket\" -o -name \"iis6.log\" -o -name \"kcpassword\" -o -name \"authorized_keys\" -o -name \"kadm5.acl\" -o -name \"*.keystore\" -o -name \"Ntds.dit\" -o -name \"fat.config\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_PRIVATE=`eval_bckgrd "find ${ROOT_FOLDER}private -name \"state.vscdb.backup\" -o -name \"snmpd.conf\" -o -name \"supervisord.conf\" -o -name \"*.kdbx\" -o -name \"*.rdg\" -o -name \"groups.xml\" -o -name \"msal_http_cache.bin\" -o -name \"setupinfo.bak\" -o -name \"*.gpg\" -o -name \"*.viminfo\" -o -name \".pypirc\" -o -name \"hudson.util.Secret\" -o -name \"cloud.cfg\" -o -name \"pg_hba.conf\" -o -name \"psk.txt\" -o -name \".claude.json\" -o -name \"ipsec.secrets\" -o -name \"credentials.tfrc.json\" -o -name \"autologin\" -o -name \"secring.gpg\" -o -name \"gitlab.rm\" -o -name \"snyk.json\" -o -name \"rsyncd.conf\" -o -name \"gitlab.yml\" -o -name \"unattended.xml\" -o -name \"SAM\" -o -name \"sites.ini\" -o -name \"KeePass.enforced*\" -o -name \"docker-compose.yml\" -o -name \"pgsql.conf\" -o -name \".secrets.mkey\" -o -name \"master.key\" -o -name \"scheduledtasks.xml\" -o -name \"*.crt\" -o -name \"private-keys-v1.d/*.key\" -o -name \"id_rsa*\" -o -name \"passbolt.php\" -o -name \"docker.sock\" -o -name \"pgadmin*.db\" -o -name \"pgadmin4.db\" -o -name \"appcmd.exe\" -o -name \".k5login\" -o -name \"ws_ftp.ini\" -o -name \"ddclient.conf\" -o -name \"msal_token_cache.json\" -o -name \"*.vhd\" -o -name \"ftp.config\" -o -name \"firebase-tools.json\" -o -name \".git\" -o -name \".plan\" -o -name \"webserver_config.py\" -o -name \"postgresql.conf\" -o -name \".sudo_as_admin_successful\" -o -name \"*.sqlite3\" -o -name \"service_principal_entries.json\" -o -name \"*.sqlite\" -o -name \".profile\" -o -name \"*kubeconfig*\" -o -name \"*.tfstate\" -o -name \"id_dsa*\" -o -name \"sitemanager.xml\" -o -name \"index.dat\" -o -name \"krb5cc_*\" -o -name \"*.swp\" -o -name \"airflow.cfg\" -o -name \"aliases\" -o -name \"*.pcapng\" -o -name \"SecEvent.Evt\" -o -name \"rsyncd.secrets\" -o -name \"legacy_credentials.db\" -o -name \"state.vscdb\" -o -name \".roadtools_auth\" -o -name \"*.maintenance*\" -o -name \"*vnc*.xml\" -o -name \"config.xml\" -o -name \"docker.socket\" -o -name \"hosts.equiv\" -o -name \"passwd.ibd\" -o -name \"*.pem\" -o -name \"server.xml\" -o -name \"Dockerfile\" -o -name \"rktlet.sock\" -o -name \"vsftpd.conf\" -o -name \".wgetrc\" -o -name \"NetSetup.log\" -o -name \"msal_token_cache.bin\" -o -name \"sysprep.inf\" -o -name \"krb5.conf\" -o -name \"pwd.ibd\" -o -name \"azureProfile.json\" -o -name \"unattend.xml\" -o -name \"authorized_hosts\" -o -name \"racoon.conf\" -o -name \"TokenCache.dat\" -o -name \"FreePBX.conf\" -o -name \"service_principal_entries.bin\" -o -name \"jetty-realm.properties\" -o -name \"glusterfs.key\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.cer\" -o -name \"RDCMan.settings\" -o -name \"backups\" -o -name \"kibana.y*ml\" -o -name \"wp-config.php\" -o -name \"adc.json\" -o -name \"passwd\" -o -name \"autounattend.xml\" -o -name \"*vnc*.txt\" -o -name \"plum.sqlite\" -o -name \"secrets.ldb\" -o -name \"bash.exe\" -o -name \"db.php\" -o -name \"crontab-ui.service\" -o -name \"*.pub\" -o -name \".credentials.json\" -o -name \"pubring.kbx\" -o -name \"filezilla.xml\" -o -name \"*vnc*.ini\" -o -name \"ffftp.ini\" -o -name \"ftp.ini\" -o -name \".github\" -o -name \".Xauthority\" -o -name \".mcp.json\" -o -name \"bitcoin.conf\" -o -name \"vault-ssh-helper.hcl\" -o -name \".msmtprc\" -o -name \"setupinfo\" -o -name \"*.p12\" -o -name \"credentials.db\" -o -name \"sess_*\" -o -name \"*_history*\" -o -name \"ntuser.dat\" -o -name \"backup\" -o -name \"bootstrap-kubelet.conf\" -o -name \"ConsoleHost_history.txt\" -o -name \".erlang.cookie\" -o -name \"smb.conf\" -o -name \"access_tokens.db\" -o -name \"*.vhdx\" -o -name \"https-xampp.conf\" -o -name \"grafana.ini\" -o -name \"containerd.sock\" -o -name \"glusterfs.ca\" -o -name \"000-default.conf\" -o -name \"printers.xml\" -o -name \"storage.php\" -o -name \"api_key\" -o -name \".htpasswd\" -o -name \"security.sav\" -o -name \"amportal.conf\" -o -name \"atlantis.db\" -o -name \"database.php\" -o -name \"secrets.yml\" -o -name \"access_tokens.json\" -o -name \"mariadb.cnf\" -o -name \"sssd.conf\" -o -name \".ldaprc\" -o -name \"*.vmdk\" -o -name \"frakti.sock\" -o -name \"scclient.exe\" -o -name \"keys.log\" -o -name \"creds*\" -o -name \"software.sav\" -o -name \"tomcat-users.xml\" -o -name \"web*.config\" -o -name \"error.log\" -o -name \".rhosts\" -o -name \"sentry.conf.py\" -o -name \"protecteduserkey.bin\" -o -name \"Elastix.conf\" -o -name \"nginx.conf\" -o -name \"*.ftpconfig\" -o -name \"apt.conf\" -o -name \"https.conf\" -o -name \"clouds.config\" -o -name \"AzureRMContext.json\" -o -name \"anaconda-ks.cfg\" -o -name \"trustdb.gpg\" -o -name \"autologin.conf\" -o -name \"environment\" -o -name \"*.ovpn\" -o -name \".git-credentials\" -o -name \"*.keyring\" -o -name \"debian.cnf\" -o -name \".gitconfig\" -o -name \"mosquitto.conf\" -o -name \"unattend.inf\" -o -name \"*.pcap\" -o -name \"known_hosts\" -o -name \"kubelet.conf\" -o -name \"secret.asc\" -o -name \"KeePass.ini\" -o -name \"glusterfs.pem\" -o -name \"*.pgp\" -o -name \"hostapd.conf\" -o -name \"admin.conf\" -o -name \"*credential*\" -o -name \"mongod*.conf\" -o -name \"*.db\" -o -name \".recently-used.xbel\" -o -name \"*vnc*.c*nf*\" -o -name \".flyrc\" -o -name \".bashrc\" -o -name \"*.timer\" -o -name \"elasticsearch.y*ml\" -o -name \"gpg-agent.conf\" -o -name \"*config*.php\" -o -name \".vault-token\" -o -name \"sysprep.xml\" -o -name \"settings.php\" -o -name \".boto\" -o -name \"accessTokens.json\" -o -name \"wcx_ftp.ini\" -o -name \"default.sav\" -o -name \".pgpass\" -o -name \"SYSTEM\" -o -name \"software\" -o -name \"*password*\" -o -name \"*.key\" -o -name \"rocketchat.service\" -o -name \"snyk.config.json\" -o -name \"zabbix_server.conf\" -o -name \"storage.json\" -o -name \"httpd.conf\" -o -name \"redis.conf\" -o -name \"recentservers.xml\" -o -name \"crio.sock\" -o -name \"*.psk\" -o -name \".env*\" -o -name \"*.der\" -o -name \"AppEvent.Evt\" -o -name \"crontab.db\" -o -name \"*.tf\" -o -name \"system.sav\" -o -name \"*.service\" -o -name \"*.asc\" -o -name \"password*.ibd\" -o -name \"*.pfx\" -o -name \"KeePass.config*\" -o -name \"winscp.ini\" -o -name \".lesshst\" -o -name \"dockershim.sock\" -o -name \"sslkeylog.log\" -o -name \"zabbix_agentd.conf\" -o -name \"gvm-tools.conf\" -o -name \"log4j-core*.jar\" -o -name \"sip.conf\" -o -name \"unattend.txt\" -o -name \"my.ini\" -o -name \"wsl.exe\" -o -name \".mylogin.cnf\" -o -name \".google_authenticator\" -o -name \"my.cnf\" -o -name \"credentials.xml\" -o -name \"php.ini\" -o -name \"fastcgi_params\" -o -name \"*.gnupg\" -o -name \"config.php\" -o -name \"access.log\" -o -name \"pagefile.sys\" -o -name \"mysqld.cnf\" -o -name \"cesi.conf\" -o -name \"rpcd\" -o -name \"*.jks\" -o -name \"ipsec.conf\" -o -name \"*.csr\" -o -name \"influxdb.conf\" -o -name \"drives.xml\" -o -name \"datasources.xml\" -o -name \"*.keytab\" -o -name \"*.socket\" -o -name \"iis6.log\" -o -name \"kcpassword\" -o -name \"authorized_keys\" -o -name \"kadm5.acl\" -o -name \"*.keystore\" -o -name \"Ntds.dit\" -o -name \"fat.config\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_RUN=`eval_bckgrd "find ${ROOT_FOLDER}run -name \"agent.*\" -o -name \"*.socket\" -o -name \"*.timer\" -o -name \"ssh-agent.sock\" -o -name \"*.service\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SBIN=`eval_bckgrd "find ${ROOT_FOLDER}sbin -name \"state.vscdb.backup\" -o -name \"snmpd.conf\" -o -name \"supervisord.conf\" -o -name \"*.kdbx\" -o -name \"*.rdg\" -o -name \"groups.xml\" -o -name \"msal_http_cache.bin\" -o -name \"setupinfo.bak\" -o -name \"*.gpg\" -o -name \"*.viminfo\" -o -name \".pypirc\" -o -name \"hudson.util.Secret\" -o -name \"cloud.cfg\" -o -name \"pg_hba.conf\" -o -name \"psk.txt\" -o -name \".claude.json\" -o -name \"ipsec.secrets\" -o -name \"credentials.tfrc.json\" -o -name \"autologin\" -o -name \"secring.gpg\" -o -name \"gitlab.rm\" -o -name \"snyk.json\" -o -name \"rsyncd.conf\" -o -name \"gitlab.yml\" -o -name \"unattended.xml\" -o -name \"SAM\" -o -name \"sites.ini\" -o -name \"KeePass.enforced*\" -o -name \"docker-compose.yml\" -o -name \"pgsql.conf\" -o -name \".secrets.mkey\" -o -name \"master.key\" -o -name \"scheduledtasks.xml\" -o -name \"*.crt\" -o -name \"private-keys-v1.d/*.key\" -o -name \"id_rsa*\" -o -name \"passbolt.php\" -o -name \"docker.sock\" -o -name \"pgadmin*.db\" -o -name \"pgadmin4.db\" -o -name \"appcmd.exe\" -o -name \".k5login\" -o -name \"ws_ftp.ini\" -o -name \"ddclient.conf\" -o -name \"msal_token_cache.json\" -o -name \"*.vhd\" -o -name \"ftp.config\" -o -name \"firebase-tools.json\" -o -name \".git\" -o -name \".plan\" -o -name \"webserver_config.py\" -o -name \"postgresql.conf\" -o -name \".sudo_as_admin_successful\" -o -name \"*.sqlite3\" -o -name \"service_principal_entries.json\" -o -name \"*.sqlite\" -o -name \".profile\" -o -name \"*kubeconfig*\" -o -name \"*.tfstate\" -o -name \"id_dsa*\" -o -name \"sitemanager.xml\" -o -name \"index.dat\" -o -name \"krb5cc_*\" -o -name \"*.swp\" -o -name \"airflow.cfg\" -o -name \"aliases\" -o -name \"*.pcapng\" -o -name \"SecEvent.Evt\" -o -name \"rsyncd.secrets\" -o -name \"legacy_credentials.db\" -o -name \"state.vscdb\" -o -name \".roadtools_auth\" -o -name \"*.maintenance*\" -o -name \"*vnc*.xml\" -o -name \"config.xml\" -o -name \"docker.socket\" -o -name \"hosts.equiv\" -o -name \"passwd.ibd\" -o -name \"*.pem\" -o -name \"server.xml\" -o -name \"Dockerfile\" -o -name \"rktlet.sock\" -o -name \"vsftpd.conf\" -o -name \".wgetrc\" -o -name \"NetSetup.log\" -o -name \"msal_token_cache.bin\" -o -name \"sysprep.inf\" -o -name \"krb5.conf\" -o -name \"pwd.ibd\" -o -name \"azureProfile.json\" -o -name \"unattend.xml\" -o -name \"authorized_hosts\" -o -name \"racoon.conf\" -o -name \"TokenCache.dat\" -o -name \"FreePBX.conf\" -o -name \"service_principal_entries.bin\" -o -name \"jetty-realm.properties\" -o -name \"glusterfs.key\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.cer\" -o -name \"RDCMan.settings\" -o -name \"backups\" -o -name \"kibana.y*ml\" -o -name \"wp-config.php\" -o -name \"adc.json\" -o -name \"passwd\" -o -name \"autounattend.xml\" -o -name \"*vnc*.txt\" -o -name \"plum.sqlite\" -o -name \"secrets.ldb\" -o -name \"bash.exe\" -o -name \"db.php\" -o -name \"crontab-ui.service\" -o -name \"*.pub\" -o -name \".credentials.json\" -o -name \"pubring.kbx\" -o -name \"filezilla.xml\" -o -name \"*vnc*.ini\" -o -name \"ffftp.ini\" -o -name \"ftp.ini\" -o -name \".github\" -o -name \".Xauthority\" -o -name \".mcp.json\" -o -name \"bitcoin.conf\" -o -name \"vault-ssh-helper.hcl\" -o -name \".msmtprc\" -o -name \"setupinfo\" -o -name \"*.p12\" -o -name \"credentials.db\" -o -name \"*_history*\" -o -name \"ntuser.dat\" -o -name \"backup\" -o -name \"bootstrap-kubelet.conf\" -o -name \"ConsoleHost_history.txt\" -o -name \".erlang.cookie\" -o -name \"smb.conf\" -o -name \"access_tokens.db\" -o -name \"*.vhdx\" -o -name \"https-xampp.conf\" -o -name \"grafana.ini\" -o -name \"containerd.sock\" -o -name \"glusterfs.ca\" -o -name \"000-default.conf\" -o -name \"printers.xml\" -o -name \"storage.php\" -o -name \"api_key\" -o -name \".htpasswd\" -o -name \"security.sav\" -o -name \"amportal.conf\" -o -name \"atlantis.db\" -o -name \"database.php\" -o -name \"secrets.yml\" -o -name \"access_tokens.json\" -o -name \"mariadb.cnf\" -o -name \"sssd.conf\" -o -name \".ldaprc\" -o -name \"*.vmdk\" -o -name \"frakti.sock\" -o -name \"scclient.exe\" -o -name \"keys.log\" -o -name \"creds*\" -o -name \"software.sav\" -o -name \"tomcat-users.xml\" -o -name \"web*.config\" -o -name \"error.log\" -o -name \".rhosts\" -o -name \"sentry.conf.py\" -o -name \"protecteduserkey.bin\" -o -name \"Elastix.conf\" -o -name \"nginx.conf\" -o -name \"*.ftpconfig\" -o -name \"apt.conf\" -o -name \"https.conf\" -o -name \"clouds.config\" -o -name \"AzureRMContext.json\" -o -name \"anaconda-ks.cfg\" -o -name \"trustdb.gpg\" -o -name \"autologin.conf\" -o -name \"environment\" -o -name \"*.ovpn\" -o -name \".git-credentials\" -o -name \"*.keyring\" -o -name \"debian.cnf\" -o -name \".gitconfig\" -o -name \"mosquitto.conf\" -o -name \"unattend.inf\" -o -name \"*.pcap\" -o -name \"known_hosts\" -o -name \"kubelet.conf\" -o -name \"secret.asc\" -o -name \"KeePass.ini\" -o -name \"glusterfs.pem\" -o -name \"*.pgp\" -o -name \"hostapd.conf\" -o -name \"admin.conf\" -o -name \"*credential*\" -o -name \"mongod*.conf\" -o -name \"*.db\" -o -name \".recently-used.xbel\" -o -name \"*vnc*.c*nf*\" -o -name \".flyrc\" -o -name \".bashrc\" -o -name \"*.timer\" -o -name \"elasticsearch.y*ml\" -o -name \"gpg-agent.conf\" -o -name \"*config*.php\" -o -name \".vault-token\" -o -name \"sysprep.xml\" -o -name \"settings.php\" -o -name \".boto\" -o -name \"accessTokens.json\" -o -name \"wcx_ftp.ini\" -o -name \"default.sav\" -o -name \".pgpass\" -o -name \"SYSTEM\" -o -name \"software\" -o -name \"*password*\" -o -name \"*.key\" -o -name \"rocketchat.service\" -o -name \"snyk.config.json\" -o -name \"zabbix_server.conf\" -o -name \"storage.json\" -o -name \"httpd.conf\" -o -name \"redis.conf\" -o -name \"recentservers.xml\" -o -name \"crio.sock\" -o -name \"*.psk\" -o -name \".env*\" -o -name \"*.der\" -o -name \"AppEvent.Evt\" -o -name \"crontab.db\" -o -name \"*.tf\" -o -name \"system.sav\" -o -name \"*.service\" -o -name \"*.asc\" -o -name \"password*.ibd\" -o -name \"*.pfx\" -o -name \"KeePass.config*\" -o -name \"winscp.ini\" -o -name \".lesshst\" -o -name \"dockershim.sock\" -o -name \"sslkeylog.log\" -o -name \"zabbix_agentd.conf\" -o -name \"gvm-tools.conf\" -o -name \"log4j-core*.jar\" -o -name \"sip.conf\" -o -name \"unattend.txt\" -o -name \"my.ini\" -o -name \"wsl.exe\" -o -name \".mylogin.cnf\" -o -name \".google_authenticator\" -o -name \"my.cnf\" -o -name \"credentials.xml\" -o -name \"php.ini\" -o -name \"fastcgi_params\" -o -name \"*.gnupg\" -o -name \"config.php\" -o -name \"access.log\" -o -name \"pagefile.sys\" -o -name \"mysqld.cnf\" -o -name \"cesi.conf\" -o -name \"rpcd\" -o -name \"*.jks\" -o -name \"ipsec.conf\" -o -name \"*.csr\" -o -name \"influxdb.conf\" -o -name \"drives.xml\" -o -name \"datasources.xml\" -o -name \"*.keytab\" -o -name \"*.socket\" -o -name \"iis6.log\" -o -name \"kcpassword\" -o -name \"authorized_keys\" -o -name \"kadm5.acl\" -o -name \"*.keystore\" -o -name \"Ntds.dit\" -o -name \"fat.config\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SNAP=`eval_bckgrd "find ${ROOT_FOLDER}snap -name \"state.vscdb.backup\" -o -name \"snmpd.conf\" -o -name \"supervisord.conf\" -o -name \"*.kdbx\" -o -name \"*.rdg\" -o -name \"groups.xml\" -o -name \"msal_http_cache.bin\" -o -name \"setupinfo.bak\" -o -name \"*.gpg\" -o -name \"*.viminfo\" -o -name \".pypirc\" -o -name \"hudson.util.Secret\" -o -name \"cloud.cfg\" -o -name \"pg_hba.conf\" -o -name \"psk.txt\" -o -name \".claude.json\" -o -name \"ipsec.secrets\" -o -name \"credentials.tfrc.json\" -o -name \"autologin\" -o -name \"secring.gpg\" -o -name \"gitlab.rm\" -o -name \"snyk.json\" -o -name \"rsyncd.conf\" -o -name \"gitlab.yml\" -o -name \"unattended.xml\" -o -name \"SAM\" -o -name \"sites.ini\" -o -name \"KeePass.enforced*\" -o -name \"docker-compose.yml\" -o -name \"pgsql.conf\" -o -name \".secrets.mkey\" -o -name \"master.key\" -o -name \"scheduledtasks.xml\" -o -name \"*.crt\" -o -name \"private-keys-v1.d/*.key\" -o -name \"id_rsa*\" -o -name \"passbolt.php\" -o -name \"docker.sock\" -o -name \"pgadmin*.db\" -o -name \"pgadmin4.db\" -o -name \"appcmd.exe\" -o -name \".k5login\" -o -name \"ws_ftp.ini\" -o -name \"ddclient.conf\" -o -name \"msal_token_cache.json\" -o -name \"*.vhd\" -o -name \"ftp.config\" -o -name \"firebase-tools.json\" -o -name \".git\" -o -name \".plan\" -o -name \"webserver_config.py\" -o -name \"postgresql.conf\" -o -name \".sudo_as_admin_successful\" -o -name \"*.sqlite3\" -o -name \"service_principal_entries.json\" -o -name \"*.sqlite\" -o -name \".profile\" -o -name \"*kubeconfig*\" -o -name \"*.tfstate\" -o -name \"id_dsa*\" -o -name \"sitemanager.xml\" -o -name \"index.dat\" -o -name \"krb5cc_*\" -o -name \"*.swp\" -o -name \"airflow.cfg\" -o -name \"aliases\" -o -name \"*.pcapng\" -o -name \"SecEvent.Evt\" -o -name \"rsyncd.secrets\" -o -name \"legacy_credentials.db\" -o -name \"state.vscdb\" -o -name \".roadtools_auth\" -o -name \"*.maintenance*\" -o -name \"*vnc*.xml\" -o -name \"config.xml\" -o -name \"docker.socket\" -o -name \"hosts.equiv\" -o -name \"passwd.ibd\" -o -name \"*.pem\" -o -name \"server.xml\" -o -name \"Dockerfile\" -o -name \"rktlet.sock\" -o -name \"vsftpd.conf\" -o -name \".wgetrc\" -o -name \"NetSetup.log\" -o -name \"msal_token_cache.bin\" -o -name \"sysprep.inf\" -o -name \"krb5.conf\" -o -name \"pwd.ibd\" -o -name \"azureProfile.json\" -o -name \"unattend.xml\" -o -name \"authorized_hosts\" -o -name \"racoon.conf\" -o -name \"TokenCache.dat\" -o -name \"FreePBX.conf\" -o -name \"service_principal_entries.bin\" -o -name \"jetty-realm.properties\" -o -name \"glusterfs.key\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.cer\" -o -name \"RDCMan.settings\" -o -name \"backups\" -o -name \"kibana.y*ml\" -o -name \"wp-config.php\" -o -name \"adc.json\" -o -name \"passwd\" -o -name \"autounattend.xml\" -o -name \"*vnc*.txt\" -o -name \"plum.sqlite\" -o -name \"secrets.ldb\" -o -name \"bash.exe\" -o -name \"db.php\" -o -name \"crontab-ui.service\" -o -name \"*.pub\" -o -name \".credentials.json\" -o -name \"pubring.kbx\" -o -name \"filezilla.xml\" -o -name \"*vnc*.ini\" -o -name \"ffftp.ini\" -o -name \"ftp.ini\" -o -name \".github\" -o -name \".Xauthority\" -o -name \".mcp.json\" -o -name \"bitcoin.conf\" -o -name \"vault-ssh-helper.hcl\" -o -name \".msmtprc\" -o -name \"setupinfo\" -o -name \"*.p12\" -o -name \"credentials.db\" -o -name \"*_history*\" -o -name \"ntuser.dat\" -o -name \"backup\" -o -name \"bootstrap-kubelet.conf\" -o -name \"ConsoleHost_history.txt\" -o -name \".erlang.cookie\" -o -name \"smb.conf\" -o -name \"access_tokens.db\" -o -name \"*.vhdx\" -o -name \"https-xampp.conf\" -o -name \"grafana.ini\" -o -name \"containerd.sock\" -o -name \"glusterfs.ca\" -o -name \"000-default.conf\" -o -name \"printers.xml\" -o -name \"storage.php\" -o -name \"api_key\" -o -name \".htpasswd\" -o -name \"security.sav\" -o -name \"amportal.conf\" -o -name \"atlantis.db\" -o -name \"database.php\" -o -name \"secrets.yml\" -o -name \"access_tokens.json\" -o -name \"mariadb.cnf\" -o -name \"sssd.conf\" -o -name \".ldaprc\" -o -name \"*.vmdk\" -o -name \"frakti.sock\" -o -name \"scclient.exe\" -o -name \"keys.log\" -o -name \"creds*\" -o -name \"software.sav\" -o -name \"tomcat-users.xml\" -o -name \"web*.config\" -o -name \"error.log\" -o -name \".rhosts\" -o -name \"sentry.conf.py\" -o -name \"protecteduserkey.bin\" -o -name \"Elastix.conf\" -o -name \"nginx.conf\" -o -name \"*.ftpconfig\" -o -name \"apt.conf\" -o -name \"https.conf\" -o -name \"clouds.config\" -o -name \"AzureRMContext.json\" -o -name \"anaconda-ks.cfg\" -o -name \"trustdb.gpg\" -o -name \"autologin.conf\" -o -name \"environment\" -o -name \"*.ovpn\" -o -name \".git-credentials\" -o -name \"*.keyring\" -o -name \"debian.cnf\" -o -name \".gitconfig\" -o -name \"mosquitto.conf\" -o -name \"unattend.inf\" -o -name \"*.pcap\" -o -name \"known_hosts\" -o -name \"kubelet.conf\" -o -name \"secret.asc\" -o -name \"KeePass.ini\" -o -name \"glusterfs.pem\" -o -name \"*.pgp\" -o -name \"hostapd.conf\" -o -name \"admin.conf\" -o -name \"*credential*\" -o -name \"mongod*.conf\" -o -name \"*.db\" -o -name \".recently-used.xbel\" -o -name \"*vnc*.c*nf*\" -o -name \".flyrc\" -o -name \".bashrc\" -o -name \"*.timer\" -o -name \"elasticsearch.y*ml\" -o -name \"gpg-agent.conf\" -o -name \"*config*.php\" -o -name \".vault-token\" -o -name \"sysprep.xml\" -o -name \"settings.php\" -o -name \".boto\" -o -name \"accessTokens.json\" -o -name \"wcx_ftp.ini\" -o -name \"default.sav\" -o -name \".pgpass\" -o -name \"SYSTEM\" -o -name \"software\" -o -name \"*password*\" -o -name \"*.key\" -o -name \"rocketchat.service\" -o -name \"snyk.config.json\" -o -name \"zabbix_server.conf\" -o -name \"storage.json\" -o -name \"httpd.conf\" -o -name \"redis.conf\" -o -name \"recentservers.xml\" -o -name \"crio.sock\" -o -name \"*.psk\" -o -name \".env*\" -o -name \"*.der\" -o -name \"AppEvent.Evt\" -o -name \"crontab.db\" -o -name \"*.tf\" -o -name \"system.sav\" -o -name \"*.service\" -o -name \"*.asc\" -o -name \"password*.ibd\" -o -name \"*.pfx\" -o -name \"KeePass.config*\" -o -name \"winscp.ini\" -o -name \".lesshst\" -o -name \"dockershim.sock\" -o -name \"sslkeylog.log\" -o -name \"zabbix_agentd.conf\" -o -name \"gvm-tools.conf\" -o -name \"log4j-core*.jar\" -o -name \"sip.conf\" -o -name \"unattend.txt\" -o -name \"my.ini\" -o -name \"wsl.exe\" -o -name \".mylogin.cnf\" -o -name \".google_authenticator\" -o -name \"my.cnf\" -o -name \"credentials.xml\" -o -name \"php.ini\" -o -name \"fastcgi_params\" -o -name \"*.gnupg\" -o -name \"config.php\" -o -name \"access.log\" -o -name \"pagefile.sys\" -o -name \"mysqld.cnf\" -o -name \"cesi.conf\" -o -name \"rpcd\" -o -name \"*.jks\" -o -name \"ipsec.conf\" -o -name \"*.csr\" -o -name \"influxdb.conf\" -o -name \"drives.xml\" -o -name \"datasources.xml\" -o -name \"*.keytab\" -o -name \"*.socket\" -o -name \"iis6.log\" -o -name \"kcpassword\" -o -name \"authorized_keys\" -o -name \"kadm5.acl\" -o -name \"*.keystore\" -o -name \"Ntds.dit\" -o -name \"fat.config\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SRV=`eval_bckgrd "find ${ROOT_FOLDER}srv -name \"state.vscdb.backup\" -o -name \"snmpd.conf\" -o -name \"supervisord.conf\" -o -name \"*.kdbx\" -o -name \"*.rdg\" -o -name \"groups.xml\" -o -name \"msal_http_cache.bin\" -o -name \"setupinfo.bak\" -o -name \"*.gpg\" -o -name \"*.viminfo\" -o -name \".pypirc\" -o -name \"hudson.util.Secret\" -o -name \"cloud.cfg\" -o -name \"pg_hba.conf\" -o -name \"psk.txt\" -o -name \".claude.json\" -o -name \"ipsec.secrets\" -o -name \"credentials.tfrc.json\" -o -name \"autologin\" -o -name \"secring.gpg\" -o -name \"gitlab.rm\" -o -name \"snyk.json\" -o -name \"rsyncd.conf\" -o -name \"gitlab.yml\" -o -name \"unattended.xml\" -o -name \"SAM\" -o -name \"sites.ini\" -o -name \"KeePass.enforced*\" -o -name \"docker-compose.yml\" -o -name \"pgsql.conf\" -o -name \".secrets.mkey\" -o -name \"master.key\" -o -name \"scheduledtasks.xml\" -o -name \"*.crt\" -o -name \"private-keys-v1.d/*.key\" -o -name \"id_rsa*\" -o -name \"passbolt.php\" -o -name \"docker.sock\" -o -name \"pgadmin*.db\" -o -name \"pgadmin4.db\" -o -name \"appcmd.exe\" -o -name \".k5login\" -o -name \"ws_ftp.ini\" -o -name \"ddclient.conf\" -o -name \"msal_token_cache.json\" -o -name \"*.vhd\" -o -name \"ftp.config\" -o -name \"firebase-tools.json\" -o -name \".git\" -o -name \".plan\" -o -name \"webserver_config.py\" -o -name \"postgresql.conf\" -o -name \".sudo_as_admin_successful\" -o -name \"*.sqlite3\" -o -name \"service_principal_entries.json\" -o -name \"*.sqlite\" -o -name \".profile\" -o -name \"*kubeconfig*\" -o -name \"*.tfstate\" -o -name \"id_dsa*\" -o -name \"sitemanager.xml\" -o -name \"index.dat\" -o -name \"krb5cc_*\" -o -name \"*.swp\" -o -name \"airflow.cfg\" -o -name \"aliases\" -o -name \"*.pcapng\" -o -name \"SecEvent.Evt\" -o -name \"rsyncd.secrets\" -o -name \"legacy_credentials.db\" -o -name \"state.vscdb\" -o -name \".roadtools_auth\" -o -name \"*.maintenance*\" -o -name \"*vnc*.xml\" -o -name \"config.xml\" -o -name \"docker.socket\" -o -name \"hosts.equiv\" -o -name \"passwd.ibd\" -o -name \"*.pem\" -o -name \"server.xml\" -o -name \"Dockerfile\" -o -name \"rktlet.sock\" -o -name \"vsftpd.conf\" -o -name \".wgetrc\" -o -name \"NetSetup.log\" -o -name \"msal_token_cache.bin\" -o -name \"sysprep.inf\" -o -name \"krb5.conf\" -o -name \"pwd.ibd\" -o -name \"azureProfile.json\" -o -name \"unattend.xml\" -o -name \"authorized_hosts\" -o -name \"racoon.conf\" -o -name \"TokenCache.dat\" -o -name \"FreePBX.conf\" -o -name \"service_principal_entries.bin\" -o -name \"jetty-realm.properties\" -o -name \"glusterfs.key\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.cer\" -o -name \"RDCMan.settings\" -o -name \"backups\" -o -name \"kibana.y*ml\" -o -name \"wp-config.php\" -o -name \"adc.json\" -o -name \"passwd\" -o -name \"autounattend.xml\" -o -name \"*vnc*.txt\" -o -name \"plum.sqlite\" -o -name \"secrets.ldb\" -o -name \"bash.exe\" -o -name \"db.php\" -o -name \"crontab-ui.service\" -o -name \"*.pub\" -o -name \".credentials.json\" -o -name \"pubring.kbx\" -o -name \"filezilla.xml\" -o -name \"*vnc*.ini\" -o -name \"ffftp.ini\" -o -name \"ftp.ini\" -o -name \".github\" -o -name \".Xauthority\" -o -name \".mcp.json\" -o -name \"bitcoin.conf\" -o -name \"vault-ssh-helper.hcl\" -o -name \".msmtprc\" -o -name \"setupinfo\" -o -name \"*.p12\" -o -name \"credentials.db\" -o -name \"*_history*\" -o -name \"ntuser.dat\" -o -name \"backup\" -o -name \"bootstrap-kubelet.conf\" -o -name \"ConsoleHost_history.txt\" -o -name \".erlang.cookie\" -o -name \"smb.conf\" -o -name \"access_tokens.db\" -o -name \"*.vhdx\" -o -name \"https-xampp.conf\" -o -name \"grafana.ini\" -o -name \"containerd.sock\" -o -name \"glusterfs.ca\" -o -name \"000-default.conf\" -o -name \"printers.xml\" -o -name \"storage.php\" -o -name \"api_key\" -o -name \".htpasswd\" -o -name \"security.sav\" -o -name \"amportal.conf\" -o -name \"atlantis.db\" -o -name \"database.php\" -o -name \"secrets.yml\" -o -name \"access_tokens.json\" -o -name \"mariadb.cnf\" -o -name \"sssd.conf\" -o -name \".ldaprc\" -o -name \"*.vmdk\" -o -name \"frakti.sock\" -o -name \"scclient.exe\" -o -name \"keys.log\" -o -name \"creds*\" -o -name \"software.sav\" -o -name \"tomcat-users.xml\" -o -name \"web*.config\" -o -name \"error.log\" -o -name \".rhosts\" -o -name \"sentry.conf.py\" -o -name \"protecteduserkey.bin\" -o -name \"Elastix.conf\" -o -name \"nginx.conf\" -o -name \"*.ftpconfig\" -o -name \"apt.conf\" -o -name \"https.conf\" -o -name \"clouds.config\" -o -name \"AzureRMContext.json\" -o -name \"anaconda-ks.cfg\" -o -name \"trustdb.gpg\" -o -name \"autologin.conf\" -o -name \"environment\" -o -name \"*.ovpn\" -o -name \".git-credentials\" -o -name \"*.keyring\" -o -name \"debian.cnf\" -o -name \".gitconfig\" -o -name \"mosquitto.conf\" -o -name \"unattend.inf\" -o -name \"*.pcap\" -o -name \"known_hosts\" -o -name \"kubelet.conf\" -o -name \"secret.asc\" -o -name \"KeePass.ini\" -o -name \"glusterfs.pem\" -o -name \"*.pgp\" -o -name \"hostapd.conf\" -o -name \"admin.conf\" -o -name \"*credential*\" -o -name \"mongod*.conf\" -o -name \"*.db\" -o -name \".recently-used.xbel\" -o -name \"*vnc*.c*nf*\" -o -name \".flyrc\" -o -name \".bashrc\" -o -name \"*.timer\" -o -name \"elasticsearch.y*ml\" -o -name \"gpg-agent.conf\" -o -name \"*config*.php\" -o -name \".vault-token\" -o -name \"sysprep.xml\" -o -name \"settings.php\" -o -name \".boto\" -o -name \"accessTokens.json\" -o -name \"wcx_ftp.ini\" -o -name \"default.sav\" -o -name \".pgpass\" -o -name \"SYSTEM\" -o -name \"software\" -o -name \"*password*\" -o -name \"*.key\" -o -name \"rocketchat.service\" -o -name \"snyk.config.json\" -o -name \"zabbix_server.conf\" -o -name \"storage.json\" -o -name \"httpd.conf\" -o -name \"redis.conf\" -o -name \"recentservers.xml\" -o -name \"crio.sock\" -o -name \"*.psk\" -o -name \".env*\" -o -name \"*.der\" -o -name \"AppEvent.Evt\" -o -name \"crontab.db\" -o -name \"*.tf\" -o -name \"system.sav\" -o -name \"*.service\" -o -name \"*.asc\" -o -name \"password*.ibd\" -o -name \"*.pfx\" -o -name \"KeePass.config*\" -o -name \"winscp.ini\" -o -name \".lesshst\" -o -name \"dockershim.sock\" -o -name \"sslkeylog.log\" -o -name \"zabbix_agentd.conf\" -o -name \"gvm-tools.conf\" -o -name \"log4j-core*.jar\" -o -name \"sip.conf\" -o -name \"unattend.txt\" -o -name \"my.ini\" -o -name \"wsl.exe\" -o -name \".mylogin.cnf\" -o -name \".google_authenticator\" -o -name \"my.cnf\" -o -name \"credentials.xml\" -o -name \"php.ini\" -o -name \"fastcgi_params\" -o -name \"*.gnupg\" -o -name \"config.php\" -o -name \"access.log\" -o -name \"pagefile.sys\" -o -name \"mysqld.cnf\" -o -name \"cesi.conf\" -o -name \"rpcd\" -o -name \"*.jks\" -o -name \"ipsec.conf\" -o -name \"*.csr\" -o -name \"influxdb.conf\" -o -name \"drives.xml\" -o -name \"datasources.xml\" -o -name \"*.keytab\" -o -name \"*.socket\" -o -name \"iis6.log\" -o -name \"kcpassword\" -o -name \"authorized_keys\" -o -name \"kadm5.acl\" -o -name \"*.keystore\" -o -name \"Ntds.dit\" -o -name \"fat.config\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  FIND_TMP=`eval_bckgrd "find ${ROOT_FOLDER}tmp -name \"state.vscdb.backup\" -o -name \"snmpd.conf\" -o -name \"supervisord.conf\" -o -name \"*.kdbx\" -o -name \"*.rdg\" -o -name \"groups.xml\" -o -name \"msal_http_cache.bin\" -o -name \"setupinfo.bak\" -o -name \"*.gpg\" -o -name \"*.viminfo\" -o -name \".pypirc\" -o -name \"hudson.util.Secret\" -o -name \"cloud.cfg\" -o -name \"pg_hba.conf\" -o -name \"psk.txt\" -o -name \".claude.json\" -o -name \"ipsec.secrets\" -o -name \"credentials.tfrc.json\" -o -name \"autologin\" -o -name \"secring.gpg\" -o -name \"gitlab.rm\" -o -name \"snyk.json\" -o -name \"rsyncd.conf\" -o -name \"gitlab.yml\" -o -name \"unattended.xml\" -o -name \"SAM\" -o -name \"sites.ini\" -o -name \"KeePass.enforced*\" -o -name \"docker-compose.yml\" -o -name \"pgsql.conf\" -o -name \".secrets.mkey\" -o -name \"master.key\" -o -name \"scheduledtasks.xml\" -o -name \"*.crt\" -o -name \"private-keys-v1.d/*.key\" -o -name \"id_rsa*\" -o -name \"passbolt.php\" -o -name \"docker.sock\" -o -name \"pgadmin*.db\" -o -name \"pgadmin4.db\" -o -name \"appcmd.exe\" -o -name \".k5login\" -o -name \"ws_ftp.ini\" -o -name \"ddclient.conf\" -o -name \"msal_token_cache.json\" -o -name \"*.vhd\" -o -name \"ftp.config\" -o -name \"firebase-tools.json\" -o -name \".git\" -o -name \".plan\" -o -name \"webserver_config.py\" -o -name \"postgresql.conf\" -o -name \".sudo_as_admin_successful\" -o -name \"*.sqlite3\" -o -name \"service_principal_entries.json\" -o -name \"*.sqlite\" -o -name \".profile\" -o -name \"*kubeconfig*\" -o -name \"*.tfstate\" -o -name \"id_dsa*\" -o -name \"sitemanager.xml\" -o -name \"index.dat\" -o -name \"krb5cc_*\" -o -name \"*.swp\" -o -name \"airflow.cfg\" -o -name \"aliases\" -o -name \"*.pcapng\" -o -name \"SecEvent.Evt\" -o -name \"rsyncd.secrets\" -o -name \"legacy_credentials.db\" -o -name \"state.vscdb\" -o -name \".roadtools_auth\" -o -name \"*.maintenance*\" -o -name \"*vnc*.xml\" -o -name \"config.xml\" -o -name \"docker.socket\" -o -name \"hosts.equiv\" -o -name \"passwd.ibd\" -o -name \"*.pem\" -o -name \"server.xml\" -o -name \"Dockerfile\" -o -name \"rktlet.sock\" -o -name \"vsftpd.conf\" -o -name \".wgetrc\" -o -name \"NetSetup.log\" -o -name \"msal_token_cache.bin\" -o -name \"sysprep.inf\" -o -name \"krb5.conf\" -o -name \"pwd.ibd\" -o -name \"azureProfile.json\" -o -name \"unattend.xml\" -o -name \"ssh-agent.sock\" -o -name \"authorized_hosts\" -o -name \"racoon.conf\" -o -name \"TokenCache.dat\" -o -name \"FreePBX.conf\" -o -name \"service_principal_entries.bin\" -o -name \"jetty-realm.properties\" -o -name \"glusterfs.key\" -o -name \"agent.*\" -o -name \"*.cer\" -o -name \"FreeSSHDservice.ini\" -o -name \"RDCMan.settings\" -o -name \"backups\" -o -name \"kibana.y*ml\" -o -name \"wp-config.php\" -o -name \"adc.json\" -o -name \"passwd\" -o -name \"autounattend.xml\" -o -name \"*vnc*.txt\" -o -name \"plum.sqlite\" -o -name \"secrets.ldb\" -o -name \"bash.exe\" -o -name \"db.php\" -o -name \"crontab-ui.service\" -o -name \"*.pub\" -o -name \".credentials.json\" -o -name \"pubring.kbx\" -o -name \"filezilla.xml\" -o -name \"*vnc*.ini\" -o -name \"ffftp.ini\" -o -name \"ftp.ini\" -o -name \".github\" -o -name \".Xauthority\" -o -name \".mcp.json\" -o -name \"bitcoin.conf\" -o -name \"vault-ssh-helper.hcl\" -o -name \".msmtprc\" -o -name \"setupinfo\" -o -name \"*.p12\" -o -name \"sess_*\" -o -name \"credentials.db\" -o -name \"*_history*\" -o -name \"ntuser.dat\" -o -name \"backup\" -o -name \"bootstrap-kubelet.conf\" -o -name \"ConsoleHost_history.txt\" -o -name \".erlang.cookie\" -o -name \"smb.conf\" -o -name \"access_tokens.db\" -o -name \"*.vhdx\" -o -name \"https-xampp.conf\" -o -name \"grafana.ini\" -o -name \"containerd.sock\" -o -name \"glusterfs.ca\" -o -name \"000-default.conf\" -o -name \"printers.xml\" -o -name \"storage.php\" -o -name \"api_key\" -o -name \".htpasswd\" -o -name \"security.sav\" -o -name \"amportal.conf\" -o -name \"atlantis.db\" -o -name \"database.php\" -o -name \"secrets.yml\" -o -name \"access_tokens.json\" -o -name \"mariadb.cnf\" -o -name \"sssd.conf\" -o -name \".ldaprc\" -o -name \"*.vmdk\" -o -name \"frakti.sock\" -o -name \"scclient.exe\" -o -name \"keys.log\" -o -name \"creds*\" -o -name \"software.sav\" -o -name \"tomcat-users.xml\" -o -name \"web*.config\" -o -name \"error.log\" -o -name \".rhosts\" -o -name \"sentry.conf.py\" -o -name \"protecteduserkey.bin\" -o -name \"Elastix.conf\" -o -name \"nginx.conf\" -o -name \"*.ftpconfig\" -o -name \"apt.conf\" -o -name \"https.conf\" -o -name \"clouds.config\" -o -name \"AzureRMContext.json\" -o -name \"anaconda-ks.cfg\" -o -name \"trustdb.gpg\" -o -name \"autologin.conf\" -o -name \"environment\" -o -name \"*.ovpn\" -o -name \".git-credentials\" -o -name \"*.keyring\" -o -name \"debian.cnf\" -o -name \".gitconfig\" -o -name \"mosquitto.conf\" -o -name \"unattend.inf\" -o -name \"*.pcap\" -o -name \"known_hosts\" -o -name \"kubelet.conf\" -o -name \"secret.asc\" -o -name \"KeePass.ini\" -o -name \"glusterfs.pem\" -o -name \"*.pgp\" -o -name \"hostapd.conf\" -o -name \"admin.conf\" -o -name \"*credential*\" -o -name \"mongod*.conf\" -o -name \"*.db\" -o -name \".recently-used.xbel\" -o -name \"*vnc*.c*nf*\" -o -name \".flyrc\" -o -name \".bashrc\" -o -name \"*.timer\" -o -name \"elasticsearch.y*ml\" -o -name \"gpg-agent.conf\" -o -name \"*config*.php\" -o -name \".vault-token\" -o -name \"sysprep.xml\" -o -name \"settings.php\" -o -name \".boto\" -o -name \"accessTokens.json\" -o -name \"wcx_ftp.ini\" -o -name \"default.sav\" -o -name \".pgpass\" -o -name \"SYSTEM\" -o -name \"software\" -o -name \"*password*\" -o -name \"*.key\" -o -name \"rocketchat.service\" -o -name \"snyk.config.json\" -o -name \"zabbix_server.conf\" -o -name \"storage.json\" -o -name \"httpd.conf\" -o -name \"redis.conf\" -o -name \"recentservers.xml\" -o -name \"crio.sock\" -o -name \"*.psk\" -o -name \".env*\" -o -name \"*.der\" -o -name \"AppEvent.Evt\" -o -name \"crontab.db\" -o -name \"*.tf\" -o -name \"system.sav\" -o -name \"*.service\" -o -name \"*.asc\" -o -name \"password*.ibd\" -o -name \"*.pfx\" -o -name \"KeePass.config*\" -o -name \"winscp.ini\" -o -name \".lesshst\" -o -name \"dockershim.sock\" -o -name \"sslkeylog.log\" -o -name \"zabbix_agentd.conf\" -o -name \"gvm-tools.conf\" -o -name \"log4j-core*.jar\" -o -name \"sip.conf\" -o -name \"unattend.txt\" -o -name \"my.ini\" -o -name \"wsl.exe\" -o -name \".mylogin.cnf\" -o -name \".google_authenticator\" -o -name \"my.cnf\" -o -name \"credentials.xml\" -o -name \"php.ini\" -o -name \"fastcgi_params\" -o -name \"*.gnupg\" -o -name \"config.php\" -o -name \"access.log\" -o -name \"pagefile.sys\" -o -name \"mysqld.cnf\" -o -name \"cesi.conf\" -o -name \"rpcd\" -o -name \"*.jks\" -o -name \"ipsec.conf\" -o -name \"*.csr\" -o -name \"influxdb.conf\" -o -name \"drives.xml\" -o -name \"datasources.xml\" -o -name \"*.keytab\" -o -name \"*.socket\" -o -name \"iis6.log\" -o -name \"kcpassword\" -o -name \"authorized_keys\" -o -name \"kadm5.acl\" -o -name \"*.keystore\" -o -name \"Ntds.dit\" -o -name \"fat.config\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_USR=`eval_bckgrd "find ${ROOT_FOLDER}usr -name \"state.vscdb.backup\" -o -name \"snmpd.conf\" -o -name \"supervisord.conf\" -o -name \"*.kdbx\" -o -name \"*.rdg\" -o -name \"groups.xml\" -o -name \"msal_http_cache.bin\" -o -name \"setupinfo.bak\" -o -name \"*.gpg\" -o -name \"*.viminfo\" -o -name \".pypirc\" -o -name \"hudson.util.Secret\" -o -name \"cloud.cfg\" -o -name \"pg_hba.conf\" -o -name \"psk.txt\" -o -name \".claude.json\" -o -name \"ipsec.secrets\" -o -name \"credentials.tfrc.json\" -o -name \"autologin\" -o -name \"secring.gpg\" -o -name \"gitlab.rm\" -o -name \"snyk.json\" -o -name \"rsyncd.conf\" -o -name \"gitlab.yml\" -o -name \"unattended.xml\" -o -name \"SAM\" -o -name \"sites.ini\" -o -name \"KeePass.enforced*\" -o -name \"docker-compose.yml\" -o -name \"pgsql.conf\" -o -name \".secrets.mkey\" -o -name \"master.key\" -o -name \"scheduledtasks.xml\" -o -name \"*.crt\" -o -name \"private-keys-v1.d/*.key\" -o -name \"id_rsa*\" -o -name \"passbolt.php\" -o -name \"docker.sock\" -o -name \"pgadmin*.db\" -o -name \"pgadmin4.db\" -o -name \"appcmd.exe\" -o -name \".k5login\" -o -name \"ws_ftp.ini\" -o -name \"ddclient.conf\" -o -name \"msal_token_cache.json\" -o -name \"*.vhd\" -o -name \"ftp.config\" -o -name \"firebase-tools.json\" -o -name \".git\" -o -name \".plan\" -o -name \"webserver_config.py\" -o -name \"postgresql.conf\" -o -name \".sudo_as_admin_successful\" -o -name \"*.sqlite3\" -o -name \"service_principal_entries.json\" -o -name \"*.sqlite\" -o -name \".profile\" -o -name \"*kubeconfig*\" -o -name \"*.tfstate\" -o -name \"id_dsa*\" -o -name \"sitemanager.xml\" -o -name \"index.dat\" -o -name \"krb5cc_*\" -o -name \"*.swp\" -o -name \"airflow.cfg\" -o -name \"aliases\" -o -name \"*.pcapng\" -o -name \"SecEvent.Evt\" -o -name \"rsyncd.secrets\" -o -name \"legacy_credentials.db\" -o -name \"state.vscdb\" -o -name \".roadtools_auth\" -o -name \"*.maintenance*\" -o -name \"*vnc*.xml\" -o -name \"config.xml\" -o -name \"docker.socket\" -o -name \"hosts.equiv\" -o -name \"passwd.ibd\" -o -name \"*.pem\" -o -name \"server.xml\" -o -name \"Dockerfile\" -o -name \"rktlet.sock\" -o -name \"vsftpd.conf\" -o -name \".wgetrc\" -o -name \"NetSetup.log\" -o -name \"msal_token_cache.bin\" -o -name \"sysprep.inf\" -o -name \"krb5.conf\" -o -name \"pwd.ibd\" -o -name \"azureProfile.json\" -o -name \"unattend.xml\" -o -name \"authorized_hosts\" -o -name \"racoon.conf\" -o -name \"TokenCache.dat\" -o -name \"FreePBX.conf\" -o -name \"service_principal_entries.bin\" -o -name \"jetty-realm.properties\" -o -name \"glusterfs.key\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.cer\" -o -name \"RDCMan.settings\" -o -name \"backups\" -o -name \"kibana.y*ml\" -o -name \"wp-config.php\" -o -name \"adc.json\" -o -name \"passwd\" -o -name \"autounattend.xml\" -o -name \"*vnc*.txt\" -o -name \"plum.sqlite\" -o -name \"secrets.ldb\" -o -name \"bash.exe\" -o -name \"db.php\" -o -name \"crontab-ui.service\" -o -name \"*.pub\" -o -name \".credentials.json\" -o -name \"pubring.kbx\" -o -name \"filezilla.xml\" -o -name \"*vnc*.ini\" -o -name \"ffftp.ini\" -o -name \"ftp.ini\" -o -name \".github\" -o -name \".Xauthority\" -o -name \".mcp.json\" -o -name \"bitcoin.conf\" -o -name \"vault-ssh-helper.hcl\" -o -name \".msmtprc\" -o -name \"setupinfo\" -o -name \"*.p12\" -o -name \"credentials.db\" -o -name \"*_history*\" -o -name \"ntuser.dat\" -o -name \"backup\" -o -name \"bootstrap-kubelet.conf\" -o -name \"ConsoleHost_history.txt\" -o -name \".erlang.cookie\" -o -name \"smb.conf\" -o -name \"access_tokens.db\" -o -name \"*.vhdx\" -o -name \"https-xampp.conf\" -o -name \"grafana.ini\" -o -name \"containerd.sock\" -o -name \"glusterfs.ca\" -o -name \"000-default.conf\" -o -name \"printers.xml\" -o -name \"storage.php\" -o -name \"api_key\" -o -name \".htpasswd\" -o -name \"security.sav\" -o -name \"amportal.conf\" -o -name \"atlantis.db\" -o -name \"database.php\" -o -name \"secrets.yml\" -o -name \"access_tokens.json\" -o -name \"mariadb.cnf\" -o -name \"sssd.conf\" -o -name \".ldaprc\" -o -name \"*.vmdk\" -o -name \"frakti.sock\" -o -name \"scclient.exe\" -o -name \"keys.log\" -o -name \"creds*\" -o -name \"software.sav\" -o -name \"tomcat-users.xml\" -o -name \"web*.config\" -o -name \"error.log\" -o -name \".rhosts\" -o -name \"sentry.conf.py\" -o -name \"protecteduserkey.bin\" -o -name \"Elastix.conf\" -o -name \"nginx.conf\" -o -name \"*.ftpconfig\" -o -name \"apt.conf\" -o -name \"https.conf\" -o -name \"clouds.config\" -o -name \"AzureRMContext.json\" -o -name \"anaconda-ks.cfg\" -o -name \"trustdb.gpg\" -o -name \"autologin.conf\" -o -name \"environment\" -o -name \"*.ovpn\" -o -name \".git-credentials\" -o -name \"*.keyring\" -o -name \"debian.cnf\" -o -name \".gitconfig\" -o -name \"mosquitto.conf\" -o -name \"unattend.inf\" -o -name \"*.pcap\" -o -name \"known_hosts\" -o -name \"kubelet.conf\" -o -name \"secret.asc\" -o -name \"KeePass.ini\" -o -name \"glusterfs.pem\" -o -name \"*.pgp\" -o -name \"hostapd.conf\" -o -name \"admin.conf\" -o -name \"*credential*\" -o -name \"mongod*.conf\" -o -name \"*.db\" -o -name \".recently-used.xbel\" -o -name \"*vnc*.c*nf*\" -o -name \".flyrc\" -o -name \".bashrc\" -o -name \"*.timer\" -o -name \"elasticsearch.y*ml\" -o -name \"gpg-agent.conf\" -o -name \"*config*.php\" -o -name \".vault-token\" -o -name \"ssh*config\" -o -name \"settings.php\" -o -name \".boto\" -o -name \"sysprep.xml\" -o -name \"accessTokens.json\" -o -name \"wcx_ftp.ini\" -o -name \"default.sav\" -o -name \".pgpass\" -o -name \"SYSTEM\" -o -name \"software\" -o -name \"*password*\" -o -name \"*.key\" -o -name \"rocketchat.service\" -o -name \"snyk.config.json\" -o -name \"zabbix_server.conf\" -o -name \"storage.json\" -o -name \"httpd.conf\" -o -name \"redis.conf\" -o -name \"recentservers.xml\" -o -name \"crio.sock\" -o -name \"*.psk\" -o -name \".env*\" -o -name \"*.der\" -o -name \"AppEvent.Evt\" -o -name \"crontab.db\" -o -name \"*.tf\" -o -name \"system.sav\" -o -name \"*.service\" -o -name \"*.asc\" -o -name \"password*.ibd\" -o -name \"*.pfx\" -o -name \"KeePass.config*\" -o -name \"winscp.ini\" -o -name \".lesshst\" -o -name \"dockershim.sock\" -o -name \"sslkeylog.log\" -o -name \"zabbix_agentd.conf\" -o -name \"gvm-tools.conf\" -o -name \"log4j-core*.jar\" -o -name \"sip.conf\" -o -name \"unattend.txt\" -o -name \"my.ini\" -o -name \"wsl.exe\" -o -name \".mylogin.cnf\" -o -name \".google_authenticator\" -o -name \"my.cnf\" -o -name \"credentials.xml\" -o -name \"php.ini\" -o -name \"fastcgi_params\" -o -name \"*.gnupg\" -o -name \"config.php\" -o -name \"access.log\" -o -name \"pagefile.sys\" -o -name \"mysqld.cnf\" -o -name \"cesi.conf\" -o -name \"rpcd\" -o -name \"*.jks\" -o -name \"ipsec.conf\" -o -name \"*.csr\" -o -name \"influxdb.conf\" -o -name \"drives.xml\" -o -name \"datasources.xml\" -o -name \"*.keytab\" -o -name \"*.socket\" -o -name \"iis6.log\" -o -name \"kcpassword\" -o -name \"authorized_keys\" -o -name \"kadm5.acl\" -o -name \"*.keystore\" -o -name \"Ntds.dit\" -o -name \"fat.config\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_VAR=`eval_bckgrd "find ${ROOT_FOLDER}var -name \"state.vscdb.backup\" -o -name \"snmpd.conf\" -o -name \"supervisord.conf\" -o -name \"*.kdbx\" -o -name \"*.rdg\" -o -name \"groups.xml\" -o -name \"msal_http_cache.bin\" -o -name \"setupinfo.bak\" -o -name \"*.gpg\" -o -name \"*.viminfo\" -o -name \".pypirc\" -o -name \"hudson.util.Secret\" -o -name \"cloud.cfg\" -o -name \"pg_hba.conf\" -o -name \"psk.txt\" -o -name \".claude.json\" -o -name \"ipsec.secrets\" -o -name \"credentials.tfrc.json\" -o -name \"autologin\" -o -name \"secring.gpg\" -o -name \"gitlab.rm\" -o -name \"snyk.json\" -o -name \"rsyncd.conf\" -o -name \"gitlab.yml\" -o -name \"unattended.xml\" -o -name \"SAM\" -o -name \"sites.ini\" -o -name \"KeePass.enforced*\" -o -name \"docker-compose.yml\" -o -name \"pgsql.conf\" -o -name \".secrets.mkey\" -o -name \"master.key\" -o -name \"scheduledtasks.xml\" -o -name \"*.crt\" -o -name \"private-keys-v1.d/*.key\" -o -name \"id_rsa*\" -o -name \"passbolt.php\" -o -name \"docker.sock\" -o -name \"pgadmin*.db\" -o -name \"pgadmin4.db\" -o -name \"appcmd.exe\" -o -name \".k5login\" -o -name \"ws_ftp.ini\" -o -name \"ddclient.conf\" -o -name \"msal_token_cache.json\" -o -name \"*.vhd\" -o -name \"ftp.config\" -o -name \"firebase-tools.json\" -o -name \".git\" -o -name \".plan\" -o -name \"webserver_config.py\" -o -name \"postgresql.conf\" -o -name \".sudo_as_admin_successful\" -o -name \"*.sqlite3\" -o -name \"service_principal_entries.json\" -o -name \"*.sqlite\" -o -name \".profile\" -o -name \"*kubeconfig*\" -o -name \"*.tfstate\" -o -name \"id_dsa*\" -o -name \"sitemanager.xml\" -o -name \"index.dat\" -o -name \"krb5cc_*\" -o -name \"*.swp\" -o -name \"airflow.cfg\" -o -name \"aliases\" -o -name \"*.pcapng\" -o -name \"SecEvent.Evt\" -o -name \"rsyncd.secrets\" -o -name \"legacy_credentials.db\" -o -name \"state.vscdb\" -o -name \".roadtools_auth\" -o -name \"*.maintenance*\" -o -name \"*vnc*.xml\" -o -name \"config.xml\" -o -name \"docker.socket\" -o -name \"hosts.equiv\" -o -name \"passwd.ibd\" -o -name \"*.pem\" -o -name \"server.xml\" -o -name \"Dockerfile\" -o -name \"rktlet.sock\" -o -name \"vsftpd.conf\" -o -name \".wgetrc\" -o -name \"NetSetup.log\" -o -name \"msal_token_cache.bin\" -o -name \"sysprep.inf\" -o -name \"krb5.conf\" -o -name \"pwd.ibd\" -o -name \"azureProfile.json\" -o -name \"unattend.xml\" -o -name \"authorized_hosts\" -o -name \"racoon.conf\" -o -name \"TokenCache.dat\" -o -name \"FreePBX.conf\" -o -name \"service_principal_entries.bin\" -o -name \"jetty-realm.properties\" -o -name \"glusterfs.key\" -o -name \"FreeSSHDservice.ini\" -o -name \"*.cer\" -o -name \"RDCMan.settings\" -o -name \"backups\" -o -name \"kibana.y*ml\" -o -name \"wp-config.php\" -o -name \"adc.json\" -o -name \"passwd\" -o -name \"autounattend.xml\" -o -name \"*vnc*.txt\" -o -name \"plum.sqlite\" -o -name \"secrets.ldb\" -o -name \"bash.exe\" -o -name \"db.php\" -o -name \"crontab-ui.service\" -o -name \"*.pub\" -o -name \".credentials.json\" -o -name \"pubring.kbx\" -o -name \"filezilla.xml\" -o -name \"*vnc*.ini\" -o -name \"ffftp.ini\" -o -name \"ftp.ini\" -o -name \".github\" -o -name \".Xauthority\" -o -name \".mcp.json\" -o -name \"bitcoin.conf\" -o -name \"vault-ssh-helper.hcl\" -o -name \".msmtprc\" -o -name \"setupinfo\" -o -name \"*.p12\" -o -name \"credentials.db\" -o -name \"sess_*\" -o -name \"*_history*\" -o -name \"ntuser.dat\" -o -name \"backup\" -o -name \"bootstrap-kubelet.conf\" -o -name \"ConsoleHost_history.txt\" -o -name \".erlang.cookie\" -o -name \"smb.conf\" -o -name \"access_tokens.db\" -o -name \"*.vhdx\" -o -name \"https-xampp.conf\" -o -name \"grafana.ini\" -o -name \"containerd.sock\" -o -name \"glusterfs.ca\" -o -name \"000-default.conf\" -o -name \"printers.xml\" -o -name \"storage.php\" -o -name \"api_key\" -o -name \".htpasswd\" -o -name \"security.sav\" -o -name \"amportal.conf\" -o -name \"atlantis.db\" -o -name \"database.php\" -o -name \"secrets.yml\" -o -name \"access_tokens.json\" -o -name \"mariadb.cnf\" -o -name \"sssd.conf\" -o -name \".ldaprc\" -o -name \"*.vmdk\" -o -name \"frakti.sock\" -o -name \"scclient.exe\" -o -name \"keys.log\" -o -name \"creds*\" -o -name \"software.sav\" -o -name \"tomcat-users.xml\" -o -name \"web*.config\" -o -name \"error.log\" -o -name \".rhosts\" -o -name \"sentry.conf.py\" -o -name \"protecteduserkey.bin\" -o -name \"Elastix.conf\" -o -name \"nginx.conf\" -o -name \"*.ftpconfig\" -o -name \"apt.conf\" -o -name \"https.conf\" -o -name \"clouds.config\" -o -name \"AzureRMContext.json\" -o -name \"anaconda-ks.cfg\" -o -name \"trustdb.gpg\" -o -name \"autologin.conf\" -o -name \"environment\" -o -name \"*.ovpn\" -o -name \".git-credentials\" -o -name \"*.keyring\" -o -name \"debian.cnf\" -o -name \".gitconfig\" -o -name \"mosquitto.conf\" -o -name \"unattend.inf\" -o -name \"*.pcap\" -o -name \"known_hosts\" -o -name \"kubelet.conf\" -o -name \"secret.asc\" -o -name \"KeePass.ini\" -o -name \"glusterfs.pem\" -o -name \"*.pgp\" -o -name \"hostapd.conf\" -o -name \"admin.conf\" -o -name \"*credential*\" -o -name \"mongod*.conf\" -o -name \"*.db\" -o -name \".recently-used.xbel\" -o -name \"*vnc*.c*nf*\" -o -name \".flyrc\" -o -name \".bashrc\" -o -name \"*.timer\" -o -name \"elasticsearch.y*ml\" -o -name \"gpg-agent.conf\" -o -name \"*config*.php\" -o -name \".vault-token\" -o -name \"sysprep.xml\" -o -name \"settings.php\" -o -name \".boto\" -o -name \"accessTokens.json\" -o -name \"wcx_ftp.ini\" -o -name \"default.sav\" -o -name \".pgpass\" -o -name \"SYSTEM\" -o -name \"software\" -o -name \"*password*\" -o -name \"*.key\" -o -name \"rocketchat.service\" -o -name \"snyk.config.json\" -o -name \"zabbix_server.conf\" -o -name \"storage.json\" -o -name \"httpd.conf\" -o -name \"redis.conf\" -o -name \"recentservers.xml\" -o -name \"crio.sock\" -o -name \"*.psk\" -o -name \".env*\" -o -name \"*.der\" -o -name \"AppEvent.Evt\" -o -name \"crontab.db\" -o -name \"*.tf\" -o -name \"system.sav\" -o -name \"*.service\" -o -name \"*.asc\" -o -name \"password*.ibd\" -o -name \"*.pfx\" -o -name \"KeePass.config*\" -o -name \"winscp.ini\" -o -name \".lesshst\" -o -name \"dockershim.sock\" -o -name \"sslkeylog.log\" -o -name \"zabbix_agentd.conf\" -o -name \"gvm-tools.conf\" -o -name \"log4j-core*.jar\" -o -name \"sip.conf\" -o -name \"unattend.txt\" -o -name \"my.ini\" -o -name \"wsl.exe\" -o -name \".mylogin.cnf\" -o -name \".google_authenticator\" -o -name \"my.cnf\" -o -name \"credentials.xml\" -o -name \"php.ini\" -o -name \"fastcgi_params\" -o -name \"*.gnupg\" -o -name \"config.php\" -o -name \"access.log\" -o -name \"pagefile.sys\" -o -name \"mysqld.cnf\" -o -name \"cesi.conf\" -o -name \"rpcd\" -o -name \"*.jks\" -o -name \"ipsec.conf\" -o -name \"*.csr\" -o -name \"influxdb.conf\" -o -name \"drives.xml\" -o -name \"datasources.xml\" -o -name \"*.keytab\" -o -name \"*.socket\" -o -name \"iis6.log\" -o -name \"kcpassword\" -o -name \"authorized_keys\" -o -name \"kadm5.acl\" -o -name \"*.keystore\" -o -name \"Ntds.dit\" -o -name \"fat.config\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
...
if [ "$SEARCH_IN_FOLDER" ] || echo $CHECKS | grep -q procs_crons_timers_srvcs_sockets || echo $CHECKS | grep -q software_information || echo $CHECKS | grep -q interesting_files; then
  ...
  PSTORAGE_SYSTEMD=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}sys|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}lib64|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}lib32|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}tmp|^$GREPHOMESEARCH|^${ROOT_FOLDER}systemd|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}concourse-auth|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}media|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}var|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}lib|^${ROOT_FOLDER}concourse-keys|^${ROOT_FOLDER}run|^${ROOT_FOLDER}system|^${ROOT_FOLDER}bin" | grep -E ".*\.service$" | sort | uniq | head -n 70)
  PSTORAGE_TIMER=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}sys|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}lib64|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}lib32|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}tmp|^$GREPHOMESEARCH|^${ROOT_FOLDER}systemd|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}concourse-auth|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}media|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}var|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}lib|^${ROOT_FOLDER}concourse-keys|^${ROOT_FOLDER}run|^${ROOT_FOLDER}system|^${ROOT_FOLDER}bin" | grep -E ".*\.timer$" | sort | uniq | head -n 70)
  PSTORAGE_SOCKET=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}sys|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}lib64|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}lib32|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}tmp|^$GREPHOMESEARCH|^${ROOT_FOLDER}systemd|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}concourse-auth|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}media|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}var|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}lib|^${ROOT_FOLDER}concourse-keys|^${ROOT_FOLDER}run|^${ROOT_FOLDER}system|^${ROOT_FOLDER}bin" | grep -E ".*\.socket$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_MYSQL=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_DIR_CACHE\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_SBIN\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_SRV\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_RUN\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_USR\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -v -E 'mysql/mysql' | grep -E '^/etc/.*mysql|/usr/var/lib/.*mysql|/var/lib/.*mysql' | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "mysql$|passwd\.ibd$|password.*\.ibd$|pwd\.ibd$|mysqld\.cnf$|\.mylogin\.cnf$" | sort | uniq | head -n 70)
  PSTORAGE_MARIADB=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "mariadb\.cnf$|debian\.cnf$" | sort | uniq | head -n 70)
  PSTORAGE_POSTGRESQL=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "pgadmin.*\.db$|pg_hba\.conf$|postgresql\.conf$|pgsql\.conf$|\.pgpass$|pgadmin4\.db$" | sort | uniq | head -n 70)
  PSTORAGE_APACHE_NGINX=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_DIR_CACHE\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_SBIN\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_SRV\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_RUN\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_USR\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "sites-enabled$|000-default\.conf$|php\.ini$|nginx\.conf$|nginx$" | sort | uniq | head -n 70)
  PSTORAGE_VARNISH=$(echo -e "$FIND_DIR_CACHE\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_SBIN\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_SRV\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_RUN\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_USR\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "varnish$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_PHP_FILES=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E ".*config.*\.php$|database\.php$|db\.php$|storage\.php$|settings\.php$" | sort | uniq | head -n 70)
  PSTORAGE_APACHE_AIRFLOW=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "airflow\.cfg$|webserver_config\.py$" | sort | uniq | head -n 70)
  PSTORAGE_X11=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "\.Xauthority$" | sort | uniq | head -n 70)
  PSTORAGE_WORDPRESS=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "wp-config\.php$" | sort | uniq | head -n 70)
  PSTORAGE_DRUPAL=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E '/default/settings.php' | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "settings\.php$" | sort | uniq | head -n 70)
  PSTORAGE_MOODLE=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E 'moodle/config.php' | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "config\.php$" | sort | uniq | head -n 70)
  PSTORAGE_TOMCAT=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "tomcat-users\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_MONGO=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "mongod.*\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_ROCKETCHAT=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}systemd|^${ROOT_FOLDER}lib" | grep -E "rocketchat\.service$" | sort | uniq | head -n 70)
  PSTORAGE_SUPERVISORD=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "supervisord\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_CESI=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "cesi\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_RSYNC=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "rsyncd\.conf$|rsyncd\.secrets$" | sort | uniq | head -n 70)
  PSTORAGE_RPCD=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -v -E '/init.d/|/sbin/|/usr/share/' | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "rpcd$" | sort | uniq | head -n 70)
  PSTORAGE_BITCOIN=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "bitcoin\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_HOSTAPD=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "hostapd\.conf$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_GLUSTERFS=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "glusterfs\.pem$|glusterfs\.ca$|glusterfs\.key$" | sort | uniq | head -n 70)
  PSTORAGE_ANACONDA_KS=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "anaconda-ks\.cfg$" | sort | uniq | head -n 70)
  PSTORAGE_TERRAFORM=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E ".*\.tfstate$|.*\.tf$|credentials\.tfrc\.json$" | sort | uniq | head -n 70)
  PSTORAGE_RACOON=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "racoon\.conf$|psk\.txt$" | sort | uniq | head -n 70)
  PSTORAGE_KUBERNETES=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_DIR_CACHE\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_SBIN\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_SRV\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_RUN\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_USR\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}run|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}var|^$GREPHOMESEARCH|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E ".*kubeconfig.*$|admin\.conf$|bootstrap-kubelet\.conf$|kubelet\.conf$|\.kube.*$|kubernetes$|kubelet$|kube-proxy$|kubernetes\.io$|net\.d$|containerd$|crio$|etcd$|origin$|k0s$|k3s$|rke2$|microk8s$" | sort | uniq | head -n 70)
  PSTORAGE_VNC=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_DIR_CACHE\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_SBIN\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_SRV\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_RUN\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_USR\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -v -E '/mime/' | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "\.vnc$|.*vnc.*\.c.*nf.*$|.*vnc.*\.ini$|.*vnc.*\.txt$|.*vnc.*\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_LDAP=$(echo -e "$FIND_DIR_CACHE\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_SBIN\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_SRV\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_RUN\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_USR\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "ldap$" | sort | uniq | head -n 70)
  PSTORAGE_LOG4SHELL=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}lib64|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}lib32|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}tmp|^$GREPHOMESEARCH|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}media|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}var|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}lib|^${ROOT_FOLDER}bin" | grep -E "log4j-core.*\.jar$" | sort | uniq | head -n 70)
  PSTORAGE_OPENVPN=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E ".*\.ovpn$" | sort | uniq | head -n 70)
  PSTORAGE_SSH=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "id_dsa.*$|id_rsa.*$|known_hosts$|authorized_hosts$|authorized_keys$|.*\.pub$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSB4=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -v -E '/usr/share/|/usr/local/lib/|/usr/lib.*' | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E ".*\.pem$|.*\.cer$|.*\.crt$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSBIN=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -v -E '/usr/share/|/usr/local/lib/|/usr/lib/.*|^/usr/share/|/usr/local/lib/|/usr/lib/.*' | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E ".*\.csr$|.*\.der$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSCLIENT=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -v -E '/usr/share/|/usr/local/lib/|/usr/lib/.*' | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E ".*\.pfx$|.*\.p12$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_SNYK=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "snyk\.json$|snyk\.config\.json$" | sort | uniq | head -n 70)
  PSTORAGE_CLOUD_CREDENTIALS=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_DIR_CACHE\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_SBIN\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_SRV\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_RUN\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_USR\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "credentials\.db$|legacy_credentials\.db$|adc\.json$|\.boto$|\.credentials\.json$|firebase-tools\.json$|access_tokens\.db$|access_tokens\.json$|accessTokens\.json$|gcloud$|legacy_credentials$|azureProfile\.json$|TokenCache\.dat$|AzureRMContext\.json$|clouds\.config$|service_principal_entries\.json$|msal_token_cache\.json$|msal_http_cache\.bin$|service_principal_entries\.bin$|msal_token_cache\.bin$|ErrorRecords$|TokenCache\.dat$|\.bluemix$|doctl$|Google Cloud Directory Sync$|Google Password Sync$" | sort | uniq | head -n 70)
  PSTORAGE_AI_CODING_ASSISTANTS=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_DIR_CACHE\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_SBIN\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_SRV\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_RUN\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_USR\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E '.*/\.config/gh$|.*/AppData/.*gh$|.*/Library/Application Support/gh$|.*/(Cursor|Code|Code - Insiders)/User/(globalStorage|workspaceStorage)(/.*)?$|.*/Library/Application Support/(Cursor|Code|Code - Insiders)/User/(globalStorage|workspaceStorage)(/.*)?$' | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "\.codex$|\.claude$|\.claude\.json$|\.gemini$|\.cursor$|\.mcp\.json$|gh$|state\.vscdb$|state\.vscdb\.backup$|storage\.json$" | sort | uniq | head -n 70)
  PSTORAGE_ROAD_RECON=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "\.roadtools_auth$" | sort | uniq | head -n 70)
  PSTORAGE_FREEIPA=$(echo -e "$FIND_DIR_CACHE\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_SBIN\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_SRV\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_RUN\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_USR\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "ipa$|dirsrv$" | sort | uniq | head -n 70)
  PSTORAGE_KERBEROS=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "krb5\.conf$|.*\.keytab$|\.k5login$|krb5cc_.*$|kadm5\.acl$|secrets\.ldb$|\.secrets\.mkey$|sssd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_KIBANA=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "kibana\.y.*ml$" | sort | uniq | head -n 70)
  PSTORAGE_GRAFANA=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "grafana\.ini$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_LOGSTASH=$(echo -e "$FIND_DIR_CACHE\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_SBIN\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_SRV\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_RUN\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_USR\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "logstash$" | sort | uniq | head -n 70)
  PSTORAGE_ELASTICSEARCH=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "elasticsearch\.y.*ml$" | sort | uniq | head -n 70)
  PSTORAGE_VAULT_SSH_HELPER=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "vault-ssh-helper\.hcl$" | sort | uniq | head -n 70)
  PSTORAGE_VAULT_SSH_TOKEN=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "\.vault-token$" | sort | uniq | head -n 70)
  PSTORAGE_COUCHDB=$(echo -e "$FIND_DIR_CACHE\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_SBIN\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_SRV\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_RUN\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_USR\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "couchdb$" | sort | uniq | head -n 70)
  PSTORAGE_REDIS=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "redis\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_MOSQUITTO=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "mosquitto\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_NEO4J=$(echo -e "$FIND_DIR_CACHE\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_SBIN\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_SRV\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_RUN\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_USR\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "neo4j$" | sort | uniq | head -n 70)
  PSTORAGE_CLOUD_INIT=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "cloud\.cfg$" | sort | uniq | head -n 70)
  PSTORAGE_ERLANG=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "\.erlang\.cookie$" | sort | uniq | head -n 70)
  PSTORAGE_SIP=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "sip\.conf$|amportal\.conf$|FreePBX\.conf$|Elastix\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_GMV_AUTH=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "gvm-tools\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_IPSEC=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "ipsec\.secrets$|ipsec\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_IRSSI=$(echo -e "$FIND_DIR_CACHE\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_SBIN\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_SRV\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_RUN\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_USR\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "\.irssi$" | sort | uniq | head -n 70)
  PSTORAGE_KEYRING=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_DIR_CACHE\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_SBIN\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_SRV\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_RUN\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_USR\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "keyrings$|.*\.keyring$|.*\.keystore$|.*\.jks$" | sort | uniq | head -n 70)
  PSTORAGE_VIRTUAL_DISKS=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E ".*\.vhd$|.*\.vhdx$|.*\.vmdk$" | sort | uniq | head -n 70)
  PSTORAGE_FILEZILLA=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_DIR_CACHE\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_SBIN\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_SRV\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_RUN\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_USR\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "filezilla$|filezilla\.xml$|recentservers\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_BACKUP_MANAGER=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "storage\.php$|database\.php$" | sort | uniq | head -n 70)
  PSTORAGE_SPLUNK=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "passwd$" | sort | uniq | head -n 70)
  PSTORAGE_GIT=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "\.git-credentials$" | sort | uniq | head -n 70)
  PSTORAGE_ATLANTIS=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "atlantis\.db$" | sort | uniq | head -n 70)
  PSTORAGE_GITLAB=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -v -E '/lib' | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "secrets\.yml$|gitlab\.yml$|gitlab\.rm$" | sort | uniq | head -n 70)
  PSTORAGE_PGP_GPG=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -v -E '/usr/share/|/usr/lib/|/lib/|/man/|README.gnupg' | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E ".*\.pgp$|.*\.gpg$|.*\.asc$|secring\.gpg$|pubring\.kbx$|trustdb\.gpg$|gpg-agent\.conf$|secret\.asc$|private-keys-v1\.d/.*\.key$|.*\.gnupg$" | sort | uniq | head -n 70)
  PSTORAGE_CACHE_VI=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E ".*\.swp$|.*\.viminfo$" | sort | uniq | head -n 70)
  PSTORAGE_DOCKER=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_DIR_CACHE\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_SBIN\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_SRV\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_RUN\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_USR\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "docker\.socket$|docker\.sock$|Dockerfile$|docker-compose\.yml$|dockershim\.sock$|containerd\.sock$|crio\.sock$|frakti\.sock$|rktlet\.sock$|\.docker$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_AUTOLOGIN=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "autologin$|autologin\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_FASTCGI=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "fastcgi_params$" | sort | uniq | head -n 70)
  PSTORAGE_FAT_FREE=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "fat\.config$" | sort | uniq | head -n 70)
  PSTORAGE_SHODAN=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "api_key$" | sort | uniq | head -n 70)
  PSTORAGE_CONCOURSE=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_DIR_CACHE\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_SBIN\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_SRV\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_RUN\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_USR\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}concourse-auth|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}concourse-keys" | grep -E "\.flyrc$|concourse-auth$|concourse-keys$" | sort | uniq | head -n 70)
  PSTORAGE_BOTO=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "\.boto$" | sort | uniq | head -n 70)
  PSTORAGE_SNMP=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "snmpd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_PYPIRC=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "\.pypirc$" | sort | uniq | head -n 70)
  PSTORAGE_POSTFIX=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_DIR_CACHE\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_SBIN\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_SRV\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_RUN\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_USR\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "aliases$|postfix$" | sort | uniq | head -n 70)
  PSTORAGE_CLOUDFLARE=$(echo -e "$FIND_DIR_CACHE\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_SBIN\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_SRV\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_RUN\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_USR\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "\.cloudflared$" | sort | uniq | head -n 70)
  PSTORAGE_HISTORY=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E ".*_history.*$" | sort | uniq | head -n 70)
  PSTORAGE_HTTP_CONF=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "httpd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_HTPASSWD=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "\.htpasswd$" | sort | uniq | head -n 70)
  PSTORAGE_LDAPRC=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "\.ldaprc$" | sort | uniq | head -n 70)
  PSTORAGE_ENV=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -v -E 'example' | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "\.env.*$" | sort | uniq | head -n 70)
  PSTORAGE_PROXY_CONFIG=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_DIR_CACHE\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_SBIN\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_SRV\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_RUN\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_USR\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E '^/etc/environment$' | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "environment$|apt\.conf$|apt\.conf\.d$" | sort | uniq | head -n 70)
  PSTORAGE_SNIFFING_ARTIFACTS=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E ".*\.pcap$|.*\.pcapng$|keys\.log$|sslkeylog\.log$" | sort | uniq | head -n 70)
  PSTORAGE_MSMTPRC=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "\.msmtprc$" | sort | uniq | head -n 70)
  PSTORAGE_INFLUXDB=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "influxdb\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_ZABBIX=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_DIR_CACHE\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_SBIN\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_SRV\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_RUN\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_USR\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "zabbix_server\.conf$|zabbix_agentd\.conf$|zabbix$" | sort | uniq | head -n 70)
  PSTORAGE_GITHUB=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "\.github$|\.gitconfig$|\.git-credentials$|\.git$" | sort | uniq | head -n 70)
  PSTORAGE_SVN=$(echo -e "$FIND_DIR_CACHE\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_SBIN\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_SRV\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_RUN\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_USR\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "\.svn$" | sort | uniq | head -n 70)
  PSTORAGE_KEEPASS=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E ".*\.kdbx$|KeePass\.config.*$|KeePass\.ini$|KeePass\.enforced.*$" | sort | uniq | head -n 70)
  PSTORAGE_PRE_SHARED_KEYS=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E ".*\.psk$" | sort | uniq | head -n 70)
  PSTORAGE_PASS_STORE_DIRECTORIES=$(echo -e "$FIND_DIR_CACHE\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_SBIN\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_SRV\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_RUN\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_USR\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "\.password-store$" | sort | uniq | head -n 70)
  PSTORAGE_FTP=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "vsftpd\.conf$|.*\.ftpconfig$|ffftp\.ini$|ftp\.ini$|ftp\.config$|sites\.ini$|wcx_ftp\.ini$|winscp\.ini$|ws_ftp\.ini$" | sort | uniq | head -n 70)
  PSTORAGE_SAMBA=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "smb\.conf$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_SEEDDMS=$(echo -e "$FIND_DIR_CACHE\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_SBIN\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_SRV\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_RUN\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_USR\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "seeddms.*$" | sort | uniq | head -n 70)
  PSTORAGE_DDCLIENT=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "ddclient\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_KCPASSWORD=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "kcpassword$" | sort | uniq | head -n 70)
  PSTORAGE_SENTRY=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_DIR_CACHE\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_SBIN\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_SRV\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_RUN\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_USR\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "sentry$|sentry\.conf\.py$" | sort | uniq | head -n 70)
  PSTORAGE_STRAPI=$(echo -e "$FIND_DIR_CACHE\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_SBIN\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_SRV\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_RUN\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_USR\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "environments$" | sort | uniq | head -n 70)
  PSTORAGE_CACTI=$(echo -e "$FIND_DIR_CACHE\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_SBIN\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_SRV\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_RUN\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_USR\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "cacti$" | sort | uniq | head -n 70)
  PSTORAGE_ROUNDCUBE=$(echo -e "$FIND_DIR_CACHE\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_SBIN\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_SRV\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_RUN\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_USR\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "roundcube$" | sort | uniq | head -n 70)
  PSTORAGE_PASSBOLT=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "passbolt\.php$" | sort | uniq | head -n 70)
  PSTORAGE_JETTY=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "jetty-realm\.properties$" | sort | uniq | head -n 70)
  PSTORAGE_JENKINS=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_DIR_CACHE\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_SBIN\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_SRV\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_MNT\n$FIND_DIR_MEDIA\n$FIND_DIR_RUN\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_OPT\n$FIND_DIR_ETC\n$FIND_DIR_BIN\n$FIND_DIR_CDROM\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_USR\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "master\.key$|hudson\.util\.Secret$|credentials\.xml$|config\.xml$|.*jenkins$" | sort | uniq | head -n 70)
  PSTORAGE_WGET=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "\.wgetrc$" | sort | uniq | head -n 70)
  PSTORAGE_INTERESTING_LOGS=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "access\.log$|error\.log$" | sort | uniq | head -n 70)
  PSTORAGE_OTHER_INTERESTING=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "\.bashrc$|\.google_authenticator$|hosts\.equiv$|\.lesshst$|\.plan$|\.profile$|\.recently-used\.xbel$|\.rhosts$|\.sudo_as_admin_successful$" | sort | uniq | head -n 70)
  PSTORAGE_WINDOWS=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E ".*\.rdg$|AppEvent\.Evt$|autounattend\.xml$|ConsoleHost_history\.txt$|FreeSSHDservice\.ini$|NetSetup\.log$|Ntds\.dit$|protecteduserkey\.bin$|RDCMan\.settings$|SAM$|SYSTEM$|SecEvent\.Evt$|appcmd\.exe$|bash\.exe$|datasources\.xml$|default\.sav$|drives\.xml$|groups\.xml$|https-xampp\.conf$|https\.conf$|iis6\.log$|index\.dat$|my\.cnf$|my\.ini$|ntuser\.dat$|pagefile\.sys$|printers\.xml$|recentservers\.xml$|scclient\.exe$|scheduledtasks\.xml$|security\.sav$|server\.xml$|setupinfo$|setupinfo\.bak$|sitemanager\.xml$|sites\.ini$|software$|software\.sav$|sysprep\.inf$|sysprep\.xml$|system\.sav$|unattend\.inf$|unattend\.txt$|unattend\.xml$|unattended\.xml$|wcx_ftp\.ini$|ws_ftp\.ini$|web.*\.config$|winscp\.ini$|wsl\.exe$|plum\.sqlite$" | sort | uniq | head -n 70)
  PSTORAGE_DATABASE=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -v -E '/man/|/usr/|/var/cache/|thumbcache|iconcache|IconCache|/man/|/usr/|/var/cache/' | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E ".*\.db$|.*\.sqlite$|.*\.sqlite3$" | sort | uniq | head -n 70)
  PSTORAGE_BACKUPS=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "backup$|backups$" | sort | uniq | head -n 70)
  PSTORAGE_PASSWORD_FILES=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E ".*password.*$|.*credential.*$|creds.*$|.*\.maintenance.*$|.*\.key$" | sort | uniq | head -n 70)
  PSTORAGE_CRONTAB_UI=$(echo -e "$FIND_ETC\n$FIND_CACHE\n$FIND_CONCOURSE_KEYS\n$FIND_HOMESEARCH\n$FIND_SNAP\n$FIND_SYS\n$FIND_USR\n$FIND_LIB\n$FIND_CDROM\n$FIND_SBIN\n$FIND_CONCOURSE_AUTH\n$FIND_PRIVATE\n$FIND_BIN\n$FIND_TMP\n$FIND_RUN\n$FIND_MEDIA\n$FIND_SYSTEM\n$FIND_LIB64\n$FIND_APPLICATIONS\n$FIND_SYSTEMD\n$FIND_LIB32\n$FIND_MNT\n$FIND_VAR\n$FIND_OPT\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}opt|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}.cache|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}media|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^$GREPHOMESEARCH|^${ROOT_FOLDER}var|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv" | grep -E "crontab\.db$|crontab-ui\.service$" | sort | uniq | head -n 70)
