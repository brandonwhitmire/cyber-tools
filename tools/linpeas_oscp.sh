#!/bin/sh
# cyber-tools-srcsha: 6a92b0abd0ef0d2702bf42160eebc93fa9b4b01eaeb1a59eea907eac724a7425
...
if [ "$SEARCH_IN_FOLDER" ]; then
  ...
  FIND_DIR_CUSTOM=`eval_bckgrd "find $SEARCH_IN_FOLDER -type d -name \"postfix\" -o -name \"dirsrv\" -o -name \"origin\" -o -name \"gh\" -o -name \".codex\" -o -name \"sites-enabled\" -o -name \"logstash\" -o -name \"varnish\" -o -name \"concourse-auth\" -o -name \".cloudflared\" -o -name \"environments\" -o -name \"couchdb\" -o -name \"microk8s\" -o -name \"nginx\" -o -name \".bluemix\" -o -name \".cursor\" -o -name \"ipa\" -o -name \"neo4j\" -o -name \".docker\" -o -name \".password-store\" -o -name \".claude\" -o -name \"kubelet\" -o -name \"kube-proxy\" -o -name \"k3s\" -o -name \"kubernetes.io\" -o -name \".svn\" -o -name \"pam.d\" -o -name \"session.d\" -o -name \"system-local.d\" -o -name \"doctl\" -o -name \"net.d\" -o -name \"legacy_credentials\" -o -name \"concourse-keys\" -o -name \"apt.conf.d\" -o -name \".gemini\" -o -name \"sentry\" -o -name \"roundcube\" -o -name \"system-connections\" -o -name \"k0s\" -o -name \"ldap\" -o -name \"filezilla\" -o -name \"keyrings\" -o -name \"crio\" -o -name \"bind\" -o -name \"gcloud\" -o -name \"ErrorRecords\" -o -name \"system.d\" -o -name \"Google Cloud Directory Sync\" -o -name \".vnc\" -o -name \"seeddms*\" -o -name \"Google Password Sync\" -o -name \"etcd\" -o -name \"services\" -o -name \".irssi\" -o -name \".kube*\" -o -name \"cacti\" -o -name \"*jenkins\" -o -name \"kubernetes\" -o -name \"system-services\" -o -name \"mysql\" -o -name \"containerd\" -o -name \"rke2\" -o -name \"zabbix\" -o -name \"wpa_supplicant\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_CUSTOM=`eval_bckgrd "find $SEARCH_IN_FOLDER -name \"krb5.conf\" -o -name \"mariadb.cnf\" -o -name \"AzureRMContext.json\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.p12\" -o -name \"FreePBX.conf\" -o -name \"trustdb.gpg\" -o -name \"software.sav\" -o -name \"backups\" -o -name \"*.pem\" -o -name \"snmpd.conf\" -o -name \".env*\" -o -name \"sysprep.inf\" -o -name \"storage.php\" -o -name \"*.vhd\" -o -name \"pg_hba.conf\" -o -name \"amportal.conf\" -o -name \"*kubeconfig*\" -o -name \"kubelet.conf\" -o -name \"*.ftpconfig\" -o -name \"hudson.util.Secret\" -o -name \"snyk.config.json\" -o -name \"smb.conf\" -o -name \"hostapd.conf\" -o -name \"*.db\" -o -name \"backup\" -o -name \"*.socket\" -o -name \"authorized_hosts\" -o -name \"id_rsa*\" -o -name \".claude.json\" -o -name \"storage.json\" -o -name \"glusterfs.key\" -o -name \".git\" -o -name \"kibana.y*ml\" -o -name \"TokenCache.dat\" -o -name \"scclient.exe\" -o -name \"msal_http_cache.bin\" -o -name \"recentservers.xml\" -o -name \"ftp.ini\" -o -name \".secrets.mkey\" -o -name \"supervisord.conf\" -o -name \"mongod*.conf\" -o -name \"api_key\" -o -name \"wp-config.php\" -o -name \"firebase-tools.json\" -o -name \"msal_token_cache.bin\" -o -name \"secrets.yml\" -o -name \"httpd.conf\" -o -name \"exports\" -o -name \"*.tfstate\" -o -name \"*.pfx\" -o -name \"docker.sock\" -o -name \".github\" -o -name \"*vnc*.txt\" -o -name \"access_tokens.json\" -o -name \"service_principal_entries.json\" -o -name \"rpcd\" -o -name \"gvm-tools.conf\" -o -name \"system.sav\" -o -name \".google_authenticator\" -o -name \"pwd.ibd\" -o -name \"*.kdbx\" -o -name \"anaconda-ks.cfg\" -o -name \".gitconfig\" -o -name \"pubring.kbx\" -o -name \"*.vmdk\" -o -name \"settings.php\" -o -name \"docker.socket\" -o -name \"bash.exe\" -o -name \".k5login\" -o -name \"glusterfs.pem\" -o -name \"*.pcap\" -o -name \"security.sav\" -o -name \".rhosts\" -o -name \"id_dsa*\" -o -name \"*vnc*.xml\" -o -name \"krb5cc_*\" -o -name \"msal_token_cache.json\" -o -name \"state.vscdb\" -o -name \"zabbix_agentd.conf\" -o -name \"setupinfo.bak\" -o -name \"software\" -o -name \"protecteduserkey.bin\" -o -name \"crontab-ui.service\" -o -name \"SAM\" -o -name \"https.conf\" -o -name \"pagefile.sys\" -o -name \"aliases\" -o -name \"*password*\" -o -name \"access.log\" -o -name \"unattended.xml\" -o -name \"secrets.ldb\" -o -name \"*_history*\" -o -name \"unattend.xml\" -o -name \"ipsec.secrets\" -o -name \"*.keytab\" -o -name \".roadtools_auth\" -o -name \".profile\" -o -name \"docker-compose.yml\" -o -name \"iis6.log\" -o -name \".flyrc\" -o -name \"web*.config\" -o -name \"psk.txt\" -o -name \"authorized_keys\" -o -name \".bashrc\" -o -name \"log4j-core*.jar\" -o -name \"*.gpg\" -o -name \"sip.conf\" -o -name \"bootstrap-kubelet.conf\" -o -name \"crio.sock\" -o -name \"000-default.conf\" -o -name \"redis.conf\" -o -name \"*.pgp\" -o -name \".pypirc\" -o -name \".git-credentials\" -o -name \"dockershim.sock\" -o -name \"hosts.equiv\" -o -name \"*.rdg\" -o -name \"database.php\" -o -name \"config.php\" -o -name \".msmtprc\" -o -name \"admin.conf\" -o -name \"unattend.txt\" -o -name \"plum.sqlite\" -o -name \"tomcat-users.xml\" -o -name \"sitemanager.xml\" -o -name \".plan\" -o -name \"pgadmin4.db\" -o -name \"winscp.ini\" -o -name \"*.viminfo\" -o -name \"known_hosts\" -o -name \"passwd.ibd\" -o -name \"clouds.config\" -o -name \"sslkeylog.log\" -o -name \"Elastix.conf\" -o -name \"Ntds.dit\" -o -name \"groups.xml\" -o -name \"private-keys-v1.d/*.key\" -o -name \"containerd.sock\" -o -name \"*.keyring\" -o -name \"mosquitto.conf\" -o -name \"environment\" -o -name \"webserver_config.py\" -o -name \"creds*\" -o -name \"printers.xml\" -o -name \"*.pcapng\" -o -name \"influxdb.conf\" -o -name \"ftp.config\" -o -name \"*.crt\" -o -name \".wgetrc\" -o -name \"scheduledtasks.xml\" -o -name \"crontab.db\" -o -name \"ntuser.dat\" -o -name \"ssh*config\" -o -name \"*.asc\" -o -name \"access_tokens.db\" -o -name \"elasticsearch.y*ml\" -o -name \"vsftpd.conf\" -o -name \"airflow.cfg\" -o -name \"server.xml\" -o -name \".mylogin.cnf\" -o -name \".pgpass\" -o -name \".erlang.cookie\" -o -name \"sess_*\" -o -name \"ddclient.conf\" -o -name \"php.ini\" -o -name \"racoon.conf\" -o -name \"index.dat\" -o -name \"*.tf\" -o -name \"snyk.json\" -o -name \".credentials.json\" -o -name \"azureProfile.json\" -o -name \"legacy_credentials.db\" -o -name \"*.vhdx\" -o -name \"*.pub\" -o -name \"*.ovpn\" -o -name \"*.keystore\" -o -name \"*.cer\" -o -name \"secret.asc\" -o -name \"gitlab.rm\" -o -name \"*vnc*.c*nf*\" -o -name \"db.php\" -o -name \".ldaprc\" -o -name \"*credential*\" -o -name \"atlantis.db\" -o -name \"*config*.php\" -o -name \"rsyncd.conf\" -o -name \"accessTokens.json\" -o -name \".mcp.json\" -o -name \"apt.conf\" -o -name \"ssh-agent.sock\" -o -name \"agent.*\" -o -name \"postgresql.conf\" -o -name \"fat.config\" -o -name \"pgsql.conf\" -o -name \"SecEvent.Evt\" -o -name \"keys.log\" -o -name \"ipsec.conf\" -o -name \"debian.cnf\" -o -name \"error.log\" -o -name \"*.key\" -o -name \".Xauthority\" -o -name \"rktlet.sock\" -o -name \"SYSTEM\" -o -name \"NetSetup.log\" -o -name \"*.service\" -o -name \"gpg-agent.conf\" -o -name \"KeePass.config*\" -o -name \"cesi.conf\" -o -name \"glusterfs.ca\" -o -name \"wsl.exe\" -o -name \"gitlab.yml\" -o -name \"zabbix_server.conf\" -o -name \"bitcoin.conf\" -o -name \"pgadmin*.db\" -o -name \"*vnc*.ini\" -o -name \"sssd.conf\" -o -name \"cloud.cfg\" -o -name \"ConsoleHost_history.txt\" -o -name \"setupinfo\" -o -name \".sudo_as_admin_successful\" -o -name \"*.maintenance*\" -o -name \"https-xampp.conf\" -o -name \"*.gnupg\" -o -name \"drives.xml\" -o -name \".recently-used.xbel\" -o -name \"appcmd.exe\" -o -name \"RDCMan.settings\" -o -name \"service_principal_entries.bin\" -o -name \"unattend.inf\" -o -name \"KeePass.ini\" -o -name \".lesshst\" -o -name \"Dockerfile\" -o -name \"KeePass.enforced*\" -o -name \".boto\" -o -name \"mysqld.cnf\" -o -name \"*.der\" -o -name \"adc.json\" -o -name \"rocketchat.service\" -o -name \"rsyncd.secrets\" -o -name \"autologin.conf\" -o -name \"autounattend.xml\" -o -name \"passwd\" -o -name \"master.key\" -o -name \"autologin\" -o -name \"*.swp\" -o -name \"FreeSSHDservice.ini\" -o -name \"default.sav\" -o -name \"credentials.db\" -o -name \"sites.ini\" -o -name \"my.cnf\" -o -name \"grafana.ini\" -o -name \"my.ini\" -o -name \"filezilla.xml\" -o -name \"ws_ftp.ini\" -o -name \"ffftp.ini\" -o -name \"wcx_ftp.ini\" -o -name \"*.timer\" -o -name \".htpasswd\" -o -name \"kcpassword\" -o -name \"nginx.conf\" -o -name \"AppEvent.Evt\" -o -name \"datasources.xml\" -o -name \"*.psk\" -o -name \"sysprep.xml\" -o -name \"*.sqlite3\" -o -name \"*knockd*\" -o -name \"secring.gpg\" -o -name \"jetty-realm.properties\" -o -name \"frakti.sock\" -o -name \"config.xml\" -o -name \"*.sqlite\" -o -name \"credentials.tfrc.json\" -o -name \"*.csr\" -o -name \"*.jks\" -o -name \"sentry.conf.py\" -o -name \"state.vscdb.backup\" -o -name \"kadm5.acl\" -o -name \".vault-token\" -o -name \"credentials.xml\" -o -name \"passbolt.php\" -o -name \"fastcgi_params\" -o -name \"password*.ibd\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  CONT_THREADS=0
  # FIND ALL KNOWN INTERESTING SOFTWARE FILES
  FIND_DIR_APPLICATIONS=`eval_bckgrd "find ${ROOT_FOLDER}applications -type d -name \"postfix\" -o -name \"dirsrv\" -o -name \"gh\" -o -name \".codex\" -o -name \"sites-enabled\" -o -name \"logstash\" -o -name \"varnish\" -o -name \"concourse-auth\" -o -name \".cloudflared\" -o -name \"environments\" -o -name \"couchdb\" -o -name \"nginx\" -o -name \".bluemix\" -o -name \".cursor\" -o -name \"ipa\" -o -name \"neo4j\" -o -name \".docker\" -o -name \".password-store\" -o -name \".claude\" -o -name \".svn\" -o -name \"doctl\" -o -name \"legacy_credentials\" -o -name \"concourse-keys\" -o -name \"apt.conf.d\" -o -name \".gemini\" -o -name \"sentry\" -o -name \"roundcube\" -o -name \"ldap\" -o -name \"filezilla\" -o -name \"keyrings\" -o -name \"gcloud\" -o -name \"ErrorRecords\" -o -name \"Google Cloud Directory Sync\" -o -name \".vnc\" -o -name \"seeddms*\" -o -name \"Google Password Sync\" -o -name \".irssi\" -o -name \".kube*\" -o -name \"cacti\" -o -name \"*jenkins\" -o -name \"mysql\" -o -name \"zabbix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_BIN=`eval_bckgrd "find ${ROOT_FOLDER}bin -type d -name \"postfix\" -o -name \"dirsrv\" -o -name \"gh\" -o -name \".codex\" -o -name \"sites-enabled\" -o -name \"logstash\" -o -name \"varnish\" -o -name \"concourse-auth\" -o -name \".cloudflared\" -o -name \"environments\" -o -name \"couchdb\" -o -name \"nginx\" -o -name \".bluemix\" -o -name \".cursor\" -o -name \"ipa\" -o -name \"neo4j\" -o -name \".docker\" -o -name \".password-store\" -o -name \".claude\" -o -name \".svn\" -o -name \"doctl\" -o -name \"legacy_credentials\" -o -name \"concourse-keys\" -o -name \"apt.conf.d\" -o -name \".gemini\" -o -name \"sentry\" -o -name \"roundcube\" -o -name \"ldap\" -o -name \"filezilla\" -o -name \"keyrings\" -o -name \"gcloud\" -o -name \"ErrorRecords\" -o -name \"Google Cloud Directory Sync\" -o -name \".vnc\" -o -name \"seeddms*\" -o -name \"Google Password Sync\" -o -name \".irssi\" -o -name \".kube*\" -o -name \"cacti\" -o -name \"*jenkins\" -o -name \"mysql\" -o -name \"zabbix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_CACHE=`eval_bckgrd "find ${ROOT_FOLDER}.cache -type d -name \"postfix\" -o -name \"dirsrv\" -o -name \"gh\" -o -name \".codex\" -o -name \"sites-enabled\" -o -name \"logstash\" -o -name \"varnish\" -o -name \"concourse-auth\" -o -name \".cloudflared\" -o -name \"environments\" -o -name \"couchdb\" -o -name \"nginx\" -o -name \".bluemix\" -o -name \".cursor\" -o -name \"ipa\" -o -name \"neo4j\" -o -name \".docker\" -o -name \".password-store\" -o -name \".claude\" -o -name \".svn\" -o -name \"doctl\" -o -name \"legacy_credentials\" -o -name \"concourse-keys\" -o -name \"apt.conf.d\" -o -name \".gemini\" -o -name \"sentry\" -o -name \"roundcube\" -o -name \"ldap\" -o -name \"filezilla\" -o -name \"keyrings\" -o -name \"gcloud\" -o -name \"ErrorRecords\" -o -name \"Google Cloud Directory Sync\" -o -name \".vnc\" -o -name \"seeddms*\" -o -name \"Google Password Sync\" -o -name \".irssi\" -o -name \".kube*\" -o -name \"cacti\" -o -name \"*jenkins\" -o -name \"mysql\" -o -name \"zabbix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_CDROM=`eval_bckgrd "find ${ROOT_FOLDER}cdrom -type d -name \"postfix\" -o -name \"dirsrv\" -o -name \"gh\" -o -name \".codex\" -o -name \"sites-enabled\" -o -name \"logstash\" -o -name \"varnish\" -o -name \"concourse-auth\" -o -name \".cloudflared\" -o -name \"environments\" -o -name \"couchdb\" -o -name \"nginx\" -o -name \".bluemix\" -o -name \".cursor\" -o -name \"ipa\" -o -name \"neo4j\" -o -name \".docker\" -o -name \".password-store\" -o -name \".claude\" -o -name \".svn\" -o -name \"doctl\" -o -name \"legacy_credentials\" -o -name \"concourse-keys\" -o -name \"apt.conf.d\" -o -name \".gemini\" -o -name \"sentry\" -o -name \"roundcube\" -o -name \"ldap\" -o -name \"filezilla\" -o -name \"keyrings\" -o -name \"gcloud\" -o -name \"ErrorRecords\" -o -name \"Google Cloud Directory Sync\" -o -name \".vnc\" -o -name \"seeddms*\" -o -name \"Google Password Sync\" -o -name \".irssi\" -o -name \".kube*\" -o -name \"cacti\" -o -name \"*jenkins\" -o -name \"mysql\" -o -name \"zabbix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_ETC=`eval_bckgrd "find ${ROOT_FOLDER}etc -type d -name \"postfix\" -o -name \"origin\" -o -name \"dirsrv\" -o -name \"gh\" -o -name \".codex\" -o -name \"sites-enabled\" -o -name \"logstash\" -o -name \"varnish\" -o -name \"concourse-auth\" -o -name \".cloudflared\" -o -name \"environments\" -o -name \"couchdb\" -o -name \"nginx\" -o -name \".bluemix\" -o -name \".cursor\" -o -name \"ipa\" -o -name \"neo4j\" -o -name \".docker\" -o -name \".password-store\" -o -name \".claude\" -o -name \"kubelet\" -o -name \"kube-proxy\" -o -name \"k3s\" -o -name \".svn\" -o -name \"pam.d\" -o -name \"session.d\" -o -name \"system-local.d\" -o -name \"doctl\" -o -name \"net.d\" -o -name \"legacy_credentials\" -o -name \"concourse-keys\" -o -name \"apt.conf.d\" -o -name \".gemini\" -o -name \"sentry\" -o -name \"system-connections\" -o -name \"roundcube\" -o -name \"k0s\" -o -name \"ldap\" -o -name \"filezilla\" -o -name \"keyrings\" -o -name \"crio\" -o -name \"bind\" -o -name \"system.d\" -o -name \"gcloud\" -o -name \"ErrorRecords\" -o -name \"Google Cloud Directory Sync\" -o -name \".vnc\" -o -name \"seeddms*\" -o -name \"Google Password Sync\" -o -name \"etcd\" -o -name \".irssi\" -o -name \".kube*\" -o -name \"cacti\" -o -name \"*jenkins\" -o -name \"kubernetes\" -o -name \"mysql\" -o -name \"containerd\" -o -name \"rke2\" -o -name \"zabbix\" -o -name \"wpa_supplicant\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_HOMESEARCH=`eval_bckgrd "find $HOMESEARCH -type d -name \"postfix\" -o -name \"dirsrv\" -o -name \"gh\" -o -name \".codex\" -o -name \"sites-enabled\" -o -name \"logstash\" -o -name \"varnish\" -o -name \"concourse-auth\" -o -name \".cloudflared\" -o -name \"environments\" -o -name \"couchdb\" -o -name \"nginx\" -o -name \".bluemix\" -o -name \".cursor\" -o -name \"ipa\" -o -name \"neo4j\" -o -name \".docker\" -o -name \".password-store\" -o -name \".claude\" -o -name \".svn\" -o -name \"doctl\" -o -name \"legacy_credentials\" -o -name \"concourse-keys\" -o -name \"apt.conf.d\" -o -name \".gemini\" -o -name \"sentry\" -o -name \"roundcube\" -o -name \"ldap\" -o -name \"filezilla\" -o -name \"keyrings\" -o -name \"gcloud\" -o -name \"ErrorRecords\" -o -name \"Google Cloud Directory Sync\" -o -name \".vnc\" -o -name \"seeddms*\" -o -name \"Google Password Sync\" -o -name \".irssi\" -o -name \".kube*\" -o -name \"cacti\" -o -name \"*jenkins\" -o -name \"mysql\" -o -name \"zabbix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_MEDIA=`eval_bckgrd "find ${ROOT_FOLDER}media -type d -name \"postfix\" -o -name \"dirsrv\" -o -name \"gh\" -o -name \".codex\" -o -name \"sites-enabled\" -o -name \"logstash\" -o -name \"varnish\" -o -name \"concourse-auth\" -o -name \".cloudflared\" -o -name \"environments\" -o -name \"couchdb\" -o -name \"nginx\" -o -name \".bluemix\" -o -name \".cursor\" -o -name \"ipa\" -o -name \"neo4j\" -o -name \".docker\" -o -name \".password-store\" -o -name \".claude\" -o -name \".svn\" -o -name \"doctl\" -o -name \"legacy_credentials\" -o -name \"concourse-keys\" -o -name \"apt.conf.d\" -o -name \".gemini\" -o -name \"sentry\" -o -name \"roundcube\" -o -name \"ldap\" -o -name \"filezilla\" -o -name \"keyrings\" -o -name \"gcloud\" -o -name \"ErrorRecords\" -o -name \"Google Cloud Directory Sync\" -o -name \".vnc\" -o -name \"seeddms*\" -o -name \"Google Password Sync\" -o -name \".irssi\" -o -name \".kube*\" -o -name \"cacti\" -o -name \"*jenkins\" -o -name \"mysql\" -o -name \"zabbix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_MNT=`eval_bckgrd "find ${ROOT_FOLDER}mnt -type d -name \"postfix\" -o -name \"dirsrv\" -o -name \"gh\" -o -name \".codex\" -o -name \"sites-enabled\" -o -name \"logstash\" -o -name \"varnish\" -o -name \"concourse-auth\" -o -name \".cloudflared\" -o -name \"environments\" -o -name \"couchdb\" -o -name \"nginx\" -o -name \".bluemix\" -o -name \".cursor\" -o -name \"ipa\" -o -name \"neo4j\" -o -name \".docker\" -o -name \".password-store\" -o -name \".claude\" -o -name \".svn\" -o -name \"doctl\" -o -name \"legacy_credentials\" -o -name \"concourse-keys\" -o -name \"apt.conf.d\" -o -name \".gemini\" -o -name \"sentry\" -o -name \"roundcube\" -o -name \"ldap\" -o -name \"filezilla\" -o -name \"keyrings\" -o -name \"gcloud\" -o -name \"ErrorRecords\" -o -name \"Google Cloud Directory Sync\" -o -name \".vnc\" -o -name \"seeddms*\" -o -name \"Google Password Sync\" -o -name \".irssi\" -o -name \".kube*\" -o -name \"cacti\" -o -name \"*jenkins\" -o -name \"mysql\" -o -name \"zabbix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_OPT=`eval_bckgrd "find ${ROOT_FOLDER}opt -type d -name \"postfix\" -o -name \"dirsrv\" -o -name \"gh\" -o -name \".codex\" -o -name \"sites-enabled\" -o -name \"logstash\" -o -name \"varnish\" -o -name \"concourse-auth\" -o -name \".cloudflared\" -o -name \"environments\" -o -name \"couchdb\" -o -name \"nginx\" -o -name \".bluemix\" -o -name \".cursor\" -o -name \"ipa\" -o -name \"neo4j\" -o -name \".docker\" -o -name \".password-store\" -o -name \".claude\" -o -name \".svn\" -o -name \"doctl\" -o -name \"legacy_credentials\" -o -name \"concourse-keys\" -o -name \"apt.conf.d\" -o -name \".gemini\" -o -name \"sentry\" -o -name \"roundcube\" -o -name \"ldap\" -o -name \"filezilla\" -o -name \"keyrings\" -o -name \"gcloud\" -o -name \"ErrorRecords\" -o -name \"Google Cloud Directory Sync\" -o -name \".vnc\" -o -name \"seeddms*\" -o -name \"Google Password Sync\" -o -name \".irssi\" -o -name \".kube*\" -o -name \"cacti\" -o -name \"*jenkins\" -o -name \"mysql\" -o -name \"zabbix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_PRIVATE=`eval_bckgrd "find ${ROOT_FOLDER}private -type d -name \"postfix\" -o -name \"dirsrv\" -o -name \"gh\" -o -name \".codex\" -o -name \"sites-enabled\" -o -name \"logstash\" -o -name \"varnish\" -o -name \"concourse-auth\" -o -name \".cloudflared\" -o -name \"environments\" -o -name \"couchdb\" -o -name \"nginx\" -o -name \".bluemix\" -o -name \".cursor\" -o -name \"ipa\" -o -name \"neo4j\" -o -name \".docker\" -o -name \".password-store\" -o -name \".claude\" -o -name \".svn\" -o -name \"doctl\" -o -name \"legacy_credentials\" -o -name \"concourse-keys\" -o -name \"apt.conf.d\" -o -name \".gemini\" -o -name \"sentry\" -o -name \"roundcube\" -o -name \"ldap\" -o -name \"filezilla\" -o -name \"keyrings\" -o -name \"gcloud\" -o -name \"ErrorRecords\" -o -name \"Google Cloud Directory Sync\" -o -name \".vnc\" -o -name \"seeddms*\" -o -name \"Google Password Sync\" -o -name \".irssi\" -o -name \".kube*\" -o -name \"cacti\" -o -name \"*jenkins\" -o -name \"mysql\" -o -name \"zabbix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_RUN=`eval_bckgrd "find ${ROOT_FOLDER}run -type d -name \"kubernetes.io\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SBIN=`eval_bckgrd "find ${ROOT_FOLDER}sbin -type d -name \"postfix\" -o -name \"dirsrv\" -o -name \"gh\" -o -name \".codex\" -o -name \"sites-enabled\" -o -name \"logstash\" -o -name \"varnish\" -o -name \"concourse-auth\" -o -name \".cloudflared\" -o -name \"environments\" -o -name \"couchdb\" -o -name \"nginx\" -o -name \".bluemix\" -o -name \".cursor\" -o -name \"ipa\" -o -name \"neo4j\" -o -name \".docker\" -o -name \".password-store\" -o -name \".claude\" -o -name \".svn\" -o -name \"doctl\" -o -name \"legacy_credentials\" -o -name \"concourse-keys\" -o -name \"apt.conf.d\" -o -name \".gemini\" -o -name \"sentry\" -o -name \"roundcube\" -o -name \"ldap\" -o -name \"filezilla\" -o -name \"keyrings\" -o -name \"gcloud\" -o -name \"ErrorRecords\" -o -name \"Google Cloud Directory Sync\" -o -name \".vnc\" -o -name \"seeddms*\" -o -name \"Google Password Sync\" -o -name \".irssi\" -o -name \".kube*\" -o -name \"cacti\" -o -name \"*jenkins\" -o -name \"mysql\" -o -name \"zabbix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SNAP=`eval_bckgrd "find ${ROOT_FOLDER}snap -type d -name \"postfix\" -o -name \"dirsrv\" -o -name \"gh\" -o -name \".codex\" -o -name \"sites-enabled\" -o -name \"logstash\" -o -name \"varnish\" -o -name \"concourse-auth\" -o -name \".cloudflared\" -o -name \"environments\" -o -name \"couchdb\" -o -name \"nginx\" -o -name \".bluemix\" -o -name \".cursor\" -o -name \"ipa\" -o -name \"neo4j\" -o -name \".docker\" -o -name \".password-store\" -o -name \".claude\" -o -name \".svn\" -o -name \"doctl\" -o -name \"legacy_credentials\" -o -name \"concourse-keys\" -o -name \"apt.conf.d\" -o -name \".gemini\" -o -name \"sentry\" -o -name \"roundcube\" -o -name \"ldap\" -o -name \"filezilla\" -o -name \"keyrings\" -o -name \"gcloud\" -o -name \"ErrorRecords\" -o -name \"Google Cloud Directory Sync\" -o -name \".vnc\" -o -name \"seeddms*\" -o -name \"Google Password Sync\" -o -name \".irssi\" -o -name \".kube*\" -o -name \"cacti\" -o -name \"*jenkins\" -o -name \"mysql\" -o -name \"zabbix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SRV=`eval_bckgrd "find ${ROOT_FOLDER}srv -type d -name \"postfix\" -o -name \"dirsrv\" -o -name \"gh\" -o -name \".codex\" -o -name \"sites-enabled\" -o -name \"logstash\" -o -name \"varnish\" -o -name \"concourse-auth\" -o -name \".cloudflared\" -o -name \"environments\" -o -name \"couchdb\" -o -name \"nginx\" -o -name \".bluemix\" -o -name \".cursor\" -o -name \"ipa\" -o -name \"neo4j\" -o -name \".docker\" -o -name \".password-store\" -o -name \".claude\" -o -name \".svn\" -o -name \"doctl\" -o -name \"legacy_credentials\" -o -name \"concourse-keys\" -o -name \"apt.conf.d\" -o -name \".gemini\" -o -name \"sentry\" -o -name \"roundcube\" -o -name \"ldap\" -o -name \"filezilla\" -o -name \"keyrings\" -o -name \"gcloud\" -o -name \"ErrorRecords\" -o -name \"Google Cloud Directory Sync\" -o -name \".vnc\" -o -name \"seeddms*\" -o -name \"Google Password Sync\" -o -name \".irssi\" -o -name \".kube*\" -o -name \"cacti\" -o -name \"*jenkins\" -o -name \"mysql\" -o -name \"zabbix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_TMP=`eval_bckgrd "find ${ROOT_FOLDER}tmp -type d -name \"postfix\" -o -name \"dirsrv\" -o -name \"gh\" -o -name \".codex\" -o -name \"sites-enabled\" -o -name \"logstash\" -o -name \"varnish\" -o -name \"concourse-auth\" -o -name \".cloudflared\" -o -name \"environments\" -o -name \"couchdb\" -o -name \"nginx\" -o -name \".bluemix\" -o -name \".cursor\" -o -name \"ipa\" -o -name \"neo4j\" -o -name \".docker\" -o -name \".password-store\" -o -name \".claude\" -o -name \".svn\" -o -name \"doctl\" -o -name \"legacy_credentials\" -o -name \"concourse-keys\" -o -name \"apt.conf.d\" -o -name \".gemini\" -o -name \"sentry\" -o -name \"roundcube\" -o -name \"ldap\" -o -name \"filezilla\" -o -name \"keyrings\" -o -name \"gcloud\" -o -name \"ErrorRecords\" -o -name \"Google Cloud Directory Sync\" -o -name \".vnc\" -o -name \"seeddms*\" -o -name \"Google Password Sync\" -o -name \".irssi\" -o -name \".kube*\" -o -name \"cacti\" -o -name \"*jenkins\" -o -name \"mysql\" -o -name \"zabbix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_USR=`eval_bckgrd "find ${ROOT_FOLDER}usr -type d -name \"postfix\" -o -name \"dirsrv\" -o -name \"gh\" -o -name \".codex\" -o -name \"sites-enabled\" -o -name \"logstash\" -o -name \"varnish\" -o -name \"concourse-auth\" -o -name \".cloudflared\" -o -name \"environments\" -o -name \"couchdb\" -o -name \"nginx\" -o -name \".bluemix\" -o -name \".cursor\" -o -name \"ipa\" -o -name \"neo4j\" -o -name \".docker\" -o -name \".password-store\" -o -name \".claude\" -o -name \".svn\" -o -name \"session.d\" -o -name \"doctl\" -o -name \"legacy_credentials\" -o -name \"concourse-keys\" -o -name \"apt.conf.d\" -o -name \".gemini\" -o -name \"sentry\" -o -name \"roundcube\" -o -name \"ldap\" -o -name \"filezilla\" -o -name \"keyrings\" -o -name \"bind\" -o -name \"gcloud\" -o -name \"ErrorRecords\" -o -name \"Google Cloud Directory Sync\" -o -name \".vnc\" -o -name \"seeddms*\" -o -name \"services\" -o -name \"Google Password Sync\" -o -name \".irssi\" -o -name \".kube*\" -o -name \"cacti\" -o -name \"system-services\" -o -name \"*jenkins\" -o -name \"mysql\" -o -name \"zabbix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_VAR=`eval_bckgrd "find ${ROOT_FOLDER}var -type d -name \"postfix\" -o -name \"origin\" -o -name \"dirsrv\" -o -name \"gh\" -o -name \".codex\" -o -name \"sites-enabled\" -o -name \"logstash\" -o -name \"varnish\" -o -name \"concourse-auth\" -o -name \".cloudflared\" -o -name \"environments\" -o -name \"couchdb\" -o -name \"microk8s\" -o -name \"nginx\" -o -name \".bluemix\" -o -name \".cursor\" -o -name \"ipa\" -o -name \"neo4j\" -o -name \".docker\" -o -name \".password-store\" -o -name \".claude\" -o -name \"kubelet\" -o -name \"kube-proxy\" -o -name \"kubernetes.io\" -o -name \"k3s\" -o -name \".svn\" -o -name \"doctl\" -o -name \"net.d\" -o -name \"legacy_credentials\" -o -name \"concourse-keys\" -o -name \"apt.conf.d\" -o -name \".gemini\" -o -name \"sentry\" -o -name \"roundcube\" -o -name \"k0s\" -o -name \"ldap\" -o -name \"filezilla\" -o -name \"keyrings\" -o -name \"crio\" -o -name \"bind\" -o -name \"gcloud\" -o -name \"ErrorRecords\" -o -name \"Google Cloud Directory Sync\" -o -name \".vnc\" -o -name \"seeddms*\" -o -name \"Google Password Sync\" -o -name \"etcd\" -o -name \".irssi\" -o -name \".kube*\" -o -name \"cacti\" -o -name \"*jenkins\" -o -name \"kubernetes\" -o -name \"mysql\" -o -name \"containerd\" -o -name \"rke2\" -o -name \"zabbix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  FIND_APPLICATIONS=`eval_bckgrd "find ${ROOT_FOLDER}applications -name \"krb5.conf\" -o -name \"mariadb.cnf\" -o -name \"AzureRMContext.json\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.p12\" -o -name \"FreePBX.conf\" -o -name \"trustdb.gpg\" -o -name \"software.sav\" -o -name \"backups\" -o -name \"passbolt.php\" -o -name \"*.pem\" -o -name \"snmpd.conf\" -o -name \".env*\" -o -name \"sysprep.inf\" -o -name \"pg_hba.conf\" -o -name \"storage.php\" -o -name \"*kubeconfig*\" -o -name \"amportal.conf\" -o -name \"*.vhd\" -o -name \"kubelet.conf\" -o -name \"*.ftpconfig\" -o -name \"hudson.util.Secret\" -o -name \"snyk.config.json\" -o -name \"smb.conf\" -o -name \"hostapd.conf\" -o -name \"*.db\" -o -name \"backup\" -o -name \"*.socket\" -o -name \"authorized_hosts\" -o -name \"id_rsa*\" -o -name \".claude.json\" -o -name \"storage.json\" -o -name \"glusterfs.key\" -o -name \".git\" -o -name \"kibana.y*ml\" -o -name \"TokenCache.dat\" -o -name \"scclient.exe\" -o -name \"msal_http_cache.bin\" -o -name \"recentservers.xml\" -o -name \"ftp.ini\" -o -name \".secrets.mkey\" -o -name \"supervisord.conf\" -o -name \"mongod*.conf\" -o -name \"api_key\" -o -name \"wp-config.php\" -o -name \"firebase-tools.json\" -o -name \"msal_token_cache.bin\" -o -name \"secrets.yml\" -o -name \"httpd.conf\" -o -name \"*.tfstate\" -o -name \"*.pfx\" -o -name \"docker.sock\" -o -name \".github\" -o -name \"*vnc*.txt\" -o -name \"access_tokens.json\" -o -name \"service_principal_entries.json\" -o -name \"rpcd\" -o -name \"gvm-tools.conf\" -o -name \"system.sav\" -o -name \".google_authenticator\" -o -name \"pwd.ibd\" -o -name \"*.kdbx\" -o -name \"anaconda-ks.cfg\" -o -name \".gitconfig\" -o -name \"pubring.kbx\" -o -name \"*.vmdk\" -o -name \"settings.php\" -o -name \"docker.socket\" -o -name \"bash.exe\" -o -name \".k5login\" -o -name \"glusterfs.pem\" -o -name \"*.pcap\" -o -name \".rhosts\" -o -name \"security.sav\" -o -name \"id_dsa*\" -o -name \"*vnc*.xml\" -o -name \"krb5cc_*\" -o -name \"msal_token_cache.json\" -o -name \"state.vscdb\" -o -name \"zabbix_agentd.conf\" -o -name \"setupinfo.bak\" -o -name \"software\" -o -name \"protecteduserkey.bin\" -o -name \"crontab-ui.service\" -o -name \"SAM\" -o -name \"https.conf\" -o -name \"pagefile.sys\" -o -name \"aliases\" -o -name \"*password*\" -o -name \"access.log\" -o -name \"unattended.xml\" -o -name \"secrets.ldb\" -o -name \"*_history*\" -o -name \"unattend.xml\" -o -name \"*.keytab\" -o -name \".roadtools_auth\" -o -name \".profile\" -o -name \"docker-compose.yml\" -o -name \"iis6.log\" -o -name \".flyrc\" -o -name \"web*.config\" -o -name \"psk.txt\" -o -name \"authorized_keys\" -o -name \".bashrc\" -o -name \"log4j-core*.jar\" -o -name \"*.gpg\" -o -name \"sip.conf\" -o -name \"bootstrap-kubelet.conf\" -o -name \"crio.sock\" -o -name \"000-default.conf\" -o -name \"redis.conf\" -o -name \"*.pgp\" -o -name \".pypirc\" -o -name \".git-credentials\" -o -name \"dockershim.sock\" -o -name \"hosts.equiv\" -o -name \"*.rdg\" -o -name \"database.php\" -o -name \"config.php\" -o -name \".msmtprc\" -o -name \"admin.conf\" -o -name \"unattend.txt\" -o -name \"plum.sqlite\" -o -name \"tomcat-users.xml\" -o -name \"sitemanager.xml\" -o -name \".plan\" -o -name \"pgadmin4.db\" -o -name \"winscp.ini\" -o -name \"*.viminfo\" -o -name \"known_hosts\" -o -name \"passwd.ibd\" -o -name \"clouds.config\" -o -name \"sslkeylog.log\" -o -name \"Elastix.conf\" -o -name \"Ntds.dit\" -o -name \"groups.xml\" -o -name \"private-keys-v1.d/*.key\" -o -name \"containerd.sock\" -o -name \"*.keyring\" -o -name \"mosquitto.conf\" -o -name \"environment\" -o -name \"webserver_config.py\" -o -name \"creds*\" -o -name \"printers.xml\" -o -name \"*.pcapng\" -o -name \"influxdb.conf\" -o -name \"ftp.config\" -o -name \"*.crt\" -o -name \".wgetrc\" -o -name \"scheduledtasks.xml\" -o -name \"crontab.db\" -o -name \"ntuser.dat\" -o -name \"*.asc\" -o -name \"access_tokens.db\" -o -name \"elasticsearch.y*ml\" -o -name \"vsftpd.conf\" -o -name \"airflow.cfg\" -o -name \"server.xml\" -o -name \".mylogin.cnf\" -o -name \".pgpass\" -o -name \".erlang.cookie\" -o -name \"ddclient.conf\" -o -name \"php.ini\" -o -name \"racoon.conf\" -o -name \"index.dat\" -o -name \"*.tf\" -o -name \"snyk.json\" -o -name \".credentials.json\" -o -name \"azureProfile.json\" -o -name \"legacy_credentials.db\" -o -name \"*.vhdx\" -o -name \"*.pub\" -o -name \"*.ovpn\" -o -name \"*.keystore\" -o -name \"*.cer\" -o -name \"secret.asc\" -o -name \"gitlab.rm\" -o -name \"*vnc*.c*nf*\" -o -name \"db.php\" -o -name \".ldaprc\" -o -name \"*credential*\" -o -name \"atlantis.db\" -o -name \"*config*.php\" -o -name \"rsyncd.conf\" -o -name \"accessTokens.json\" -o -name \".mcp.json\" -o -name \"apt.conf\" -o -name \"postgresql.conf\" -o -name \"fat.config\" -o -name \"pgsql.conf\" -o -name \"SecEvent.Evt\" -o -name \"keys.log\" -o -name \"ipsec.conf\" -o -name \"debian.cnf\" -o -name \"error.log\" -o -name \"*.key\" -o -name \".Xauthority\" -o -name \"rktlet.sock\" -o -name \"SYSTEM\" -o -name \"NetSetup.log\" -o -name \"*.service\" -o -name \"gpg-agent.conf\" -o -name \"KeePass.config*\" -o -name \"cesi.conf\" -o -name \"glusterfs.ca\" -o -name \"wsl.exe\" -o -name \"gitlab.yml\" -o -name \"zabbix_server.conf\" -o -name \"bitcoin.conf\" -o -name \"pgadmin*.db\" -o -name \"*vnc*.ini\" -o -name \"sssd.conf\" -o -name \"cloud.cfg\" -o -name \"ConsoleHost_history.txt\" -o -name \"setupinfo\" -o -name \".sudo_as_admin_successful\" -o -name \"*.maintenance*\" -o -name \"https-xampp.conf\" -o -name \"*.gnupg\" -o -name \"drives.xml\" -o -name \".recently-used.xbel\" -o -name \"appcmd.exe\" -o -name \"RDCMan.settings\" -o -name \"service_principal_entries.bin\" -o -name \"unattend.inf\" -o -name \"KeePass.ini\" -o -name \".lesshst\" -o -name \"Dockerfile\" -o -name \"KeePass.enforced*\" -o -name \".boto\" -o -name \"mysqld.cnf\" -o -name \"*.der\" -o -name \"adc.json\" -o -name \"rocketchat.service\" -o -name \"rsyncd.secrets\" -o -name \"autologin.conf\" -o -name \"autounattend.xml\" -o -name \"passwd\" -o -name \"master.key\" -o -name \"autologin\" -o -name \"*.swp\" -o -name \"FreeSSHDservice.ini\" -o -name \"default.sav\" -o -name \"credentials.db\" -o -name \"sites.ini\" -o -name \"my.cnf\" -o -name \"grafana.ini\" -o -name \"my.ini\" -o -name \"filezilla.xml\" -o -name \"ws_ftp.ini\" -o -name \"ffftp.ini\" -o -name \"wcx_ftp.ini\" -o -name \"*.timer\" -o -name \".htpasswd\" -o -name \"kcpassword\" -o -name \"nginx.conf\" -o -name \"AppEvent.Evt\" -o -name \"datasources.xml\" -o -name \"*.psk\" -o -name \"sysprep.xml\" -o -name \"*.sqlite3\" -o -name \"secring.gpg\" -o -name \"jetty-realm.properties\" -o -name \"frakti.sock\" -o -name \"config.xml\" -o -name \"*.sqlite\" -o -name \"credentials.tfrc.json\" -o -name \"*.csr\" -o -name \"*.jks\" -o -name \"sentry.conf.py\" -o -name \"state.vscdb.backup\" -o -name \"kadm5.acl\" -o -name \".vault-token\" -o -name \"credentials.xml\" -o -name \"ipsec.secrets\" -o -name \"fastcgi_params\" -o -name \"password*.ibd\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_BIN=`eval_bckgrd "find ${ROOT_FOLDER}bin -name \"krb5.conf\" -o -name \"mariadb.cnf\" -o -name \"AzureRMContext.json\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.p12\" -o -name \"FreePBX.conf\" -o -name \"trustdb.gpg\" -o -name \"software.sav\" -o -name \"backups\" -o -name \"passbolt.php\" -o -name \"*.pem\" -o -name \"snmpd.conf\" -o -name \".env*\" -o -name \"sysprep.inf\" -o -name \"pg_hba.conf\" -o -name \"storage.php\" -o -name \"*kubeconfig*\" -o -name \"amportal.conf\" -o -name \"*.vhd\" -o -name \"kubelet.conf\" -o -name \"*.ftpconfig\" -o -name \"hudson.util.Secret\" -o -name \"snyk.config.json\" -o -name \"smb.conf\" -o -name \"hostapd.conf\" -o -name \"*.db\" -o -name \"backup\" -o -name \"*.socket\" -o -name \"authorized_hosts\" -o -name \"id_rsa*\" -o -name \".claude.json\" -o -name \"storage.json\" -o -name \"glusterfs.key\" -o -name \".git\" -o -name \"kibana.y*ml\" -o -name \"TokenCache.dat\" -o -name \"scclient.exe\" -o -name \"msal_http_cache.bin\" -o -name \"recentservers.xml\" -o -name \"ftp.ini\" -o -name \".secrets.mkey\" -o -name \"supervisord.conf\" -o -name \"mongod*.conf\" -o -name \"api_key\" -o -name \"wp-config.php\" -o -name \"firebase-tools.json\" -o -name \"msal_token_cache.bin\" -o -name \"secrets.yml\" -o -name \"httpd.conf\" -o -name \"*.tfstate\" -o -name \"*.pfx\" -o -name \"docker.sock\" -o -name \".github\" -o -name \"*vnc*.txt\" -o -name \"access_tokens.json\" -o -name \"service_principal_entries.json\" -o -name \"rpcd\" -o -name \"gvm-tools.conf\" -o -name \"system.sav\" -o -name \".google_authenticator\" -o -name \"pwd.ibd\" -o -name \"*.kdbx\" -o -name \"anaconda-ks.cfg\" -o -name \".gitconfig\" -o -name \"pubring.kbx\" -o -name \"*.vmdk\" -o -name \"settings.php\" -o -name \"docker.socket\" -o -name \"bash.exe\" -o -name \".k5login\" -o -name \"glusterfs.pem\" -o -name \"*.pcap\" -o -name \".rhosts\" -o -name \"security.sav\" -o -name \"id_dsa*\" -o -name \"*vnc*.xml\" -o -name \"krb5cc_*\" -o -name \"msal_token_cache.json\" -o -name \"state.vscdb\" -o -name \"zabbix_agentd.conf\" -o -name \"setupinfo.bak\" -o -name \"software\" -o -name \"protecteduserkey.bin\" -o -name \"crontab-ui.service\" -o -name \"SAM\" -o -name \"https.conf\" -o -name \"pagefile.sys\" -o -name \"aliases\" -o -name \"*password*\" -o -name \"access.log\" -o -name \"unattended.xml\" -o -name \"secrets.ldb\" -o -name \"*_history*\" -o -name \"unattend.xml\" -o -name \"*.keytab\" -o -name \".roadtools_auth\" -o -name \".profile\" -o -name \"docker-compose.yml\" -o -name \"iis6.log\" -o -name \".flyrc\" -o -name \"web*.config\" -o -name \"psk.txt\" -o -name \"authorized_keys\" -o -name \".bashrc\" -o -name \"log4j-core*.jar\" -o -name \"*.gpg\" -o -name \"sip.conf\" -o -name \"bootstrap-kubelet.conf\" -o -name \"crio.sock\" -o -name \"000-default.conf\" -o -name \"redis.conf\" -o -name \"*.pgp\" -o -name \".pypirc\" -o -name \".git-credentials\" -o -name \"dockershim.sock\" -o -name \"hosts.equiv\" -o -name \"*.rdg\" -o -name \"database.php\" -o -name \"config.php\" -o -name \".msmtprc\" -o -name \"admin.conf\" -o -name \"unattend.txt\" -o -name \"plum.sqlite\" -o -name \"tomcat-users.xml\" -o -name \"sitemanager.xml\" -o -name \".plan\" -o -name \"pgadmin4.db\" -o -name \"winscp.ini\" -o -name \"*.viminfo\" -o -name \"known_hosts\" -o -name \"passwd.ibd\" -o -name \"clouds.config\" -o -name \"sslkeylog.log\" -o -name \"Elastix.conf\" -o -name \"Ntds.dit\" -o -name \"groups.xml\" -o -name \"private-keys-v1.d/*.key\" -o -name \"containerd.sock\" -o -name \"*.keyring\" -o -name \"mosquitto.conf\" -o -name \"environment\" -o -name \"webserver_config.py\" -o -name \"creds*\" -o -name \"printers.xml\" -o -name \"*.pcapng\" -o -name \"influxdb.conf\" -o -name \"ftp.config\" -o -name \"*.crt\" -o -name \".wgetrc\" -o -name \"scheduledtasks.xml\" -o -name \"crontab.db\" -o -name \"ntuser.dat\" -o -name \"*.asc\" -o -name \"access_tokens.db\" -o -name \"elasticsearch.y*ml\" -o -name \"vsftpd.conf\" -o -name \"airflow.cfg\" -o -name \"server.xml\" -o -name \".mylogin.cnf\" -o -name \".pgpass\" -o -name \".erlang.cookie\" -o -name \"ddclient.conf\" -o -name \"php.ini\" -o -name \"racoon.conf\" -o -name \"index.dat\" -o -name \"*.tf\" -o -name \"snyk.json\" -o -name \".credentials.json\" -o -name \"azureProfile.json\" -o -name \"legacy_credentials.db\" -o -name \"*.vhdx\" -o -name \"*.pub\" -o -name \"*.ovpn\" -o -name \"*.keystore\" -o -name \"*.cer\" -o -name \"secret.asc\" -o -name \"gitlab.rm\" -o -name \"*vnc*.c*nf*\" -o -name \"db.php\" -o -name \".ldaprc\" -o -name \"*credential*\" -o -name \"atlantis.db\" -o -name \"*config*.php\" -o -name \"rsyncd.conf\" -o -name \"accessTokens.json\" -o -name \".mcp.json\" -o -name \"apt.conf\" -o -name \"postgresql.conf\" -o -name \"fat.config\" -o -name \"pgsql.conf\" -o -name \"SecEvent.Evt\" -o -name \"keys.log\" -o -name \"ipsec.conf\" -o -name \"debian.cnf\" -o -name \"error.log\" -o -name \"*.key\" -o -name \".Xauthority\" -o -name \"rktlet.sock\" -o -name \"SYSTEM\" -o -name \"NetSetup.log\" -o -name \"*.service\" -o -name \"gpg-agent.conf\" -o -name \"KeePass.config*\" -o -name \"cesi.conf\" -o -name \"glusterfs.ca\" -o -name \"wsl.exe\" -o -name \"gitlab.yml\" -o -name \"zabbix_server.conf\" -o -name \"bitcoin.conf\" -o -name \"pgadmin*.db\" -o -name \"*vnc*.ini\" -o -name \"sssd.conf\" -o -name \"cloud.cfg\" -o -name \"ConsoleHost_history.txt\" -o -name \"setupinfo\" -o -name \".sudo_as_admin_successful\" -o -name \"*.maintenance*\" -o -name \"https-xampp.conf\" -o -name \"*.gnupg\" -o -name \"drives.xml\" -o -name \".recently-used.xbel\" -o -name \"appcmd.exe\" -o -name \"RDCMan.settings\" -o -name \"service_principal_entries.bin\" -o -name \"unattend.inf\" -o -name \"KeePass.ini\" -o -name \".lesshst\" -o -name \"Dockerfile\" -o -name \"KeePass.enforced*\" -o -name \".boto\" -o -name \"mysqld.cnf\" -o -name \"*.der\" -o -name \"adc.json\" -o -name \"rocketchat.service\" -o -name \"rsyncd.secrets\" -o -name \"autologin.conf\" -o -name \"autounattend.xml\" -o -name \"passwd\" -o -name \"master.key\" -o -name \"autologin\" -o -name \"*.swp\" -o -name \"FreeSSHDservice.ini\" -o -name \"default.sav\" -o -name \"credentials.db\" -o -name \"sites.ini\" -o -name \"my.cnf\" -o -name \"grafana.ini\" -o -name \"my.ini\" -o -name \"filezilla.xml\" -o -name \"ws_ftp.ini\" -o -name \"ffftp.ini\" -o -name \"wcx_ftp.ini\" -o -name \"*.timer\" -o -name \".htpasswd\" -o -name \"kcpassword\" -o -name \"nginx.conf\" -o -name \"AppEvent.Evt\" -o -name \"datasources.xml\" -o -name \"*.psk\" -o -name \"sysprep.xml\" -o -name \"*.sqlite3\" -o -name \"secring.gpg\" -o -name \"jetty-realm.properties\" -o -name \"frakti.sock\" -o -name \"config.xml\" -o -name \"*.sqlite\" -o -name \"credentials.tfrc.json\" -o -name \"*.csr\" -o -name \"*.jks\" -o -name \"sentry.conf.py\" -o -name \"state.vscdb.backup\" -o -name \"kadm5.acl\" -o -name \".vault-token\" -o -name \"credentials.xml\" -o -name \"ipsec.secrets\" -o -name \"fastcgi_params\" -o -name \"password*.ibd\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_CACHE=`eval_bckgrd "find ${ROOT_FOLDER}.cache -name \"krb5.conf\" -o -name \"mariadb.cnf\" -o -name \"AzureRMContext.json\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.p12\" -o -name \"FreePBX.conf\" -o -name \"trustdb.gpg\" -o -name \"software.sav\" -o -name \"backups\" -o -name \"passbolt.php\" -o -name \"*.pem\" -o -name \"snmpd.conf\" -o -name \".env*\" -o -name \"sysprep.inf\" -o -name \"pg_hba.conf\" -o -name \"storage.php\" -o -name \"*kubeconfig*\" -o -name \"amportal.conf\" -o -name \"*.vhd\" -o -name \"kubelet.conf\" -o -name \"*.ftpconfig\" -o -name \"hudson.util.Secret\" -o -name \"snyk.config.json\" -o -name \"smb.conf\" -o -name \"hostapd.conf\" -o -name \"*.db\" -o -name \"backup\" -o -name \"*.socket\" -o -name \"authorized_hosts\" -o -name \"id_rsa*\" -o -name \".claude.json\" -o -name \"storage.json\" -o -name \"glusterfs.key\" -o -name \".git\" -o -name \"kibana.y*ml\" -o -name \"TokenCache.dat\" -o -name \"scclient.exe\" -o -name \"msal_http_cache.bin\" -o -name \"recentservers.xml\" -o -name \"ftp.ini\" -o -name \".secrets.mkey\" -o -name \"supervisord.conf\" -o -name \"mongod*.conf\" -o -name \"api_key\" -o -name \"wp-config.php\" -o -name \"firebase-tools.json\" -o -name \"msal_token_cache.bin\" -o -name \"secrets.yml\" -o -name \"httpd.conf\" -o -name \"*.tfstate\" -o -name \"*.pfx\" -o -name \"docker.sock\" -o -name \".github\" -o -name \"*vnc*.txt\" -o -name \"access_tokens.json\" -o -name \"service_principal_entries.json\" -o -name \"rpcd\" -o -name \"gvm-tools.conf\" -o -name \"system.sav\" -o -name \".google_authenticator\" -o -name \"pwd.ibd\" -o -name \"*.kdbx\" -o -name \"anaconda-ks.cfg\" -o -name \".gitconfig\" -o -name \"pubring.kbx\" -o -name \"*.vmdk\" -o -name \"settings.php\" -o -name \"docker.socket\" -o -name \"bash.exe\" -o -name \".k5login\" -o -name \"glusterfs.pem\" -o -name \"*.pcap\" -o -name \".rhosts\" -o -name \"security.sav\" -o -name \"id_dsa*\" -o -name \"*vnc*.xml\" -o -name \"krb5cc_*\" -o -name \"msal_token_cache.json\" -o -name \"state.vscdb\" -o -name \"zabbix_agentd.conf\" -o -name \"setupinfo.bak\" -o -name \"software\" -o -name \"protecteduserkey.bin\" -o -name \"crontab-ui.service\" -o -name \"SAM\" -o -name \"https.conf\" -o -name \"pagefile.sys\" -o -name \"aliases\" -o -name \"*password*\" -o -name \"access.log\" -o -name \"unattended.xml\" -o -name \"secrets.ldb\" -o -name \"*_history*\" -o -name \"unattend.xml\" -o -name \"*.keytab\" -o -name \".roadtools_auth\" -o -name \".profile\" -o -name \"docker-compose.yml\" -o -name \"iis6.log\" -o -name \".flyrc\" -o -name \"web*.config\" -o -name \"psk.txt\" -o -name \"authorized_keys\" -o -name \".bashrc\" -o -name \"log4j-core*.jar\" -o -name \"*.gpg\" -o -name \"sip.conf\" -o -name \"bootstrap-kubelet.conf\" -o -name \"crio.sock\" -o -name \"000-default.conf\" -o -name \"redis.conf\" -o -name \"*.pgp\" -o -name \".pypirc\" -o -name \".git-credentials\" -o -name \"dockershim.sock\" -o -name \"hosts.equiv\" -o -name \"*.rdg\" -o -name \"database.php\" -o -name \"config.php\" -o -name \".msmtprc\" -o -name \"admin.conf\" -o -name \"unattend.txt\" -o -name \"plum.sqlite\" -o -name \"tomcat-users.xml\" -o -name \"sitemanager.xml\" -o -name \".plan\" -o -name \"pgadmin4.db\" -o -name \"winscp.ini\" -o -name \"*.viminfo\" -o -name \"known_hosts\" -o -name \"passwd.ibd\" -o -name \"clouds.config\" -o -name \"sslkeylog.log\" -o -name \"Elastix.conf\" -o -name \"Ntds.dit\" -o -name \"groups.xml\" -o -name \"private-keys-v1.d/*.key\" -o -name \"containerd.sock\" -o -name \"*.keyring\" -o -name \"mosquitto.conf\" -o -name \"environment\" -o -name \"webserver_config.py\" -o -name \"creds*\" -o -name \"printers.xml\" -o -name \"*.pcapng\" -o -name \"influxdb.conf\" -o -name \"ftp.config\" -o -name \"*.crt\" -o -name \".wgetrc\" -o -name \"scheduledtasks.xml\" -o -name \"crontab.db\" -o -name \"ntuser.dat\" -o -name \"*.asc\" -o -name \"access_tokens.db\" -o -name \"elasticsearch.y*ml\" -o -name \"vsftpd.conf\" -o -name \"airflow.cfg\" -o -name \"server.xml\" -o -name \".mylogin.cnf\" -o -name \".pgpass\" -o -name \".erlang.cookie\" -o -name \"ddclient.conf\" -o -name \"php.ini\" -o -name \"racoon.conf\" -o -name \"index.dat\" -o -name \"*.tf\" -o -name \"snyk.json\" -o -name \".credentials.json\" -o -name \"azureProfile.json\" -o -name \"legacy_credentials.db\" -o -name \"*.vhdx\" -o -name \"*.pub\" -o -name \"*.ovpn\" -o -name \"*.keystore\" -o -name \"*.cer\" -o -name \"secret.asc\" -o -name \"gitlab.rm\" -o -name \"*vnc*.c*nf*\" -o -name \"db.php\" -o -name \".ldaprc\" -o -name \"*credential*\" -o -name \"atlantis.db\" -o -name \"*config*.php\" -o -name \"rsyncd.conf\" -o -name \"accessTokens.json\" -o -name \".mcp.json\" -o -name \"apt.conf\" -o -name \"postgresql.conf\" -o -name \"fat.config\" -o -name \"pgsql.conf\" -o -name \"SecEvent.Evt\" -o -name \"keys.log\" -o -name \"ipsec.conf\" -o -name \"debian.cnf\" -o -name \"error.log\" -o -name \"*.key\" -o -name \".Xauthority\" -o -name \"rktlet.sock\" -o -name \"SYSTEM\" -o -name \"NetSetup.log\" -o -name \"*.service\" -o -name \"gpg-agent.conf\" -o -name \"KeePass.config*\" -o -name \"cesi.conf\" -o -name \"glusterfs.ca\" -o -name \"wsl.exe\" -o -name \"gitlab.yml\" -o -name \"zabbix_server.conf\" -o -name \"bitcoin.conf\" -o -name \"pgadmin*.db\" -o -name \"*vnc*.ini\" -o -name \"sssd.conf\" -o -name \"cloud.cfg\" -o -name \"ConsoleHost_history.txt\" -o -name \"setupinfo\" -o -name \".sudo_as_admin_successful\" -o -name \"*.maintenance*\" -o -name \"https-xampp.conf\" -o -name \"*.gnupg\" -o -name \"drives.xml\" -o -name \".recently-used.xbel\" -o -name \"appcmd.exe\" -o -name \"RDCMan.settings\" -o -name \"service_principal_entries.bin\" -o -name \"unattend.inf\" -o -name \"KeePass.ini\" -o -name \".lesshst\" -o -name \"Dockerfile\" -o -name \"KeePass.enforced*\" -o -name \".boto\" -o -name \"mysqld.cnf\" -o -name \"*.der\" -o -name \"adc.json\" -o -name \"rocketchat.service\" -o -name \"rsyncd.secrets\" -o -name \"autologin.conf\" -o -name \"autounattend.xml\" -o -name \"passwd\" -o -name \"master.key\" -o -name \"autologin\" -o -name \"*.swp\" -o -name \"FreeSSHDservice.ini\" -o -name \"default.sav\" -o -name \"credentials.db\" -o -name \"sites.ini\" -o -name \"my.cnf\" -o -name \"grafana.ini\" -o -name \"my.ini\" -o -name \"filezilla.xml\" -o -name \"ws_ftp.ini\" -o -name \"ffftp.ini\" -o -name \"wcx_ftp.ini\" -o -name \"*.timer\" -o -name \".htpasswd\" -o -name \"kcpassword\" -o -name \"nginx.conf\" -o -name \"AppEvent.Evt\" -o -name \"datasources.xml\" -o -name \"*.psk\" -o -name \"sysprep.xml\" -o -name \"*.sqlite3\" -o -name \"secring.gpg\" -o -name \"jetty-realm.properties\" -o -name \"frakti.sock\" -o -name \"config.xml\" -o -name \"*.sqlite\" -o -name \"credentials.tfrc.json\" -o -name \"*.csr\" -o -name \"*.jks\" -o -name \"sentry.conf.py\" -o -name \"state.vscdb.backup\" -o -name \"kadm5.acl\" -o -name \".vault-token\" -o -name \"credentials.xml\" -o -name \"ipsec.secrets\" -o -name \"fastcgi_params\" -o -name \"password*.ibd\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_CDROM=`eval_bckgrd "find ${ROOT_FOLDER}cdrom -name \"krb5.conf\" -o -name \"mariadb.cnf\" -o -name \"AzureRMContext.json\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.p12\" -o -name \"FreePBX.conf\" -o -name \"trustdb.gpg\" -o -name \"software.sav\" -o -name \"backups\" -o -name \"passbolt.php\" -o -name \"*.pem\" -o -name \"snmpd.conf\" -o -name \".env*\" -o -name \"sysprep.inf\" -o -name \"pg_hba.conf\" -o -name \"storage.php\" -o -name \"*kubeconfig*\" -o -name \"amportal.conf\" -o -name \"*.vhd\" -o -name \"kubelet.conf\" -o -name \"*.ftpconfig\" -o -name \"hudson.util.Secret\" -o -name \"snyk.config.json\" -o -name \"smb.conf\" -o -name \"hostapd.conf\" -o -name \"*.db\" -o -name \"backup\" -o -name \"*.socket\" -o -name \"authorized_hosts\" -o -name \"id_rsa*\" -o -name \".claude.json\" -o -name \"storage.json\" -o -name \"glusterfs.key\" -o -name \".git\" -o -name \"kibana.y*ml\" -o -name \"TokenCache.dat\" -o -name \"scclient.exe\" -o -name \"msal_http_cache.bin\" -o -name \"recentservers.xml\" -o -name \"ftp.ini\" -o -name \".secrets.mkey\" -o -name \"supervisord.conf\" -o -name \"mongod*.conf\" -o -name \"api_key\" -o -name \"wp-config.php\" -o -name \"firebase-tools.json\" -o -name \"msal_token_cache.bin\" -o -name \"secrets.yml\" -o -name \"httpd.conf\" -o -name \"*.tfstate\" -o -name \"*.pfx\" -o -name \"docker.sock\" -o -name \".github\" -o -name \"*vnc*.txt\" -o -name \"access_tokens.json\" -o -name \"service_principal_entries.json\" -o -name \"rpcd\" -o -name \"gvm-tools.conf\" -o -name \"system.sav\" -o -name \".google_authenticator\" -o -name \"pwd.ibd\" -o -name \"*.kdbx\" -o -name \"anaconda-ks.cfg\" -o -name \".gitconfig\" -o -name \"pubring.kbx\" -o -name \"*.vmdk\" -o -name \"settings.php\" -o -name \"docker.socket\" -o -name \"bash.exe\" -o -name \".k5login\" -o -name \"glusterfs.pem\" -o -name \"*.pcap\" -o -name \".rhosts\" -o -name \"security.sav\" -o -name \"id_dsa*\" -o -name \"*vnc*.xml\" -o -name \"krb5cc_*\" -o -name \"msal_token_cache.json\" -o -name \"state.vscdb\" -o -name \"zabbix_agentd.conf\" -o -name \"setupinfo.bak\" -o -name \"software\" -o -name \"protecteduserkey.bin\" -o -name \"crontab-ui.service\" -o -name \"SAM\" -o -name \"https.conf\" -o -name \"pagefile.sys\" -o -name \"aliases\" -o -name \"*password*\" -o -name \"access.log\" -o -name \"unattended.xml\" -o -name \"secrets.ldb\" -o -name \"*_history*\" -o -name \"unattend.xml\" -o -name \"*.keytab\" -o -name \".roadtools_auth\" -o -name \".profile\" -o -name \"docker-compose.yml\" -o -name \"iis6.log\" -o -name \".flyrc\" -o -name \"web*.config\" -o -name \"psk.txt\" -o -name \"authorized_keys\" -o -name \".bashrc\" -o -name \"log4j-core*.jar\" -o -name \"*.gpg\" -o -name \"sip.conf\" -o -name \"bootstrap-kubelet.conf\" -o -name \"crio.sock\" -o -name \"000-default.conf\" -o -name \"redis.conf\" -o -name \"*.pgp\" -o -name \".pypirc\" -o -name \".git-credentials\" -o -name \"dockershim.sock\" -o -name \"hosts.equiv\" -o -name \"*.rdg\" -o -name \"database.php\" -o -name \"config.php\" -o -name \".msmtprc\" -o -name \"admin.conf\" -o -name \"unattend.txt\" -o -name \"plum.sqlite\" -o -name \"tomcat-users.xml\" -o -name \"sitemanager.xml\" -o -name \".plan\" -o -name \"pgadmin4.db\" -o -name \"winscp.ini\" -o -name \"*.viminfo\" -o -name \"known_hosts\" -o -name \"passwd.ibd\" -o -name \"clouds.config\" -o -name \"sslkeylog.log\" -o -name \"Elastix.conf\" -o -name \"Ntds.dit\" -o -name \"groups.xml\" -o -name \"private-keys-v1.d/*.key\" -o -name \"containerd.sock\" -o -name \"*.keyring\" -o -name \"mosquitto.conf\" -o -name \"environment\" -o -name \"webserver_config.py\" -o -name \"creds*\" -o -name \"printers.xml\" -o -name \"*.pcapng\" -o -name \"influxdb.conf\" -o -name \"ftp.config\" -o -name \"*.crt\" -o -name \".wgetrc\" -o -name \"scheduledtasks.xml\" -o -name \"crontab.db\" -o -name \"ntuser.dat\" -o -name \"*.asc\" -o -name \"access_tokens.db\" -o -name \"elasticsearch.y*ml\" -o -name \"vsftpd.conf\" -o -name \"airflow.cfg\" -o -name \"server.xml\" -o -name \".mylogin.cnf\" -o -name \".pgpass\" -o -name \".erlang.cookie\" -o -name \"ddclient.conf\" -o -name \"php.ini\" -o -name \"racoon.conf\" -o -name \"index.dat\" -o -name \"*.tf\" -o -name \"snyk.json\" -o -name \".credentials.json\" -o -name \"azureProfile.json\" -o -name \"legacy_credentials.db\" -o -name \"*.vhdx\" -o -name \"*.pub\" -o -name \"*.ovpn\" -o -name \"*.keystore\" -o -name \"*.cer\" -o -name \"secret.asc\" -o -name \"gitlab.rm\" -o -name \"*vnc*.c*nf*\" -o -name \"db.php\" -o -name \".ldaprc\" -o -name \"*credential*\" -o -name \"atlantis.db\" -o -name \"*config*.php\" -o -name \"rsyncd.conf\" -o -name \"accessTokens.json\" -o -name \".mcp.json\" -o -name \"apt.conf\" -o -name \"postgresql.conf\" -o -name \"fat.config\" -o -name \"pgsql.conf\" -o -name \"SecEvent.Evt\" -o -name \"keys.log\" -o -name \"ipsec.conf\" -o -name \"debian.cnf\" -o -name \"error.log\" -o -name \"*.key\" -o -name \".Xauthority\" -o -name \"rktlet.sock\" -o -name \"SYSTEM\" -o -name \"NetSetup.log\" -o -name \"*.service\" -o -name \"gpg-agent.conf\" -o -name \"KeePass.config*\" -o -name \"cesi.conf\" -o -name \"glusterfs.ca\" -o -name \"wsl.exe\" -o -name \"gitlab.yml\" -o -name \"zabbix_server.conf\" -o -name \"bitcoin.conf\" -o -name \"pgadmin*.db\" -o -name \"*vnc*.ini\" -o -name \"sssd.conf\" -o -name \"cloud.cfg\" -o -name \"ConsoleHost_history.txt\" -o -name \"setupinfo\" -o -name \".sudo_as_admin_successful\" -o -name \"*.maintenance*\" -o -name \"https-xampp.conf\" -o -name \"*.gnupg\" -o -name \"drives.xml\" -o -name \".recently-used.xbel\" -o -name \"appcmd.exe\" -o -name \"RDCMan.settings\" -o -name \"service_principal_entries.bin\" -o -name \"unattend.inf\" -o -name \"KeePass.ini\" -o -name \".lesshst\" -o -name \"Dockerfile\" -o -name \"KeePass.enforced*\" -o -name \".boto\" -o -name \"mysqld.cnf\" -o -name \"*.der\" -o -name \"adc.json\" -o -name \"rocketchat.service\" -o -name \"rsyncd.secrets\" -o -name \"autologin.conf\" -o -name \"autounattend.xml\" -o -name \"passwd\" -o -name \"master.key\" -o -name \"autologin\" -o -name \"*.swp\" -o -name \"FreeSSHDservice.ini\" -o -name \"default.sav\" -o -name \"credentials.db\" -o -name \"sites.ini\" -o -name \"my.cnf\" -o -name \"grafana.ini\" -o -name \"my.ini\" -o -name \"filezilla.xml\" -o -name \"ws_ftp.ini\" -o -name \"ffftp.ini\" -o -name \"wcx_ftp.ini\" -o -name \"*.timer\" -o -name \".htpasswd\" -o -name \"kcpassword\" -o -name \"nginx.conf\" -o -name \"AppEvent.Evt\" -o -name \"datasources.xml\" -o -name \"*.psk\" -o -name \"sysprep.xml\" -o -name \"*.sqlite3\" -o -name \"secring.gpg\" -o -name \"jetty-realm.properties\" -o -name \"frakti.sock\" -o -name \"config.xml\" -o -name \"*.sqlite\" -o -name \"credentials.tfrc.json\" -o -name \"*.csr\" -o -name \"*.jks\" -o -name \"sentry.conf.py\" -o -name \"state.vscdb.backup\" -o -name \"kadm5.acl\" -o -name \".vault-token\" -o -name \"credentials.xml\" -o -name \"ipsec.secrets\" -o -name \"fastcgi_params\" -o -name \"password*.ibd\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_ETC=`eval_bckgrd "find ${ROOT_FOLDER}etc -name \"krb5.conf\" -o -name \"mariadb.cnf\" -o -name \"AzureRMContext.json\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.p12\" -o -name \"FreePBX.conf\" -o -name \"trustdb.gpg\" -o -name \"software.sav\" -o -name \"backups\" -o -name \"passbolt.php\" -o -name \"*.pem\" -o -name \"snmpd.conf\" -o -name \".env*\" -o -name \"sysprep.inf\" -o -name \"pg_hba.conf\" -o -name \"storage.php\" -o -name \"*kubeconfig*\" -o -name \"amportal.conf\" -o -name \"*.vhd\" -o -name \"kubelet.conf\" -o -name \"*.ftpconfig\" -o -name \"hudson.util.Secret\" -o -name \"snyk.config.json\" -o -name \"smb.conf\" -o -name \"hostapd.conf\" -o -name \"*.db\" -o -name \"backup\" -o -name \"*.socket\" -o -name \"authorized_hosts\" -o -name \"id_rsa*\" -o -name \".claude.json\" -o -name \"storage.json\" -o -name \"glusterfs.key\" -o -name \".git\" -o -name \"kibana.y*ml\" -o -name \"TokenCache.dat\" -o -name \"scclient.exe\" -o -name \"msal_http_cache.bin\" -o -name \"recentservers.xml\" -o -name \"ftp.ini\" -o -name \".secrets.mkey\" -o -name \"supervisord.conf\" -o -name \"mongod*.conf\" -o -name \"api_key\" -o -name \"wp-config.php\" -o -name \"firebase-tools.json\" -o -name \"msal_token_cache.bin\" -o -name \"secrets.yml\" -o -name \"httpd.conf\" -o -name \"exports\" -o -name \"*.tfstate\" -o -name \"*.pfx\" -o -name \"docker.sock\" -o -name \".github\" -o -name \"*vnc*.txt\" -o -name \"access_tokens.json\" -o -name \"service_principal_entries.json\" -o -name \"rpcd\" -o -name \"gvm-tools.conf\" -o -name \"system.sav\" -o -name \".google_authenticator\" -o -name \"pwd.ibd\" -o -name \"*.kdbx\" -o -name \"anaconda-ks.cfg\" -o -name \".gitconfig\" -o -name \"pubring.kbx\" -o -name \"*.vmdk\" -o -name \"settings.php\" -o -name \"docker.socket\" -o -name \"bash.exe\" -o -name \".k5login\" -o -name \"glusterfs.pem\" -o -name \"*.pcap\" -o -name \".rhosts\" -o -name \"security.sav\" -o -name \"id_dsa*\" -o -name \"*vnc*.xml\" -o -name \"krb5cc_*\" -o -name \"msal_token_cache.json\" -o -name \"state.vscdb\" -o -name \"zabbix_agentd.conf\" -o -name \"setupinfo.bak\" -o -name \"software\" -o -name \"protecteduserkey.bin\" -o -name \"crontab-ui.service\" -o -name \"SAM\" -o -name \"https.conf\" -o -name \"pagefile.sys\" -o -name \"aliases\" -o -name \"*password*\" -o -name \"access.log\" -o -name \"unattended.xml\" -o -name \"secrets.ldb\" -o -name \"*_history*\" -o -name \"unattend.xml\" -o -name \"*.keytab\" -o -name \".roadtools_auth\" -o -name \".profile\" -o -name \"docker-compose.yml\" -o -name \"iis6.log\" -o -name \".flyrc\" -o -name \"web*.config\" -o -name \"psk.txt\" -o -name \"authorized_keys\" -o -name \".bashrc\" -o -name \"log4j-core*.jar\" -o -name \"*.gpg\" -o -name \"sip.conf\" -o -name \"bootstrap-kubelet.conf\" -o -name \"crio.sock\" -o -name \"000-default.conf\" -o -name \"redis.conf\" -o -name \"*.pgp\" -o -name \".pypirc\" -o -name \".git-credentials\" -o -name \"dockershim.sock\" -o -name \"hosts.equiv\" -o -name \"*.rdg\" -o -name \"database.php\" -o -name \"config.php\" -o -name \".msmtprc\" -o -name \"admin.conf\" -o -name \"unattend.txt\" -o -name \"plum.sqlite\" -o -name \"tomcat-users.xml\" -o -name \"sitemanager.xml\" -o -name \".plan\" -o -name \"pgadmin4.db\" -o -name \"winscp.ini\" -o -name \"*.viminfo\" -o -name \"known_hosts\" -o -name \"passwd.ibd\" -o -name \"clouds.config\" -o -name \"sslkeylog.log\" -o -name \"Elastix.conf\" -o -name \"Ntds.dit\" -o -name \"groups.xml\" -o -name \"private-keys-v1.d/*.key\" -o -name \"containerd.sock\" -o -name \"*.keyring\" -o -name \"mosquitto.conf\" -o -name \"environment\" -o -name \"webserver_config.py\" -o -name \"creds*\" -o -name \"printers.xml\" -o -name \"*.pcapng\" -o -name \"influxdb.conf\" -o -name \"ftp.config\" -o -name \"*.crt\" -o -name \".wgetrc\" -o -name \"scheduledtasks.xml\" -o -name \"crontab.db\" -o -name \"ntuser.dat\" -o -name \"*.asc\" -o -name \"access_tokens.db\" -o -name \"elasticsearch.y*ml\" -o -name \"vsftpd.conf\" -o -name \"airflow.cfg\" -o -name \"server.xml\" -o -name \".mylogin.cnf\" -o -name \".pgpass\" -o -name \".erlang.cookie\" -o -name \"ddclient.conf\" -o -name \"php.ini\" -o -name \"racoon.conf\" -o -name \"index.dat\" -o -name \"*.tf\" -o -name \"snyk.json\" -o -name \".credentials.json\" -o -name \"azureProfile.json\" -o -name \"legacy_credentials.db\" -o -name \"*.vhdx\" -o -name \"*.pub\" -o -name \"*.ovpn\" -o -name \"*.keystore\" -o -name \"*.cer\" -o -name \"secret.asc\" -o -name \"gitlab.rm\" -o -name \"*vnc*.c*nf*\" -o -name \"db.php\" -o -name \".ldaprc\" -o -name \"*credential*\" -o -name \"atlantis.db\" -o -name \"*config*.php\" -o -name \"rsyncd.conf\" -o -name \"accessTokens.json\" -o -name \".mcp.json\" -o -name \"apt.conf\" -o -name \"postgresql.conf\" -o -name \"fat.config\" -o -name \"pgsql.conf\" -o -name \"SecEvent.Evt\" -o -name \"keys.log\" -o -name \"ipsec.conf\" -o -name \"debian.cnf\" -o -name \"error.log\" -o -name \"*.key\" -o -name \".Xauthority\" -o -name \"rktlet.sock\" -o -name \"SYSTEM\" -o -name \"NetSetup.log\" -o -name \"*.service\" -o -name \"gpg-agent.conf\" -o -name \"KeePass.config*\" -o -name \"cesi.conf\" -o -name \"glusterfs.ca\" -o -name \"wsl.exe\" -o -name \"gitlab.yml\" -o -name \"zabbix_server.conf\" -o -name \"bitcoin.conf\" -o -name \"pgadmin*.db\" -o -name \"*vnc*.ini\" -o -name \"sssd.conf\" -o -name \"cloud.cfg\" -o -name \"ConsoleHost_history.txt\" -o -name \"setupinfo\" -o -name \".sudo_as_admin_successful\" -o -name \"*.maintenance*\" -o -name \"https-xampp.conf\" -o -name \"*.gnupg\" -o -name \"drives.xml\" -o -name \".recently-used.xbel\" -o -name \"appcmd.exe\" -o -name \"RDCMan.settings\" -o -name \"service_principal_entries.bin\" -o -name \"unattend.inf\" -o -name \"KeePass.ini\" -o -name \".lesshst\" -o -name \"Dockerfile\" -o -name \"KeePass.enforced*\" -o -name \"mysqld.cnf\" -o -name \"*.der\" -o -name \".boto\" -o -name \"adc.json\" -o -name \"rocketchat.service\" -o -name \"rsyncd.secrets\" -o -name \"autologin.conf\" -o -name \"autounattend.xml\" -o -name \"passwd\" -o -name \"master.key\" -o -name \"autologin\" -o -name \"*.swp\" -o -name \"FreeSSHDservice.ini\" -o -name \"default.sav\" -o -name \"credentials.db\" -o -name \"sites.ini\" -o -name \"my.cnf\" -o -name \"grafana.ini\" -o -name \"my.ini\" -o -name \"filezilla.xml\" -o -name \"ws_ftp.ini\" -o -name \"ffftp.ini\" -o -name \"wcx_ftp.ini\" -o -name \"*.timer\" -o -name \".htpasswd\" -o -name \"kcpassword\" -o -name \"nginx.conf\" -o -name \"AppEvent.Evt\" -o -name \"datasources.xml\" -o -name \"*.psk\" -o -name \"*knockd*\" -o -name \"sysprep.xml\" -o -name \"*.sqlite3\" -o -name \"secring.gpg\" -o -name \"jetty-realm.properties\" -o -name \"frakti.sock\" -o -name \"config.xml\" -o -name \"*.sqlite\" -o -name \"credentials.tfrc.json\" -o -name \"*.csr\" -o -name \"*.jks\" -o -name \"sentry.conf.py\" -o -name \"state.vscdb.backup\" -o -name \"kadm5.acl\" -o -name \".vault-token\" -o -name \"credentials.xml\" -o -name \"ipsec.secrets\" -o -name \"fastcgi_params\" -o -name \"password*.ibd\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_HOMESEARCH=`eval_bckgrd "find $HOMESEARCH -name \"krb5.conf\" -o -name \"mariadb.cnf\" -o -name \"AzureRMContext.json\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.p12\" -o -name \"FreePBX.conf\" -o -name \"trustdb.gpg\" -o -name \"software.sav\" -o -name \"backups\" -o -name \"passbolt.php\" -o -name \"*.pem\" -o -name \"snmpd.conf\" -o -name \".env*\" -o -name \"sysprep.inf\" -o -name \"pg_hba.conf\" -o -name \"storage.php\" -o -name \"*kubeconfig*\" -o -name \"amportal.conf\" -o -name \"*.vhd\" -o -name \"kubelet.conf\" -o -name \"*.ftpconfig\" -o -name \"hudson.util.Secret\" -o -name \"snyk.config.json\" -o -name \"smb.conf\" -o -name \"hostapd.conf\" -o -name \"*.db\" -o -name \"backup\" -o -name \"*.socket\" -o -name \"authorized_hosts\" -o -name \"id_rsa*\" -o -name \".claude.json\" -o -name \"storage.json\" -o -name \"glusterfs.key\" -o -name \".git\" -o -name \"kibana.y*ml\" -o -name \"TokenCache.dat\" -o -name \"scclient.exe\" -o -name \"msal_http_cache.bin\" -o -name \"recentservers.xml\" -o -name \"ftp.ini\" -o -name \".secrets.mkey\" -o -name \"supervisord.conf\" -o -name \"mongod*.conf\" -o -name \"api_key\" -o -name \"wp-config.php\" -o -name \"firebase-tools.json\" -o -name \"msal_token_cache.bin\" -o -name \"secrets.yml\" -o -name \"httpd.conf\" -o -name \"*.tfstate\" -o -name \"*.pfx\" -o -name \"docker.sock\" -o -name \".github\" -o -name \"*vnc*.txt\" -o -name \"access_tokens.json\" -o -name \"service_principal_entries.json\" -o -name \"rpcd\" -o -name \"gvm-tools.conf\" -o -name \"system.sav\" -o -name \".google_authenticator\" -o -name \"pwd.ibd\" -o -name \"*.kdbx\" -o -name \"anaconda-ks.cfg\" -o -name \".gitconfig\" -o -name \"pubring.kbx\" -o -name \"*.vmdk\" -o -name \"settings.php\" -o -name \"docker.socket\" -o -name \"bash.exe\" -o -name \".k5login\" -o -name \"glusterfs.pem\" -o -name \"*.pcap\" -o -name \".rhosts\" -o -name \"security.sav\" -o -name \"id_dsa*\" -o -name \"*vnc*.xml\" -o -name \"krb5cc_*\" -o -name \"msal_token_cache.json\" -o -name \"state.vscdb\" -o -name \"zabbix_agentd.conf\" -o -name \"setupinfo.bak\" -o -name \"software\" -o -name \"protecteduserkey.bin\" -o -name \"crontab-ui.service\" -o -name \"SAM\" -o -name \"https.conf\" -o -name \"pagefile.sys\" -o -name \"aliases\" -o -name \"*password*\" -o -name \"access.log\" -o -name \"unattended.xml\" -o -name \"secrets.ldb\" -o -name \"*_history*\" -o -name \"unattend.xml\" -o -name \"*.keytab\" -o -name \".roadtools_auth\" -o -name \".profile\" -o -name \"docker-compose.yml\" -o -name \"iis6.log\" -o -name \".flyrc\" -o -name \"web*.config\" -o -name \"psk.txt\" -o -name \"authorized_keys\" -o -name \".bashrc\" -o -name \"log4j-core*.jar\" -o -name \"*.gpg\" -o -name \"sip.conf\" -o -name \"bootstrap-kubelet.conf\" -o -name \"crio.sock\" -o -name \"000-default.conf\" -o -name \"redis.conf\" -o -name \"*.pgp\" -o -name \".pypirc\" -o -name \".git-credentials\" -o -name \"dockershim.sock\" -o -name \"hosts.equiv\" -o -name \"*.rdg\" -o -name \"database.php\" -o -name \"config.php\" -o -name \".msmtprc\" -o -name \"admin.conf\" -o -name \"unattend.txt\" -o -name \"plum.sqlite\" -o -name \"tomcat-users.xml\" -o -name \"sitemanager.xml\" -o -name \".plan\" -o -name \"pgadmin4.db\" -o -name \"winscp.ini\" -o -name \"*.viminfo\" -o -name \"known_hosts\" -o -name \"passwd.ibd\" -o -name \"clouds.config\" -o -name \"sslkeylog.log\" -o -name \"Elastix.conf\" -o -name \"Ntds.dit\" -o -name \"groups.xml\" -o -name \"private-keys-v1.d/*.key\" -o -name \"containerd.sock\" -o -name \"*.keyring\" -o -name \"mosquitto.conf\" -o -name \"environment\" -o -name \"webserver_config.py\" -o -name \"creds*\" -o -name \"printers.xml\" -o -name \"*.pcapng\" -o -name \"influxdb.conf\" -o -name \"ftp.config\" -o -name \"*.crt\" -o -name \".wgetrc\" -o -name \"scheduledtasks.xml\" -o -name \"crontab.db\" -o -name \"ntuser.dat\" -o -name \"ssh*config\" -o -name \"*.asc\" -o -name \"access_tokens.db\" -o -name \"elasticsearch.y*ml\" -o -name \"vsftpd.conf\" -o -name \"airflow.cfg\" -o -name \"server.xml\" -o -name \".mylogin.cnf\" -o -name \".pgpass\" -o -name \".erlang.cookie\" -o -name \"ddclient.conf\" -o -name \"php.ini\" -o -name \"racoon.conf\" -o -name \"index.dat\" -o -name \"*.tf\" -o -name \"snyk.json\" -o -name \".credentials.json\" -o -name \"azureProfile.json\" -o -name \"legacy_credentials.db\" -o -name \"*.vhdx\" -o -name \"*.pub\" -o -name \"*.ovpn\" -o -name \"*.keystore\" -o -name \"*.cer\" -o -name \"secret.asc\" -o -name \"gitlab.rm\" -o -name \"*vnc*.c*nf*\" -o -name \"db.php\" -o -name \".ldaprc\" -o -name \"*credential*\" -o -name \"atlantis.db\" -o -name \"*config*.php\" -o -name \"rsyncd.conf\" -o -name \"accessTokens.json\" -o -name \".mcp.json\" -o -name \"apt.conf\" -o -name \"postgresql.conf\" -o -name \"fat.config\" -o -name \"pgsql.conf\" -o -name \"SecEvent.Evt\" -o -name \"keys.log\" -o -name \"ipsec.conf\" -o -name \"debian.cnf\" -o -name \"error.log\" -o -name \"*.key\" -o -name \".Xauthority\" -o -name \"rktlet.sock\" -o -name \"SYSTEM\" -o -name \"NetSetup.log\" -o -name \"*.service\" -o -name \"gpg-agent.conf\" -o -name \"KeePass.config*\" -o -name \"cesi.conf\" -o -name \"glusterfs.ca\" -o -name \"wsl.exe\" -o -name \"gitlab.yml\" -o -name \"zabbix_server.conf\" -o -name \"bitcoin.conf\" -o -name \"pgadmin*.db\" -o -name \"*vnc*.ini\" -o -name \"sssd.conf\" -o -name \"cloud.cfg\" -o -name \"ConsoleHost_history.txt\" -o -name \"setupinfo\" -o -name \".sudo_as_admin_successful\" -o -name \"*.maintenance*\" -o -name \"https-xampp.conf\" -o -name \"*.gnupg\" -o -name \"drives.xml\" -o -name \".recently-used.xbel\" -o -name \"appcmd.exe\" -o -name \"RDCMan.settings\" -o -name \"service_principal_entries.bin\" -o -name \"unattend.inf\" -o -name \"KeePass.ini\" -o -name \".lesshst\" -o -name \"Dockerfile\" -o -name \"KeePass.enforced*\" -o -name \"mysqld.cnf\" -o -name \"*.der\" -o -name \".boto\" -o -name \"adc.json\" -o -name \"rocketchat.service\" -o -name \"rsyncd.secrets\" -o -name \"autologin.conf\" -o -name \"autounattend.xml\" -o -name \"passwd\" -o -name \"master.key\" -o -name \"autologin\" -o -name \"*.swp\" -o -name \"FreeSSHDservice.ini\" -o -name \"default.sav\" -o -name \"credentials.db\" -o -name \"sites.ini\" -o -name \"my.cnf\" -o -name \"grafana.ini\" -o -name \"my.ini\" -o -name \"filezilla.xml\" -o -name \"ws_ftp.ini\" -o -name \"ffftp.ini\" -o -name \"wcx_ftp.ini\" -o -name \"*.timer\" -o -name \".htpasswd\" -o -name \"kcpassword\" -o -name \"nginx.conf\" -o -name \"AppEvent.Evt\" -o -name \"datasources.xml\" -o -name \"*.psk\" -o -name \"sysprep.xml\" -o -name \"*.sqlite3\" -o -name \"secring.gpg\" -o -name \"jetty-realm.properties\" -o -name \"frakti.sock\" -o -name \"config.xml\" -o -name \"*.sqlite\" -o -name \"credentials.tfrc.json\" -o -name \"*.csr\" -o -name \"*.jks\" -o -name \"sentry.conf.py\" -o -name \"state.vscdb.backup\" -o -name \"kadm5.acl\" -o -name \".vault-token\" -o -name \"credentials.xml\" -o -name \"ipsec.secrets\" -o -name \"fastcgi_params\" -o -name \"password*.ibd\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  FIND_MEDIA=`eval_bckgrd "find ${ROOT_FOLDER}media -name \"krb5.conf\" -o -name \"mariadb.cnf\" -o -name \"AzureRMContext.json\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.p12\" -o -name \"FreePBX.conf\" -o -name \"trustdb.gpg\" -o -name \"software.sav\" -o -name \"backups\" -o -name \"passbolt.php\" -o -name \"*.pem\" -o -name \"snmpd.conf\" -o -name \".env*\" -o -name \"sysprep.inf\" -o -name \"pg_hba.conf\" -o -name \"storage.php\" -o -name \"*kubeconfig*\" -o -name \"amportal.conf\" -o -name \"*.vhd\" -o -name \"kubelet.conf\" -o -name \"*.ftpconfig\" -o -name \"hudson.util.Secret\" -o -name \"snyk.config.json\" -o -name \"smb.conf\" -o -name \"hostapd.conf\" -o -name \"*.db\" -o -name \"backup\" -o -name \"*.socket\" -o -name \"authorized_hosts\" -o -name \"id_rsa*\" -o -name \".claude.json\" -o -name \"storage.json\" -o -name \"glusterfs.key\" -o -name \".git\" -o -name \"kibana.y*ml\" -o -name \"TokenCache.dat\" -o -name \"scclient.exe\" -o -name \"msal_http_cache.bin\" -o -name \"recentservers.xml\" -o -name \"ftp.ini\" -o -name \".secrets.mkey\" -o -name \"supervisord.conf\" -o -name \"mongod*.conf\" -o -name \"api_key\" -o -name \"wp-config.php\" -o -name \"firebase-tools.json\" -o -name \"msal_token_cache.bin\" -o -name \"secrets.yml\" -o -name \"httpd.conf\" -o -name \"*.tfstate\" -o -name \"*.pfx\" -o -name \"docker.sock\" -o -name \".github\" -o -name \"*vnc*.txt\" -o -name \"access_tokens.json\" -o -name \"service_principal_entries.json\" -o -name \"rpcd\" -o -name \"gvm-tools.conf\" -o -name \"system.sav\" -o -name \".google_authenticator\" -o -name \"pwd.ibd\" -o -name \"*.kdbx\" -o -name \"anaconda-ks.cfg\" -o -name \".gitconfig\" -o -name \"pubring.kbx\" -o -name \"*.vmdk\" -o -name \"settings.php\" -o -name \"docker.socket\" -o -name \"bash.exe\" -o -name \".k5login\" -o -name \"glusterfs.pem\" -o -name \"*.pcap\" -o -name \".rhosts\" -o -name \"security.sav\" -o -name \"id_dsa*\" -o -name \"*vnc*.xml\" -o -name \"krb5cc_*\" -o -name \"msal_token_cache.json\" -o -name \"state.vscdb\" -o -name \"zabbix_agentd.conf\" -o -name \"setupinfo.bak\" -o -name \"software\" -o -name \"protecteduserkey.bin\" -o -name \"crontab-ui.service\" -o -name \"SAM\" -o -name \"https.conf\" -o -name \"pagefile.sys\" -o -name \"aliases\" -o -name \"*password*\" -o -name \"access.log\" -o -name \"unattended.xml\" -o -name \"secrets.ldb\" -o -name \"*_history*\" -o -name \"unattend.xml\" -o -name \"*.keytab\" -o -name \".roadtools_auth\" -o -name \".profile\" -o -name \"docker-compose.yml\" -o -name \"iis6.log\" -o -name \".flyrc\" -o -name \"web*.config\" -o -name \"psk.txt\" -o -name \"authorized_keys\" -o -name \".bashrc\" -o -name \"log4j-core*.jar\" -o -name \"*.gpg\" -o -name \"sip.conf\" -o -name \"bootstrap-kubelet.conf\" -o -name \"crio.sock\" -o -name \"000-default.conf\" -o -name \"redis.conf\" -o -name \"*.pgp\" -o -name \".pypirc\" -o -name \".git-credentials\" -o -name \"dockershim.sock\" -o -name \"hosts.equiv\" -o -name \"*.rdg\" -o -name \"database.php\" -o -name \"config.php\" -o -name \".msmtprc\" -o -name \"admin.conf\" -o -name \"unattend.txt\" -o -name \"plum.sqlite\" -o -name \"tomcat-users.xml\" -o -name \"sitemanager.xml\" -o -name \".plan\" -o -name \"pgadmin4.db\" -o -name \"winscp.ini\" -o -name \"*.viminfo\" -o -name \"known_hosts\" -o -name \"passwd.ibd\" -o -name \"clouds.config\" -o -name \"sslkeylog.log\" -o -name \"Elastix.conf\" -o -name \"Ntds.dit\" -o -name \"groups.xml\" -o -name \"private-keys-v1.d/*.key\" -o -name \"containerd.sock\" -o -name \"*.keyring\" -o -name \"mosquitto.conf\" -o -name \"environment\" -o -name \"webserver_config.py\" -o -name \"creds*\" -o -name \"printers.xml\" -o -name \"*.pcapng\" -o -name \"influxdb.conf\" -o -name \"ftp.config\" -o -name \"*.crt\" -o -name \".wgetrc\" -o -name \"scheduledtasks.xml\" -o -name \"crontab.db\" -o -name \"ntuser.dat\" -o -name \"*.asc\" -o -name \"access_tokens.db\" -o -name \"elasticsearch.y*ml\" -o -name \"vsftpd.conf\" -o -name \"airflow.cfg\" -o -name \"server.xml\" -o -name \".mylogin.cnf\" -o -name \".pgpass\" -o -name \".erlang.cookie\" -o -name \"ddclient.conf\" -o -name \"php.ini\" -o -name \"racoon.conf\" -o -name \"index.dat\" -o -name \"*.tf\" -o -name \"snyk.json\" -o -name \".credentials.json\" -o -name \"azureProfile.json\" -o -name \"legacy_credentials.db\" -o -name \"*.vhdx\" -o -name \"*.pub\" -o -name \"*.ovpn\" -o -name \"*.keystore\" -o -name \"*.cer\" -o -name \"secret.asc\" -o -name \"gitlab.rm\" -o -name \"*vnc*.c*nf*\" -o -name \"db.php\" -o -name \".ldaprc\" -o -name \"*credential*\" -o -name \"atlantis.db\" -o -name \"*config*.php\" -o -name \"rsyncd.conf\" -o -name \"accessTokens.json\" -o -name \".mcp.json\" -o -name \"apt.conf\" -o -name \"postgresql.conf\" -o -name \"fat.config\" -o -name \"pgsql.conf\" -o -name \"SecEvent.Evt\" -o -name \"keys.log\" -o -name \"ipsec.conf\" -o -name \"debian.cnf\" -o -name \"error.log\" -o -name \"*.key\" -o -name \".Xauthority\" -o -name \"rktlet.sock\" -o -name \"SYSTEM\" -o -name \"NetSetup.log\" -o -name \"*.service\" -o -name \"gpg-agent.conf\" -o -name \"KeePass.config*\" -o -name \"cesi.conf\" -o -name \"glusterfs.ca\" -o -name \"wsl.exe\" -o -name \"gitlab.yml\" -o -name \"zabbix_server.conf\" -o -name \"bitcoin.conf\" -o -name \"pgadmin*.db\" -o -name \"*vnc*.ini\" -o -name \"sssd.conf\" -o -name \"cloud.cfg\" -o -name \"ConsoleHost_history.txt\" -o -name \"setupinfo\" -o -name \".sudo_as_admin_successful\" -o -name \"*.maintenance*\" -o -name \"https-xampp.conf\" -o -name \"*.gnupg\" -o -name \"drives.xml\" -o -name \".recently-used.xbel\" -o -name \"appcmd.exe\" -o -name \"RDCMan.settings\" -o -name \"service_principal_entries.bin\" -o -name \"unattend.inf\" -o -name \"KeePass.ini\" -o -name \".lesshst\" -o -name \"Dockerfile\" -o -name \"KeePass.enforced*\" -o -name \".boto\" -o -name \"mysqld.cnf\" -o -name \"*.der\" -o -name \"adc.json\" -o -name \"rocketchat.service\" -o -name \"rsyncd.secrets\" -o -name \"autologin.conf\" -o -name \"autounattend.xml\" -o -name \"passwd\" -o -name \"master.key\" -o -name \"autologin\" -o -name \"*.swp\" -o -name \"FreeSSHDservice.ini\" -o -name \"default.sav\" -o -name \"credentials.db\" -o -name \"sites.ini\" -o -name \"my.cnf\" -o -name \"grafana.ini\" -o -name \"my.ini\" -o -name \"filezilla.xml\" -o -name \"ws_ftp.ini\" -o -name \"ffftp.ini\" -o -name \"wcx_ftp.ini\" -o -name \"*.timer\" -o -name \".htpasswd\" -o -name \"kcpassword\" -o -name \"nginx.conf\" -o -name \"AppEvent.Evt\" -o -name \"datasources.xml\" -o -name \"*.psk\" -o -name \"sysprep.xml\" -o -name \"*.sqlite3\" -o -name \"secring.gpg\" -o -name \"jetty-realm.properties\" -o -name \"frakti.sock\" -o -name \"config.xml\" -o -name \"*.sqlite\" -o -name \"credentials.tfrc.json\" -o -name \"*.csr\" -o -name \"*.jks\" -o -name \"sentry.conf.py\" -o -name \"state.vscdb.backup\" -o -name \"kadm5.acl\" -o -name \".vault-token\" -o -name \"credentials.xml\" -o -name \"ipsec.secrets\" -o -name \"fastcgi_params\" -o -name \"password*.ibd\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_MNT=`eval_bckgrd "find ${ROOT_FOLDER}mnt -name \"krb5.conf\" -o -name \"mariadb.cnf\" -o -name \"AzureRMContext.json\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.p12\" -o -name \"FreePBX.conf\" -o -name \"trustdb.gpg\" -o -name \"software.sav\" -o -name \"backups\" -o -name \"passbolt.php\" -o -name \"*.pem\" -o -name \"snmpd.conf\" -o -name \".env*\" -o -name \"sysprep.inf\" -o -name \"pg_hba.conf\" -o -name \"storage.php\" -o -name \"*kubeconfig*\" -o -name \"amportal.conf\" -o -name \"*.vhd\" -o -name \"kubelet.conf\" -o -name \"*.ftpconfig\" -o -name \"hudson.util.Secret\" -o -name \"snyk.config.json\" -o -name \"smb.conf\" -o -name \"hostapd.conf\" -o -name \"*.db\" -o -name \"backup\" -o -name \"*.socket\" -o -name \"authorized_hosts\" -o -name \"id_rsa*\" -o -name \".claude.json\" -o -name \"storage.json\" -o -name \"glusterfs.key\" -o -name \".git\" -o -name \"kibana.y*ml\" -o -name \"TokenCache.dat\" -o -name \"scclient.exe\" -o -name \"msal_http_cache.bin\" -o -name \"recentservers.xml\" -o -name \"ftp.ini\" -o -name \".secrets.mkey\" -o -name \"supervisord.conf\" -o -name \"mongod*.conf\" -o -name \"api_key\" -o -name \"wp-config.php\" -o -name \"firebase-tools.json\" -o -name \"msal_token_cache.bin\" -o -name \"secrets.yml\" -o -name \"httpd.conf\" -o -name \"*.tfstate\" -o -name \"*.pfx\" -o -name \"docker.sock\" -o -name \".github\" -o -name \"*vnc*.txt\" -o -name \"access_tokens.json\" -o -name \"service_principal_entries.json\" -o -name \"rpcd\" -o -name \"gvm-tools.conf\" -o -name \"system.sav\" -o -name \".google_authenticator\" -o -name \"pwd.ibd\" -o -name \"*.kdbx\" -o -name \"anaconda-ks.cfg\" -o -name \".gitconfig\" -o -name \"pubring.kbx\" -o -name \"*.vmdk\" -o -name \"settings.php\" -o -name \"docker.socket\" -o -name \"bash.exe\" -o -name \".k5login\" -o -name \"glusterfs.pem\" -o -name \"*.pcap\" -o -name \".rhosts\" -o -name \"security.sav\" -o -name \"id_dsa*\" -o -name \"*vnc*.xml\" -o -name \"krb5cc_*\" -o -name \"msal_token_cache.json\" -o -name \"state.vscdb\" -o -name \"zabbix_agentd.conf\" -o -name \"setupinfo.bak\" -o -name \"software\" -o -name \"protecteduserkey.bin\" -o -name \"crontab-ui.service\" -o -name \"SAM\" -o -name \"https.conf\" -o -name \"pagefile.sys\" -o -name \"aliases\" -o -name \"*password*\" -o -name \"access.log\" -o -name \"unattended.xml\" -o -name \"secrets.ldb\" -o -name \"*_history*\" -o -name \"unattend.xml\" -o -name \"*.keytab\" -o -name \".roadtools_auth\" -o -name \".profile\" -o -name \"docker-compose.yml\" -o -name \"iis6.log\" -o -name \".flyrc\" -o -name \"web*.config\" -o -name \"psk.txt\" -o -name \"authorized_keys\" -o -name \".bashrc\" -o -name \"log4j-core*.jar\" -o -name \"*.gpg\" -o -name \"sip.conf\" -o -name \"bootstrap-kubelet.conf\" -o -name \"crio.sock\" -o -name \"000-default.conf\" -o -name \"redis.conf\" -o -name \"*.pgp\" -o -name \".pypirc\" -o -name \".git-credentials\" -o -name \"dockershim.sock\" -o -name \"hosts.equiv\" -o -name \"*.rdg\" -o -name \"database.php\" -o -name \"config.php\" -o -name \".msmtprc\" -o -name \"admin.conf\" -o -name \"unattend.txt\" -o -name \"plum.sqlite\" -o -name \"tomcat-users.xml\" -o -name \"sitemanager.xml\" -o -name \".plan\" -o -name \"pgadmin4.db\" -o -name \"winscp.ini\" -o -name \"*.viminfo\" -o -name \"known_hosts\" -o -name \"passwd.ibd\" -o -name \"clouds.config\" -o -name \"sslkeylog.log\" -o -name \"Elastix.conf\" -o -name \"Ntds.dit\" -o -name \"groups.xml\" -o -name \"private-keys-v1.d/*.key\" -o -name \"containerd.sock\" -o -name \"*.keyring\" -o -name \"mosquitto.conf\" -o -name \"environment\" -o -name \"webserver_config.py\" -o -name \"creds*\" -o -name \"printers.xml\" -o -name \"*.pcapng\" -o -name \"influxdb.conf\" -o -name \"ftp.config\" -o -name \"*.crt\" -o -name \".wgetrc\" -o -name \"scheduledtasks.xml\" -o -name \"crontab.db\" -o -name \"ntuser.dat\" -o -name \"*.asc\" -o -name \"access_tokens.db\" -o -name \"elasticsearch.y*ml\" -o -name \"vsftpd.conf\" -o -name \"airflow.cfg\" -o -name \"server.xml\" -o -name \".mylogin.cnf\" -o -name \".pgpass\" -o -name \"sess_*\" -o -name \".erlang.cookie\" -o -name \"ddclient.conf\" -o -name \"php.ini\" -o -name \"racoon.conf\" -o -name \"index.dat\" -o -name \"*.tf\" -o -name \"snyk.json\" -o -name \".credentials.json\" -o -name \"azureProfile.json\" -o -name \"legacy_credentials.db\" -o -name \"*.vhdx\" -o -name \"*.pub\" -o -name \"*.ovpn\" -o -name \"*.keystore\" -o -name \"*.cer\" -o -name \"secret.asc\" -o -name \"gitlab.rm\" -o -name \"*vnc*.c*nf*\" -o -name \"db.php\" -o -name \".ldaprc\" -o -name \"*credential*\" -o -name \"atlantis.db\" -o -name \"*config*.php\" -o -name \"rsyncd.conf\" -o -name \"accessTokens.json\" -o -name \".mcp.json\" -o -name \"apt.conf\" -o -name \"postgresql.conf\" -o -name \"fat.config\" -o -name \"pgsql.conf\" -o -name \"SecEvent.Evt\" -o -name \"keys.log\" -o -name \"ipsec.conf\" -o -name \"debian.cnf\" -o -name \"error.log\" -o -name \"*.key\" -o -name \".Xauthority\" -o -name \"rktlet.sock\" -o -name \"SYSTEM\" -o -name \"NetSetup.log\" -o -name \"*.service\" -o -name \"gpg-agent.conf\" -o -name \"KeePass.config*\" -o -name \"cesi.conf\" -o -name \"glusterfs.ca\" -o -name \"wsl.exe\" -o -name \"gitlab.yml\" -o -name \"zabbix_server.conf\" -o -name \"bitcoin.conf\" -o -name \"pgadmin*.db\" -o -name \"*vnc*.ini\" -o -name \"sssd.conf\" -o -name \"cloud.cfg\" -o -name \"ConsoleHost_history.txt\" -o -name \"setupinfo\" -o -name \".sudo_as_admin_successful\" -o -name \"*.maintenance*\" -o -name \"https-xampp.conf\" -o -name \"*.gnupg\" -o -name \"drives.xml\" -o -name \".recently-used.xbel\" -o -name \"appcmd.exe\" -o -name \"RDCMan.settings\" -o -name \"service_principal_entries.bin\" -o -name \"unattend.inf\" -o -name \"KeePass.ini\" -o -name \".lesshst\" -o -name \"Dockerfile\" -o -name \"KeePass.enforced*\" -o -name \"mysqld.cnf\" -o -name \"*.der\" -o -name \".boto\" -o -name \"adc.json\" -o -name \"rocketchat.service\" -o -name \"rsyncd.secrets\" -o -name \"autologin.conf\" -o -name \"autounattend.xml\" -o -name \"passwd\" -o -name \"master.key\" -o -name \"autologin\" -o -name \"*.swp\" -o -name \"FreeSSHDservice.ini\" -o -name \"default.sav\" -o -name \"credentials.db\" -o -name \"sites.ini\" -o -name \"my.cnf\" -o -name \"grafana.ini\" -o -name \"my.ini\" -o -name \"filezilla.xml\" -o -name \"ws_ftp.ini\" -o -name \"ffftp.ini\" -o -name \"wcx_ftp.ini\" -o -name \"*.timer\" -o -name \".htpasswd\" -o -name \"kcpassword\" -o -name \"nginx.conf\" -o -name \"AppEvent.Evt\" -o -name \"datasources.xml\" -o -name \"*.psk\" -o -name \"sysprep.xml\" -o -name \"*.sqlite3\" -o -name \"secring.gpg\" -o -name \"jetty-realm.properties\" -o -name \"frakti.sock\" -o -name \"config.xml\" -o -name \"*.sqlite\" -o -name \"credentials.tfrc.json\" -o -name \"*.csr\" -o -name \"*.jks\" -o -name \"sentry.conf.py\" -o -name \"state.vscdb.backup\" -o -name \"kadm5.acl\" -o -name \".vault-token\" -o -name \"credentials.xml\" -o -name \"ipsec.secrets\" -o -name \"fastcgi_params\" -o -name \"password*.ibd\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_OPT=`eval_bckgrd "find ${ROOT_FOLDER}opt -name \"krb5.conf\" -o -name \"mariadb.cnf\" -o -name \"AzureRMContext.json\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.p12\" -o -name \"FreePBX.conf\" -o -name \"trustdb.gpg\" -o -name \"software.sav\" -o -name \"backups\" -o -name \"passbolt.php\" -o -name \"*.pem\" -o -name \"snmpd.conf\" -o -name \".env*\" -o -name \"sysprep.inf\" -o -name \"pg_hba.conf\" -o -name \"storage.php\" -o -name \"*kubeconfig*\" -o -name \"amportal.conf\" -o -name \"*.vhd\" -o -name \"kubelet.conf\" -o -name \"*.ftpconfig\" -o -name \"hudson.util.Secret\" -o -name \"snyk.config.json\" -o -name \"smb.conf\" -o -name \"hostapd.conf\" -o -name \"*.db\" -o -name \"backup\" -o -name \"*.socket\" -o -name \"authorized_hosts\" -o -name \"id_rsa*\" -o -name \".claude.json\" -o -name \"storage.json\" -o -name \"glusterfs.key\" -o -name \".git\" -o -name \"kibana.y*ml\" -o -name \"TokenCache.dat\" -o -name \"scclient.exe\" -o -name \"msal_http_cache.bin\" -o -name \"recentservers.xml\" -o -name \"ftp.ini\" -o -name \".secrets.mkey\" -o -name \"supervisord.conf\" -o -name \"mongod*.conf\" -o -name \"api_key\" -o -name \"wp-config.php\" -o -name \"firebase-tools.json\" -o -name \"msal_token_cache.bin\" -o -name \"secrets.yml\" -o -name \"httpd.conf\" -o -name \"*.tfstate\" -o -name \"*.pfx\" -o -name \"docker.sock\" -o -name \".github\" -o -name \"*vnc*.txt\" -o -name \"access_tokens.json\" -o -name \"service_principal_entries.json\" -o -name \"rpcd\" -o -name \"gvm-tools.conf\" -o -name \"system.sav\" -o -name \".google_authenticator\" -o -name \"pwd.ibd\" -o -name \"*.kdbx\" -o -name \"anaconda-ks.cfg\" -o -name \".gitconfig\" -o -name \"pubring.kbx\" -o -name \"*.vmdk\" -o -name \"settings.php\" -o -name \"docker.socket\" -o -name \"bash.exe\" -o -name \".k5login\" -o -name \"glusterfs.pem\" -o -name \"*.pcap\" -o -name \".rhosts\" -o -name \"security.sav\" -o -name \"id_dsa*\" -o -name \"*vnc*.xml\" -o -name \"krb5cc_*\" -o -name \"msal_token_cache.json\" -o -name \"state.vscdb\" -o -name \"zabbix_agentd.conf\" -o -name \"setupinfo.bak\" -o -name \"software\" -o -name \"protecteduserkey.bin\" -o -name \"crontab-ui.service\" -o -name \"SAM\" -o -name \"https.conf\" -o -name \"pagefile.sys\" -o -name \"aliases\" -o -name \"*password*\" -o -name \"access.log\" -o -name \"unattended.xml\" -o -name \"secrets.ldb\" -o -name \"*_history*\" -o -name \"unattend.xml\" -o -name \"*.keytab\" -o -name \".roadtools_auth\" -o -name \".profile\" -o -name \"docker-compose.yml\" -o -name \"iis6.log\" -o -name \".flyrc\" -o -name \"web*.config\" -o -name \"psk.txt\" -o -name \"authorized_keys\" -o -name \".bashrc\" -o -name \"log4j-core*.jar\" -o -name \"*.gpg\" -o -name \"sip.conf\" -o -name \"bootstrap-kubelet.conf\" -o -name \"crio.sock\" -o -name \"000-default.conf\" -o -name \"redis.conf\" -o -name \"*.pgp\" -o -name \".pypirc\" -o -name \".git-credentials\" -o -name \"dockershim.sock\" -o -name \"hosts.equiv\" -o -name \"*.rdg\" -o -name \"database.php\" -o -name \"config.php\" -o -name \".msmtprc\" -o -name \"admin.conf\" -o -name \"unattend.txt\" -o -name \"plum.sqlite\" -o -name \"tomcat-users.xml\" -o -name \"sitemanager.xml\" -o -name \".plan\" -o -name \"pgadmin4.db\" -o -name \"winscp.ini\" -o -name \"*.viminfo\" -o -name \"known_hosts\" -o -name \"passwd.ibd\" -o -name \"clouds.config\" -o -name \"sslkeylog.log\" -o -name \"Elastix.conf\" -o -name \"Ntds.dit\" -o -name \"groups.xml\" -o -name \"private-keys-v1.d/*.key\" -o -name \"containerd.sock\" -o -name \"*.keyring\" -o -name \"mosquitto.conf\" -o -name \"environment\" -o -name \"webserver_config.py\" -o -name \"creds*\" -o -name \"printers.xml\" -o -name \"*.pcapng\" -o -name \"influxdb.conf\" -o -name \"ftp.config\" -o -name \"*.crt\" -o -name \".wgetrc\" -o -name \"scheduledtasks.xml\" -o -name \"crontab.db\" -o -name \"ntuser.dat\" -o -name \"*.asc\" -o -name \"access_tokens.db\" -o -name \"elasticsearch.y*ml\" -o -name \"vsftpd.conf\" -o -name \"airflow.cfg\" -o -name \"server.xml\" -o -name \".mylogin.cnf\" -o -name \".pgpass\" -o -name \".erlang.cookie\" -o -name \"ddclient.conf\" -o -name \"php.ini\" -o -name \"racoon.conf\" -o -name \"index.dat\" -o -name \"*.tf\" -o -name \"snyk.json\" -o -name \".credentials.json\" -o -name \"azureProfile.json\" -o -name \"legacy_credentials.db\" -o -name \"*.vhdx\" -o -name \"*.pub\" -o -name \"*.ovpn\" -o -name \"*.keystore\" -o -name \"*.cer\" -o -name \"secret.asc\" -o -name \"gitlab.rm\" -o -name \"*vnc*.c*nf*\" -o -name \"db.php\" -o -name \".ldaprc\" -o -name \"*credential*\" -o -name \"atlantis.db\" -o -name \"*config*.php\" -o -name \"rsyncd.conf\" -o -name \"accessTokens.json\" -o -name \".mcp.json\" -o -name \"apt.conf\" -o -name \"postgresql.conf\" -o -name \"fat.config\" -o -name \"pgsql.conf\" -o -name \"SecEvent.Evt\" -o -name \"keys.log\" -o -name \"ipsec.conf\" -o -name \"debian.cnf\" -o -name \"error.log\" -o -name \"*.key\" -o -name \".Xauthority\" -o -name \"rktlet.sock\" -o -name \"SYSTEM\" -o -name \"NetSetup.log\" -o -name \"*.service\" -o -name \"gpg-agent.conf\" -o -name \"KeePass.config*\" -o -name \"cesi.conf\" -o -name \"glusterfs.ca\" -o -name \"wsl.exe\" -o -name \"gitlab.yml\" -o -name \"zabbix_server.conf\" -o -name \"bitcoin.conf\" -o -name \"pgadmin*.db\" -o -name \"*vnc*.ini\" -o -name \"sssd.conf\" -o -name \"cloud.cfg\" -o -name \"ConsoleHost_history.txt\" -o -name \"setupinfo\" -o -name \".sudo_as_admin_successful\" -o -name \"*.maintenance*\" -o -name \"https-xampp.conf\" -o -name \"*.gnupg\" -o -name \"drives.xml\" -o -name \".recently-used.xbel\" -o -name \"appcmd.exe\" -o -name \"RDCMan.settings\" -o -name \"service_principal_entries.bin\" -o -name \"unattend.inf\" -o -name \"KeePass.ini\" -o -name \".lesshst\" -o -name \"Dockerfile\" -o -name \"KeePass.enforced*\" -o -name \".boto\" -o -name \"mysqld.cnf\" -o -name \"*.der\" -o -name \"adc.json\" -o -name \"rocketchat.service\" -o -name \"rsyncd.secrets\" -o -name \"autologin.conf\" -o -name \"autounattend.xml\" -o -name \"passwd\" -o -name \"master.key\" -o -name \"autologin\" -o -name \"*.swp\" -o -name \"FreeSSHDservice.ini\" -o -name \"default.sav\" -o -name \"credentials.db\" -o -name \"sites.ini\" -o -name \"my.cnf\" -o -name \"grafana.ini\" -o -name \"my.ini\" -o -name \"filezilla.xml\" -o -name \"ws_ftp.ini\" -o -name \"ffftp.ini\" -o -name \"wcx_ftp.ini\" -o -name \"*.timer\" -o -name \".htpasswd\" -o -name \"kcpassword\" -o -name \"nginx.conf\" -o -name \"AppEvent.Evt\" -o -name \"datasources.xml\" -o -name \"*.psk\" -o -name \"sysprep.xml\" -o -name \"*.sqlite3\" -o -name \"secring.gpg\" -o -name \"jetty-realm.properties\" -o -name \"frakti.sock\" -o -name \"config.xml\" -o -name \"*.sqlite\" -o -name \"credentials.tfrc.json\" -o -name \"*.csr\" -o -name \"*.jks\" -o -name \"sentry.conf.py\" -o -name \"state.vscdb.backup\" -o -name \"kadm5.acl\" -o -name \".vault-token\" -o -name \"credentials.xml\" -o -name \"ipsec.secrets\" -o -name \"fastcgi_params\" -o -name \"password*.ibd\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_PRIVATE=`eval_bckgrd "find ${ROOT_FOLDER}private -name \"krb5.conf\" -o -name \"mariadb.cnf\" -o -name \"AzureRMContext.json\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.p12\" -o -name \"FreePBX.conf\" -o -name \"trustdb.gpg\" -o -name \"software.sav\" -o -name \"backups\" -o -name \"passbolt.php\" -o -name \"*.pem\" -o -name \"snmpd.conf\" -o -name \".env*\" -o -name \"sysprep.inf\" -o -name \"pg_hba.conf\" -o -name \"storage.php\" -o -name \"*kubeconfig*\" -o -name \"amportal.conf\" -o -name \"*.vhd\" -o -name \"kubelet.conf\" -o -name \"*.ftpconfig\" -o -name \"hudson.util.Secret\" -o -name \"snyk.config.json\" -o -name \"smb.conf\" -o -name \"hostapd.conf\" -o -name \"*.db\" -o -name \"backup\" -o -name \"*.socket\" -o -name \"authorized_hosts\" -o -name \"id_rsa*\" -o -name \".claude.json\" -o -name \"storage.json\" -o -name \"glusterfs.key\" -o -name \".git\" -o -name \"kibana.y*ml\" -o -name \"TokenCache.dat\" -o -name \"scclient.exe\" -o -name \"msal_http_cache.bin\" -o -name \"recentservers.xml\" -o -name \"ftp.ini\" -o -name \".secrets.mkey\" -o -name \"supervisord.conf\" -o -name \"mongod*.conf\" -o -name \"api_key\" -o -name \"wp-config.php\" -o -name \"firebase-tools.json\" -o -name \"msal_token_cache.bin\" -o -name \"secrets.yml\" -o -name \"httpd.conf\" -o -name \"*.tfstate\" -o -name \"*.pfx\" -o -name \"docker.sock\" -o -name \".github\" -o -name \"*vnc*.txt\" -o -name \"access_tokens.json\" -o -name \"service_principal_entries.json\" -o -name \"rpcd\" -o -name \"gvm-tools.conf\" -o -name \"system.sav\" -o -name \".google_authenticator\" -o -name \"pwd.ibd\" -o -name \"*.kdbx\" -o -name \"anaconda-ks.cfg\" -o -name \".gitconfig\" -o -name \"pubring.kbx\" -o -name \"*.vmdk\" -o -name \"settings.php\" -o -name \"docker.socket\" -o -name \"bash.exe\" -o -name \".k5login\" -o -name \"glusterfs.pem\" -o -name \"*.pcap\" -o -name \".rhosts\" -o -name \"security.sav\" -o -name \"id_dsa*\" -o -name \"*vnc*.xml\" -o -name \"krb5cc_*\" -o -name \"msal_token_cache.json\" -o -name \"state.vscdb\" -o -name \"zabbix_agentd.conf\" -o -name \"setupinfo.bak\" -o -name \"software\" -o -name \"protecteduserkey.bin\" -o -name \"crontab-ui.service\" -o -name \"SAM\" -o -name \"https.conf\" -o -name \"pagefile.sys\" -o -name \"aliases\" -o -name \"*password*\" -o -name \"access.log\" -o -name \"unattended.xml\" -o -name \"secrets.ldb\" -o -name \"*_history*\" -o -name \"unattend.xml\" -o -name \"*.keytab\" -o -name \".roadtools_auth\" -o -name \".profile\" -o -name \"docker-compose.yml\" -o -name \"iis6.log\" -o -name \".flyrc\" -o -name \"web*.config\" -o -name \"psk.txt\" -o -name \"authorized_keys\" -o -name \".bashrc\" -o -name \"log4j-core*.jar\" -o -name \"*.gpg\" -o -name \"sip.conf\" -o -name \"bootstrap-kubelet.conf\" -o -name \"crio.sock\" -o -name \"000-default.conf\" -o -name \"redis.conf\" -o -name \"*.pgp\" -o -name \".pypirc\" -o -name \".git-credentials\" -o -name \"dockershim.sock\" -o -name \"hosts.equiv\" -o -name \"*.rdg\" -o -name \"database.php\" -o -name \"config.php\" -o -name \".msmtprc\" -o -name \"admin.conf\" -o -name \"unattend.txt\" -o -name \"plum.sqlite\" -o -name \"tomcat-users.xml\" -o -name \"sitemanager.xml\" -o -name \".plan\" -o -name \"pgadmin4.db\" -o -name \"winscp.ini\" -o -name \"*.viminfo\" -o -name \"known_hosts\" -o -name \"passwd.ibd\" -o -name \"clouds.config\" -o -name \"sslkeylog.log\" -o -name \"Elastix.conf\" -o -name \"Ntds.dit\" -o -name \"groups.xml\" -o -name \"private-keys-v1.d/*.key\" -o -name \"containerd.sock\" -o -name \"*.keyring\" -o -name \"mosquitto.conf\" -o -name \"environment\" -o -name \"webserver_config.py\" -o -name \"creds*\" -o -name \"printers.xml\" -o -name \"*.pcapng\" -o -name \"influxdb.conf\" -o -name \"ftp.config\" -o -name \"*.crt\" -o -name \".wgetrc\" -o -name \"scheduledtasks.xml\" -o -name \"crontab.db\" -o -name \"ntuser.dat\" -o -name \"*.asc\" -o -name \"access_tokens.db\" -o -name \"elasticsearch.y*ml\" -o -name \"vsftpd.conf\" -o -name \"airflow.cfg\" -o -name \"server.xml\" -o -name \".mylogin.cnf\" -o -name \".pgpass\" -o -name \"sess_*\" -o -name \".erlang.cookie\" -o -name \"ddclient.conf\" -o -name \"php.ini\" -o -name \"racoon.conf\" -o -name \"index.dat\" -o -name \"*.tf\" -o -name \"snyk.json\" -o -name \".credentials.json\" -o -name \"azureProfile.json\" -o -name \"legacy_credentials.db\" -o -name \"*.vhdx\" -o -name \"*.pub\" -o -name \"*.ovpn\" -o -name \"*.keystore\" -o -name \"*.cer\" -o -name \"secret.asc\" -o -name \"gitlab.rm\" -o -name \"*vnc*.c*nf*\" -o -name \"db.php\" -o -name \".ldaprc\" -o -name \"*credential*\" -o -name \"atlantis.db\" -o -name \"*config*.php\" -o -name \"rsyncd.conf\" -o -name \"accessTokens.json\" -o -name \".mcp.json\" -o -name \"apt.conf\" -o -name \"postgresql.conf\" -o -name \"fat.config\" -o -name \"pgsql.conf\" -o -name \"SecEvent.Evt\" -o -name \"keys.log\" -o -name \"ipsec.conf\" -o -name \"debian.cnf\" -o -name \"error.log\" -o -name \"*.key\" -o -name \".Xauthority\" -o -name \"rktlet.sock\" -o -name \"SYSTEM\" -o -name \"NetSetup.log\" -o -name \"*.service\" -o -name \"gpg-agent.conf\" -o -name \"KeePass.config*\" -o -name \"cesi.conf\" -o -name \"glusterfs.ca\" -o -name \"wsl.exe\" -o -name \"gitlab.yml\" -o -name \"zabbix_server.conf\" -o -name \"bitcoin.conf\" -o -name \"pgadmin*.db\" -o -name \"*vnc*.ini\" -o -name \"sssd.conf\" -o -name \"cloud.cfg\" -o -name \"ConsoleHost_history.txt\" -o -name \"setupinfo\" -o -name \".sudo_as_admin_successful\" -o -name \"*.maintenance*\" -o -name \"https-xampp.conf\" -o -name \"*.gnupg\" -o -name \"drives.xml\" -o -name \".recently-used.xbel\" -o -name \"appcmd.exe\" -o -name \"RDCMan.settings\" -o -name \"service_principal_entries.bin\" -o -name \"unattend.inf\" -o -name \"KeePass.ini\" -o -name \".lesshst\" -o -name \"Dockerfile\" -o -name \"KeePass.enforced*\" -o -name \"mysqld.cnf\" -o -name \"*.der\" -o -name \".boto\" -o -name \"adc.json\" -o -name \"rocketchat.service\" -o -name \"rsyncd.secrets\" -o -name \"autologin.conf\" -o -name \"autounattend.xml\" -o -name \"passwd\" -o -name \"master.key\" -o -name \"autologin\" -o -name \"*.swp\" -o -name \"FreeSSHDservice.ini\" -o -name \"default.sav\" -o -name \"credentials.db\" -o -name \"sites.ini\" -o -name \"my.cnf\" -o -name \"grafana.ini\" -o -name \"my.ini\" -o -name \"filezilla.xml\" -o -name \"ws_ftp.ini\" -o -name \"ffftp.ini\" -o -name \"wcx_ftp.ini\" -o -name \"*.timer\" -o -name \".htpasswd\" -o -name \"kcpassword\" -o -name \"nginx.conf\" -o -name \"AppEvent.Evt\" -o -name \"datasources.xml\" -o -name \"*.psk\" -o -name \"sysprep.xml\" -o -name \"*.sqlite3\" -o -name \"secring.gpg\" -o -name \"jetty-realm.properties\" -o -name \"frakti.sock\" -o -name \"config.xml\" -o -name \"*.sqlite\" -o -name \"credentials.tfrc.json\" -o -name \"*.csr\" -o -name \"*.jks\" -o -name \"sentry.conf.py\" -o -name \"state.vscdb.backup\" -o -name \"kadm5.acl\" -o -name \".vault-token\" -o -name \"credentials.xml\" -o -name \"ipsec.secrets\" -o -name \"fastcgi_params\" -o -name \"password*.ibd\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_RUN=`eval_bckgrd "find ${ROOT_FOLDER}run -name \"ssh-agent.sock\" -o -name \"agent.*\" -o -name \"*.socket\" -o -name \"*.timer\" -o -name \"*.service\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SBIN=`eval_bckgrd "find ${ROOT_FOLDER}sbin -name \"krb5.conf\" -o -name \"mariadb.cnf\" -o -name \"AzureRMContext.json\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.p12\" -o -name \"FreePBX.conf\" -o -name \"trustdb.gpg\" -o -name \"software.sav\" -o -name \"backups\" -o -name \"passbolt.php\" -o -name \"*.pem\" -o -name \"snmpd.conf\" -o -name \".env*\" -o -name \"sysprep.inf\" -o -name \"pg_hba.conf\" -o -name \"storage.php\" -o -name \"*kubeconfig*\" -o -name \"amportal.conf\" -o -name \"*.vhd\" -o -name \"kubelet.conf\" -o -name \"*.ftpconfig\" -o -name \"hudson.util.Secret\" -o -name \"snyk.config.json\" -o -name \"smb.conf\" -o -name \"hostapd.conf\" -o -name \"*.db\" -o -name \"backup\" -o -name \"*.socket\" -o -name \"authorized_hosts\" -o -name \"id_rsa*\" -o -name \".claude.json\" -o -name \"storage.json\" -o -name \"glusterfs.key\" -o -name \".git\" -o -name \"kibana.y*ml\" -o -name \"TokenCache.dat\" -o -name \"scclient.exe\" -o -name \"msal_http_cache.bin\" -o -name \"recentservers.xml\" -o -name \"ftp.ini\" -o -name \".secrets.mkey\" -o -name \"supervisord.conf\" -o -name \"mongod*.conf\" -o -name \"api_key\" -o -name \"wp-config.php\" -o -name \"firebase-tools.json\" -o -name \"msal_token_cache.bin\" -o -name \"secrets.yml\" -o -name \"httpd.conf\" -o -name \"*.tfstate\" -o -name \"*.pfx\" -o -name \"docker.sock\" -o -name \".github\" -o -name \"*vnc*.txt\" -o -name \"access_tokens.json\" -o -name \"service_principal_entries.json\" -o -name \"rpcd\" -o -name \"gvm-tools.conf\" -o -name \"system.sav\" -o -name \".google_authenticator\" -o -name \"pwd.ibd\" -o -name \"*.kdbx\" -o -name \"anaconda-ks.cfg\" -o -name \".gitconfig\" -o -name \"pubring.kbx\" -o -name \"*.vmdk\" -o -name \"settings.php\" -o -name \"docker.socket\" -o -name \"bash.exe\" -o -name \".k5login\" -o -name \"glusterfs.pem\" -o -name \"*.pcap\" -o -name \".rhosts\" -o -name \"security.sav\" -o -name \"id_dsa*\" -o -name \"*vnc*.xml\" -o -name \"krb5cc_*\" -o -name \"msal_token_cache.json\" -o -name \"state.vscdb\" -o -name \"zabbix_agentd.conf\" -o -name \"setupinfo.bak\" -o -name \"software\" -o -name \"protecteduserkey.bin\" -o -name \"crontab-ui.service\" -o -name \"SAM\" -o -name \"https.conf\" -o -name \"pagefile.sys\" -o -name \"aliases\" -o -name \"*password*\" -o -name \"access.log\" -o -name \"unattended.xml\" -o -name \"secrets.ldb\" -o -name \"*_history*\" -o -name \"unattend.xml\" -o -name \"*.keytab\" -o -name \".roadtools_auth\" -o -name \".profile\" -o -name \"docker-compose.yml\" -o -name \"iis6.log\" -o -name \".flyrc\" -o -name \"web*.config\" -o -name \"psk.txt\" -o -name \"authorized_keys\" -o -name \".bashrc\" -o -name \"log4j-core*.jar\" -o -name \"*.gpg\" -o -name \"sip.conf\" -o -name \"bootstrap-kubelet.conf\" -o -name \"crio.sock\" -o -name \"000-default.conf\" -o -name \"redis.conf\" -o -name \"*.pgp\" -o -name \".pypirc\" -o -name \".git-credentials\" -o -name \"dockershim.sock\" -o -name \"hosts.equiv\" -o -name \"*.rdg\" -o -name \"database.php\" -o -name \"config.php\" -o -name \".msmtprc\" -o -name \"admin.conf\" -o -name \"unattend.txt\" -o -name \"plum.sqlite\" -o -name \"tomcat-users.xml\" -o -name \"sitemanager.xml\" -o -name \".plan\" -o -name \"pgadmin4.db\" -o -name \"winscp.ini\" -o -name \"*.viminfo\" -o -name \"known_hosts\" -o -name \"passwd.ibd\" -o -name \"clouds.config\" -o -name \"sslkeylog.log\" -o -name \"Elastix.conf\" -o -name \"Ntds.dit\" -o -name \"groups.xml\" -o -name \"private-keys-v1.d/*.key\" -o -name \"containerd.sock\" -o -name \"*.keyring\" -o -name \"mosquitto.conf\" -o -name \"environment\" -o -name \"webserver_config.py\" -o -name \"creds*\" -o -name \"printers.xml\" -o -name \"*.pcapng\" -o -name \"influxdb.conf\" -o -name \"ftp.config\" -o -name \"*.crt\" -o -name \".wgetrc\" -o -name \"scheduledtasks.xml\" -o -name \"crontab.db\" -o -name \"ntuser.dat\" -o -name \"*.asc\" -o -name \"access_tokens.db\" -o -name \"elasticsearch.y*ml\" -o -name \"vsftpd.conf\" -o -name \"airflow.cfg\" -o -name \"server.xml\" -o -name \".mylogin.cnf\" -o -name \".pgpass\" -o -name \".erlang.cookie\" -o -name \"ddclient.conf\" -o -name \"php.ini\" -o -name \"racoon.conf\" -o -name \"index.dat\" -o -name \"*.tf\" -o -name \"snyk.json\" -o -name \".credentials.json\" -o -name \"azureProfile.json\" -o -name \"legacy_credentials.db\" -o -name \"*.vhdx\" -o -name \"*.pub\" -o -name \"*.ovpn\" -o -name \"*.keystore\" -o -name \"*.cer\" -o -name \"secret.asc\" -o -name \"gitlab.rm\" -o -name \"*vnc*.c*nf*\" -o -name \"db.php\" -o -name \".ldaprc\" -o -name \"*credential*\" -o -name \"atlantis.db\" -o -name \"*config*.php\" -o -name \"rsyncd.conf\" -o -name \"accessTokens.json\" -o -name \".mcp.json\" -o -name \"apt.conf\" -o -name \"postgresql.conf\" -o -name \"fat.config\" -o -name \"pgsql.conf\" -o -name \"SecEvent.Evt\" -o -name \"keys.log\" -o -name \"ipsec.conf\" -o -name \"debian.cnf\" -o -name \"error.log\" -o -name \"*.key\" -o -name \".Xauthority\" -o -name \"rktlet.sock\" -o -name \"SYSTEM\" -o -name \"NetSetup.log\" -o -name \"*.service\" -o -name \"gpg-agent.conf\" -o -name \"KeePass.config*\" -o -name \"cesi.conf\" -o -name \"glusterfs.ca\" -o -name \"wsl.exe\" -o -name \"gitlab.yml\" -o -name \"zabbix_server.conf\" -o -name \"bitcoin.conf\" -o -name \"pgadmin*.db\" -o -name \"*vnc*.ini\" -o -name \"sssd.conf\" -o -name \"cloud.cfg\" -o -name \"ConsoleHost_history.txt\" -o -name \"setupinfo\" -o -name \".sudo_as_admin_successful\" -o -name \"*.maintenance*\" -o -name \"https-xampp.conf\" -o -name \"*.gnupg\" -o -name \"drives.xml\" -o -name \".recently-used.xbel\" -o -name \"appcmd.exe\" -o -name \"RDCMan.settings\" -o -name \"service_principal_entries.bin\" -o -name \"unattend.inf\" -o -name \"KeePass.ini\" -o -name \".lesshst\" -o -name \"Dockerfile\" -o -name \"KeePass.enforced*\" -o -name \".boto\" -o -name \"mysqld.cnf\" -o -name \"*.der\" -o -name \"adc.json\" -o -name \"rocketchat.service\" -o -name \"rsyncd.secrets\" -o -name \"autologin.conf\" -o -name \"autounattend.xml\" -o -name \"passwd\" -o -name \"master.key\" -o -name \"autologin\" -o -name \"*.swp\" -o -name \"FreeSSHDservice.ini\" -o -name \"default.sav\" -o -name \"credentials.db\" -o -name \"sites.ini\" -o -name \"my.cnf\" -o -name \"grafana.ini\" -o -name \"my.ini\" -o -name \"filezilla.xml\" -o -name \"ws_ftp.ini\" -o -name \"ffftp.ini\" -o -name \"wcx_ftp.ini\" -o -name \"*.timer\" -o -name \".htpasswd\" -o -name \"kcpassword\" -o -name \"nginx.conf\" -o -name \"AppEvent.Evt\" -o -name \"datasources.xml\" -o -name \"*.psk\" -o -name \"sysprep.xml\" -o -name \"*.sqlite3\" -o -name \"secring.gpg\" -o -name \"jetty-realm.properties\" -o -name \"frakti.sock\" -o -name \"config.xml\" -o -name \"*.sqlite\" -o -name \"credentials.tfrc.json\" -o -name \"*.csr\" -o -name \"*.jks\" -o -name \"sentry.conf.py\" -o -name \"state.vscdb.backup\" -o -name \"kadm5.acl\" -o -name \".vault-token\" -o -name \"credentials.xml\" -o -name \"ipsec.secrets\" -o -name \"fastcgi_params\" -o -name \"password*.ibd\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SNAP=`eval_bckgrd "find ${ROOT_FOLDER}snap -name \"krb5.conf\" -o -name \"mariadb.cnf\" -o -name \"AzureRMContext.json\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.p12\" -o -name \"FreePBX.conf\" -o -name \"trustdb.gpg\" -o -name \"software.sav\" -o -name \"backups\" -o -name \"passbolt.php\" -o -name \"*.pem\" -o -name \"snmpd.conf\" -o -name \".env*\" -o -name \"sysprep.inf\" -o -name \"pg_hba.conf\" -o -name \"storage.php\" -o -name \"*kubeconfig*\" -o -name \"amportal.conf\" -o -name \"*.vhd\" -o -name \"kubelet.conf\" -o -name \"*.ftpconfig\" -o -name \"hudson.util.Secret\" -o -name \"snyk.config.json\" -o -name \"smb.conf\" -o -name \"hostapd.conf\" -o -name \"*.db\" -o -name \"backup\" -o -name \"*.socket\" -o -name \"authorized_hosts\" -o -name \"id_rsa*\" -o -name \".claude.json\" -o -name \"storage.json\" -o -name \"glusterfs.key\" -o -name \".git\" -o -name \"kibana.y*ml\" -o -name \"TokenCache.dat\" -o -name \"scclient.exe\" -o -name \"msal_http_cache.bin\" -o -name \"recentservers.xml\" -o -name \"ftp.ini\" -o -name \".secrets.mkey\" -o -name \"supervisord.conf\" -o -name \"mongod*.conf\" -o -name \"api_key\" -o -name \"wp-config.php\" -o -name \"firebase-tools.json\" -o -name \"msal_token_cache.bin\" -o -name \"secrets.yml\" -o -name \"httpd.conf\" -o -name \"*.tfstate\" -o -name \"*.pfx\" -o -name \"docker.sock\" -o -name \".github\" -o -name \"*vnc*.txt\" -o -name \"access_tokens.json\" -o -name \"service_principal_entries.json\" -o -name \"rpcd\" -o -name \"gvm-tools.conf\" -o -name \"system.sav\" -o -name \".google_authenticator\" -o -name \"pwd.ibd\" -o -name \"*.kdbx\" -o -name \"anaconda-ks.cfg\" -o -name \".gitconfig\" -o -name \"pubring.kbx\" -o -name \"*.vmdk\" -o -name \"settings.php\" -o -name \"docker.socket\" -o -name \"bash.exe\" -o -name \".k5login\" -o -name \"glusterfs.pem\" -o -name \"*.pcap\" -o -name \".rhosts\" -o -name \"security.sav\" -o -name \"id_dsa*\" -o -name \"*vnc*.xml\" -o -name \"krb5cc_*\" -o -name \"msal_token_cache.json\" -o -name \"state.vscdb\" -o -name \"zabbix_agentd.conf\" -o -name \"setupinfo.bak\" -o -name \"software\" -o -name \"protecteduserkey.bin\" -o -name \"crontab-ui.service\" -o -name \"SAM\" -o -name \"https.conf\" -o -name \"pagefile.sys\" -o -name \"aliases\" -o -name \"*password*\" -o -name \"access.log\" -o -name \"unattended.xml\" -o -name \"secrets.ldb\" -o -name \"*_history*\" -o -name \"unattend.xml\" -o -name \"*.keytab\" -o -name \".roadtools_auth\" -o -name \".profile\" -o -name \"docker-compose.yml\" -o -name \"iis6.log\" -o -name \".flyrc\" -o -name \"web*.config\" -o -name \"psk.txt\" -o -name \"authorized_keys\" -o -name \".bashrc\" -o -name \"log4j-core*.jar\" -o -name \"*.gpg\" -o -name \"sip.conf\" -o -name \"bootstrap-kubelet.conf\" -o -name \"crio.sock\" -o -name \"000-default.conf\" -o -name \"redis.conf\" -o -name \"*.pgp\" -o -name \".pypirc\" -o -name \".git-credentials\" -o -name \"dockershim.sock\" -o -name \"hosts.equiv\" -o -name \"*.rdg\" -o -name \"database.php\" -o -name \"config.php\" -o -name \".msmtprc\" -o -name \"admin.conf\" -o -name \"unattend.txt\" -o -name \"plum.sqlite\" -o -name \"tomcat-users.xml\" -o -name \"sitemanager.xml\" -o -name \".plan\" -o -name \"pgadmin4.db\" -o -name \"winscp.ini\" -o -name \"*.viminfo\" -o -name \"known_hosts\" -o -name \"passwd.ibd\" -o -name \"clouds.config\" -o -name \"sslkeylog.log\" -o -name \"Elastix.conf\" -o -name \"Ntds.dit\" -o -name \"groups.xml\" -o -name \"private-keys-v1.d/*.key\" -o -name \"containerd.sock\" -o -name \"*.keyring\" -o -name \"mosquitto.conf\" -o -name \"environment\" -o -name \"webserver_config.py\" -o -name \"creds*\" -o -name \"printers.xml\" -o -name \"*.pcapng\" -o -name \"influxdb.conf\" -o -name \"ftp.config\" -o -name \"*.crt\" -o -name \".wgetrc\" -o -name \"scheduledtasks.xml\" -o -name \"crontab.db\" -o -name \"ntuser.dat\" -o -name \"*.asc\" -o -name \"access_tokens.db\" -o -name \"elasticsearch.y*ml\" -o -name \"vsftpd.conf\" -o -name \"airflow.cfg\" -o -name \"server.xml\" -o -name \".mylogin.cnf\" -o -name \".pgpass\" -o -name \".erlang.cookie\" -o -name \"ddclient.conf\" -o -name \"php.ini\" -o -name \"racoon.conf\" -o -name \"index.dat\" -o -name \"*.tf\" -o -name \"snyk.json\" -o -name \".credentials.json\" -o -name \"azureProfile.json\" -o -name \"legacy_credentials.db\" -o -name \"*.vhdx\" -o -name \"*.pub\" -o -name \"*.ovpn\" -o -name \"*.keystore\" -o -name \"*.cer\" -o -name \"secret.asc\" -o -name \"gitlab.rm\" -o -name \"*vnc*.c*nf*\" -o -name \"db.php\" -o -name \".ldaprc\" -o -name \"*credential*\" -o -name \"atlantis.db\" -o -name \"*config*.php\" -o -name \"rsyncd.conf\" -o -name \"accessTokens.json\" -o -name \".mcp.json\" -o -name \"apt.conf\" -o -name \"postgresql.conf\" -o -name \"fat.config\" -o -name \"pgsql.conf\" -o -name \"SecEvent.Evt\" -o -name \"keys.log\" -o -name \"ipsec.conf\" -o -name \"debian.cnf\" -o -name \"error.log\" -o -name \"*.key\" -o -name \".Xauthority\" -o -name \"rktlet.sock\" -o -name \"SYSTEM\" -o -name \"NetSetup.log\" -o -name \"*.service\" -o -name \"gpg-agent.conf\" -o -name \"KeePass.config*\" -o -name \"cesi.conf\" -o -name \"glusterfs.ca\" -o -name \"wsl.exe\" -o -name \"gitlab.yml\" -o -name \"zabbix_server.conf\" -o -name \"bitcoin.conf\" -o -name \"pgadmin*.db\" -o -name \"*vnc*.ini\" -o -name \"sssd.conf\" -o -name \"cloud.cfg\" -o -name \"ConsoleHost_history.txt\" -o -name \"setupinfo\" -o -name \".sudo_as_admin_successful\" -o -name \"*.maintenance*\" -o -name \"https-xampp.conf\" -o -name \"*.gnupg\" -o -name \"drives.xml\" -o -name \".recently-used.xbel\" -o -name \"appcmd.exe\" -o -name \"RDCMan.settings\" -o -name \"service_principal_entries.bin\" -o -name \"unattend.inf\" -o -name \"KeePass.ini\" -o -name \".lesshst\" -o -name \"Dockerfile\" -o -name \"KeePass.enforced*\" -o -name \".boto\" -o -name \"mysqld.cnf\" -o -name \"*.der\" -o -name \"adc.json\" -o -name \"rocketchat.service\" -o -name \"rsyncd.secrets\" -o -name \"autologin.conf\" -o -name \"autounattend.xml\" -o -name \"passwd\" -o -name \"master.key\" -o -name \"autologin\" -o -name \"*.swp\" -o -name \"FreeSSHDservice.ini\" -o -name \"default.sav\" -o -name \"credentials.db\" -o -name \"sites.ini\" -o -name \"my.cnf\" -o -name \"grafana.ini\" -o -name \"my.ini\" -o -name \"filezilla.xml\" -o -name \"ws_ftp.ini\" -o -name \"ffftp.ini\" -o -name \"wcx_ftp.ini\" -o -name \"*.timer\" -o -name \".htpasswd\" -o -name \"kcpassword\" -o -name \"nginx.conf\" -o -name \"AppEvent.Evt\" -o -name \"datasources.xml\" -o -name \"*.psk\" -o -name \"sysprep.xml\" -o -name \"*.sqlite3\" -o -name \"secring.gpg\" -o -name \"jetty-realm.properties\" -o -name \"frakti.sock\" -o -name \"config.xml\" -o -name \"*.sqlite\" -o -name \"credentials.tfrc.json\" -o -name \"*.csr\" -o -name \"*.jks\" -o -name \"sentry.conf.py\" -o -name \"state.vscdb.backup\" -o -name \"kadm5.acl\" -o -name \".vault-token\" -o -name \"credentials.xml\" -o -name \"ipsec.secrets\" -o -name \"fastcgi_params\" -o -name \"password*.ibd\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SRV=`eval_bckgrd "find ${ROOT_FOLDER}srv -name \"krb5.conf\" -o -name \"mariadb.cnf\" -o -name \"AzureRMContext.json\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.p12\" -o -name \"FreePBX.conf\" -o -name \"trustdb.gpg\" -o -name \"software.sav\" -o -name \"backups\" -o -name \"passbolt.php\" -o -name \"*.pem\" -o -name \"snmpd.conf\" -o -name \".env*\" -o -name \"sysprep.inf\" -o -name \"pg_hba.conf\" -o -name \"storage.php\" -o -name \"*kubeconfig*\" -o -name \"amportal.conf\" -o -name \"*.vhd\" -o -name \"kubelet.conf\" -o -name \"*.ftpconfig\" -o -name \"hudson.util.Secret\" -o -name \"snyk.config.json\" -o -name \"smb.conf\" -o -name \"hostapd.conf\" -o -name \"*.db\" -o -name \"backup\" -o -name \"*.socket\" -o -name \"authorized_hosts\" -o -name \"id_rsa*\" -o -name \".claude.json\" -o -name \"storage.json\" -o -name \"glusterfs.key\" -o -name \".git\" -o -name \"kibana.y*ml\" -o -name \"TokenCache.dat\" -o -name \"scclient.exe\" -o -name \"msal_http_cache.bin\" -o -name \"recentservers.xml\" -o -name \"ftp.ini\" -o -name \".secrets.mkey\" -o -name \"supervisord.conf\" -o -name \"mongod*.conf\" -o -name \"api_key\" -o -name \"wp-config.php\" -o -name \"firebase-tools.json\" -o -name \"msal_token_cache.bin\" -o -name \"secrets.yml\" -o -name \"httpd.conf\" -o -name \"*.tfstate\" -o -name \"*.pfx\" -o -name \"docker.sock\" -o -name \".github\" -o -name \"*vnc*.txt\" -o -name \"access_tokens.json\" -o -name \"service_principal_entries.json\" -o -name \"rpcd\" -o -name \"gvm-tools.conf\" -o -name \"system.sav\" -o -name \".google_authenticator\" -o -name \"pwd.ibd\" -o -name \"*.kdbx\" -o -name \"anaconda-ks.cfg\" -o -name \".gitconfig\" -o -name \"pubring.kbx\" -o -name \"*.vmdk\" -o -name \"settings.php\" -o -name \"docker.socket\" -o -name \"bash.exe\" -o -name \".k5login\" -o -name \"glusterfs.pem\" -o -name \"*.pcap\" -o -name \".rhosts\" -o -name \"security.sav\" -o -name \"id_dsa*\" -o -name \"*vnc*.xml\" -o -name \"krb5cc_*\" -o -name \"msal_token_cache.json\" -o -name \"state.vscdb\" -o -name \"zabbix_agentd.conf\" -o -name \"setupinfo.bak\" -o -name \"software\" -o -name \"protecteduserkey.bin\" -o -name \"crontab-ui.service\" -o -name \"SAM\" -o -name \"https.conf\" -o -name \"pagefile.sys\" -o -name \"aliases\" -o -name \"*password*\" -o -name \"access.log\" -o -name \"unattended.xml\" -o -name \"secrets.ldb\" -o -name \"*_history*\" -o -name \"unattend.xml\" -o -name \"*.keytab\" -o -name \".roadtools_auth\" -o -name \".profile\" -o -name \"docker-compose.yml\" -o -name \"iis6.log\" -o -name \".flyrc\" -o -name \"web*.config\" -o -name \"psk.txt\" -o -name \"authorized_keys\" -o -name \".bashrc\" -o -name \"log4j-core*.jar\" -o -name \"*.gpg\" -o -name \"sip.conf\" -o -name \"bootstrap-kubelet.conf\" -o -name \"crio.sock\" -o -name \"000-default.conf\" -o -name \"redis.conf\" -o -name \"*.pgp\" -o -name \".pypirc\" -o -name \".git-credentials\" -o -name \"dockershim.sock\" -o -name \"hosts.equiv\" -o -name \"*.rdg\" -o -name \"database.php\" -o -name \"config.php\" -o -name \".msmtprc\" -o -name \"admin.conf\" -o -name \"unattend.txt\" -o -name \"plum.sqlite\" -o -name \"tomcat-users.xml\" -o -name \"sitemanager.xml\" -o -name \".plan\" -o -name \"pgadmin4.db\" -o -name \"winscp.ini\" -o -name \"*.viminfo\" -o -name \"known_hosts\" -o -name \"passwd.ibd\" -o -name \"clouds.config\" -o -name \"sslkeylog.log\" -o -name \"Elastix.conf\" -o -name \"Ntds.dit\" -o -name \"groups.xml\" -o -name \"private-keys-v1.d/*.key\" -o -name \"containerd.sock\" -o -name \"*.keyring\" -o -name \"mosquitto.conf\" -o -name \"environment\" -o -name \"webserver_config.py\" -o -name \"creds*\" -o -name \"printers.xml\" -o -name \"*.pcapng\" -o -name \"influxdb.conf\" -o -name \"ftp.config\" -o -name \"*.crt\" -o -name \".wgetrc\" -o -name \"scheduledtasks.xml\" -o -name \"crontab.db\" -o -name \"ntuser.dat\" -o -name \"*.asc\" -o -name \"access_tokens.db\" -o -name \"elasticsearch.y*ml\" -o -name \"vsftpd.conf\" -o -name \"airflow.cfg\" -o -name \"server.xml\" -o -name \".mylogin.cnf\" -o -name \".pgpass\" -o -name \".erlang.cookie\" -o -name \"ddclient.conf\" -o -name \"php.ini\" -o -name \"racoon.conf\" -o -name \"index.dat\" -o -name \"*.tf\" -o -name \"snyk.json\" -o -name \".credentials.json\" -o -name \"azureProfile.json\" -o -name \"legacy_credentials.db\" -o -name \"*.vhdx\" -o -name \"*.pub\" -o -name \"*.ovpn\" -o -name \"*.keystore\" -o -name \"*.cer\" -o -name \"secret.asc\" -o -name \"gitlab.rm\" -o -name \"*vnc*.c*nf*\" -o -name \"db.php\" -o -name \".ldaprc\" -o -name \"*credential*\" -o -name \"atlantis.db\" -o -name \"*config*.php\" -o -name \"rsyncd.conf\" -o -name \"accessTokens.json\" -o -name \".mcp.json\" -o -name \"apt.conf\" -o -name \"postgresql.conf\" -o -name \"fat.config\" -o -name \"pgsql.conf\" -o -name \"SecEvent.Evt\" -o -name \"keys.log\" -o -name \"ipsec.conf\" -o -name \"debian.cnf\" -o -name \"error.log\" -o -name \"*.key\" -o -name \".Xauthority\" -o -name \"rktlet.sock\" -o -name \"SYSTEM\" -o -name \"NetSetup.log\" -o -name \"*.service\" -o -name \"gpg-agent.conf\" -o -name \"KeePass.config*\" -o -name \"cesi.conf\" -o -name \"glusterfs.ca\" -o -name \"wsl.exe\" -o -name \"gitlab.yml\" -o -name \"zabbix_server.conf\" -o -name \"bitcoin.conf\" -o -name \"pgadmin*.db\" -o -name \"*vnc*.ini\" -o -name \"sssd.conf\" -o -name \"cloud.cfg\" -o -name \"ConsoleHost_history.txt\" -o -name \"setupinfo\" -o -name \".sudo_as_admin_successful\" -o -name \"*.maintenance*\" -o -name \"https-xampp.conf\" -o -name \"*.gnupg\" -o -name \"drives.xml\" -o -name \".recently-used.xbel\" -o -name \"appcmd.exe\" -o -name \"RDCMan.settings\" -o -name \"service_principal_entries.bin\" -o -name \"unattend.inf\" -o -name \"KeePass.ini\" -o -name \".lesshst\" -o -name \"Dockerfile\" -o -name \"KeePass.enforced*\" -o -name \".boto\" -o -name \"mysqld.cnf\" -o -name \"*.der\" -o -name \"adc.json\" -o -name \"rocketchat.service\" -o -name \"rsyncd.secrets\" -o -name \"autologin.conf\" -o -name \"autounattend.xml\" -o -name \"passwd\" -o -name \"master.key\" -o -name \"autologin\" -o -name \"*.swp\" -o -name \"FreeSSHDservice.ini\" -o -name \"default.sav\" -o -name \"credentials.db\" -o -name \"sites.ini\" -o -name \"my.cnf\" -o -name \"grafana.ini\" -o -name \"my.ini\" -o -name \"filezilla.xml\" -o -name \"ws_ftp.ini\" -o -name \"ffftp.ini\" -o -name \"wcx_ftp.ini\" -o -name \"*.timer\" -o -name \".htpasswd\" -o -name \"kcpassword\" -o -name \"nginx.conf\" -o -name \"AppEvent.Evt\" -o -name \"datasources.xml\" -o -name \"*.psk\" -o -name \"sysprep.xml\" -o -name \"*.sqlite3\" -o -name \"secring.gpg\" -o -name \"jetty-realm.properties\" -o -name \"frakti.sock\" -o -name \"config.xml\" -o -name \"*.sqlite\" -o -name \"credentials.tfrc.json\" -o -name \"*.csr\" -o -name \"*.jks\" -o -name \"sentry.conf.py\" -o -name \"state.vscdb.backup\" -o -name \"kadm5.acl\" -o -name \".vault-token\" -o -name \"credentials.xml\" -o -name \"ipsec.secrets\" -o -name \"fastcgi_params\" -o -name \"password*.ibd\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  FIND_TMP=`eval_bckgrd "find ${ROOT_FOLDER}tmp -name \"krb5.conf\" -o -name \"mariadb.cnf\" -o -name \"AzureRMContext.json\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.p12\" -o -name \"FreePBX.conf\" -o -name \"trustdb.gpg\" -o -name \"software.sav\" -o -name \"backups\" -o -name \"passbolt.php\" -o -name \"*.pem\" -o -name \"snmpd.conf\" -o -name \".env*\" -o -name \"sysprep.inf\" -o -name \"pg_hba.conf\" -o -name \"storage.php\" -o -name \"*kubeconfig*\" -o -name \"amportal.conf\" -o -name \"*.vhd\" -o -name \"kubelet.conf\" -o -name \"*.ftpconfig\" -o -name \"hudson.util.Secret\" -o -name \"snyk.config.json\" -o -name \"smb.conf\" -o -name \"hostapd.conf\" -o -name \"*.db\" -o -name \"backup\" -o -name \"*.socket\" -o -name \"authorized_hosts\" -o -name \"id_rsa*\" -o -name \".claude.json\" -o -name \"storage.json\" -o -name \"glusterfs.key\" -o -name \".git\" -o -name \"kibana.y*ml\" -o -name \"TokenCache.dat\" -o -name \"scclient.exe\" -o -name \"msal_http_cache.bin\" -o -name \"recentservers.xml\" -o -name \"ftp.ini\" -o -name \".secrets.mkey\" -o -name \"supervisord.conf\" -o -name \"mongod*.conf\" -o -name \"api_key\" -o -name \"wp-config.php\" -o -name \"firebase-tools.json\" -o -name \"msal_token_cache.bin\" -o -name \"secrets.yml\" -o -name \"httpd.conf\" -o -name \"*.tfstate\" -o -name \"*.pfx\" -o -name \"docker.sock\" -o -name \".github\" -o -name \"*vnc*.txt\" -o -name \"access_tokens.json\" -o -name \"service_principal_entries.json\" -o -name \"rpcd\" -o -name \"gvm-tools.conf\" -o -name \"system.sav\" -o -name \".google_authenticator\" -o -name \"pwd.ibd\" -o -name \"*.kdbx\" -o -name \"anaconda-ks.cfg\" -o -name \".gitconfig\" -o -name \"pubring.kbx\" -o -name \"*.vmdk\" -o -name \"settings.php\" -o -name \"docker.socket\" -o -name \"bash.exe\" -o -name \".k5login\" -o -name \"glusterfs.pem\" -o -name \"*.pcap\" -o -name \".rhosts\" -o -name \"security.sav\" -o -name \"id_dsa*\" -o -name \"*vnc*.xml\" -o -name \"krb5cc_*\" -o -name \"msal_token_cache.json\" -o -name \"state.vscdb\" -o -name \"zabbix_agentd.conf\" -o -name \"setupinfo.bak\" -o -name \"software\" -o -name \"protecteduserkey.bin\" -o -name \"crontab-ui.service\" -o -name \"SAM\" -o -name \"https.conf\" -o -name \"pagefile.sys\" -o -name \"aliases\" -o -name \"*password*\" -o -name \"access.log\" -o -name \"unattended.xml\" -o -name \"secrets.ldb\" -o -name \"*_history*\" -o -name \"unattend.xml\" -o -name \"*.keytab\" -o -name \".roadtools_auth\" -o -name \".profile\" -o -name \"docker-compose.yml\" -o -name \"iis6.log\" -o -name \".flyrc\" -o -name \"web*.config\" -o -name \"psk.txt\" -o -name \"authorized_keys\" -o -name \".bashrc\" -o -name \"log4j-core*.jar\" -o -name \"*.gpg\" -o -name \"sip.conf\" -o -name \"bootstrap-kubelet.conf\" -o -name \"crio.sock\" -o -name \"000-default.conf\" -o -name \"redis.conf\" -o -name \"*.pgp\" -o -name \".pypirc\" -o -name \".git-credentials\" -o -name \"dockershim.sock\" -o -name \"hosts.equiv\" -o -name \"*.rdg\" -o -name \"database.php\" -o -name \"config.php\" -o -name \".msmtprc\" -o -name \"admin.conf\" -o -name \"unattend.txt\" -o -name \"plum.sqlite\" -o -name \"tomcat-users.xml\" -o -name \"sitemanager.xml\" -o -name \".plan\" -o -name \"pgadmin4.db\" -o -name \"winscp.ini\" -o -name \"*.viminfo\" -o -name \"known_hosts\" -o -name \"passwd.ibd\" -o -name \"clouds.config\" -o -name \"sslkeylog.log\" -o -name \"Elastix.conf\" -o -name \"Ntds.dit\" -o -name \"groups.xml\" -o -name \"private-keys-v1.d/*.key\" -o -name \"containerd.sock\" -o -name \"*.keyring\" -o -name \"mosquitto.conf\" -o -name \"environment\" -o -name \"webserver_config.py\" -o -name \"creds*\" -o -name \"printers.xml\" -o -name \"*.pcapng\" -o -name \"influxdb.conf\" -o -name \"ftp.config\" -o -name \"*.crt\" -o -name \".wgetrc\" -o -name \"scheduledtasks.xml\" -o -name \"crontab.db\" -o -name \"ntuser.dat\" -o -name \"*.asc\" -o -name \"access_tokens.db\" -o -name \"elasticsearch.y*ml\" -o -name \"vsftpd.conf\" -o -name \"airflow.cfg\" -o -name \"server.xml\" -o -name \".mylogin.cnf\" -o -name \".pgpass\" -o -name \"sess_*\" -o -name \".erlang.cookie\" -o -name \"ddclient.conf\" -o -name \"php.ini\" -o -name \"racoon.conf\" -o -name \"index.dat\" -o -name \"*.tf\" -o -name \"snyk.json\" -o -name \".credentials.json\" -o -name \"azureProfile.json\" -o -name \"legacy_credentials.db\" -o -name \"*.vhdx\" -o -name \"*.pub\" -o -name \"*.ovpn\" -o -name \"*.keystore\" -o -name \"*.cer\" -o -name \"secret.asc\" -o -name \"gitlab.rm\" -o -name \"*vnc*.c*nf*\" -o -name \"db.php\" -o -name \".ldaprc\" -o -name \"*credential*\" -o -name \"atlantis.db\" -o -name \"*config*.php\" -o -name \"rsyncd.conf\" -o -name \"accessTokens.json\" -o -name \".mcp.json\" -o -name \"apt.conf\" -o -name \"ssh-agent.sock\" -o -name \"agent.*\" -o -name \"postgresql.conf\" -o -name \"fat.config\" -o -name \"pgsql.conf\" -o -name \"SecEvent.Evt\" -o -name \"keys.log\" -o -name \"ipsec.conf\" -o -name \"debian.cnf\" -o -name \"error.log\" -o -name \"*.key\" -o -name \".Xauthority\" -o -name \"rktlet.sock\" -o -name \"SYSTEM\" -o -name \"NetSetup.log\" -o -name \"*.service\" -o -name \"gpg-agent.conf\" -o -name \"KeePass.config*\" -o -name \"cesi.conf\" -o -name \"glusterfs.ca\" -o -name \"wsl.exe\" -o -name \"gitlab.yml\" -o -name \"zabbix_server.conf\" -o -name \"bitcoin.conf\" -o -name \"pgadmin*.db\" -o -name \"*vnc*.ini\" -o -name \"sssd.conf\" -o -name \"cloud.cfg\" -o -name \"ConsoleHost_history.txt\" -o -name \"setupinfo\" -o -name \".sudo_as_admin_successful\" -o -name \"*.maintenance*\" -o -name \"https-xampp.conf\" -o -name \"*.gnupg\" -o -name \"drives.xml\" -o -name \".recently-used.xbel\" -o -name \"appcmd.exe\" -o -name \"RDCMan.settings\" -o -name \"service_principal_entries.bin\" -o -name \"unattend.inf\" -o -name \"KeePass.ini\" -o -name \".lesshst\" -o -name \"Dockerfile\" -o -name \"KeePass.enforced*\" -o -name \"mysqld.cnf\" -o -name \"*.der\" -o -name \".boto\" -o -name \"adc.json\" -o -name \"rocketchat.service\" -o -name \"rsyncd.secrets\" -o -name \"autologin.conf\" -o -name \"autounattend.xml\" -o -name \"passwd\" -o -name \"master.key\" -o -name \"autologin\" -o -name \"*.swp\" -o -name \"FreeSSHDservice.ini\" -o -name \"default.sav\" -o -name \"credentials.db\" -o -name \"sites.ini\" -o -name \"my.cnf\" -o -name \"grafana.ini\" -o -name \"my.ini\" -o -name \"filezilla.xml\" -o -name \"ws_ftp.ini\" -o -name \"ffftp.ini\" -o -name \"wcx_ftp.ini\" -o -name \"*.timer\" -o -name \".htpasswd\" -o -name \"kcpassword\" -o -name \"nginx.conf\" -o -name \"AppEvent.Evt\" -o -name \"datasources.xml\" -o -name \"*.psk\" -o -name \"sysprep.xml\" -o -name \"*.sqlite3\" -o -name \"secring.gpg\" -o -name \"jetty-realm.properties\" -o -name \"frakti.sock\" -o -name \"config.xml\" -o -name \"*.sqlite\" -o -name \"credentials.tfrc.json\" -o -name \"*.csr\" -o -name \"*.jks\" -o -name \"sentry.conf.py\" -o -name \"state.vscdb.backup\" -o -name \"kadm5.acl\" -o -name \".vault-token\" -o -name \"credentials.xml\" -o -name \"ipsec.secrets\" -o -name \"fastcgi_params\" -o -name \"password*.ibd\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_USR=`eval_bckgrd "find ${ROOT_FOLDER}usr -name \"krb5.conf\" -o -name \"mariadb.cnf\" -o -name \"AzureRMContext.json\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.p12\" -o -name \"FreePBX.conf\" -o -name \"trustdb.gpg\" -o -name \"software.sav\" -o -name \"backups\" -o -name \"passbolt.php\" -o -name \"*.pem\" -o -name \"snmpd.conf\" -o -name \".env*\" -o -name \"sysprep.inf\" -o -name \"pg_hba.conf\" -o -name \"storage.php\" -o -name \"*kubeconfig*\" -o -name \"amportal.conf\" -o -name \"*.vhd\" -o -name \"kubelet.conf\" -o -name \"*.ftpconfig\" -o -name \"hudson.util.Secret\" -o -name \"snyk.config.json\" -o -name \"smb.conf\" -o -name \"hostapd.conf\" -o -name \"*.db\" -o -name \"backup\" -o -name \"*.socket\" -o -name \"authorized_hosts\" -o -name \"id_rsa*\" -o -name \".claude.json\" -o -name \"storage.json\" -o -name \"glusterfs.key\" -o -name \".git\" -o -name \"kibana.y*ml\" -o -name \"TokenCache.dat\" -o -name \"scclient.exe\" -o -name \"msal_http_cache.bin\" -o -name \"recentservers.xml\" -o -name \"ftp.ini\" -o -name \".secrets.mkey\" -o -name \"supervisord.conf\" -o -name \"mongod*.conf\" -o -name \"api_key\" -o -name \"wp-config.php\" -o -name \"firebase-tools.json\" -o -name \"msal_token_cache.bin\" -o -name \"secrets.yml\" -o -name \"httpd.conf\" -o -name \"*.tfstate\" -o -name \"*.pfx\" -o -name \"docker.sock\" -o -name \".github\" -o -name \"*vnc*.txt\" -o -name \"access_tokens.json\" -o -name \"service_principal_entries.json\" -o -name \"rpcd\" -o -name \"gvm-tools.conf\" -o -name \"system.sav\" -o -name \".google_authenticator\" -o -name \"pwd.ibd\" -o -name \"*.kdbx\" -o -name \"anaconda-ks.cfg\" -o -name \".gitconfig\" -o -name \"pubring.kbx\" -o -name \"*.vmdk\" -o -name \"settings.php\" -o -name \"docker.socket\" -o -name \"bash.exe\" -o -name \".k5login\" -o -name \"glusterfs.pem\" -o -name \"*.pcap\" -o -name \".rhosts\" -o -name \"security.sav\" -o -name \"id_dsa*\" -o -name \"*vnc*.xml\" -o -name \"krb5cc_*\" -o -name \"msal_token_cache.json\" -o -name \"state.vscdb\" -o -name \"zabbix_agentd.conf\" -o -name \"setupinfo.bak\" -o -name \"software\" -o -name \"protecteduserkey.bin\" -o -name \"crontab-ui.service\" -o -name \"SAM\" -o -name \"https.conf\" -o -name \"pagefile.sys\" -o -name \"aliases\" -o -name \"*password*\" -o -name \"access.log\" -o -name \"unattended.xml\" -o -name \"secrets.ldb\" -o -name \"*_history*\" -o -name \"unattend.xml\" -o -name \"*.keytab\" -o -name \".roadtools_auth\" -o -name \".profile\" -o -name \"docker-compose.yml\" -o -name \"iis6.log\" -o -name \".flyrc\" -o -name \"web*.config\" -o -name \"psk.txt\" -o -name \"authorized_keys\" -o -name \".bashrc\" -o -name \"log4j-core*.jar\" -o -name \"*.gpg\" -o -name \"sip.conf\" -o -name \"bootstrap-kubelet.conf\" -o -name \"crio.sock\" -o -name \"000-default.conf\" -o -name \"redis.conf\" -o -name \"*.pgp\" -o -name \".pypirc\" -o -name \".git-credentials\" -o -name \"dockershim.sock\" -o -name \"hosts.equiv\" -o -name \"*.rdg\" -o -name \"database.php\" -o -name \"config.php\" -o -name \".msmtprc\" -o -name \"admin.conf\" -o -name \"unattend.txt\" -o -name \"plum.sqlite\" -o -name \"tomcat-users.xml\" -o -name \"sitemanager.xml\" -o -name \".plan\" -o -name \"pgadmin4.db\" -o -name \"winscp.ini\" -o -name \"*.viminfo\" -o -name \"known_hosts\" -o -name \"passwd.ibd\" -o -name \"clouds.config\" -o -name \"sslkeylog.log\" -o -name \"Elastix.conf\" -o -name \"Ntds.dit\" -o -name \"groups.xml\" -o -name \"private-keys-v1.d/*.key\" -o -name \"containerd.sock\" -o -name \"*.keyring\" -o -name \"mosquitto.conf\" -o -name \"environment\" -o -name \"webserver_config.py\" -o -name \"creds*\" -o -name \"printers.xml\" -o -name \"*.pcapng\" -o -name \"influxdb.conf\" -o -name \"ftp.config\" -o -name \"*.crt\" -o -name \".wgetrc\" -o -name \"scheduledtasks.xml\" -o -name \"crontab.db\" -o -name \"ntuser.dat\" -o -name \"ssh*config\" -o -name \"*.asc\" -o -name \"access_tokens.db\" -o -name \"elasticsearch.y*ml\" -o -name \"vsftpd.conf\" -o -name \"airflow.cfg\" -o -name \"server.xml\" -o -name \".mylogin.cnf\" -o -name \".pgpass\" -o -name \".erlang.cookie\" -o -name \"ddclient.conf\" -o -name \"php.ini\" -o -name \"racoon.conf\" -o -name \"index.dat\" -o -name \"*.tf\" -o -name \"snyk.json\" -o -name \".credentials.json\" -o -name \"azureProfile.json\" -o -name \"legacy_credentials.db\" -o -name \"*.vhdx\" -o -name \"*.pub\" -o -name \"*.ovpn\" -o -name \"*.keystore\" -o -name \"*.cer\" -o -name \"secret.asc\" -o -name \"gitlab.rm\" -o -name \"*vnc*.c*nf*\" -o -name \"db.php\" -o -name \".ldaprc\" -o -name \"*credential*\" -o -name \"atlantis.db\" -o -name \"*config*.php\" -o -name \"rsyncd.conf\" -o -name \"accessTokens.json\" -o -name \".mcp.json\" -o -name \"apt.conf\" -o -name \"postgresql.conf\" -o -name \"fat.config\" -o -name \"pgsql.conf\" -o -name \"SecEvent.Evt\" -o -name \"keys.log\" -o -name \"ipsec.conf\" -o -name \"debian.cnf\" -o -name \"error.log\" -o -name \"*.key\" -o -name \".Xauthority\" -o -name \"rktlet.sock\" -o -name \"SYSTEM\" -o -name \"NetSetup.log\" -o -name \"*.service\" -o -name \"gpg-agent.conf\" -o -name \"KeePass.config*\" -o -name \"cesi.conf\" -o -name \"glusterfs.ca\" -o -name \"wsl.exe\" -o -name \"gitlab.yml\" -o -name \"zabbix_server.conf\" -o -name \"bitcoin.conf\" -o -name \"pgadmin*.db\" -o -name \"*vnc*.ini\" -o -name \"sssd.conf\" -o -name \"cloud.cfg\" -o -name \"ConsoleHost_history.txt\" -o -name \"setupinfo\" -o -name \".sudo_as_admin_successful\" -o -name \"*.maintenance*\" -o -name \"https-xampp.conf\" -o -name \"*.gnupg\" -o -name \"drives.xml\" -o -name \".recently-used.xbel\" -o -name \"appcmd.exe\" -o -name \"RDCMan.settings\" -o -name \"service_principal_entries.bin\" -o -name \"unattend.inf\" -o -name \"KeePass.ini\" -o -name \".lesshst\" -o -name \"Dockerfile\" -o -name \"KeePass.enforced*\" -o -name \"mysqld.cnf\" -o -name \"*.der\" -o -name \".boto\" -o -name \"adc.json\" -o -name \"rocketchat.service\" -o -name \"rsyncd.secrets\" -o -name \"autologin.conf\" -o -name \"autounattend.xml\" -o -name \"passwd\" -o -name \"master.key\" -o -name \"autologin\" -o -name \"*.swp\" -o -name \"FreeSSHDservice.ini\" -o -name \"default.sav\" -o -name \"credentials.db\" -o -name \"sites.ini\" -o -name \"my.cnf\" -o -name \"grafana.ini\" -o -name \"my.ini\" -o -name \"filezilla.xml\" -o -name \"ws_ftp.ini\" -o -name \"ffftp.ini\" -o -name \"wcx_ftp.ini\" -o -name \"*.timer\" -o -name \".htpasswd\" -o -name \"kcpassword\" -o -name \"nginx.conf\" -o -name \"AppEvent.Evt\" -o -name \"datasources.xml\" -o -name \"*.psk\" -o -name \"sysprep.xml\" -o -name \"*.sqlite3\" -o -name \"secring.gpg\" -o -name \"jetty-realm.properties\" -o -name \"frakti.sock\" -o -name \"config.xml\" -o -name \"*.sqlite\" -o -name \"credentials.tfrc.json\" -o -name \"*.csr\" -o -name \"*.jks\" -o -name \"sentry.conf.py\" -o -name \"state.vscdb.backup\" -o -name \"kadm5.acl\" -o -name \".vault-token\" -o -name \"credentials.xml\" -o -name \"ipsec.secrets\" -o -name \"fastcgi_params\" -o -name \"password*.ibd\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_VAR=`eval_bckgrd "find ${ROOT_FOLDER}var -name \"krb5.conf\" -o -name \"mariadb.cnf\" -o -name \"AzureRMContext.json\" -o -name \"vault-ssh-helper.hcl\" -o -name \"*.p12\" -o -name \"FreePBX.conf\" -o -name \"trustdb.gpg\" -o -name \"software.sav\" -o -name \"backups\" -o -name \"passbolt.php\" -o -name \"*.pem\" -o -name \"snmpd.conf\" -o -name \".env*\" -o -name \"sysprep.inf\" -o -name \"pg_hba.conf\" -o -name \"storage.php\" -o -name \"*kubeconfig*\" -o -name \"amportal.conf\" -o -name \"*.vhd\" -o -name \"kubelet.conf\" -o -name \"*.ftpconfig\" -o -name \"hudson.util.Secret\" -o -name \"snyk.config.json\" -o -name \"smb.conf\" -o -name \"hostapd.conf\" -o -name \"*.db\" -o -name \"backup\" -o -name \"*.socket\" -o -name \"authorized_hosts\" -o -name \"id_rsa*\" -o -name \".claude.json\" -o -name \"storage.json\" -o -name \"glusterfs.key\" -o -name \".git\" -o -name \"kibana.y*ml\" -o -name \"TokenCache.dat\" -o -name \"scclient.exe\" -o -name \"msal_http_cache.bin\" -o -name \"recentservers.xml\" -o -name \"ftp.ini\" -o -name \".secrets.mkey\" -o -name \"supervisord.conf\" -o -name \"mongod*.conf\" -o -name \"api_key\" -o -name \"wp-config.php\" -o -name \"firebase-tools.json\" -o -name \"msal_token_cache.bin\" -o -name \"secrets.yml\" -o -name \"httpd.conf\" -o -name \"*.tfstate\" -o -name \"*.pfx\" -o -name \"docker.sock\" -o -name \".github\" -o -name \"*vnc*.txt\" -o -name \"access_tokens.json\" -o -name \"service_principal_entries.json\" -o -name \"rpcd\" -o -name \"gvm-tools.conf\" -o -name \"system.sav\" -o -name \".google_authenticator\" -o -name \"pwd.ibd\" -o -name \"*.kdbx\" -o -name \"anaconda-ks.cfg\" -o -name \".gitconfig\" -o -name \"pubring.kbx\" -o -name \"*.vmdk\" -o -name \"settings.php\" -o -name \"docker.socket\" -o -name \"bash.exe\" -o -name \".k5login\" -o -name \"glusterfs.pem\" -o -name \"*.pcap\" -o -name \".rhosts\" -o -name \"security.sav\" -o -name \"id_dsa*\" -o -name \"*vnc*.xml\" -o -name \"krb5cc_*\" -o -name \"msal_token_cache.json\" -o -name \"state.vscdb\" -o -name \"zabbix_agentd.conf\" -o -name \"setupinfo.bak\" -o -name \"software\" -o -name \"protecteduserkey.bin\" -o -name \"crontab-ui.service\" -o -name \"SAM\" -o -name \"https.conf\" -o -name \"pagefile.sys\" -o -name \"aliases\" -o -name \"*password*\" -o -name \"access.log\" -o -name \"unattended.xml\" -o -name \"secrets.ldb\" -o -name \"*_history*\" -o -name \"unattend.xml\" -o -name \"*.keytab\" -o -name \".roadtools_auth\" -o -name \".profile\" -o -name \"docker-compose.yml\" -o -name \"iis6.log\" -o -name \".flyrc\" -o -name \"web*.config\" -o -name \"psk.txt\" -o -name \"authorized_keys\" -o -name \".bashrc\" -o -name \"log4j-core*.jar\" -o -name \"*.gpg\" -o -name \"sip.conf\" -o -name \"bootstrap-kubelet.conf\" -o -name \"crio.sock\" -o -name \"000-default.conf\" -o -name \"redis.conf\" -o -name \"*.pgp\" -o -name \".pypirc\" -o -name \".git-credentials\" -o -name \"dockershim.sock\" -o -name \"hosts.equiv\" -o -name \"*.rdg\" -o -name \"database.php\" -o -name \"config.php\" -o -name \".msmtprc\" -o -name \"admin.conf\" -o -name \"unattend.txt\" -o -name \"plum.sqlite\" -o -name \"tomcat-users.xml\" -o -name \"sitemanager.xml\" -o -name \".plan\" -o -name \"pgadmin4.db\" -o -name \"winscp.ini\" -o -name \"*.viminfo\" -o -name \"known_hosts\" -o -name \"passwd.ibd\" -o -name \"clouds.config\" -o -name \"sslkeylog.log\" -o -name \"Elastix.conf\" -o -name \"Ntds.dit\" -o -name \"groups.xml\" -o -name \"private-keys-v1.d/*.key\" -o -name \"containerd.sock\" -o -name \"*.keyring\" -o -name \"mosquitto.conf\" -o -name \"environment\" -o -name \"webserver_config.py\" -o -name \"creds*\" -o -name \"printers.xml\" -o -name \"*.pcapng\" -o -name \"influxdb.conf\" -o -name \"ftp.config\" -o -name \"*.crt\" -o -name \".wgetrc\" -o -name \"scheduledtasks.xml\" -o -name \"crontab.db\" -o -name \"ntuser.dat\" -o -name \"*.asc\" -o -name \"access_tokens.db\" -o -name \"elasticsearch.y*ml\" -o -name \"vsftpd.conf\" -o -name \"airflow.cfg\" -o -name \"server.xml\" -o -name \".mylogin.cnf\" -o -name \".pgpass\" -o -name \"sess_*\" -o -name \".erlang.cookie\" -o -name \"ddclient.conf\" -o -name \"php.ini\" -o -name \"racoon.conf\" -o -name \"index.dat\" -o -name \"*.tf\" -o -name \"snyk.json\" -o -name \".credentials.json\" -o -name \"azureProfile.json\" -o -name \"legacy_credentials.db\" -o -name \"*.vhdx\" -o -name \"*.pub\" -o -name \"*.ovpn\" -o -name \"*.keystore\" -o -name \"*.cer\" -o -name \"secret.asc\" -o -name \"gitlab.rm\" -o -name \"*vnc*.c*nf*\" -o -name \"db.php\" -o -name \".ldaprc\" -o -name \"*credential*\" -o -name \"atlantis.db\" -o -name \"*config*.php\" -o -name \"rsyncd.conf\" -o -name \"accessTokens.json\" -o -name \".mcp.json\" -o -name \"apt.conf\" -o -name \"postgresql.conf\" -o -name \"fat.config\" -o -name \"pgsql.conf\" -o -name \"SecEvent.Evt\" -o -name \"keys.log\" -o -name \"ipsec.conf\" -o -name \"debian.cnf\" -o -name \"error.log\" -o -name \"*.key\" -o -name \".Xauthority\" -o -name \"rktlet.sock\" -o -name \"SYSTEM\" -o -name \"NetSetup.log\" -o -name \"*.service\" -o -name \"gpg-agent.conf\" -o -name \"KeePass.config*\" -o -name \"cesi.conf\" -o -name \"glusterfs.ca\" -o -name \"wsl.exe\" -o -name \"gitlab.yml\" -o -name \"zabbix_server.conf\" -o -name \"bitcoin.conf\" -o -name \"pgadmin*.db\" -o -name \"*vnc*.ini\" -o -name \"sssd.conf\" -o -name \"cloud.cfg\" -o -name \"ConsoleHost_history.txt\" -o -name \"setupinfo\" -o -name \".sudo_as_admin_successful\" -o -name \"*.maintenance*\" -o -name \"https-xampp.conf\" -o -name \"*.gnupg\" -o -name \"drives.xml\" -o -name \".recently-used.xbel\" -o -name \"appcmd.exe\" -o -name \"RDCMan.settings\" -o -name \"service_principal_entries.bin\" -o -name \"unattend.inf\" -o -name \"KeePass.ini\" -o -name \".lesshst\" -o -name \"Dockerfile\" -o -name \"KeePass.enforced*\" -o -name \"mysqld.cnf\" -o -name \"*.der\" -o -name \".boto\" -o -name \"adc.json\" -o -name \"rocketchat.service\" -o -name \"rsyncd.secrets\" -o -name \"autologin.conf\" -o -name \"autounattend.xml\" -o -name \"passwd\" -o -name \"master.key\" -o -name \"autologin\" -o -name \"*.swp\" -o -name \"FreeSSHDservice.ini\" -o -name \"default.sav\" -o -name \"credentials.db\" -o -name \"sites.ini\" -o -name \"my.cnf\" -o -name \"grafana.ini\" -o -name \"my.ini\" -o -name \"filezilla.xml\" -o -name \"ws_ftp.ini\" -o -name \"ffftp.ini\" -o -name \"wcx_ftp.ini\" -o -name \"*.timer\" -o -name \".htpasswd\" -o -name \"kcpassword\" -o -name \"nginx.conf\" -o -name \"AppEvent.Evt\" -o -name \"datasources.xml\" -o -name \"*.psk\" -o -name \"sysprep.xml\" -o -name \"*.sqlite3\" -o -name \"secring.gpg\" -o -name \"jetty-realm.properties\" -o -name \"frakti.sock\" -o -name \"config.xml\" -o -name \"*.sqlite\" -o -name \"credentials.tfrc.json\" -o -name \"*.csr\" -o -name \"*.jks\" -o -name \"sentry.conf.py\" -o -name \"state.vscdb.backup\" -o -name \"kadm5.acl\" -o -name \".vault-token\" -o -name \"credentials.xml\" -o -name \"ipsec.secrets\" -o -name \"fastcgi_params\" -o -name \"password*.ibd\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
...
if [ "$SEARCH_IN_FOLDER" ] || echo $CHECKS | grep -q procs_crons_timers_srvcs_sockets || echo $CHECKS | grep -q software_information || echo $CHECKS | grep -q interesting_files; then
  ...
  PSTORAGE_SYSTEMD=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}bin|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}sys|^${ROOT_FOLDER}private|^${ROOT_FOLDER}concourse-auth|^${ROOT_FOLDER}concourse-keys|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}media|^${ROOT_FOLDER}lib32|^${ROOT_FOLDER}lib|^${ROOT_FOLDER}systemd|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}run|^${ROOT_FOLDER}lib64|^${ROOT_FOLDER}system|^${ROOT_FOLDER}var" | grep -E ".*\.service$" | sort | uniq | head -n 70)
  PSTORAGE_TIMER=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}bin|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}sys|^${ROOT_FOLDER}private|^${ROOT_FOLDER}concourse-auth|^${ROOT_FOLDER}concourse-keys|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}media|^${ROOT_FOLDER}lib32|^${ROOT_FOLDER}lib|^${ROOT_FOLDER}systemd|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}run|^${ROOT_FOLDER}lib64|^${ROOT_FOLDER}system|^${ROOT_FOLDER}var" | grep -E ".*\.timer$" | sort | uniq | head -n 70)
  PSTORAGE_SOCKET=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}bin|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}sys|^${ROOT_FOLDER}private|^${ROOT_FOLDER}concourse-auth|^${ROOT_FOLDER}concourse-keys|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}media|^${ROOT_FOLDER}lib32|^${ROOT_FOLDER}lib|^${ROOT_FOLDER}systemd|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}run|^${ROOT_FOLDER}lib64|^${ROOT_FOLDER}system|^${ROOT_FOLDER}var" | grep -E ".*\.socket$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_MYSQL=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CDROM\n$FIND_DIR_OPT\n$FIND_DIR_SBIN\n$FIND_DIR_BIN\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_USR\n$FIND_DIR_SNAP\n$FIND_DIR_MEDIA\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_MNT\n$FIND_DIR_RUN\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -v -E 'mysql/mysql' | grep -E '^/etc/.*mysql|/usr/var/lib/.*mysql|/var/lib/.*mysql' | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "mysql$|passwd\.ibd$|password.*\.ibd$|pwd\.ibd$|mysqld\.cnf$|\.mylogin\.cnf$" | sort | uniq | head -n 70)
  PSTORAGE_MARIADB=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "mariadb\.cnf$|debian\.cnf$" | sort | uniq | head -n 70)
  PSTORAGE_POSTGRESQL=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "pgadmin.*\.db$|pg_hba\.conf$|postgresql\.conf$|pgsql\.conf$|\.pgpass$|pgadmin4\.db$" | sort | uniq | head -n 70)
  PSTORAGE_APACHE_NGINX=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CDROM\n$FIND_DIR_OPT\n$FIND_DIR_SBIN\n$FIND_DIR_BIN\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_USR\n$FIND_DIR_SNAP\n$FIND_DIR_MEDIA\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_MNT\n$FIND_DIR_RUN\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "sites-enabled$|000-default\.conf$|php\.ini$|nginx\.conf$|nginx$" | sort | uniq | head -n 70)
  PSTORAGE_VARNISH=$(echo -e "$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CDROM\n$FIND_DIR_OPT\n$FIND_DIR_SBIN\n$FIND_DIR_BIN\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_USR\n$FIND_DIR_SNAP\n$FIND_DIR_MEDIA\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_MNT\n$FIND_DIR_RUN\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "varnish$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_PHP_FILES=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E ".*config.*\.php$|database\.php$|db\.php$|storage\.php$|settings\.php$" | sort | uniq | head -n 70)
  PSTORAGE_APACHE_AIRFLOW=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "airflow\.cfg$|webserver_config\.py$" | sort | uniq | head -n 70)
  PSTORAGE_X11=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "\.Xauthority$" | sort | uniq | head -n 70)
  PSTORAGE_WORDPRESS=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "wp-config\.php$" | sort | uniq | head -n 70)
  PSTORAGE_DRUPAL=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E '/default/settings.php' | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "settings\.php$" | sort | uniq | head -n 70)
  PSTORAGE_MOODLE=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E 'moodle/config.php' | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "config\.php$" | sort | uniq | head -n 70)
  PSTORAGE_TOMCAT=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "tomcat-users\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_MONGO=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "mongod.*\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_ROCKETCHAT=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}systemd|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}lib" | grep -E "rocketchat\.service$" | sort | uniq | head -n 70)
  PSTORAGE_SUPERVISORD=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "supervisord\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_CESI=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "cesi\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_RSYNC=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "rsyncd\.conf$|rsyncd\.secrets$" | sort | uniq | head -n 70)
  PSTORAGE_RPCD=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -v -E '/init.d/|/sbin/|/usr/share/' | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "rpcd$" | sort | uniq | head -n 70)
  PSTORAGE_BITCOIN=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "bitcoin\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_HOSTAPD=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "hostapd\.conf$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_GLUSTERFS=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "glusterfs\.pem$|glusterfs\.ca$|glusterfs\.key$" | sort | uniq | head -n 70)
  PSTORAGE_ANACONDA_KS=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "anaconda-ks\.cfg$" | sort | uniq | head -n 70)
  PSTORAGE_TERRAFORM=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E ".*\.tfstate$|.*\.tf$|credentials\.tfrc\.json$" | sort | uniq | head -n 70)
  PSTORAGE_RACOON=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "racoon\.conf$|psk\.txt$" | sort | uniq | head -n 70)
  PSTORAGE_KUBERNETES=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CDROM\n$FIND_DIR_OPT\n$FIND_DIR_SBIN\n$FIND_DIR_BIN\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_USR\n$FIND_DIR_SNAP\n$FIND_DIR_MEDIA\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_MNT\n$FIND_DIR_RUN\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}run|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E ".*kubeconfig.*$|admin\.conf$|bootstrap-kubelet\.conf$|kubelet\.conf$|\.kube.*$|kubernetes$|kubelet$|kube-proxy$|kubernetes\.io$|net\.d$|containerd$|crio$|etcd$|origin$|k0s$|k3s$|rke2$|microk8s$" | sort | uniq | head -n 70)
  PSTORAGE_VNC=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CDROM\n$FIND_DIR_OPT\n$FIND_DIR_SBIN\n$FIND_DIR_BIN\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_USR\n$FIND_DIR_SNAP\n$FIND_DIR_MEDIA\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_MNT\n$FIND_DIR_RUN\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -v -E '/mime/' | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "\.vnc$|.*vnc.*\.c.*nf.*$|.*vnc.*\.ini$|.*vnc.*\.txt$|.*vnc.*\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_LDAP=$(echo -e "$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CDROM\n$FIND_DIR_OPT\n$FIND_DIR_SBIN\n$FIND_DIR_BIN\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_USR\n$FIND_DIR_SNAP\n$FIND_DIR_MEDIA\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_MNT\n$FIND_DIR_RUN\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "ldap$" | sort | uniq | head -n 70)
  PSTORAGE_LOG4SHELL=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}bin|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}private|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr|^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}media|^${ROOT_FOLDER}lib32|^${ROOT_FOLDER}lib|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}lib64|^${ROOT_FOLDER}var" | grep -E "log4j-core.*\.jar$" | sort | uniq | head -n 70)
  PSTORAGE_OPENVPN=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E ".*\.ovpn$" | sort | uniq | head -n 70)
  PSTORAGE_SSH=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "id_dsa.*$|id_rsa.*$|known_hosts$|authorized_hosts$|authorized_keys$|.*\.pub$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSB4=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -v -E '/usr/share/|/usr/local/lib/|/usr/lib.*' | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E ".*\.pem$|.*\.cer$|.*\.crt$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSBIN=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -v -E '/usr/share/|/usr/local/lib/|/usr/lib/.*|^/usr/share/|/usr/local/lib/|/usr/lib/.*' | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E ".*\.csr$|.*\.der$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSCLIENT=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -v -E '/usr/share/|/usr/local/lib/|/usr/lib/.*' | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E ".*\.pfx$|.*\.p12$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_SNYK=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "snyk\.json$|snyk\.config\.json$" | sort | uniq | head -n 70)
  PSTORAGE_CLOUD_CREDENTIALS=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CDROM\n$FIND_DIR_OPT\n$FIND_DIR_SBIN\n$FIND_DIR_BIN\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_USR\n$FIND_DIR_SNAP\n$FIND_DIR_MEDIA\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_MNT\n$FIND_DIR_RUN\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "credentials\.db$|legacy_credentials\.db$|adc\.json$|\.boto$|\.credentials\.json$|firebase-tools\.json$|access_tokens\.db$|access_tokens\.json$|accessTokens\.json$|gcloud$|legacy_credentials$|azureProfile\.json$|TokenCache\.dat$|AzureRMContext\.json$|clouds\.config$|service_principal_entries\.json$|msal_token_cache\.json$|msal_http_cache\.bin$|service_principal_entries\.bin$|msal_token_cache\.bin$|ErrorRecords$|TokenCache\.dat$|\.bluemix$|doctl$|Google Cloud Directory Sync$|Google Password Sync$" | sort | uniq | head -n 70)
  PSTORAGE_AI_CODING_ASSISTANTS=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CDROM\n$FIND_DIR_OPT\n$FIND_DIR_SBIN\n$FIND_DIR_BIN\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_USR\n$FIND_DIR_SNAP\n$FIND_DIR_MEDIA\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_MNT\n$FIND_DIR_RUN\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E '.*/\.config/gh$|.*/AppData/.*gh$|.*/Library/Application Support/gh$|.*/(Cursor|Code|Code - Insiders)/User/(globalStorage|workspaceStorage)(/.*)?$|.*/Library/Application Support/(Cursor|Code|Code - Insiders)/User/(globalStorage|workspaceStorage)(/.*)?$' | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "\.codex$|\.claude$|\.claude\.json$|\.gemini$|\.cursor$|\.mcp\.json$|gh$|state\.vscdb$|state\.vscdb\.backup$|storage\.json$" | sort | uniq | head -n 70)
  PSTORAGE_ROAD_RECON=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "\.roadtools_auth$" | sort | uniq | head -n 70)
  PSTORAGE_FREEIPA=$(echo -e "$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CDROM\n$FIND_DIR_OPT\n$FIND_DIR_SBIN\n$FIND_DIR_BIN\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_USR\n$FIND_DIR_SNAP\n$FIND_DIR_MEDIA\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_MNT\n$FIND_DIR_RUN\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "ipa$|dirsrv$" | sort | uniq | head -n 70)
  PSTORAGE_KERBEROS=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "krb5\.conf$|.*\.keytab$|\.k5login$|krb5cc_.*$|kadm5\.acl$|secrets\.ldb$|\.secrets\.mkey$|sssd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_KIBANA=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "kibana\.y.*ml$" | sort | uniq | head -n 70)
  PSTORAGE_GRAFANA=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "grafana\.ini$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_LOGSTASH=$(echo -e "$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CDROM\n$FIND_DIR_OPT\n$FIND_DIR_SBIN\n$FIND_DIR_BIN\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_USR\n$FIND_DIR_SNAP\n$FIND_DIR_MEDIA\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_MNT\n$FIND_DIR_RUN\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "logstash$" | sort | uniq | head -n 70)
  PSTORAGE_ELASTICSEARCH=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "elasticsearch\.y.*ml$" | sort | uniq | head -n 70)
  PSTORAGE_VAULT_SSH_HELPER=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "vault-ssh-helper\.hcl$" | sort | uniq | head -n 70)
  PSTORAGE_VAULT_SSH_TOKEN=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "\.vault-token$" | sort | uniq | head -n 70)
  PSTORAGE_COUCHDB=$(echo -e "$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CDROM\n$FIND_DIR_OPT\n$FIND_DIR_SBIN\n$FIND_DIR_BIN\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_USR\n$FIND_DIR_SNAP\n$FIND_DIR_MEDIA\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_MNT\n$FIND_DIR_RUN\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "couchdb$" | sort | uniq | head -n 70)
  PSTORAGE_REDIS=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "redis\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_MOSQUITTO=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "mosquitto\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_NEO4J=$(echo -e "$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CDROM\n$FIND_DIR_OPT\n$FIND_DIR_SBIN\n$FIND_DIR_BIN\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_USR\n$FIND_DIR_SNAP\n$FIND_DIR_MEDIA\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_MNT\n$FIND_DIR_RUN\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "neo4j$" | sort | uniq | head -n 70)
  PSTORAGE_CLOUD_INIT=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "cloud\.cfg$" | sort | uniq | head -n 70)
  PSTORAGE_ERLANG=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "\.erlang\.cookie$" | sort | uniq | head -n 70)
  PSTORAGE_SIP=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "sip\.conf$|amportal\.conf$|FreePBX\.conf$|Elastix\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_GMV_AUTH=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "gvm-tools\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_IPSEC=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "ipsec\.secrets$|ipsec\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_IRSSI=$(echo -e "$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CDROM\n$FIND_DIR_OPT\n$FIND_DIR_SBIN\n$FIND_DIR_BIN\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_USR\n$FIND_DIR_SNAP\n$FIND_DIR_MEDIA\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_MNT\n$FIND_DIR_RUN\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "\.irssi$" | sort | uniq | head -n 70)
  PSTORAGE_KEYRING=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CDROM\n$FIND_DIR_OPT\n$FIND_DIR_SBIN\n$FIND_DIR_BIN\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_USR\n$FIND_DIR_SNAP\n$FIND_DIR_MEDIA\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_MNT\n$FIND_DIR_RUN\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "keyrings$|.*\.keyring$|.*\.keystore$|.*\.jks$" | sort | uniq | head -n 70)
  PSTORAGE_VIRTUAL_DISKS=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E ".*\.vhd$|.*\.vhdx$|.*\.vmdk$" | sort | uniq | head -n 70)
  PSTORAGE_FILEZILLA=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CDROM\n$FIND_DIR_OPT\n$FIND_DIR_SBIN\n$FIND_DIR_BIN\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_USR\n$FIND_DIR_SNAP\n$FIND_DIR_MEDIA\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_MNT\n$FIND_DIR_RUN\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "filezilla$|filezilla\.xml$|recentservers\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_BACKUP_MANAGER=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "storage\.php$|database\.php$" | sort | uniq | head -n 70)
  PSTORAGE_SPLUNK=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "passwd$" | sort | uniq | head -n 70)
  PSTORAGE_GIT=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "\.git-credentials$" | sort | uniq | head -n 70)
  PSTORAGE_ATLANTIS=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "atlantis\.db$" | sort | uniq | head -n 70)
  PSTORAGE_GITLAB=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -v -E '/lib' | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "secrets\.yml$|gitlab\.yml$|gitlab\.rm$" | sort | uniq | head -n 70)
  PSTORAGE_PGP_GPG=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -v -E 'README.gnupg|/usr/share/|/usr/lib/|/lib/|/man/' | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E ".*\.pgp$|.*\.gpg$|.*\.asc$|secring\.gpg$|pubring\.kbx$|trustdb\.gpg$|gpg-agent\.conf$|secret\.asc$|private-keys-v1\.d/.*\.key$|.*\.gnupg$" | sort | uniq | head -n 70)
  PSTORAGE_CACHE_VI=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E ".*\.swp$|.*\.viminfo$" | sort | uniq | head -n 70)
  PSTORAGE_DOCKER=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CDROM\n$FIND_DIR_OPT\n$FIND_DIR_SBIN\n$FIND_DIR_BIN\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_USR\n$FIND_DIR_SNAP\n$FIND_DIR_MEDIA\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_MNT\n$FIND_DIR_RUN\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "docker\.socket$|docker\.sock$|Dockerfile$|docker-compose\.yml$|dockershim\.sock$|containerd\.sock$|crio\.sock$|frakti\.sock$|rktlet\.sock$|\.docker$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_AUTOLOGIN=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "autologin$|autologin\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_FASTCGI=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "fastcgi_params$" | sort | uniq | head -n 70)
  PSTORAGE_FAT_FREE=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "fat\.config$" | sort | uniq | head -n 70)
  PSTORAGE_SHODAN=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "api_key$" | sort | uniq | head -n 70)
  PSTORAGE_CONCOURSE=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CDROM\n$FIND_DIR_OPT\n$FIND_DIR_SBIN\n$FIND_DIR_BIN\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_USR\n$FIND_DIR_SNAP\n$FIND_DIR_MEDIA\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_MNT\n$FIND_DIR_RUN\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}concourse-keys|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}concourse-auth|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "\.flyrc$|concourse-auth$|concourse-keys$" | sort | uniq | head -n 70)
  PSTORAGE_BOTO=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "\.boto$" | sort | uniq | head -n 70)
  PSTORAGE_SNMP=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "snmpd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_PYPIRC=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "\.pypirc$" | sort | uniq | head -n 70)
  PSTORAGE_POSTFIX=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CDROM\n$FIND_DIR_OPT\n$FIND_DIR_SBIN\n$FIND_DIR_BIN\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_USR\n$FIND_DIR_SNAP\n$FIND_DIR_MEDIA\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_MNT\n$FIND_DIR_RUN\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "aliases$|postfix$" | sort | uniq | head -n 70)
  PSTORAGE_CLOUDFLARE=$(echo -e "$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CDROM\n$FIND_DIR_OPT\n$FIND_DIR_SBIN\n$FIND_DIR_BIN\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_USR\n$FIND_DIR_SNAP\n$FIND_DIR_MEDIA\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_MNT\n$FIND_DIR_RUN\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "\.cloudflared$" | sort | uniq | head -n 70)
  PSTORAGE_HISTORY=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E ".*_history.*$" | sort | uniq | head -n 70)
  PSTORAGE_HTTP_CONF=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "httpd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_HTPASSWD=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "\.htpasswd$" | sort | uniq | head -n 70)
  PSTORAGE_LDAPRC=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "\.ldaprc$" | sort | uniq | head -n 70)
  PSTORAGE_ENV=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -v -E 'example' | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "\.env.*$" | sort | uniq | head -n 70)
  PSTORAGE_PROXY_CONFIG=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CDROM\n$FIND_DIR_OPT\n$FIND_DIR_SBIN\n$FIND_DIR_BIN\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_USR\n$FIND_DIR_SNAP\n$FIND_DIR_MEDIA\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_MNT\n$FIND_DIR_RUN\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E '^/etc/environment$' | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "environment$|apt\.conf$|apt\.conf\.d$" | sort | uniq | head -n 70)
  PSTORAGE_SNIFFING_ARTIFACTS=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E ".*\.pcap$|.*\.pcapng$|keys\.log$|sslkeylog\.log$" | sort | uniq | head -n 70)
  PSTORAGE_MSMTPRC=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "\.msmtprc$" | sort | uniq | head -n 70)
  PSTORAGE_INFLUXDB=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "influxdb\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_ZABBIX=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CDROM\n$FIND_DIR_OPT\n$FIND_DIR_SBIN\n$FIND_DIR_BIN\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_USR\n$FIND_DIR_SNAP\n$FIND_DIR_MEDIA\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_MNT\n$FIND_DIR_RUN\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "zabbix_server\.conf$|zabbix_agentd\.conf$|zabbix$" | sort | uniq | head -n 70)
  PSTORAGE_GITHUB=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "\.github$|\.gitconfig$|\.git-credentials$|\.git$" | sort | uniq | head -n 70)
  PSTORAGE_SVN=$(echo -e "$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CDROM\n$FIND_DIR_OPT\n$FIND_DIR_SBIN\n$FIND_DIR_BIN\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_USR\n$FIND_DIR_SNAP\n$FIND_DIR_MEDIA\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_MNT\n$FIND_DIR_RUN\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "\.svn$" | sort | uniq | head -n 70)
  PSTORAGE_KEEPASS=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E ".*\.kdbx$|KeePass\.config.*$|KeePass\.ini$|KeePass\.enforced.*$" | sort | uniq | head -n 70)
  PSTORAGE_PRE_SHARED_KEYS=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E ".*\.psk$" | sort | uniq | head -n 70)
  PSTORAGE_PASS_STORE_DIRECTORIES=$(echo -e "$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CDROM\n$FIND_DIR_OPT\n$FIND_DIR_SBIN\n$FIND_DIR_BIN\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_USR\n$FIND_DIR_SNAP\n$FIND_DIR_MEDIA\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_MNT\n$FIND_DIR_RUN\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "\.password-store$" | sort | uniq | head -n 70)
  PSTORAGE_FTP=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "vsftpd\.conf$|.*\.ftpconfig$|ffftp\.ini$|ftp\.ini$|ftp\.config$|sites\.ini$|wcx_ftp\.ini$|winscp\.ini$|ws_ftp\.ini$" | sort | uniq | head -n 70)
  PSTORAGE_SAMBA=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "smb\.conf$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_SEEDDMS=$(echo -e "$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CDROM\n$FIND_DIR_OPT\n$FIND_DIR_SBIN\n$FIND_DIR_BIN\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_USR\n$FIND_DIR_SNAP\n$FIND_DIR_MEDIA\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_MNT\n$FIND_DIR_RUN\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "seeddms.*$" | sort | uniq | head -n 70)
  PSTORAGE_DDCLIENT=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "ddclient\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_KCPASSWORD=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "kcpassword$" | sort | uniq | head -n 70)
  PSTORAGE_SENTRY=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CDROM\n$FIND_DIR_OPT\n$FIND_DIR_SBIN\n$FIND_DIR_BIN\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_USR\n$FIND_DIR_SNAP\n$FIND_DIR_MEDIA\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_MNT\n$FIND_DIR_RUN\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "sentry$|sentry\.conf\.py$" | sort | uniq | head -n 70)
  PSTORAGE_STRAPI=$(echo -e "$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CDROM\n$FIND_DIR_OPT\n$FIND_DIR_SBIN\n$FIND_DIR_BIN\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_USR\n$FIND_DIR_SNAP\n$FIND_DIR_MEDIA\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_MNT\n$FIND_DIR_RUN\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "environments$" | sort | uniq | head -n 70)
  PSTORAGE_CACTI=$(echo -e "$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CDROM\n$FIND_DIR_OPT\n$FIND_DIR_SBIN\n$FIND_DIR_BIN\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_USR\n$FIND_DIR_SNAP\n$FIND_DIR_MEDIA\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_MNT\n$FIND_DIR_RUN\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "cacti$" | sort | uniq | head -n 70)
  PSTORAGE_ROUNDCUBE=$(echo -e "$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CDROM\n$FIND_DIR_OPT\n$FIND_DIR_SBIN\n$FIND_DIR_BIN\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_USR\n$FIND_DIR_SNAP\n$FIND_DIR_MEDIA\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_MNT\n$FIND_DIR_RUN\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "roundcube$" | sort | uniq | head -n 70)
  PSTORAGE_PASSBOLT=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "passbolt\.php$" | sort | uniq | head -n 70)
  PSTORAGE_JETTY=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "jetty-realm\.properties$" | sort | uniq | head -n 70)
  PSTORAGE_JENKINS=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_DIR_CACHE\n$FIND_DIR_SRV\n$FIND_DIR_ETC\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_CDROM\n$FIND_DIR_OPT\n$FIND_DIR_SBIN\n$FIND_DIR_BIN\n$FIND_DIR_TMP\n$FIND_DIR_VAR\n$FIND_DIR_PRIVATE\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_CONCOURSE_AUTH\n$FIND_DIR_USR\n$FIND_DIR_SNAP\n$FIND_DIR_MEDIA\n$FIND_DIR_CONCOURSE_KEYS\n$FIND_DIR_MNT\n$FIND_DIR_RUN\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "master\.key$|hudson\.util\.Secret$|credentials\.xml$|config\.xml$|.*jenkins$" | sort | uniq | head -n 70)
  PSTORAGE_WGET=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "\.wgetrc$" | sort | uniq | head -n 70)
  PSTORAGE_INTERESTING_LOGS=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "access\.log$|error\.log$" | sort | uniq | head -n 70)
  PSTORAGE_OTHER_INTERESTING=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "\.bashrc$|\.google_authenticator$|hosts\.equiv$|\.lesshst$|\.plan$|\.profile$|\.recently-used\.xbel$|\.rhosts$|\.sudo_as_admin_successful$" | sort | uniq | head -n 70)
  PSTORAGE_WINDOWS=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E ".*\.rdg$|AppEvent\.Evt$|autounattend\.xml$|ConsoleHost_history\.txt$|FreeSSHDservice\.ini$|NetSetup\.log$|Ntds\.dit$|protecteduserkey\.bin$|RDCMan\.settings$|SAM$|SYSTEM$|SecEvent\.Evt$|appcmd\.exe$|bash\.exe$|datasources\.xml$|default\.sav$|drives\.xml$|groups\.xml$|https-xampp\.conf$|https\.conf$|iis6\.log$|index\.dat$|my\.cnf$|my\.ini$|ntuser\.dat$|pagefile\.sys$|printers\.xml$|recentservers\.xml$|scclient\.exe$|scheduledtasks\.xml$|security\.sav$|server\.xml$|setupinfo$|setupinfo\.bak$|sitemanager\.xml$|sites\.ini$|software$|software\.sav$|sysprep\.inf$|sysprep\.xml$|system\.sav$|unattend\.inf$|unattend\.txt$|unattend\.xml$|unattended\.xml$|wcx_ftp\.ini$|ws_ftp\.ini$|web.*\.config$|winscp\.ini$|wsl\.exe$|plum\.sqlite$" | sort | uniq | head -n 70)
  PSTORAGE_DATABASE=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -v -E '/man/|/usr/|/var/cache/|/man/|/usr/|/var/cache/|thumbcache|iconcache|IconCache' | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E ".*\.db$|.*\.sqlite$|.*\.sqlite3$" | sort | uniq | head -n 70)
  PSTORAGE_BACKUPS=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "backup$|backups$" | sort | uniq | head -n 70)
  PSTORAGE_PASSWORD_FILES=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E ".*password.*$|.*credential.*$|creds.*$|.*\.maintenance.*$|.*\.key$" | sort | uniq | head -n 70)
  PSTORAGE_CRONTAB_UI=$(echo -e "$FIND_USR\n$FIND_BIN\n$FIND_LIB32\n$FIND_CONCOURSE_KEYS\n$FIND_SNAP\n$FIND_LIB64\n$FIND_SYSTEM\n$FIND_TMP\n$FIND_HOMESEARCH\n$FIND_SYS\n$FIND_MNT\n$FIND_APPLICATIONS\n$FIND_SBIN\n$FIND_VAR\n$FIND_SYSTEMD\n$FIND_CONCOURSE_AUTH\n$FIND_RUN\n$FIND_OPT\n$FIND_PRIVATE\n$FIND_CDROM\n$FIND_MEDIA\n$FIND_CACHE\n$FIND_ETC\n$FIND_LIB\n$FIND_SRV\n$FIND_CUSTOM\n$FIND_DIR_CUSTOM"  | grep -E "^${ROOT_FOLDER}cdrom|^${ROOT_FOLDER}mnt|^${ROOT_FOLDER}sbin|^${ROOT_FOLDER}bin|^${ROOT_FOLDER}applications|^${ROOT_FOLDER}opt|^${ROOT_FOLDER}snap|^${ROOT_FOLDER}tmp|^${ROOT_FOLDER}var|^${ROOT_FOLDER}.cache|^$GREPHOMESEARCH|^${ROOT_FOLDER}etc|^${ROOT_FOLDER}private|^${ROOT_FOLDER}media|^${ROOT_FOLDER}srv|^${ROOT_FOLDER}usr" | grep -E "crontab\.db$|crontab-ui\.service$" | sort | uniq | head -n 70)
